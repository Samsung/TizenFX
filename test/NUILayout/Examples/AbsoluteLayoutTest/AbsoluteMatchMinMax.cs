...
namespace NUILayout
{
    internal class AbsoluteMatchMinMax : View, IExample
    {
        public AbsoluteMatchMinMax()
        {
            ...
            var view = new View()
            {
                ...
                MinimumSize = new Size2D(200, 200),
        ...
        public void Activate()
        {
            ...
            {
                AppBar = new AppBar() { Title = "MatchParent Min Max", BackgroundColor = Color.White },
                Content = this,
                WidthSpecification = LayoutParamPolicies.MatchParent,
                HeightSpecification = LayoutParamPolicies.MatchParent,
