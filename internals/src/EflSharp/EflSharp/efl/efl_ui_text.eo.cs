...
/// <param name="style">The widget style to use. See <see cref="Efl.Ui.Widget.SetStyle" /></param>
    ...
    /// <summary>Set the input panel layout of the entry.</summary>
    /// <param name="layout">Layout type.<br/>The default value is <see cref="Elm.Input.Panel.Layout.Invalid"/>.</param>
    ...
    /// If <c>enabled</c> is <c>true</c>, the return key on input panel is disabled when the entry has no text. The return key on the input panel is automatically enabled when the entry has text.</summary>
    /// <param name="enabled">If <c>true</c>, the return key is automatically disabled when the entry has no text.<br/>The default value is <c>false</c>.</param>
...
rect = _out_rect;
    ...
    protected virtual bool RemoveSelection(int selection_number) {
    ...
    public new class NativeMethods : Efl.Ui.LayoutBase.NativeMethods
    {
        ...
        public override System.Collections.Generic.List<Efl_Op_Description> GetEoOps(System.Type type, bool includeInherited)
        {
            ...
            if (methods.FirstOrDefault(m => m.Name == "CopySelection") != null)
            {
            ...
            if (methods.FirstOrDefault(m => m.Name == "PasteSelection") != null)
            {
            ...
            if (methods.FirstOrDefault(m => m.Name == "CutSelection") != null)
            {
            ...
            if (methods.FirstOrDefault(m => m.Name == "RemoveSelection") != null)
            {
...
bool _ret_var = default(bool);
        ...
        private static bool selection_remove(System.IntPtr obj, System.IntPtr pd, int selection_number)
        {
            ...
            if (ws != null)
            {
                ...
                try
                {
                    _ret_var = ((Text)ws.Target).RemoveSelection(selection_number);
                }
                catch (Exception e)
                {
                    Eina.Log.Warning($"Callback error: {e.ToString()}");
