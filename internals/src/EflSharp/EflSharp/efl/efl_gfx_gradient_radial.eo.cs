    ...
    , Efl.Gfx.IGradient
{
    ...
    public System.IntPtr NativeClass {
        get {
            if (((object)this).GetType() == typeof (IGradientRadialConcrete))
                return Efl.Gfx.IGradientRadialNativeInherit.GetEflClassStatic();
            else
    ...
    public void GetCenter( out double x,  out double y) {
                                                         Efl.Gfx.IGradientRadialNativeInherit.efl_gfx_gradient_radial_center_get_ptr.Value.Delegate(this.NativeHandle, out x,  out y);
    ...
    public void SetCenter( double x,  double y) {
                                                         Efl.Gfx.IGradientRadialNativeInherit.efl_gfx_gradient_radial_center_set_ptr.Value.Delegate(this.NativeHandle, x,  y);
        Eina.Error.RaiseIfUnhandledException();
                                         }
    /// <summary>Gets the center radius of this radial gradient.</summary>
    /// <returns>Center radius</returns>
    public double GetRadius() {
         var _ret_var = Efl.Gfx.IGradientRadialNativeInherit.efl_gfx_gradient_radial_radius_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    /// <summary>Sets the center radius of this radial gradient.</summary>
    ...
    public void SetRadius( double r) {
                                 Efl.Gfx.IGradientRadialNativeInherit.efl_gfx_gradient_radial_radius_set_ptr.Value.Delegate(this.NativeHandle, r);
        Eina.Error.RaiseIfUnhandledException();
                         }
    /// <summary>Gets the focal point of this radial gradient.</summary>
    /// <param name="x">X co-ordinate of focal point</param>
    ...
    public void GetFocal( out double x,  out double y) {
                                                         Efl.Gfx.IGradientRadialNativeInherit.efl_gfx_gradient_radial_focal_get_ptr.Value.Delegate(this.NativeHandle, out x,  out y);
        Eina.Error.RaiseIfUnhandledException();
                                         }
    /// <summary>Sets the focal point of this radial gradient.</summary>
    /// <param name="x">X co-ordinate of focal point</param>
    ...
    public void SetFocal( double x,  double y) {
                                                         Efl.Gfx.IGradientRadialNativeInherit.efl_gfx_gradient_radial_focal_set_ptr.Value.Delegate(this.NativeHandle, x,  y);
        Eina.Error.RaiseIfUnhandledException();
                                         }
...
public class IGradientRadialNativeInherit  : Efl.Eo.NativeClass{
