...
using static UIKit.DataTypes.EinaNative.StrbufNativeMethods;
...
static internal class StrbufNativeMethods
{
    ...
    [return:
     MarshalAs(UnmanagedType.CustomMarshaler,
	       MarshalTypeRef=typeof(UIKit.Wrapper.StringKeepOwnershipMarshaler))]
...
public class Strbuf : IDisposable
{
    ...
    protected virtual void Dispose(bool disposing)
    {
        ...
        if (!Disposed && (Handle != IntPtr.Zero))
        {
            ...
            {
                UIKit.Wrapper.Globals.ThreadSafeFreeCbExec(eina_strbuf_free, Handle);
            }
