...
public class Fallback : Efl.Object, Efl.Eo.IWrapper,Efl.Canvas.TextFactory
{
   ...
   public new delegate void ConstructingMethod(Fallback obj);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)] internal static extern System.IntPtr
      efl_ui_text_factory_fallback_class_get();
   ///<summary>Creates a new instance.</summary>
   ///<param name="parent">Parent instance.</param>
   ///<param name="init_cb">Delegate to call constructing methods that should be run inside the constructor.</param>
   public Fallback(Efl.Object parent = null, ConstructingMethod init_cb=null) : base("Fallback", efl_ui_text_factory_fallback_class_get(), typeof(Fallback), parent)
   {
      if (init_cb != null) {
         init_cb(this);
      }
   ...
   protected Fallback(String klass_name, IntPtr base_klass, System.Type managed_type, Efl.Object parent) : base(klass_name, base_klass, managed_type, parent) {}
