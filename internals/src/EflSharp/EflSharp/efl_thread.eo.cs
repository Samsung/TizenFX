...
/// <summary></summary>
[ThreadNativeInherit]
public class Thread : Efl.Task, Efl.Eo.IWrapper,Efl.ThreadIO
{
   ...
   public new delegate void ConstructingMethod(Thread obj);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Ecore)] internal static extern System.IntPtr
      efl_thread_class_get();
   ///<summary>Creates a new instance.</summary>
   ///<param name="parent">Parent instance.</param>
   ///<param name="init_cb">Delegate to call constructing methods that should be run inside the constructor.</param>
   public Thread(Efl.Object parent = null, ConstructingMethod init_cb=null) : base("Thread", efl_thread_class_get(), typeof(Thread), parent)
   {
      if (init_cb != null) {
         init_cb(this);
      }
   ...
   protected Thread(String klass_name, IntPtr base_klass, System.Type managed_type, Efl.Object parent) : base(klass_name, base_klass, managed_type, parent) {}
