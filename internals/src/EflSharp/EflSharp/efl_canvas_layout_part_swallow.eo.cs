...
public class LayoutPartSwallow : Efl.Canvas.LayoutPart, Efl.Eo.IWrapper,Efl.Content
{
   ...
   public new delegate void ConstructingMethod(LayoutPartSwallow obj);
   ...
   public LayoutPartSwallow(Efl.Object parent = null, ConstructingMethod init_cb=null) : base("LayoutPartSwallow", efl_canvas_layout_part_swallow_class_get(), typeof(LayoutPartSwallow), parent)
   {
      if (init_cb != null) {
         init_cb(this);
      }
   ...
   protected LayoutPartSwallow(String klass_name, IntPtr base_klass, System.Type managed_type, Efl.Object parent) : base(klass_name, base_klass, managed_type, parent) {}
