    ...
    
{
    ...
    public System.IntPtr NativeClass {
        get {
            if (((object)this).GetType() == typeof (IConfigConcrete))
                return Efl.IConfigNativeInherit.GetEflClassStatic();
            else
    ...
    public Eina.Value GetConfig( System.String name) {
                                 var _ret_var = Efl.IConfigNativeInherit.efl_config_get_ptr.Value.Delegate(this.NativeHandle, name);
    ...
    public bool SetConfig( System.String name,  Eina.Value value) {
                                                         var _ret_var = Efl.IConfigNativeInherit.efl_config_set_ptr.Value.Delegate(this.NativeHandle, name,  value);
        Eina.Error.RaiseIfUnhandledException();
                                        return _ret_var;
 }
...
public class IConfigNativeInherit  : Efl.Eo.NativeClass{
