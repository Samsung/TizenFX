...
/// <summary>Event argument wrapper for event <see cref="Efl.Ui.CollectionView.ItemRealizedEvent"/>.</summary>
[Efl.Eo.BindingEntity]
public class CollectionViewItemRealizedEventArgs : EventArgs {
    /// <summary>Actual event payload.</summary>
    /// <value>Event triggered when an <see cref="Efl.Ui.Item"/> has been provided by the <see cref="Efl.Ui.IFactory"/> and is about to be used.</value>
    public Efl.Ui.Item arg { get; set; }
}

/// <summary>Event argument wrapper for event <see cref="Efl.Ui.CollectionView.ItemUnrealizedEvent"/>.</summary>
[Efl.Eo.BindingEntity]
public class CollectionViewItemUnrealizedEventArgs : EventArgs {
    /// <summary>Actual event payload.</summary>
    /// <value>Event triggered when the <see cref="Efl.Ui.CollectionView"/> is about to give an <see cref="Efl.Ui.Item"/> back to the <see cref="Efl.Ui.IFactory"/>.</value>
    public Efl.Ui.Item arg { get; set; }
}

/// <summary>This widget displays a list of items in an arrangement controlled by an external <see cref="Efl.Ui.CollectionView.PositionManager"/> object. By using different <see cref="Efl.Ui.CollectionView.PositionManager"/> objects this widget can show unidimensional lists or two-dimensional grids of items, for example.
/// This class is intended to act as a base for widgets like List_View or <see cref="Efl.Ui.GridView"/>, which hide this complexity from the user.
/// 
/// Items are generated by the <see cref="Efl.Ui.IFactory"/> defined with .factory.set to match the content of the <see cref="Efl.IModel"/> defined with <see cref="Efl.Ui.IView.SetModel"/>. They are dynamically created/destroyed to only have the one that are necessary to display all the one that are to far out of the viewport will not be created to lighten the usage for very large list.
/// 
...
[Efl.Ui.CollectionView.NativeMethods]
[Efl.Eo.BindingEntity]
public class CollectionView : Efl.Ui.LayoutBase, Efl.Ui.IItemClickable, Efl.Ui.ILayoutOrientable, Efl.Ui.IMultiSelectableAsync, Efl.Ui.IScrollable, Efl.Ui.IScrollbar, Efl.Ui.ISingleSelectable, Efl.Ui.IWidgetFocusManager, Efl.Ui.Focus.IManager, Efl.Ui.Focus.IManagerSub
{
...
/// <param name="style">The widget style to use. See <see cref="Efl.Ui.Widget.SetStyle" /></param>
    public CollectionView(Efl.Object parent
            , System.String style = null) : base(efl_ui_collection_view_class_get(), parent)
    {
    ...
    protected CollectionView(Efl.Eo.Globals.WrappingHandle wh) : base(wh)
    {
    }
    ...
    protected CollectionView(IntPtr baseKlass, Efl.Object parent) : base(baseKlass, parent)
    {
    }

    /// <summary>Event triggered when an <see cref="Efl.Ui.Item"/> has been provided by the <see cref="Efl.Ui.IFactory"/> and is about to be used.</summary>
    /// <value><see cref="Efl.Ui.CollectionViewItemRealizedEventArgs"/></value>
    public event EventHandler<Efl.Ui.CollectionViewItemRealizedEventArgs> ItemRealizedEvent
    {
        add
        {
            lock (eflBindingEventLock)
            {
                Efl.EventCb callerCb = (IntPtr data, ref Efl.Event.NativeStruct evt) =>
                {
                    ...
                    if (obj != null)
                    {
                        Efl.Ui.CollectionViewItemRealizedEventArgs args = new Efl.Ui.CollectionViewItemRealizedEventArgs();
    ...
    public void OnItemRealizedEvent(Efl.Ui.CollectionViewItemRealizedEventArgs e)
    {
        var key = "_EFL_UI_COLLECTION_VIEW_EVENT_ITEM_REALIZED";
    ...
    /// <summary>Event triggered when the <see cref="Efl.Ui.CollectionView"/> is about to give an <see cref="Efl.Ui.Item"/> back to the <see cref="Efl.Ui.IFactory"/>.</summary>
    /// <value><see cref="Efl.Ui.CollectionViewItemUnrealizedEventArgs"/></value>
    public event EventHandler<Efl.Ui.CollectionViewItemUnrealizedEventArgs> ItemUnrealizedEvent
    {
        add
        {
            lock (eflBindingEventLock)
            {
                Efl.EventCb callerCb = (IntPtr data, ref Efl.Event.NativeStruct evt) =>
                {
                    ...
                    if (obj != null)
                    {
                        Efl.Ui.CollectionViewItemUnrealizedEventArgs args = new Efl.Ui.CollectionViewItemUnrealizedEventArgs();
                        args.arg = (Efl.Eo.Globals.CreateWrapperFor(evt.Info) as Efl.Ui.Item);
                        try
                        {
                            value?.Invoke(obj, args);
    ...
    /// <param name="e">Event to raise.</param>
    public void OnItemUnrealizedEvent(Efl.Ui.CollectionViewItemUnrealizedEventArgs e)
    {
        var key = "_EFL_UI_COLLECTION_VIEW_EVENT_ITEM_UNREALIZED";
        IntPtr desc = Efl.EventDescription.GetNative(efl.Libs.Elementary, key);
        if (desc == IntPtr.Zero)
        {
            Eina.Log.Error($"Failed to get native event {key}");
    ...
    public virtual Efl.Ui.IFactory GetFactory() {
        var _ret_var = Efl.Ui.CollectionView.NativeMethods.efl_ui_collection_view_factory_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass)));
    ...
    public virtual void SetFactory(Efl.Ui.IFactory factory) {
        Efl.Ui.CollectionView.NativeMethods.efl_ui_collection_view_factory_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass)),factory);
        Eina.Error.RaiseIfUnhandledException();
    ...
    public virtual Efl.Ui.PositionManager.IEntity GetPositionManager() {
        var _ret_var = Efl.Ui.CollectionView.NativeMethods.efl_ui_collection_view_position_manager_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass)));
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SetPositionManager(Efl.Ui.PositionManager.IEntity position_manager) {
        Efl.Ui.CollectionView.NativeMethods.efl_ui_collection_view_position_manager_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass)),position_manager);
        Eina.Error.RaiseIfUnhandledException();
...
var _ret_var = Efl.Ui.Focus.ManagerConcrete.NativeMethods.efl_ui_focus_manager_viewport_elements_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass)),_in_viewport);
    ...
    public Efl.Ui.IFactory Factory {
    ...
    {
        return Efl.Ui.CollectionView.efl_ui_collection_view_class_get();
    }
    ...
    public new class NativeMethods : Efl.Ui.LayoutBase.NativeMethods
    {
        ...
        public override System.Collections.Generic.List<Efl_Op_Description> GetEoOps(System.Type type, bool includeInherited)
        {
            ...
            if (methods.FirstOrDefault(m => m.Name == "GetFactory") != null)
            {
                descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.FunctionInterop.LoadFunctionPointer(Module.Module, "efl_ui_collection_view_factory_get"), func = Marshal.GetFunctionPointerForDelegate(efl_ui_collection_view_factory_get_static_delegate) });
            }
            ...
            if (methods.FirstOrDefault(m => m.Name == "SetFactory") != null)
            {
                descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.FunctionInterop.LoadFunctionPointer(Module.Module, "efl_ui_collection_view_factory_set"), func = Marshal.GetFunctionPointerForDelegate(efl_ui_collection_view_factory_set_static_delegate) });
            }
            ...
            {
                descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.FunctionInterop.LoadFunctionPointer(Module.Module, "efl_ui_collection_view_position_manager_get"), func = Marshal.GetFunctionPointerForDelegate(efl_ui_collection_view_position_manager_get_static_delegate) });
            }
            ...
            {
                descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.FunctionInterop.LoadFunctionPointer(Module.Module, "efl_ui_collection_view_position_manager_set"), func = Marshal.GetFunctionPointerForDelegate(efl_ui_collection_view_position_manager_set_static_delegate) });
            }
        ...
        private delegate Efl.Ui.IFactory efl_ui_collection_view_factory_get_delegate(System.IntPtr obj, System.IntPtr pd);

        [return:MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(Efl.Eo.MarshalEo<Efl.Eo.NonOwnTag>))]
        public delegate Efl.Ui.IFactory efl_ui_collection_view_factory_get_api_delegate(System.IntPtr obj);

        public static Efl.Eo.FunctionWrapper<efl_ui_collection_view_factory_get_api_delegate> efl_ui_collection_view_factory_get_ptr = new Efl.Eo.FunctionWrapper<efl_ui_collection_view_factory_get_api_delegate>(Module, "efl_ui_collection_view_factory_get");

        private static Efl.Ui.IFactory factory_get(System.IntPtr obj, System.IntPtr pd)
        {
            Eina.Log.Debug("function efl_ui_collection_view_factory_get was called");
            var ws = Efl.Eo.Globals.GetWrapperSupervisor(obj);
            if (ws != null)
            {
                Efl.Ui.IFactory _ret_var = default(Efl.Ui.IFactory);
                try
                {
            ...
            {
                return efl_ui_collection_view_factory_get_ptr.Value.Delegate(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)));
            }
        }
        ...
        private delegate void efl_ui_collection_view_factory_set_delegate(System.IntPtr obj, System.IntPtr pd, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(Efl.Eo.MarshalEo<Efl.Eo.NonOwnTag>))] Efl.Ui.IFactory factory);

        
        public delegate void efl_ui_collection_view_factory_set_api_delegate(System.IntPtr obj, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(Efl.Eo.MarshalEo<Efl.Eo.NonOwnTag>))] Efl.Ui.IFactory factory);

        public static Efl.Eo.FunctionWrapper<efl_ui_collection_view_factory_set_api_delegate> efl_ui_collection_view_factory_set_ptr = new Efl.Eo.FunctionWrapper<efl_ui_collection_view_factory_set_api_delegate>(Module, "efl_ui_collection_view_factory_set");

        private static void factory_set(System.IntPtr obj, System.IntPtr pd, Efl.Ui.IFactory factory)
        {
            Eina.Log.Debug("function efl_ui_collection_view_factory_set was called");
            var ws = Efl.Eo.Globals.GetWrapperSupervisor(obj);
            if (ws != null)
            {
            ...
            {
                efl_ui_collection_view_factory_set_ptr.Value.Delegate(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)), factory);
            }
        }
        ...
        private delegate Efl.Ui.PositionManager.IEntity efl_ui_collection_view_position_manager_get_delegate(System.IntPtr obj, System.IntPtr pd);

        [return:MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(Efl.Eo.MarshalEo<Efl.Eo.OwnTag>))]
        public delegate Efl.Ui.PositionManager.IEntity efl_ui_collection_view_position_manager_get_api_delegate(System.IntPtr obj);

        public static Efl.Eo.FunctionWrapper<efl_ui_collection_view_position_manager_get_api_delegate> efl_ui_collection_view_position_manager_get_ptr = new Efl.Eo.FunctionWrapper<efl_ui_collection_view_position_manager_get_api_delegate>(Module, "efl_ui_collection_view_position_manager_get");

        private static Efl.Ui.PositionManager.IEntity position_manager_get(System.IntPtr obj, System.IntPtr pd)
        {
            Eina.Log.Debug("function efl_ui_collection_view_position_manager_get was called");
            var ws = Efl.Eo.Globals.GetWrapperSupervisor(obj);
            if (ws != null)
            {
            ...
            {
                return efl_ui_collection_view_position_manager_get_ptr.Value.Delegate(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)));
            }
        }
        ...
        private delegate void efl_ui_collection_view_position_manager_set_delegate(System.IntPtr obj, System.IntPtr pd, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(Efl.Eo.MarshalEo<Efl.Eo.OwnTag>))] Efl.Ui.PositionManager.IEntity position_manager);

        
        public delegate void efl_ui_collection_view_position_manager_set_api_delegate(System.IntPtr obj, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(Efl.Eo.MarshalEo<Efl.Eo.OwnTag>))] Efl.Ui.PositionManager.IEntity position_manager);

        public static Efl.Eo.FunctionWrapper<efl_ui_collection_view_position_manager_set_api_delegate> efl_ui_collection_view_position_manager_set_ptr = new Efl.Eo.FunctionWrapper<efl_ui_collection_view_position_manager_set_api_delegate>(Module, "efl_ui_collection_view_position_manager_set");
        ...
        {
            Eina.Log.Debug("function efl_ui_collection_view_position_manager_set was called");
            var ws = Efl.Eo.Globals.GetWrapperSupervisor(obj);
            if (ws != null)
            {
            ...
            {
                efl_ui_collection_view_position_manager_set_ptr.Value.Delegate(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)), position_manager);
            }
        }
        ...
        private static void bar_visibility_update(System.IntPtr obj, System.IntPtr pd)
        {
            ...
            if (ws != null)
            {
                ...
                try
                {
                    ((CollectionView)ws.Target).UpdateBarVisibility();
                }
                catch (Exception e)
                {
                    Eina.Log.Warning($"Callback error: {e.ToString()}");
        ...
        private static Efl.Ui.Focus.IManager focus_manager_create(System.IntPtr obj, System.IntPtr pd, Efl.Ui.Focus.IObject root)
        {
            ...
            if (ws != null)
            {
                ...
                try
                {
                    _ret_var = ((CollectionView)ws.Target).CreateFocusManager(root);
                }
                catch (Exception e)
                {
                    Eina.Log.Warning($"Callback error: {e.ToString()}");
...
#if EFL_BETA
#pragma warning disable CS1591
public static class Efl_UiCollectionView_ExtensionMethods {
    public static Efl.BindableProperty<Efl.Ui.IFactory> Factory<T>(this Efl.Ui.ItemFactory<T> fac, Efl.Csharp.ExtensionTag<Efl.Ui.CollectionView, T>magic = null) where T : Efl.Ui.CollectionView {
        return new Efl.BindableProperty<Efl.Ui.IFactory>("factory", fac);
    }

    public static Efl.BindableProperty<Efl.Ui.PositionManager.IEntity> PositionManager<T>(this Efl.Ui.ItemFactory<T> fac, Efl.Csharp.ExtensionTag<Efl.Ui.CollectionView, T>magic = null) where T : Efl.Ui.CollectionView {
        return new Efl.BindableProperty<Efl.Ui.PositionManager.IEntity>("position_manager", fac);
    }

    public static Efl.BindableProperty<Efl.Ui.LayoutOrientation> Orientation<T>(this Efl.Ui.ItemFactory<T> fac, Efl.Csharp.ExtensionTag<Efl.Ui.CollectionView, T>magic = null) where T : Efl.Ui.CollectionView {
        return new Efl.BindableProperty<Efl.Ui.LayoutOrientation>("orientation", fac);
    }

    public static Efl.BindableProperty<Efl.Ui.SelectMode> SelectMode<T>(this Efl.Ui.ItemFactory<T> fac, Efl.Csharp.ExtensionTag<Efl.Ui.CollectionView, T>magic = null) where T : Efl.Ui.CollectionView {
        return new Efl.BindableProperty<Efl.Ui.SelectMode>("select_mode", fac);
    }

    public static Efl.BindableProperty<Eina.Position2D> ContentPos<T>(this Efl.Ui.ItemFactory<T> fac, Efl.Csharp.ExtensionTag<Efl.Ui.CollectionView, T>magic = null) where T : Efl.Ui.CollectionView {
        return new Efl.BindableProperty<Eina.Position2D>("content_pos", fac);
    }

    public static Efl.BindableProperty<bool> ScrollFreeze<T>(this Efl.Ui.ItemFactory<T> fac, Efl.Csharp.ExtensionTag<Efl.Ui.CollectionView, T>magic = null) where T : Efl.Ui.CollectionView {
        return new Efl.BindableProperty<bool>("scroll_freeze", fac);
    }

    public static Efl.BindableProperty<bool> ScrollHold<T>(this Efl.Ui.ItemFactory<T> fac, Efl.Csharp.ExtensionTag<Efl.Ui.CollectionView, T>magic = null) where T : Efl.Ui.CollectionView {
        return new Efl.BindableProperty<bool>("scroll_hold", fac);
    }

    public static Efl.BindableProperty<Efl.Ui.LayoutOrientation> MovementBlock<T>(this Efl.Ui.ItemFactory<T> fac, Efl.Csharp.ExtensionTag<Efl.Ui.CollectionView, T>magic = null) where T : Efl.Ui.CollectionView {
        return new Efl.BindableProperty<Efl.Ui.LayoutOrientation>("movement_block", fac);
    }

    public static Efl.BindableProperty<Eina.Position2D> StepSize<T>(this Efl.Ui.ItemFactory<T> fac, Efl.Csharp.ExtensionTag<Efl.Ui.CollectionView, T>magic = null) where T : Efl.Ui.CollectionView {
        return new Efl.BindableProperty<Eina.Position2D>("step_size", fac);
    }

    public static Efl.BindableProperty<Efl.Ui.ISelectable> FallbackSelection<T>(this Efl.Ui.ItemFactory<T> fac, Efl.Csharp.ExtensionTag<Efl.Ui.CollectionView, T>magic = null) where T : Efl.Ui.CollectionView {
        return new Efl.BindableProperty<Efl.Ui.ISelectable>("fallback_selection", fac);
    }

    public static Efl.BindableProperty<Efl.Ui.Focus.IObject> ManagerFocus<T>(this Efl.Ui.ItemFactory<T> fac, Efl.Csharp.ExtensionTag<Efl.Ui.CollectionView, T>magic = null) where T : Efl.Ui.CollectionView {
        return new Efl.BindableProperty<Efl.Ui.Focus.IObject>("manager_focus", fac);
    }

    public static Efl.BindableProperty<Efl.Ui.Focus.IManager> Redirect<T>(this Efl.Ui.ItemFactory<T> fac, Efl.Csharp.ExtensionTag<Efl.Ui.CollectionView, T>magic = null) where T : Efl.Ui.CollectionView {
        return new Efl.BindableProperty<Efl.Ui.Focus.IManager>("redirect", fac);
    }

    public static Efl.BindableProperty<Efl.Ui.Focus.IObject> Root<T>(this Efl.Ui.ItemFactory<T> fac, Efl.Csharp.ExtensionTag<Efl.Ui.CollectionView, T>magic = null) where T : Efl.Ui.CollectionView {
