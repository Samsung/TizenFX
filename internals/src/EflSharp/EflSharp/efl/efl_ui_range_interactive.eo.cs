...
[Efl.Ui.RangeInteractiveConcrete.NativeMethods]
    ...
    , Efl.Ui.IRangeDisplay
{
    ...
    private RangeInteractiveConcrete(Efl.Eo.Globals.WrappingHandle wh) : base(wh)
    {
    }
...
#pragma warning disable CS0628
    ...
    public double GetRangeStep() {
         var _ret_var = Efl.Ui.RangeInteractiveConcrete.NativeMethods.efl_ui_range_step_get_ptr.Value.Delegate(this.NativeHandle);
    ...
    public void SetRangeStep(double step) {
                                 Efl.Ui.RangeInteractiveConcrete.NativeMethods.efl_ui_range_step_set_ptr.Value.Delegate(this.NativeHandle,step);
        Eina.Error.RaiseIfUnhandledException();
                         }
...
#if EFL_BETA
#pragma warning disable CS1591
public static class Efl_UiRangeInteractiveConcrete_ExtensionMethods {
