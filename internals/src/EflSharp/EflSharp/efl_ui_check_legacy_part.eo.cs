...
public class CheckLegacyPart : Efl.Ui.LayoutPartContent, Efl.Eo.IWrapper
{
   ...
   public new delegate void ConstructingMethod(CheckLegacyPart obj);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)] internal static extern System.IntPtr
      efl_ui_check_legacy_part_class_get();
   ///<summary>Creates a new instance.</summary>
   ///<param name="parent">Parent instance.</param>
   ///<param name="init_cb">Delegate to call constructing methods that should be run inside the constructor.</param>
   public CheckLegacyPart(Efl.Object parent = null, ConstructingMethod init_cb=null) : base("CheckLegacyPart", efl_ui_check_legacy_part_class_get(), typeof(CheckLegacyPart), parent)
   {
      if (init_cb != null) {
         init_cb(this);
      }
   ...
   protected CheckLegacyPart(String klass_name, IntPtr base_klass, System.Type managed_type, Efl.Object parent) : base(klass_name, base_klass, managed_type, parent) {}
