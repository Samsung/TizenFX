...
namespace Tizen.NUI.Devel.Tests
{
    ...
    public class PublicSpannedTest
    {
        ...
        public void SpannedRetrieveAllSpansAndRanges()
        {
            ...
            Assert.IsInstanceOf<ForegroundColorSpan>( spans[0], "Should return List<BaseSpan> instance.");
            Assert.IsInstanceOf<Tizen.NUI.Range>( ranges[0], "Should return List<BaseSpan> instance.");
