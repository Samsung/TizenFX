...
public class ConfigGlobal : Efl.Object, Efl.IConfig
{
    ...
    public virtual Eina.Iterator<System.String> IterateProfile(bool hidden) {
    ...
    public new class NativeMethods : Efl.Object.NativeMethods
    {
        ...
        public override System.Collections.Generic.List<Efl_Op_Description> GetEoOps(System.Type type, bool includeInherited)
        {
            ...
            if (methods.FirstOrDefault(m => m.Name == "IterateProfile") != null)
            {
        ...
        private static System.IntPtr profile_iterate(System.IntPtr obj, System.IntPtr pd, bool hidden)
        {
            ...
            if (ws != null)
            {
                ...
                try
                {
                    _ret_var = ((ConfigGlobal)ws.Target).IterateProfile(hidden);
                }
                catch (Exception e)
                {
                    Eina.Log.Warning($"Callback error: {e.ToString()}");
