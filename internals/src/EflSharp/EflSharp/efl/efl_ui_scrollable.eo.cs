...
#pragma warning disable CS0628
    ...
    public Eina.Position2D GetContentPos() {
        var _ret_var = Efl.Ui.ScrollableConcrete.NativeMethods.efl_ui_scrollable_content_pos_get_ptr.Value.Delegate(this.NativeHandle);
...
Efl.Ui.ScrollableConcrete.NativeMethods.efl_ui_scrollable_content_pos_set_ptr.Value.Delegate(this.NativeHandle,_in_pos);
        Eina.Error.RaiseIfUnhandledException();
    ...
    public Eina.Size2D GetContentSize() {
        var _ret_var = Efl.Ui.ScrollableConcrete.NativeMethods.efl_ui_scrollable_content_size_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public Eina.Rect GetViewportGeometry() {
        var _ret_var = Efl.Ui.ScrollableConcrete.NativeMethods.efl_ui_scrollable_viewport_geometry_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public void GetBounceEnabled(out bool horiz, out bool vert) {
        Efl.Ui.ScrollableConcrete.NativeMethods.efl_ui_scrollable_bounce_enabled_get_ptr.Value.Delegate(this.NativeHandle,out horiz, out vert);
        Eina.Error.RaiseIfUnhandledException();
    ...
    public void SetBounceEnabled(bool horiz, bool vert) {
        Efl.Ui.ScrollableConcrete.NativeMethods.efl_ui_scrollable_bounce_enabled_set_ptr.Value.Delegate(this.NativeHandle,horiz, vert);
        Eina.Error.RaiseIfUnhandledException();
    ...
    public bool GetScrollFreeze() {
        var _ret_var = Efl.Ui.ScrollableConcrete.NativeMethods.efl_ui_scrollable_scroll_freeze_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public void SetScrollFreeze(bool freeze) {
        Efl.Ui.ScrollableConcrete.NativeMethods.efl_ui_scrollable_scroll_freeze_set_ptr.Value.Delegate(this.NativeHandle,freeze);
        Eina.Error.RaiseIfUnhandledException();
    ...
    public bool GetScrollHold() {
        var _ret_var = Efl.Ui.ScrollableConcrete.NativeMethods.efl_ui_scrollable_scroll_hold_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public void SetScrollHold(bool hold) {
        Efl.Ui.ScrollableConcrete.NativeMethods.efl_ui_scrollable_scroll_hold_set_ptr.Value.Delegate(this.NativeHandle,hold);
        Eina.Error.RaiseIfUnhandledException();
    ...
    public void GetLooping(out bool loop_h, out bool loop_v) {
        Efl.Ui.ScrollableConcrete.NativeMethods.efl_ui_scrollable_looping_get_ptr.Value.Delegate(this.NativeHandle,out loop_h, out loop_v);
        Eina.Error.RaiseIfUnhandledException();
    ...
    public void SetLooping(bool loop_h, bool loop_v) {
        Efl.Ui.ScrollableConcrete.NativeMethods.efl_ui_scrollable_looping_set_ptr.Value.Delegate(this.NativeHandle,loop_h, loop_v);
        Eina.Error.RaiseIfUnhandledException();
    ...
    public Efl.Ui.LayoutOrientation GetMovementBlock() {
        var _ret_var = Efl.Ui.ScrollableConcrete.NativeMethods.efl_ui_scrollable_movement_block_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public void SetMovementBlock(Efl.Ui.LayoutOrientation block) {
        Efl.Ui.ScrollableConcrete.NativeMethods.efl_ui_scrollable_movement_block_set_ptr.Value.Delegate(this.NativeHandle,block);
        Eina.Error.RaiseIfUnhandledException();
    ...
    public void GetGravity(out double x, out double y) {
        Efl.Ui.ScrollableConcrete.NativeMethods.efl_ui_scrollable_gravity_get_ptr.Value.Delegate(this.NativeHandle,out x, out y);
        Eina.Error.RaiseIfUnhandledException();
    ...
    public void SetGravity(double x, double y) {
        Efl.Ui.ScrollableConcrete.NativeMethods.efl_ui_scrollable_gravity_set_ptr.Value.Delegate(this.NativeHandle,x, y);
        Eina.Error.RaiseIfUnhandledException();
    ...
    public void SetMatchContent(bool w, bool h) {
        Efl.Ui.ScrollableConcrete.NativeMethods.efl_ui_scrollable_match_content_set_ptr.Value.Delegate(this.NativeHandle,w, h);
        Eina.Error.RaiseIfUnhandledException();
    ...
    public Eina.Position2D GetStepSize() {
        var _ret_var = Efl.Ui.ScrollableConcrete.NativeMethods.efl_ui_scrollable_step_size_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
...
Efl.Ui.ScrollableConcrete.NativeMethods.efl_ui_scrollable_step_size_set_ptr.Value.Delegate(this.NativeHandle,_in_step);
        Eina.Error.RaiseIfUnhandledException();
...
Efl.Ui.ScrollableConcrete.NativeMethods.efl_ui_scrollable_scroll_ptr.Value.Delegate(this.NativeHandle,_in_rect, animation);
        Eina.Error.RaiseIfUnhandledException();
...
public static class Efl_UiScrollableConcrete_ExtensionMethods {
    public static Efl.BindableProperty<Eina.Position2D> ContentPos<T>(this Efl.Ui.ItemFactory<T> fac, Efl.Csharp.ExtensionTag<Efl.Ui.IScrollable, T>magic = null) where T : Efl.Ui.IScrollable {
        return new Efl.BindableProperty<Eina.Position2D>("content_pos", fac);
    }

    public static Efl.BindableProperty<bool> ScrollFreeze<T>(this Efl.Ui.ItemFactory<T> fac, Efl.Csharp.ExtensionTag<Efl.Ui.IScrollable, T>magic = null) where T : Efl.Ui.IScrollable {
        return new Efl.BindableProperty<bool>("scroll_freeze", fac);
    }

    public static Efl.BindableProperty<bool> ScrollHold<T>(this Efl.Ui.ItemFactory<T> fac, Efl.Csharp.ExtensionTag<Efl.Ui.IScrollable, T>magic = null) where T : Efl.Ui.IScrollable {
        return new Efl.BindableProperty<bool>("scroll_hold", fac);
    }

    public static Efl.BindableProperty<Efl.Ui.LayoutOrientation> MovementBlock<T>(this Efl.Ui.ItemFactory<T> fac, Efl.Csharp.ExtensionTag<Efl.Ui.IScrollable, T>magic = null) where T : Efl.Ui.IScrollable {
        return new Efl.BindableProperty<Efl.Ui.LayoutOrientation>("movement_block", fac);
    }

    public static Efl.BindableProperty<Eina.Position2D> StepSize<T>(this Efl.Ui.ItemFactory<T> fac, Efl.Csharp.ExtensionTag<Efl.Ui.IScrollable, T>magic = null) where T : Efl.Ui.IScrollable {
