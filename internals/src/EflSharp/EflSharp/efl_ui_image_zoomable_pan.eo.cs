...
public class ImageZoomablePan : Efl.Ui.Pan, Efl.Eo.IWrapper
{
   ...
   public new delegate void ConstructingMethod(ImageZoomablePan obj);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)] internal static extern System.IntPtr
      efl_ui_image_zoomable_pan_class_get();
   ///<summary>Creates a new instance.</summary>
   ///<param name="parent">Parent instance.</param>
   ///<param name="init_cb">Delegate to call constructing methods that should be run inside the constructor.</param>
   public ImageZoomablePan(Efl.Object parent = null, ConstructingMethod init_cb=null) : base("ImageZoomablePan", efl_ui_image_zoomable_pan_class_get(), typeof(ImageZoomablePan), parent)
   {
      if (init_cb != null) {
         init_cb(this);
      }
   ...
   protected ImageZoomablePan(String klass_name, IntPtr base_klass, System.Type managed_type, Efl.Object parent) : base(klass_name, base_klass, managed_type, parent) {}
