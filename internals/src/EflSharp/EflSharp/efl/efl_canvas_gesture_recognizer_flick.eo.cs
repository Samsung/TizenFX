...
/// <summary>This is the recognizer for Flick gestures. See <see cref="Efl.Canvas.GestureFlick"/> and <see cref="Efl.Canvas.GestureRecognizer"/>. For internal use only.</summary>
