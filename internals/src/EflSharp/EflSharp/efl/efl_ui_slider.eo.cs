...
/// This lets the UI user select a numerical value inside the <see cref="Efl.Ui.IRangeDisplay.GetRangeLimits"/> limits. The current value can be retrieved using the <see cref="Efl.Ui.IRangeInteractive"/> interface. Events monitoring its changes are also available in that interface. The visual representation of min and max can be swapped using <see cref="Efl.Ui.ILayoutOrientable.Orientation"/>. Normally the minimum of <see cref="Efl.Ui.IRangeDisplay.GetRangeLimits"/> is shown on the left side, the max on the right side.</summary>
...
public class Slider : Efl.Ui.LayoutBase, Efl.Access.IValue, Efl.Ui.ILayoutOrientable, Efl.Ui.IRangeDisplay, Efl.Ui.IRangeInteractive
{
    ...
    /// <summary>Method to raise event SliderDragStartEvent.</summary>
    /// <param name="e">Event to raise.</param>
    public void OnSliderDragStartEvent(EventArgs e)
    {
    ...
    /// <summary>Method to raise event SliderDragStopEvent.</summary>
    /// <param name="e">Event to raise.</param>
    public void OnSliderDragStopEvent(EventArgs e)
    {
