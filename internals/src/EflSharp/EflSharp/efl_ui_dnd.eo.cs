   ...
   public System.IntPtr NativeClass {
      get {
         if (((object)this).GetType() == typeof (DndConcrete))
            return Efl.Ui.DndConcreteNativeInherit.GetEflClassStatic();
         else
...
private static object DragDropEvtKey = new object();
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void efl_ui_dnd_drag_start(System.IntPtr obj,   Efl.Ui.SelectionFormat format,   Eina.Slice data,   Efl.Ui.SelectionAction action,  IntPtr icon_func_data, Efl.Dnd.DragIconCreateInternal icon_func, EinaFreeCb icon_func_free_cb,    uint seat);
   /// <summary>Start a drag and drop process at the drag side. During dragging, there are three events emitted as belows: - EFL_UI_DND_EVENT_DRAG_POS - EFL_UI_DND_EVENT_DRAG_ACCEPT - EFL_UI_DND_EVENT_DRAG_DONE</summary>
   /// <param name="format">The data format</param>
   /// <param name="data">The drag data</param>
   /// <param name="action">Action when data is transferred</param>
   ...
   public  void DragStart( Efl.Ui.SelectionFormat format,  Eina.Slice data,  Efl.Ui.SelectionAction action,  Efl.Dnd.DragIconCreate icon_func,   uint seat) {
            ...
            efl_ui_dnd_drag_start(Efl.Ui.DndConcrete.efl_ui_dnd_mixin_get(),  format,  data,  action, GCHandle.ToIntPtr(icon_func_handle), Efl.Dnd.DragIconCreateWrapper.Cb, Efl.Eo.Globals.free_gchandle,  seat);
      Eina.Error.RaiseIfUnhandledException();
                                                                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void efl_ui_dnd_drag_action_set(System.IntPtr obj,   Efl.Ui.SelectionAction action,    uint seat);
   /// <summary>Set the action for the drag</summary>
   /// <param name="action">Drag action</param>
   /// <param name="seat">Specified seat for multiple seats case.</param>
   /// <returns></returns>
   public  void SetDragAction( Efl.Ui.SelectionAction action,   uint seat) {
                                           efl_ui_dnd_drag_action_set(Efl.Ui.DndConcrete.efl_ui_dnd_mixin_get(),  action,  seat);
      Eina.Error.RaiseIfUnhandledException();
                               }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void efl_ui_dnd_drag_cancel(System.IntPtr obj,    uint seat);
   /// <summary>Cancel the on-going drag</summary>
   /// <param name="seat">Specified seat for multiple seats case.</param>
   /// <returns></returns>
   public  void DragCancel(  uint seat) {
                         efl_ui_dnd_drag_cancel(Efl.Ui.DndConcrete.efl_ui_dnd_mixin_get(),  seat);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void efl_ui_dnd_drop_target_add(System.IntPtr obj,   Efl.Ui.SelectionFormat format,    uint seat);
   /// <summary>Make the current object as drop target. There are four events emitted: - EFL_UI_DND_EVENT_DRAG_ENTER - EFL_UI_DND_EVENT_DRAG_LEAVE - EFL_UI_DND_EVENT_DRAG_POS - EFL_UI_DND_EVENT_DRAG_DROP.</summary>
   /// <param name="format">Accepted data format</param>
   /// <param name="seat">Specified seat for multiple seats case.</param>
   /// <returns></returns>
   public  void AddDropTarget( Efl.Ui.SelectionFormat format,   uint seat) {
                                           efl_ui_dnd_drop_target_add(Efl.Ui.DndConcrete.efl_ui_dnd_mixin_get(),  format,  seat);
      Eina.Error.RaiseIfUnhandledException();
                               }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void efl_ui_dnd_drop_target_del(System.IntPtr obj,   Efl.Ui.SelectionFormat format,    uint seat);
   /// <summary>Delete the dropable status from object</summary>
   /// <param name="format">Accepted data format</param>
   /// <param name="seat">Specified seat for multiple seats case.</param>
   /// <returns></returns>
   public  void DelDropTarget( Efl.Ui.SelectionFormat format,   uint seat) {
                                           efl_ui_dnd_drop_target_del(Efl.Ui.DndConcrete.efl_ui_dnd_mixin_get(),  format,  seat);
      Eina.Error.RaiseIfUnhandledException();
                               }
}
public class DndConcreteNativeInherit : Efl.Eo.NativeClass{
