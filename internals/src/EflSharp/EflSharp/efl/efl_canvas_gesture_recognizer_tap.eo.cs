...
/// <summary>This is the recognizer for Tap gestures. See <see cref="Efl.Canvas.GestureTap"/> and <see cref="Efl.Canvas.GestureRecognizer"/>. For internal use only.</summary>
