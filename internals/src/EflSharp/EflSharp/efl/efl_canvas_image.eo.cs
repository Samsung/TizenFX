...
private static object LoadErrorEvtKey = new object();
    ...
    virtual public bool GetAnimated() {
         var _ret_var = Efl.Gfx.IFrameControllerNativeInherit.efl_gfx_frame_controller_animated_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    ...
    virtual public int GetFrame() {
         var _ret_var = Efl.Gfx.IFrameControllerNativeInherit.efl_gfx_frame_controller_frame_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    ...
    virtual public bool SetFrame( int frame_index) {
                                 var _ret_var = Efl.Gfx.IFrameControllerNativeInherit.efl_gfx_frame_controller_frame_set_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), frame_index);
        Eina.Error.RaiseIfUnhandledException();
                        return _ret_var;
 }
    ...
    virtual public int GetFrameCount() {
         var _ret_var = Efl.Gfx.IFrameControllerNativeInherit.efl_gfx_frame_controller_frame_count_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    ...
    virtual public Efl.Gfx.FrameControllerLoopHint GetLoopType() {
         var _ret_var = Efl.Gfx.IFrameControllerNativeInherit.efl_gfx_frame_controller_loop_type_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    ...
    virtual public int GetLoopCount() {
         var _ret_var = Efl.Gfx.IFrameControllerNativeInherit.efl_gfx_frame_controller_loop_count_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    ...
    virtual public double GetFrameDuration( int start_frame,  int frame_num) {
                                                         var _ret_var = Efl.Gfx.IFrameControllerNativeInherit.efl_gfx_frame_controller_frame_duration_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), start_frame,  frame_num);
        Eina.Error.RaiseIfUnhandledException();
                                        return _ret_var;
 }
