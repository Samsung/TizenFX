...
namespace Tizen.Applications
{
    ...
    public interface IUIGadgetFactory
    {
        /// <summary>
        ...
        /// <returns>A new UIGadget instance</returns>
        /// <since_tizen> 13 </since_tizen>
        UIGadget CreateInstance(UIGadgetInfo info, string className, bool useDefaultContext);
    }
}
