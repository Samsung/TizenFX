...
[Efl.Gfx.FrameControllerConcrete.NativeMethods]
...
/// <summary>Efl frame controller of frame based animated object interface.</summary>
/// <remarks>This is a <b>BETA</b> class. It can be modified or removed in the future. Do not use it for product development.</remarks>
public sealed class FrameControllerConcrete :
    Efl.Eo.EoWrapper
    , IFrameController
    
{
    ...
    private FrameControllerConcrete(ConstructingHandle ch) : base(ch)
    {
    }
    ...
    private FrameControllerConcrete(Efl.Eo.Globals.WrappingHandle wh) : base(wh)
    {
    }
...
#pragma warning disable CS0628
    ...
    public bool GetAnimated() {
        var _ret_var = Efl.Gfx.FrameControllerConcrete.NativeMethods.efl_gfx_frame_controller_animated_get_ptr.Value.Delegate(this.NativeHandle);
    ...
    /// <returns>The index of current frame.</returns>
    public int GetFrame() {
        var _ret_var = Efl.Gfx.FrameControllerConcrete.NativeMethods.efl_gfx_frame_controller_frame_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public bool SetFrame(int frame_index) {
        var _ret_var = Efl.Gfx.FrameControllerConcrete.NativeMethods.efl_gfx_frame_controller_frame_set_ptr.Value.Delegate(this.NativeHandle,frame_index);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public int GetFrameCount() {
        var _ret_var = Efl.Gfx.FrameControllerConcrete.NativeMethods.efl_gfx_frame_controller_frame_count_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public Efl.Gfx.FrameControllerLoopHint GetLoopType() {
        var _ret_var = Efl.Gfx.FrameControllerConcrete.NativeMethods.efl_gfx_frame_controller_loop_type_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public int GetLoopCount() {
        var _ret_var = Efl.Gfx.FrameControllerConcrete.NativeMethods.efl_gfx_frame_controller_loop_count_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public double GetFrameDuration(int start_frame, int frame_num) {
        var _ret_var = Efl.Gfx.FrameControllerConcrete.NativeMethods.efl_gfx_frame_controller_frame_duration_get_ptr.Value.Delegate(this.NativeHandle,start_frame, frame_num);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
...
#if EFL_BETA
#pragma warning disable CS1591
public static class Efl_GfxFrameControllerConcrete_ExtensionMethods {
