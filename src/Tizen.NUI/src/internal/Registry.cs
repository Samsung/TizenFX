...
namespace Tizen.NUI
{
    ...
    internal sealed class Registry
    {
        ...
        internal static void Register(BaseHandle baseHandle)
        {
            ...
            IntPtr refCptr = Interop.BaseHandle.BaseHandleGetObjectPtr(baseHandle.GetBaseHandleCPtrHandleRef);
        ...
        {
            IntPtr refObjectPtr = Interop.BaseHandle.BaseHandleGetObjectPtr(baseHandle.GetBaseHandleCPtrHandleRef);
