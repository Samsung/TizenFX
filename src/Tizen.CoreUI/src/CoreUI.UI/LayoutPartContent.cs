...
#pragma warning disable CS1591
    /// <since_tizen> 6 </since_tizen>
    public static class LayoutPartContentExtensions {
        /// <since_tizen> 6 </since_tizen>
        public static CoreUI.BindableProperty<CoreUI.Gfx.IEntity> Content<T>(this CoreUI.UI.IGenericFactoryExtended<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.LayoutPartContent, T>magic = null) where T : CoreUI.UI.LayoutPartContent {
