...
/// <summary>This is the recognizer for Long-tap gestures. See <see cref="Efl.Canvas.GestureLongTap"/> and <see cref="Efl.Canvas.GestureRecognizer"/>. For internal use only.</summary>
...
public class GestureRecognizerLongTap : Efl.Canvas.GestureRecognizer
{
    ...
    /// <summary>Minimum holding time to be recognized as a long tap.</summary>
