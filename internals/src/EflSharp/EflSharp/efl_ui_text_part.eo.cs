...
public class TextPart : Efl.Ui.LayoutPartText, Efl.Eo.IWrapper
{
   ...
   public new delegate void ConstructingMethod(TextPart obj);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)] internal static extern System.IntPtr
      efl_ui_text_part_class_get();
   ///<summary>Creates a new instance.</summary>
   ///<param name="parent">Parent instance.</param>
   ///<param name="init_cb">Delegate to call constructing methods that should be run inside the constructor.</param>
   public TextPart(Efl.Object parent = null, ConstructingMethod init_cb=null) : base("TextPart", efl_ui_text_part_class_get(), typeof(TextPart), parent)
   {
      if (init_cb != null) {
         init_cb(this);
      }
   ...
   protected TextPart(String klass_name, IntPtr base_klass, System.Type managed_type, Efl.Object parent) : base(klass_name, base_klass, managed_type, parent) {}
