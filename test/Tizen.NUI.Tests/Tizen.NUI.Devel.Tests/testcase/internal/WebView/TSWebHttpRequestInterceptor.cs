...
namespace Tizen.NUI.Devel.Tests
{
    ...
    public class InternalWebHttpRequestInterceptorTest
    {
        ...
        public async Task WebHttpRequestInterceptorSetResponseBody()
        {
            ...
            webview_.Context.RegisterHttpRequestInterceptedCallback(onRequestIntercepted);

            webview_.LoadUrl(invalidUrl);
            ...
            webview_.Context.RegisterHttpRequestInterceptedCallback(null);
        ...
        public async Task WebHttpRequestInterceptorIgnore()
        {
            ...
            webview_.PageLoadError += onLoadError;
