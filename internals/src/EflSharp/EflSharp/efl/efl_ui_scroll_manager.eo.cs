...
public class Manager : Efl.Object, Efl.Ui.II18n, Efl.Ui.IScrollable, Efl.Ui.IScrollbar
{
    ...
    /// This property is protected as it is meant for scrollable object implementations only, to set and access the internal pan object. If pan is set to <c>NULL</c>, scrolling does not work.</summary>
    /// <param name="pan">Pan object</param>
    protected virtual void SetPan(Efl.Ui.Pan pan) {
...
public static class Efl_Ui_ScrollManager_ExtensionMethods {
    ...
    public static Efl.BindableProperty<Efl.Ui.LayoutOrientation> MovementBlock<T>(this Efl.Ui.ItemFactory<T> fac, Efl.Csharp.ExtensionTag<Efl.Ui.Scroll.Manager, T>magic = null) where T : Efl.Ui.Scroll.Manager {
