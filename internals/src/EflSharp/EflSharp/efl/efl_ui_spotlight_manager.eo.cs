...
/// <summary>Event argument wrapper for event <see cref="Efl.Ui.Spotlight.Manager.PosUpdateEvent"/>.</summary>
[Efl.Eo.BindingEntity]
public class ManagerPosUpdateEventArgs : EventArgs {
...
/// For instance, changes to the current sub-widget in the spotlight (<see cref="Efl.Ui.Spotlight.Container.ActiveElement"/>) can be animated with a transition. This object can also handle user interaction. For example, dragging the sub-widget to one side to get to a different sub-widget (like an smartphone home screen). Such user interactions should end up setting a new <see cref="Efl.Ui.Spotlight.Container.ActiveElement"/>. During a transition, the evolution of the current position should be exposed by emitting <c>pos_update</c> events.</summary>
...
public abstract class Manager : Efl.Object
{
    ...
    /// <value><see cref="Efl.Ui.Spotlight.ManagerPosUpdateEventArgs"/></value>
    public event EventHandler<Efl.Ui.Spotlight.ManagerPosUpdateEventArgs> PosUpdateEvent
    {
        add
        {
            lock (eflBindingEventLock)
            {
                Efl.EventCb callerCb = (IntPtr data, ref Efl.Event.NativeStruct evt) =>
                {
                    ...
                    if (obj != null)
                    {
                        Efl.Ui.Spotlight.ManagerPosUpdateEventArgs args = new Efl.Ui.Spotlight.ManagerPosUpdateEventArgs();
    ...
    /// <summary>Method to raise event PosUpdateEvent.</summary>
    /// <param name="e">Event to raise.</param>
    public void OnPosUpdateEvent(Efl.Ui.Spotlight.ManagerPosUpdateEventArgs e)
    {
...
Efl.Ui.Spotlight.Manager.NativeMethods.efl_ui_spotlight_manager_size_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass)),_in_size);
    ...
    public virtual bool GetAnimationEnabled() {
    ...
    public virtual void SetAnimationEnabled(bool enable) {
    ...
    /// <param name="group">The graphical group where the views should be added with <see cref="Efl.Canvas.Group.AddGroupMember"/> and removed with <see cref="Efl.Canvas.Group.RemoveGroupMember"/>.</param>
    public virtual void Bind(Efl.Ui.Spotlight.Container spotlight, Efl.Canvas.Group group) {
    ...
    public virtual void SwitchTo(int from, int to) {
