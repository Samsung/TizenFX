...
/// <summary>This is the recognizer for Zoom gestures. See <see cref="Efl.Canvas.GestureZoom"/> and <see cref="Efl.Canvas.GestureRecognizer"/>. For internal use only.</summary>
