...
[RangeInteractiveConcreteNativeInherit]
   ...
   , Efl.Ui.RangeDisplay
{
   ...
   public System.IntPtr NativeClass {
      get {
         if (((object)this).GetType() == typeof (RangeInteractiveConcrete))
            return Efl.Ui.RangeInteractiveConcreteNativeInherit.GetEflClassStatic();
         else
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    private static extern double efl_ui_range_step_get(System.IntPtr obj);
   /// <summary>Control the step used to increment or decrement values for given widget.
   /// This value will be incremented or decremented to the displayed value.
   /// 
   /// By default step value is equal to 1.
   ...
   public double GetRangeStep() {
       var _ret_var = efl_ui_range_step_get(Efl.Ui.RangeInteractiveConcrete.efl_ui_range_interactive_interface_get());
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    private static extern  void efl_ui_range_step_set(System.IntPtr obj,   double step);
   /// <summary>Control the step used to increment or decrement values for given widget.
   /// This value will be incremented or decremented to the displayed value.
   /// 
   /// By default step value is equal to 1.
   ...
   public  void SetRangeStep( double step) {
                         efl_ui_range_step_set(Efl.Ui.RangeInteractiveConcrete.efl_ui_range_interactive_interface_get(),  step);
      Eina.Error.RaiseIfUnhandledException();
                   }
...
public class RangeInteractiveConcreteNativeInherit : Efl.Eo.NativeClass{
