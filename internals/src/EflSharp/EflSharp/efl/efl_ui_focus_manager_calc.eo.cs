...
/// <summary>Calculates the elements present in each <see cref="Efl.Ui.Focus.Direction"/>.
/// Each registered item will get a target item in each direction. You can get the target items for the currently focused item by calling <see cref="Efl.Ui.Focus.IManager.MoveRequest"/>.</summary>
...
public class ManagerCalc : Efl.Object, Efl.Ui.Focus.IManager
{
    ...
    /// <summary>Registers a new item in the graph.
    ...
    public virtual bool Register(Efl.Ui.Focus.IObject child, Efl.Ui.Focus.IObject parent, Efl.Ui.Focus.IManager redirect) {
    ...
    /// <summary>Registers a new logical item in the graph.
    /// The item can never get focus, it just helps to build the tree. Compare to <see cref="Efl.Ui.Focus.ManagerCalc.Register"/>.</summary>
    /// <param name="child">The object to register.</param>
    /// <param name="parent">The parent to use in the logical tree.</param>
    /// <param name="redirect">The redirect manager to set once this child is focused. Can be <c>NULL</c> for no redirect.</param>
    /// <returns><c>true</c> if successful, <c>false</c> otherwise.</returns>
    public virtual bool RegisterLogical(Efl.Ui.Focus.IObject child, Efl.Ui.Focus.IObject parent, Efl.Ui.Focus.IManager redirect) {
    ...
    /// <summary>Sets a new redirect object for the given child.
    ...
    /// <returns><c>true</c> if successful, <c>false</c> otherwise.</returns>
    public virtual bool UpdateRedirect(Efl.Ui.Focus.IObject child, Efl.Ui.Focus.IManager redirect) {
    ...
    /// <summary>Sets a new logical parent for the given child.</summary>
    /// <param name="child">The child to update.</param>
    /// <param name="parent">The parent which now will be the logical parent of child.</param>
    /// <returns><c>true</c> if successful, <c>false</c> otherwise.</returns>
    public virtual bool UpdateParent(Efl.Ui.Focus.IObject child, Efl.Ui.Focus.IObject parent) {
    ...
    /// <summary>Sets the list of children to a different order.</summary>
    /// <param name="parent">The parent to update.</param>
    /// <param name="children">The list of children with the new order.</param>
    /// <returns><c>true</c> if successful, <c>false</c> otherwise.</returns>
    public virtual bool UpdateChildren(Efl.Ui.Focus.IObject parent, Eina.List<Efl.Ui.Focus.IObject> children) {
...
var _ret_var = Efl.Ui.Focus.ManagerCalc.NativeMethods.efl_ui_focus_manager_calc_update_children_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass)),parent, _in_children);
    ...
    /// <summary>Sets the list of children to a different order.
    /// Objects in the list which are not children of <c>parent</c> are ignored. Compare to <see cref="Efl.Ui.Focus.ManagerCalc.UpdateChildren"/>.</summary>
    /// <param name="parent">The parent to update.</param>
    /// <param name="children">The list of objects with the new order.</param>
    public virtual void UpdateOrder(Efl.Ui.Focus.IObject parent, Eina.List<Efl.Ui.Focus.IObject> children) {
        var _in_children = children.Handle;
children.Own = false;
Efl.Ui.Focus.ManagerCalc.NativeMethods.efl_ui_focus_manager_calc_update_order_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass)),parent, _in_children);
    ...
    public virtual void Unregister(Efl.Ui.Focus.IObject child) {
