...
private static object PartInvalidEvtKey = new object();
    ...
    public event EventHandler<Efl.Canvas.LayoutPartInvalidEvt_Args> PartInvalidEvt
    {
        add {
            lock (eventLock) {
                ...
                if (AddNativeEventHandler(efl.Libs.Edje, key, this.evt_PartInvalidEvt_delegate)) {
        ...
        remove {
            lock (eventLock) {
                string key = "_EFL_LAYOUT_EVENT_PART_INVALID";
                if (RemoveNativeEventHandler(key, this.evt_PartInvalidEvt_delegate)) { 
    ...
    private void on_PartInvalidEvt_NativeCallback(System.IntPtr data, ref Efl.Event.NativeStruct evt)
    {
...
private static object CircularDependencyEvtKey = new object();
    ...
    virtual public void Update( Efl.Object obs,  System.String key,  System.IntPtr data) {
                                                                                 Efl.IObserverNativeInherit.efl_observer_update_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), obs,  key,  data);
        Eina.Error.RaiseIfUnhandledException();
                                                         }
    ...
    virtual public bool GetColorClass( System.String color_class,  Efl.Gfx.ColorClassLayer layer,  out int r,  out int g,  out int b,  out int a) {
                                                                                                                                                         var _ret_var = Efl.Gfx.IColorClassNativeInherit.efl_gfx_color_class_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), color_class,  layer,  out r,  out g,  out b,  out a);
        Eina.Error.RaiseIfUnhandledException();
                                                                                                        return _ret_var;
 }
    ...
    virtual public bool SetColorClass( System.String color_class,  Efl.Gfx.ColorClassLayer layer,  int r,  int g,  int b,  int a) {
                                                                                                                                                         var _ret_var = Efl.Gfx.IColorClassNativeInherit.efl_gfx_color_class_set_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), color_class,  layer,  r,  g,  b,  a);
        Eina.Error.RaiseIfUnhandledException();
                                                                                                        return _ret_var;
 }
    ...
    virtual public System.String GetColorClassCode( System.String color_class,  Efl.Gfx.ColorClassLayer layer) {
                                                         var _ret_var = Efl.Gfx.IColorClassNativeInherit.efl_gfx_color_class_code_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), color_class,  layer);
        Eina.Error.RaiseIfUnhandledException();
                                        return _ret_var;
 }
    ...
    virtual public bool SetColorClassCode( System.String color_class,  Efl.Gfx.ColorClassLayer layer,  System.String colorcode) {
                                                                                 var _ret_var = Efl.Gfx.IColorClassNativeInherit.efl_gfx_color_class_code_set_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), color_class,  layer,  colorcode);
        Eina.Error.RaiseIfUnhandledException();
                                                        return _ret_var;
 }
    ...
    virtual public System.String GetColorClassDescription( System.String color_class) {
                                 var _ret_var = Efl.Gfx.IColorClassNativeInherit.efl_gfx_color_class_description_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), color_class);
        Eina.Error.RaiseIfUnhandledException();
                        return _ret_var;
 }
    ...
    virtual public void DelColorClass( System.String color_class) {
                                 Efl.Gfx.IColorClassNativeInherit.efl_gfx_color_class_del_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), color_class);
        Eina.Error.RaiseIfUnhandledException();
                         }
    ...
    virtual public void ClearColorClass() {
         Efl.Gfx.IColorClassNativeInherit.efl_gfx_color_class_clear_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
        Eina.Error.RaiseIfUnhandledException();
         }
    ...
    virtual public bool GetSizeClass( System.String size_class,  out int minw,  out int minh,  out int maxw,  out int maxh) {
                                                                                                                                 var _ret_var = Efl.Gfx.ISizeClassNativeInherit.efl_gfx_size_class_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), size_class,  out minw,  out minh,  out maxw,  out maxh);
        Eina.Error.RaiseIfUnhandledException();
                                                                                        return _ret_var;
 }
    ...
    virtual public bool SetSizeClass( System.String size_class,  int minw,  int minh,  int maxw,  int maxh) {
                                                                                                                                 var _ret_var = Efl.Gfx.ISizeClassNativeInherit.efl_gfx_size_class_set_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), size_class,  minw,  minh,  maxw,  maxh);
        Eina.Error.RaiseIfUnhandledException();
                                                                                        return _ret_var;
 }
    ...
    virtual public void DelSizeClass( System.String size_class) {
                                 Efl.Gfx.ISizeClassNativeInherit.efl_gfx_size_class_del_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), size_class);
        Eina.Error.RaiseIfUnhandledException();
                         }
    ...
    virtual public bool GetTextClass( System.String text_class,  out System.String font,  out Efl.Font.Size size) {
                                                                                 var _ret_var = Efl.Gfx.ITextClassNativeInherit.efl_gfx_text_class_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), text_class,  out font,  out size);
        Eina.Error.RaiseIfUnhandledException();
                                                        return _ret_var;
 }
    ...
    virtual public bool SetTextClass( System.String text_class,  System.String font,  Efl.Font.Size size) {
                                                                                 var _ret_var = Efl.Gfx.ITextClassNativeInherit.efl_gfx_text_class_set_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), text_class,  font,  size);
        Eina.Error.RaiseIfUnhandledException();
                                                        return _ret_var;
 }
    ...
    virtual public void DelTextClass( System.String text_class) {
                                 Efl.Gfx.ITextClassNativeInherit.efl_gfx_text_class_del_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), text_class);
        Eina.Error.RaiseIfUnhandledException();
                         }
...
public class LayoutNativeInherit : Efl.Canvas.GroupNativeInherit{
    ...
    private static efl_canvas_layout_access_part_iterate_delegate efl_canvas_layout_access_part_iterate_static_delegate;
     ...
     [return: MarshalAs(UnmanagedType.U1)] private delegate bool efl_canvas_layout_content_remove_delegate(System.IntPtr obj, System.IntPtr pd, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(Efl.Eo.MarshalTest<Efl.Gfx.IEntityConcrete, Efl.Eo.NonOwnTag>))]  Efl.Gfx.IEntity content);


     [return: MarshalAs(UnmanagedType.U1)] public delegate bool efl_canvas_layout_content_remove_api_delegate(System.IntPtr obj, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(Efl.Eo.MarshalTest<Efl.Gfx.IEntityConcrete, Efl.Eo.NonOwnTag>))]  Efl.Gfx.IEntity content);
