...
namespace Tizen.NUI
{
    ...
    public class InputAction : BaseHandle
    {
        ...
        /// </summary>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public InputAction() : this(Interop.InputAction.New((int)InputAction.ActionType.None, 0, Vector2.getCPtr(new Vector2(0, 0)), 0), true)
        {
        ...
        [EditorBrowsable(EditorBrowsableState.Never)]
        public InputAction(InputAction.ActionType type, uint modifiers, Vector2 point, uint timeStamp) : this(Interop.InputAction.New((int)type, modifiers, Vector2.getCPtr(point), timeStamp), true)
        {
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
        }

        internal InputAction(global::System.IntPtr cPtr, bool cMemoryOwn) : base(cPtr, cMemoryOwn)
        {
        }
        ...
        private InputAction.ActionType type
        {
            get
            {
                InputAction.ActionType ret = (InputAction.ActionType)Interop.InputAction.TypeGet(SwigCPtr);
                if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
                return ret;
            }
        }
        ...
        private uint modifiers
        {
            get
            {
                uint ret = Interop.InputAction.ModifiersGet(SwigCPtr);
                if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
                return ret;
            }
        }
        ...
        private Vector2 point
        {
            get
            {
                global::System.IntPtr cPtr = Interop.InputAction.PointGet(SwigCPtr);
        ...
        private uint timeStamp
        {
            get
            {
                uint ret = Interop.InputAction.TimeStampGet(SwigCPtr);
                if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
                return ret;
            }
        }
        ...
        private DeviceClassType deviceClass
        {
            get
            {
                int ret = Interop.InputAction.DeviceClassGet(SwigCPtr);
                if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
        ...
        private DeviceSubClassType deviceSubClass
        {
            get
            {
                int ret = Interop.InputAction.DeviceSubClassGet(SwigCPtr);
                if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
                return (DeviceSubClassType)ret;
            }
        }

        internal static InputAction GetInputActionFromPtr(global::System.IntPtr cPtr)
        {
            InputAction ret = new InputAction(cPtr, false);
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
            return ret;
        }
        ...
        {
            Interop.InputAction.DeleteInputAction(swigCPtr);
        }
    }
}
