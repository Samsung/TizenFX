...
namespace Tizen.NUI.Components
{
    ...
    public class TitleBar : TextLabel
    {
        ...
        private Color startColor = new Vector4(0, 0, 0, 0.6F); // default fadeout color
        private Color endColor = new Vector4(0, 0, 0, 0);
        private int fadeOutWidth = 32; // default size
        private int fadeOutHeight = 0;
        ...
        /// <summary>
        /// The constructor of the TitleBar class with specific Style.
        /// </summary>
        /// <param name="textLabelStyle">Construct Style</param>
        /// <since_tizen> 8 </since_tizen>
        /// This will be public opened in tizen_6.0 after ACR done. Before ACR, need to be hidden as inhouse API.
        [EditorBrowsable(EditorBrowsableState.Never)]
        public TitleBar(TextLabelStyle textLabelStyle) : base(textLabelStyle)
        {
            Initialize();
        }

        /// <summary>
        /// Constructor of the TitleBar class with special style.
        /// </summary>
        /// <param name="style"> style name </param>
        /// <since_tizen> 8 </since_tizen>
        /// This will be public opened in tizen_6.0 after ACR done. Before ACR, need to be hidden as inhouse API.
        [EditorBrowsable(EditorBrowsableState.Never)]
        public TitleBar(string style) : base(style)
        {
            Initialize();
        }
        ...
        /// This will be public opened in tizen_6.0 after ACR done. Before ACR, need to be hidden as inhouse API.
        [EditorBrowsable(EditorBrowsableState.Never)]
        public void FadeOutColor(Color startColor, Color endColor)
        {
        ...
        /// <summary>
        /// Gets or Sets the height of the fadeout effect.
        /// </summary>
        /// <since_tizen> 8 </since_tizen>
        /// This will be public opened in tizen_6.0 after ACR done. Before ACR, need to be hidden as inhouse API.
        [EditorBrowsable(EditorBrowsableState.Never)]
        public int FadeOutHeight
        {
            get
            {
        ...
        protected override void Dispose(DisposeTypes type)
        {
            ...
            if (type == DisposeTypes.Explicit)
            {
                if (null != leftImage)
                {
                    Utility.Dispose(leftImage);
                }
                if (null != rightImage)
                {
                    Utility.Dispose(rightImage);
                }
            }
            base.Dispose(type);
        }
        ...
        private void UpdateImage()
        {
            ...
            if(fadeOutWidth > 0)
            {
                TextureSet outerTextureSet = CreateTexture(this.startColor, this.endColor);
                TextureSet insiderTextureSet = CreateTexture(this.endColor, this.startColor);
            ...
            if(fadeOutHeight > 0)
            {
                leftImage.Size.Height = fadeOutHeight;
                rightImage.Size.Height = fadeOutHeight;
            }
        }
