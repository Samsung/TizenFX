...
namespace MyCSharpExample
{
    class Example
    {
        ...
        public void OnInitialize(object source, EventArgs e)
        {
            ...
            _contentContainer.StateFocusEnable = true;
        ...
        private View OnPreFocusChange(object source, FocusManager.PreFocusChangeEventArgs e)
        {
            ...
            {
                e.Proposed = _contentContainer.GetChildViewAt(1);
            }
            return e.Proposed;
        }
        ...
        private void CreateItem(Item item, int idx)
        {
            ...
            {
                ImageView notSupportView = new ImageView("/home/owner/apps_rw/NUISamples.Tizen/res/images/not_yet_sign.png");
                notSupportView.Size = new Vector3(_stage.GetSize().Width * 0.2f, _stage.GetSize().Height * 0.25f, 0.0f);
                notSupportView.StateFocusEnable = true;
        ...
        Popup CreatePopup()
        {
            ...
            footer.Size = new Size3D(new Size(0.0f, 80.0f));
        ...
        PushButton CreateOKButton()
        {
            ...
            okayButton.StateFocusEnable = true;
        ...
        PushButton CreateCancelButton()
        {
            ...
            cancelButton.StateFocusEnable = true;
