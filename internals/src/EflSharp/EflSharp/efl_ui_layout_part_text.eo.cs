...
public class LayoutPartText : Efl.Ui.LayoutPart, Efl.Eo.IWrapper,Efl.Text,Efl.TextCursor,Efl.TextMarkup,Efl.Ui.L10n
{
   ...
   public LayoutPartText(Efl.Object parent = null, ConstructingMethod init_cb=null) : base("LayoutPartText", efl_ui_layout_part_text_class_get(), typeof(LayoutPartText), parent)
   {
      if (init_cb != null) {
         init_cb(this);
      }
...
public class LayoutPartTextNativeInherit : Efl.Ui.LayoutPartNativeInherit{
    ...
    private static  System.IntPtr l10n_text_get(System.IntPtr obj, System.IntPtr pd,  out  System.IntPtr domain)
   {
      ...
      domain= Efl.Eo.Globals.cached_string_to_intptr(((LayoutPartText)wrapper).cached_strings, _out_domain);
            return Efl.Eo.Globals.cached_string_to_intptr(((LayoutPartText)wrapper).cached_strings, _ret_var);
      } else {
