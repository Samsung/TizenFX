...
public class TabPage : Efl.Ui.Layout, Efl.Eo.IWrapper,Efl.Content
{
   ...
   public new delegate void ConstructingMethod(TabPage obj);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)] internal static extern System.IntPtr
      efl_ui_tab_page_class_get();
   ///<summary>Creates a new instance.</summary>
   ///<param name="parent">Parent instance.</param>
   ///<param name="init_cb">Delegate to call constructing methods that should be run inside the constructor.</param>
   public TabPage(Efl.Object parent = null, ConstructingMethod init_cb=null) : base("TabPage", efl_ui_tab_page_class_get(), typeof(TabPage), parent)
   {
      if (init_cb != null) {
         init_cb(this);
      }
   ...
   protected TabPage(String klass_name, IntPtr base_klass, System.Type managed_type, Efl.Object parent) : base(klass_name, base_klass, managed_type, parent) {}
...
private static object TabChangedEvtKey = new object();
   ...
   public event EventHandler<Efl.Ui.TabPageTabChangedEvt_Args> TabChangedEvt
   {
      add {
         lock (eventLock) {
            ...
            if (add_cpp_event_handler(key, this.evt_TabChangedEvt_delegate)) {
   ...
   public Efl.Ui.TabPagePartTab Tab
   {
      get
      {
         Efl.Object obj = efl_part_get(NativeHandle, "tab");
...
public class TabPageNativeInherit : Efl.Ui.LayoutNativeInherit{
