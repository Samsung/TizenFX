...
public class Loop : Efl.Task, Efl.Eo.IWrapper
{
   ...
   public new delegate void ConstructingMethod(Loop obj);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Ecore)] internal static extern System.IntPtr
      efl_loop_class_get();
   ///<summary>Creates a new instance.</summary>
   ///<param name="parent">Parent instance.</param>
   ///<param name="init_cb">Delegate to call constructing methods that should be run inside the constructor.</param>
   public Loop(Efl.Object parent = null, ConstructingMethod init_cb=null) : base("Loop", efl_loop_class_get(), typeof(Loop), parent)
   {
      if (init_cb != null) {
         init_cb(this);
      }
   ...
   protected Loop(String klass_name, IntPtr base_klass, System.Type managed_type, Efl.Object parent) : base(klass_name, base_klass, managed_type, parent) {}
   ...
   public event EventHandler IdleEnterEvt
   {
      add {
         lock (eventLock) {
            ...
            if (add_cpp_event_handler(key, this.evt_IdleEnterEvt_delegate)) {
   ...
   public event EventHandler IdleExitEvt
   {
      add {
         lock (eventLock) {
            ...
            if (add_cpp_event_handler(key, this.evt_IdleExitEvt_delegate)) {
   ...
   public event EventHandler IdleEvt
   {
      add {
         lock (eventLock) {
            ...
            if (add_cpp_event_handler(key, this.evt_IdleEvt_delegate)) {
   ...
   public event EventHandler<Efl.LoopArgumentsEvt_Args> ArgumentsEvt
   {
      add {
         lock (eventLock) {
            ...
            if (add_cpp_event_handler(key, this.evt_ArgumentsEvt_delegate)) {
   ...
   public event EventHandler PollHighEvt
   {
      add {
         lock (eventLock) {
            ...
            if (add_cpp_event_handler(key, this.evt_PollHighEvt_delegate)) {
   ...
   public event EventHandler PollMediumEvt
   {
      add {
         lock (eventLock) {
            ...
            if (add_cpp_event_handler(key, this.evt_PollMediumEvt_delegate)) {
   ...
   public event EventHandler PollLowEvt
   {
      add {
         lock (eventLock) {
            ...
            if (add_cpp_event_handler(key, this.evt_PollLowEvt_delegate)) {
...
private static object QuitEvtKey = new object();
   ...
   public event EventHandler QuitEvt
   {
      add {
         lock (eventLock) {
            ...
            if (add_cpp_event_handler(key, this.evt_QuitEvt_delegate)) {
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Ecore)]
    protected static extern double efl_loop_throttle_get(System.IntPtr obj);
   ...
   virtual public double GetThrottle() {
       var _ret_var = efl_loop_throttle_get((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Ecore)]
    protected static extern  void efl_loop_throttle_set(System.IntPtr obj,   double amount);
   /// <summary>Slow down the loop execution by forcing sleep for a small period of time every time the loop iterates/loops.</summary>
   /// <param name="amount">Time to sleep for each &quot;loop iteration&quot;</param>
   /// <returns></returns>
   virtual public  void SetThrottle( double amount) {
                         efl_loop_throttle_set((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle),  amount);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Ecore)]
    protected static extern double efl_loop_time_get(System.IntPtr obj);
   /// <summary>The time point when the loop was logically woken.</summary>
   /// <returns>Time in seconds since process specific start point</returns>
   virtual public double GetTime() {
       var _ret_var = efl_loop_time_get((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Ecore)]
    protected static extern  void efl_loop_time_set(System.IntPtr obj,   double timepoint);
   /// <summary>The time point when the loop was logically woken.</summary>
   /// <param name="timepoint">Time in seconds since process specific start point</param>
   /// <returns></returns>
   virtual public  void SetTime( double timepoint) {
                         efl_loop_time_set((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle),  timepoint);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Ecore)]
    protected static extern  void efl_loop_iterate(System.IntPtr obj);
   /// <summary>Runs a single iteration of the main loop to process everything on the queue.</summary>
   /// <returns></returns>
   virtual public  void Iterate() {
       efl_loop_iterate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
      Eina.Error.RaiseIfUnhandledException();
       }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Ecore)]
    protected static extern  int efl_loop_iterate_may_block(System.IntPtr obj,    int may_block);
   ...
   virtual public  int IterateMayBlock(  int may_block) {
                         var _ret_var = efl_loop_iterate_may_block((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle),  may_block);
      Eina.Error.RaiseIfUnhandledException();
                  return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Ecore)]
    [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(Eina.ValueMarshaler))] protected static extern  Eina.Value efl_loop_begin(System.IntPtr obj);
   /// <summary>Runs the application main loop.</summary>
   /// <returns>Value set by quit()</returns>
   virtual public  Eina.Value Begin() {
       var _ret_var = efl_loop_begin((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Ecore)]
    protected static extern  void efl_loop_quit(System.IntPtr obj,    Eina.ValueNative exit_code);
   ...
   virtual public  void Quit(  Eina.Value exit_code) {
       var _in_exit_code = exit_code.GetNative();
                  efl_loop_quit((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle),  _in_exit_code);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Ecore)]
   [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(Eina.FutureMarshaler))] protected static extern  Eina.Future efl_loop_job(System.IntPtr obj);
   ...
   virtual public  Eina.Future Job() {
       var _ret_var = efl_loop_job((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Ecore)]
   [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(Eina.FutureMarshaler))] protected static extern  Eina.Future efl_loop_idle(System.IntPtr obj);
   ...
   virtual public  Eina.Future Idle() {
       var _ret_var = efl_loop_idle((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Ecore)]
   [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(Eina.FutureMarshaler))] protected static extern  Eina.Future efl_loop_timeout(System.IntPtr obj,   double time);
   ...
   virtual public  Eina.Future Timeout( double time) {
                         var _ret_var = efl_loop_timeout((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle),  time);
      Eina.Error.RaiseIfUnhandledException();
                  return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Ecore)]
    [return: MarshalAs(UnmanagedType.U1)] protected static extern bool efl_loop_register(System.IntPtr obj, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Efl.Eo.MarshalTest<Efl.Class, Efl.Eo.NonOwnTag>))]  Efl.Class klass, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Efl.Eo.MarshalTest<Efl.Object, Efl.Eo.NonOwnTag>))]  Efl.Object provider);
   ...
   virtual public bool Register( Efl.Class klass,  Efl.Object provider) {
                                           var _ret_var = efl_loop_register((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle),  klass,  provider);
      Eina.Error.RaiseIfUnhandledException();
                              return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Ecore)]
    [return: MarshalAs(UnmanagedType.U1)] protected static extern bool efl_loop_unregister(System.IntPtr obj, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Efl.Eo.MarshalTest<Efl.Class, Efl.Eo.NonOwnTag>))]  Efl.Class klass, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Efl.Eo.MarshalTest<Efl.Object, Efl.Eo.NonOwnTag>))]  Efl.Object provider);
   ...
   virtual public bool Unregister( Efl.Class klass,  Efl.Object provider) {
                                           var _ret_var = efl_loop_unregister((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle),  klass,  provider);
      Eina.Error.RaiseIfUnhandledException();
                              return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Ecore)]
   [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Efl.Eo.MarshalTest<Efl.LoopMessageHandler, Efl.Eo.NonOwnTag>))] protected static extern Efl.LoopMessageHandler efl_loop_message_handler_get(System.IntPtr obj, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Efl.Eo.MarshalTest<Efl.Loop, Efl.Eo.NonOwnTag>))]  Efl.Loop loop, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Efl.Eo.MarshalTest<Efl.Class, Efl.Eo.NonOwnTag>))]  Efl.Class klass);
   /// <summary>Get a message handler object that is created by and owned by the Efl.Loop object, so you can listen to this message type by listening to message events on the handler as well as send objects as events.</summary>
   /// <param name="loop">The loop to get the object from.</param>
   /// <param name="klass">The class of the message object.</param>
   /// <returns>The message handler to use.</returns>
   public static Efl.LoopMessageHandler GetMessageHandler( Efl.Loop loop,  Efl.Class klass) {
                                           var _ret_var = efl_loop_message_handler_get(Efl.Loop.efl_loop_class_get(),  loop,  klass);
      Eina.Error.RaiseIfUnhandledException();
                              return _ret_var;
 }
...
public class LoopNativeInherit : Efl.TaskNativeInherit{
   public override System.Collections.Generic.List<Efl_Op_Description> GetEoOps(System.Type type)
   {
      ...
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_loop_throttle_get"), func = Marshal.GetFunctionPointerForDelegate(efl_loop_throttle_get_static_delegate)});
      efl_loop_throttle_set_static_delegate = new efl_loop_throttle_set_delegate(throttle_set);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_loop_throttle_set"), func = Marshal.GetFunctionPointerForDelegate(efl_loop_throttle_set_static_delegate)});
      efl_loop_time_get_static_delegate = new efl_loop_time_get_delegate(time_get);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_loop_time_get"), func = Marshal.GetFunctionPointerForDelegate(efl_loop_time_get_static_delegate)});
      efl_loop_time_set_static_delegate = new efl_loop_time_set_delegate(time_set);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_loop_time_set"), func = Marshal.GetFunctionPointerForDelegate(efl_loop_time_set_static_delegate)});
      efl_loop_iterate_static_delegate = new efl_loop_iterate_delegate(iterate);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_loop_iterate"), func = Marshal.GetFunctionPointerForDelegate(efl_loop_iterate_static_delegate)});
      efl_loop_iterate_may_block_static_delegate = new efl_loop_iterate_may_block_delegate(iterate_may_block);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_loop_iterate_may_block"), func = Marshal.GetFunctionPointerForDelegate(efl_loop_iterate_may_block_static_delegate)});
      efl_loop_begin_static_delegate = new efl_loop_begin_delegate(begin);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_loop_begin"), func = Marshal.GetFunctionPointerForDelegate(efl_loop_begin_static_delegate)});
      efl_loop_quit_static_delegate = new efl_loop_quit_delegate(quit);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_loop_quit"), func = Marshal.GetFunctionPointerForDelegate(efl_loop_quit_static_delegate)});
      efl_loop_job_static_delegate = new efl_loop_job_delegate(job);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_loop_job"), func = Marshal.GetFunctionPointerForDelegate(efl_loop_job_static_delegate)});
      efl_loop_idle_static_delegate = new efl_loop_idle_delegate(idle);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_loop_idle"), func = Marshal.GetFunctionPointerForDelegate(efl_loop_idle_static_delegate)});
      efl_loop_timeout_static_delegate = new efl_loop_timeout_delegate(timeout);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_loop_timeout"), func = Marshal.GetFunctionPointerForDelegate(efl_loop_timeout_static_delegate)});
      efl_loop_register_static_delegate = new efl_loop_register_delegate(register);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_loop_register"), func = Marshal.GetFunctionPointerForDelegate(efl_loop_register_static_delegate)});
      efl_loop_unregister_static_delegate = new efl_loop_unregister_delegate(unregister);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_loop_unregister"), func = Marshal.GetFunctionPointerForDelegate(efl_loop_unregister_static_delegate)});
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Ecore)]  private static extern double efl_loop_throttle_get(System.IntPtr obj);
    private static double throttle_get(System.IntPtr obj, System.IntPtr pd)
   {
      ...
      return _ret_var;
         ...
         return efl_loop_throttle_get(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)));
      }
   }
   private efl_loop_throttle_get_delegate efl_loop_throttle_get_static_delegate;


    private delegate  void efl_loop_throttle_set_delegate(System.IntPtr obj, System.IntPtr pd,   double amount);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Ecore)]  private static extern  void efl_loop_throttle_set(System.IntPtr obj,   double amount);
    private static  void throttle_set(System.IntPtr obj, System.IntPtr pd,  double amount)
   {
      ...
      if(wrapper != null) {
         ...
         efl_loop_throttle_set(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)),  amount);
      }
   }
   private efl_loop_throttle_set_delegate efl_loop_throttle_set_static_delegate;


    private delegate double efl_loop_time_get_delegate(System.IntPtr obj, System.IntPtr pd);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Ecore)]  private static extern double efl_loop_time_get(System.IntPtr obj);
    private static double time_get(System.IntPtr obj, System.IntPtr pd)
   {
      ...
      return _ret_var;
         ...
         return efl_loop_time_get(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)));
      }
   }
   private efl_loop_time_get_delegate efl_loop_time_get_static_delegate;


    private delegate  void efl_loop_time_set_delegate(System.IntPtr obj, System.IntPtr pd,   double timepoint);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Ecore)]  private static extern  void efl_loop_time_set(System.IntPtr obj,   double timepoint);
    private static  void time_set(System.IntPtr obj, System.IntPtr pd,  double timepoint)
   {
      ...
      if(wrapper != null) {
         ...
         efl_loop_time_set(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)),  timepoint);
      }
   }
   private efl_loop_time_set_delegate efl_loop_time_set_static_delegate;


    private delegate  void efl_loop_iterate_delegate(System.IntPtr obj, System.IntPtr pd);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Ecore)]  private static extern  void efl_loop_iterate(System.IntPtr obj);
    private static  void iterate(System.IntPtr obj, System.IntPtr pd)
   {
      ...
      if(wrapper != null) {
         ...
         efl_loop_iterate(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)));
      }
   }
   private efl_loop_iterate_delegate efl_loop_iterate_static_delegate;


    private delegate  int efl_loop_iterate_may_block_delegate(System.IntPtr obj, System.IntPtr pd,    int may_block);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Ecore)]  private static extern  int efl_loop_iterate_may_block(System.IntPtr obj,    int may_block);
    private static  int iterate_may_block(System.IntPtr obj, System.IntPtr pd,   int may_block)
   {
      ...
      if(wrapper != null) {
         ...
         return efl_loop_iterate_may_block(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)),  may_block);
      }
   }
   private efl_loop_iterate_may_block_delegate efl_loop_iterate_may_block_static_delegate;


    private delegate  Eina.Value efl_loop_begin_delegate(System.IntPtr obj, System.IntPtr pd);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Ecore)]  private static extern  Eina.Value efl_loop_begin(System.IntPtr obj);
    private static  Eina.Value begin(System.IntPtr obj, System.IntPtr pd)
   {
      ...
      return _ret_var;
         ...
         return efl_loop_begin(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)));
      }
   }
   private efl_loop_begin_delegate efl_loop_begin_static_delegate;


    private delegate  void efl_loop_quit_delegate(System.IntPtr obj, System.IntPtr pd,    Eina.ValueNative exit_code);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Ecore)]  private static extern  void efl_loop_quit(System.IntPtr obj,    Eina.ValueNative exit_code);
    private static  void quit(System.IntPtr obj, System.IntPtr pd,   Eina.ValueNative exit_code)
   {
      ...
      if(wrapper != null) {
         ...
         efl_loop_quit(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)),  exit_code);
      }
   }
   private efl_loop_quit_delegate efl_loop_quit_static_delegate;
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Ecore)] [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(Eina.FutureMarshaler))] private static extern  Eina.Future efl_loop_job(System.IntPtr obj);
    private static  Eina.Future job(System.IntPtr obj, System.IntPtr pd)
   {
      ...
      return _ret_var;
         ...
         return efl_loop_job(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)));
      }
   }
   private efl_loop_job_delegate efl_loop_job_static_delegate;
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Ecore)] [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(Eina.FutureMarshaler))] private static extern  Eina.Future efl_loop_idle(System.IntPtr obj);
    private static  Eina.Future idle(System.IntPtr obj, System.IntPtr pd)
   {
      ...
      return _ret_var;
         ...
         return efl_loop_idle(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)));
      }
   }
   private efl_loop_idle_delegate efl_loop_idle_static_delegate;
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Ecore)] [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(Eina.FutureMarshaler))] private static extern  Eina.Future efl_loop_timeout(System.IntPtr obj,   double time);
    private static  Eina.Future timeout(System.IntPtr obj, System.IntPtr pd,  double time)
   {
      ...
      if(wrapper != null) {
         ...
         return efl_loop_timeout(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)),  time);
      }
   }
   private efl_loop_timeout_delegate efl_loop_timeout_static_delegate;


    [return: MarshalAs(UnmanagedType.U1)] private delegate bool efl_loop_register_delegate(System.IntPtr obj, System.IntPtr pd, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Efl.Eo.MarshalTest<Efl.Class, Efl.Eo.NonOwnTag>))]  Efl.Class klass, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Efl.Eo.MarshalTest<Efl.Object, Efl.Eo.NonOwnTag>))]  Efl.Object provider);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Ecore)]  [return: MarshalAs(UnmanagedType.U1)] private static extern bool efl_loop_register(System.IntPtr obj, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Efl.Eo.MarshalTest<Efl.Class, Efl.Eo.NonOwnTag>))]  Efl.Class klass, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Efl.Eo.MarshalTest<Efl.Object, Efl.Eo.NonOwnTag>))]  Efl.Object provider);
    private static bool register(System.IntPtr obj, System.IntPtr pd,  Efl.Class klass,  Efl.Object provider)
   {
      ...
      if(wrapper != null) {
         ...
         return efl_loop_register(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)),  klass,  provider);
      }
   }
   private efl_loop_register_delegate efl_loop_register_static_delegate;


    [return: MarshalAs(UnmanagedType.U1)] private delegate bool efl_loop_unregister_delegate(System.IntPtr obj, System.IntPtr pd, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Efl.Eo.MarshalTest<Efl.Class, Efl.Eo.NonOwnTag>))]  Efl.Class klass, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Efl.Eo.MarshalTest<Efl.Object, Efl.Eo.NonOwnTag>))]  Efl.Object provider);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Ecore)]  [return: MarshalAs(UnmanagedType.U1)] private static extern bool efl_loop_unregister(System.IntPtr obj, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Efl.Eo.MarshalTest<Efl.Class, Efl.Eo.NonOwnTag>))]  Efl.Class klass, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Efl.Eo.MarshalTest<Efl.Object, Efl.Eo.NonOwnTag>))]  Efl.Object provider);
    private static bool unregister(System.IntPtr obj, System.IntPtr pd,  Efl.Class klass,  Efl.Object provider)
   {
      ...
      if(wrapper != null) {
         ...
         return efl_loop_unregister(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)),  klass,  provider);
      }
   }
   private efl_loop_unregister_delegate efl_loop_unregister_static_delegate;
}
} 
namespace Efl { 
...
public static class LoopArguments_StructConversion
{
   internal static LoopArguments_StructInternal ToInternal(LoopArguments _external_struct)
   {
      ...
      _internal_struct.Initialization = _external_struct.Initialization;
   ...
   internal static LoopArguments ToManaged(LoopArguments_StructInternal _internal_struct)
   {
      ...
      _external_struct.Initialization = _internal_struct.Initialization;
