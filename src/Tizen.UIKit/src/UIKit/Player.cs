...
/// <summary>UIKit media player interface</summary>
/// <since_tizen> 6 </since_tizen>
[UIKit.PlayerConcrete.NativeMethods]
    ...
    UIKit.Wrapper.IWrapper, IDisposable
{
    ...
    /// 
    /// If set to <c>false</c>, the object&apos;s <see cref="UIKit.IPlayer.GetPlaybackProgress"/> property is, by default, reset to <c>0.0</c>. A class may alter this behavior, and it will be stated in the documentation for a class if such behavior changes should be expected.
    /// 
    ...
    /// 
    /// If <see cref="UIKit.IPlayer.Playing"/> is set to <c>true</c>, this property can be used to pause and resume playback of the media without changing its <see cref="UIKit.IPlayer.GetPlaybackProgress"/> property. This property cannot be changed if <see cref="UIKit.IPlayer.Playing"/> is <c>false</c>.</summary>
    /// <since_tizen> 6 </since_tizen>
    ...
    /// This property sets the current position of the media file to <c>sec</c> seconds since the beginning of the media file. This only works on seekable streams. Setting the position doesn&apos;t change the <see cref="UIKit.IPlayer.Playing"/> or <see cref="UIKit.IPlayer.Paused"/> states of the media file.</summary>
    /// <since_tizen> 6 </since_tizen>
    ...
    
{
    ...
    private PlayerConcrete(UIKit.Wrapper.Globals.WrappingHandle wh) : base(wh)
    {
    }
...
#pragma warning disable CS0628
    ...
    public bool GetPlaying() {
        var _ret_var = UIKit.PlayerConcrete.NativeMethods.efl_player_playing_get_ptr.Value.Delegate(this.NativeHandle);
    ...
    public bool SetPlaying(bool playing) {
        var _ret_var = UIKit.PlayerConcrete.NativeMethods.efl_player_playing_set_ptr.Value.Delegate(this.NativeHandle,playing);
        UIKit.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public bool GetPaused() {
        var _ret_var = UIKit.PlayerConcrete.NativeMethods.efl_player_paused_get_ptr.Value.Delegate(this.NativeHandle);
        UIKit.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public bool SetPaused(bool paused) {
        var _ret_var = UIKit.PlayerConcrete.NativeMethods.efl_player_paused_set_ptr.Value.Delegate(this.NativeHandle,paused);
        UIKit.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public void SetPlaybackPosition(double sec) {
        UIKit.PlayerConcrete.NativeMethods.efl_player_playback_position_set_ptr.Value.Delegate(this.NativeHandle,sec);
        UIKit.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public double GetPlaybackProgress() {
        var _ret_var = UIKit.PlayerConcrete.NativeMethods.efl_player_playback_progress_get_ptr.Value.Delegate(this.NativeHandle);
        UIKit.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public double GetPlaybackSpeed() {
        var _ret_var = UIKit.PlayerConcrete.NativeMethods.efl_player_playback_speed_get_ptr.Value.Delegate(this.NativeHandle);
        UIKit.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public void SetPlaybackSpeed(double speed) {
        UIKit.PlayerConcrete.NativeMethods.efl_player_playback_speed_set_ptr.Value.Delegate(this.NativeHandle,speed);
        UIKit.DataTypes.Error.RaiseIfUnhandledException();
...
#pragma warning restore CS0628
    ...
    {
        return UIKit.PlayerConcrete.efl_player_interface_get();
    }
    ...
    public new class NativeMethods : UIKit.Wrapper.ObjectWrapper.NativeMethods
    {
        ...
        public override System.Collections.Generic.List<UIKit_Op_Description> GetEoOps(System.Type type, bool includeInherited)
        {
            ...
            {
                descs.Add(new UIKit_Op_Description() {api_func = UIKit.Wrapper.FunctionInterop.LoadFunctionPointer(Module.Module, "efl_player_playing_get"), func = Marshal.GetFunctionPointerForDelegate(efl_player_playing_get_static_delegate) });
            }
            ...
            {
                descs.Add(new UIKit_Op_Description() {api_func = UIKit.Wrapper.FunctionInterop.LoadFunctionPointer(Module.Module, "efl_player_playing_set"), func = Marshal.GetFunctionPointerForDelegate(efl_player_playing_set_static_delegate) });
            }
            ...
            {
                descs.Add(new UIKit_Op_Description() {api_func = UIKit.Wrapper.FunctionInterop.LoadFunctionPointer(Module.Module, "efl_player_paused_get"), func = Marshal.GetFunctionPointerForDelegate(efl_player_paused_get_static_delegate) });
            }
            ...
            {
                descs.Add(new UIKit_Op_Description() {api_func = UIKit.Wrapper.FunctionInterop.LoadFunctionPointer(Module.Module, "efl_player_paused_set"), func = Marshal.GetFunctionPointerForDelegate(efl_player_paused_set_static_delegate) });
            }
            ...
            {
                descs.Add(new UIKit_Op_Description() {api_func = UIKit.Wrapper.FunctionInterop.LoadFunctionPointer(Module.Module, "efl_player_playback_position_set"), func = Marshal.GetFunctionPointerForDelegate(efl_player_playback_position_set_static_delegate) });
            }
            ...
            {
                descs.Add(new UIKit_Op_Description() {api_func = UIKit.Wrapper.FunctionInterop.LoadFunctionPointer(Module.Module, "efl_player_playback_progress_get"), func = Marshal.GetFunctionPointerForDelegate(efl_player_playback_progress_get_static_delegate) });
            }
            ...
            {
                descs.Add(new UIKit_Op_Description() {api_func = UIKit.Wrapper.FunctionInterop.LoadFunctionPointer(Module.Module, "efl_player_playback_speed_get"), func = Marshal.GetFunctionPointerForDelegate(efl_player_playback_speed_get_static_delegate) });
            }
            ...
            {
                descs.Add(new UIKit_Op_Description() {api_func = UIKit.Wrapper.FunctionInterop.LoadFunctionPointer(Module.Module, "efl_player_playback_speed_set"), func = Marshal.GetFunctionPointerForDelegate(efl_player_playback_speed_set_static_delegate) });
            }
        ...
        public static UIKit.Wrapper.FunctionWrapper<efl_player_playing_get_api_delegate> efl_player_playing_get_ptr = new UIKit.Wrapper.FunctionWrapper<efl_player_playing_get_api_delegate>(Module, "efl_player_playing_get");

        private static bool playing_get(System.IntPtr obj, System.IntPtr pd)
        {
            UIKit.DataTypes.Log.Debug("function efl_player_playing_get was called");
            ...
            {
                return efl_player_playing_get_ptr.Value.Delegate(UIKit.Wrapper.Globals.efl_super(obj, UIKit.Wrapper.Globals.efl_class_get(obj)));
            }
        }
        ...
        public static UIKit.Wrapper.FunctionWrapper<efl_player_playing_set_api_delegate> efl_player_playing_set_ptr = new UIKit.Wrapper.FunctionWrapper<efl_player_playing_set_api_delegate>(Module, "efl_player_playing_set");

        private static bool playing_set(System.IntPtr obj, System.IntPtr pd, bool playing)
        {
            UIKit.DataTypes.Log.Debug("function efl_player_playing_set was called");
            var ws = UIKit.Wrapper.Globals.GetWrapperSupervisor(obj);
            if (ws != null)
            {
                bool _ret_var = default(bool);
            ...
            {
                return efl_player_playing_set_ptr.Value.Delegate(UIKit.Wrapper.Globals.efl_super(obj, UIKit.Wrapper.Globals.efl_class_get(obj)), playing);
            }
        }
        ...
        public static UIKit.Wrapper.FunctionWrapper<efl_player_paused_get_api_delegate> efl_player_paused_get_ptr = new UIKit.Wrapper.FunctionWrapper<efl_player_paused_get_api_delegate>(Module, "efl_player_paused_get");

        private static bool paused_get(System.IntPtr obj, System.IntPtr pd)
        {
            UIKit.DataTypes.Log.Debug("function efl_player_paused_get was called");
            var ws = UIKit.Wrapper.Globals.GetWrapperSupervisor(obj);
            if (ws != null)
            {
                bool _ret_var = default(bool);
            ...
            {
                return efl_player_paused_get_ptr.Value.Delegate(UIKit.Wrapper.Globals.efl_super(obj, UIKit.Wrapper.Globals.efl_class_get(obj)));
            }
        }
        ...
        public static UIKit.Wrapper.FunctionWrapper<efl_player_paused_set_api_delegate> efl_player_paused_set_ptr = new UIKit.Wrapper.FunctionWrapper<efl_player_paused_set_api_delegate>(Module, "efl_player_paused_set");

        private static bool paused_set(System.IntPtr obj, System.IntPtr pd, bool paused)
        {
            UIKit.DataTypes.Log.Debug("function efl_player_paused_set was called");
            var ws = UIKit.Wrapper.Globals.GetWrapperSupervisor(obj);
            if (ws != null)
            {
                bool _ret_var = default(bool);
            ...
            {
                return efl_player_paused_set_ptr.Value.Delegate(UIKit.Wrapper.Globals.efl_super(obj, UIKit.Wrapper.Globals.efl_class_get(obj)), paused);
            }
        }
        ...
        public static UIKit.Wrapper.FunctionWrapper<efl_player_playback_position_set_api_delegate> efl_player_playback_position_set_ptr = new UIKit.Wrapper.FunctionWrapper<efl_player_playback_position_set_api_delegate>(Module, "efl_player_playback_position_set");

        private static void playback_position_set(System.IntPtr obj, System.IntPtr pd, double sec)
        {
            UIKit.DataTypes.Log.Debug("function efl_player_playback_position_set was called");
            var ws = UIKit.Wrapper.Globals.GetWrapperSupervisor(obj);
            if (ws != null)
            {
            ...
            {
                efl_player_playback_position_set_ptr.Value.Delegate(UIKit.Wrapper.Globals.efl_super(obj, UIKit.Wrapper.Globals.efl_class_get(obj)), sec);
            }
        }
        ...
        public static UIKit.Wrapper.FunctionWrapper<efl_player_playback_progress_get_api_delegate> efl_player_playback_progress_get_ptr = new UIKit.Wrapper.FunctionWrapper<efl_player_playback_progress_get_api_delegate>(Module, "efl_player_playback_progress_get");

        private static double playback_progress_get(System.IntPtr obj, System.IntPtr pd)
        {
            UIKit.DataTypes.Log.Debug("function efl_player_playback_progress_get was called");
            var ws = UIKit.Wrapper.Globals.GetWrapperSupervisor(obj);
            if (ws != null)
            {
            ...
            {
                return efl_player_playback_progress_get_ptr.Value.Delegate(UIKit.Wrapper.Globals.efl_super(obj, UIKit.Wrapper.Globals.efl_class_get(obj)));
            }
        }
        ...
        public static UIKit.Wrapper.FunctionWrapper<efl_player_playback_speed_get_api_delegate> efl_player_playback_speed_get_ptr = new UIKit.Wrapper.FunctionWrapper<efl_player_playback_speed_get_api_delegate>(Module, "efl_player_playback_speed_get");

        private static double playback_speed_get(System.IntPtr obj, System.IntPtr pd)
        {
            UIKit.DataTypes.Log.Debug("function efl_player_playback_speed_get was called");
            var ws = UIKit.Wrapper.Globals.GetWrapperSupervisor(obj);
            if (ws != null)
            {
                double _ret_var = default(double);
            ...
            {
                return efl_player_playback_speed_get_ptr.Value.Delegate(UIKit.Wrapper.Globals.efl_super(obj, UIKit.Wrapper.Globals.efl_class_get(obj)));
            }
        }
        ...
        public static UIKit.Wrapper.FunctionWrapper<efl_player_playback_speed_set_api_delegate> efl_player_playback_speed_set_ptr = new UIKit.Wrapper.FunctionWrapper<efl_player_playback_speed_set_api_delegate>(Module, "efl_player_playback_speed_set");

        private static void playback_speed_set(System.IntPtr obj, System.IntPtr pd, double speed)
        {
            UIKit.DataTypes.Log.Debug("function efl_player_playback_speed_set was called");
            var ws = UIKit.Wrapper.Globals.GetWrapperSupervisor(obj);
            if (ws != null)
            {
            ...
            {
                efl_player_playback_speed_set_ptr.Value.Delegate(UIKit.Wrapper.Globals.efl_super(obj, UIKit.Wrapper.Globals.efl_class_get(obj)), speed);
            }
        }
...
#if EFL_BETA
#pragma warning disable CS1591
public static class UIKitPlayerConcrete_ExtensionMethods {
}
