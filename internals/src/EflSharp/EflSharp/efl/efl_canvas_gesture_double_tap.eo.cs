...
/// <summary>Double-tap gesture class holding state information. See <see cref="Efl.Canvas.Gesture"/> to see what this state is and <see cref="Efl.Gesture.IEvents.GestureDoubleTapEvent"/> for a description of the Double-tap gesture.</summary>
