...
//         private static readonly string DefaultTitle = "BorderWindow";
...
//         private static readonly string DefaultTerminateIcon = ResourcePath + "close.png";
//         private static readonly Color DefaultBackgroundColor = new Color(1, 1, 1, 0.3f);
//         private static readonly int DefaultBorderHeight = 90;
//         private static readonly int DefaultBorderLineSize = 40;
...
//         private float rightViewFixedWidth = DefaultBorderLineSize;
...
//         {
//             style.Title = (customStyle.Title  != "" && customStyle.Title  != null) ? customStyle.Title : DefaultTitle;
//             style.TitleColor = customStyle.TitleColor != null ? customStyle.TitleColor : DefaultTitleColor;
...
//             style.TerminateIcon = (customStyle.TerminateIcon != "" && customStyle.TerminateIcon != null) ? customStyle.TerminateIcon : DefaultTerminateIcon;
...
//             {
//                 ResourceUrl = style.TerminateIcon,
//             };
...
//             borderView.AddChild(leftView, new TableView.CellPosition(0, 0));
//             borderView.AddChild(rightView, new TableView.CellPosition(0, 1));
//             borderView.SetFixedWidth(1, rightViewFixedWidth);

//             min.ResourcesLoaded += (s, e) =>
//             {
//                 rightViewFixedWidth += min.Size.Width;
//                 borderView.SetFixedWidth(1, rightViewFixedWidth);
//                 Tizen.Log.Error("gab_test", $"min.Size [{min.Size.Width}, {min.Size.Height}]\n");
//             };

//             max.ResourcesLoaded += (s, e) =>
//             {
//                 rightViewFixedWidth += max.Size.Width;
//                 borderView.SetFixedWidth(1, rightViewFixedWidth);
//                 Tizen.Log.Error("gab_test", $"max.Size [{max.Size.Width}, {max.Size.Height}]\n");
//             };

//             terminate.ResourcesLoaded += (s, e) =>
//             {
//                 rightViewFixedWidth += terminate.Size.Width;
//                 borderView.SetFixedWidth(1, rightViewFixedWidth);
//                 Tizen.Log.Error("gab_test", $"terminate.Size [{terminate.Size.Width}, {terminate.Size.Height}]\n");
//             };
...
//             // check left corner
//             if (xPosition < DefaultBorderLineSize && yPosition > style.Height - DefaultBorderLineSize)
//             {
//                 this.RequestResizeToServer(ResizeDirection.BottomLeft);
//                 return CommandType.ResizeLeftCorner;
//             }
//             // check right corner
//             else if (xPosition > this.WindowSize.Width - DefaultBorderLineSize && yPosition > style.Height - DefaultBorderLineSize)
//             {
//                 this.RequestResizeToServer(ResizeDirection.BottomRight);
//                 return CommandType.ResizeRightCorner;
//             }
//             // check left side
//             else if (xPosition < DefaultBorderLineSize)
//             {
//                 this.RequestResizeToServer(ResizeDirection.Left);
//                 return CommandType.ResizeLeftSide;
//             }
//             // check right side
//             else if (xPosition > this.WindowSize.Width - DefaultBorderLineSize)
//             {
//                 this.RequestResizeToServer(ResizeDirection.Right);
//                 return CommandType.ResizeRightSide;
//             }
//             // check bottom side
//             else if (yPosition > style.Height - DefaultBorderLineSize + 10)
//             {
...
//             if (resizeWidth < (int)(rightViewFixedWidth * 2))
//             {
//                 resizeWidth = (int)(rightViewFixedWidth * 2);
//             }
...
//             /// </summary>
//             [EditorBrowsable(EditorBrowsableState.Never)]
//             public string TerminateIcon {get; set;}
