    ...
    
{
    ...
    public System.IntPtr NativeClass {
        get {
            if (((object)this).GetType() == typeof (IPlayableConcrete))
                return Efl.IPlayableNativeInherit.GetEflClassStatic();
            else
    ...
    public double GetLength() {
         var _ret_var = Efl.IPlayableNativeInherit.efl_playable_length_get_ptr.Value.Delegate(this.NativeHandle);
    ...
    public bool GetPlayable() {
         var _ret_var = Efl.IPlayableNativeInherit.efl_playable_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    /// <summary>Get whether the media file is seekable.</summary>
    ...
    public bool GetSeekable() {
         var _ret_var = Efl.IPlayableNativeInherit.efl_playable_seekable_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    /// <summary>Get the length of play for the media file.</summary>
