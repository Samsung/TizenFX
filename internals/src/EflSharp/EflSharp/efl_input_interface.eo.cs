   ...
   public System.IntPtr NativeClass {
      get {
         if (((object)this).GetType() == typeof (InterfaceConcrete))
            return Efl.Input.InterfaceConcreteNativeInherit.GetEflClassStatic();
         else
...
private static object FocusOutEvtKey = new object();
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Evas)]
    [return: MarshalAs(UnmanagedType.U1)] private static extern bool efl_input_seat_event_filter_get(System.IntPtr obj, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Efl.Eo.MarshalTest<Efl.Input.Device, Efl.Eo.NonOwnTag>))]  Efl.Input.Device seat);
   /// <summary>Check if input events from a given seat is enabled.
   /// 1.19</summary>
   /// <param name="seat">The seat to act on.
   /// 1.19</param>
   ...
   public bool GetSeatEventFilter( Efl.Input.Device seat) {
                         var _ret_var = efl_input_seat_event_filter_get(Efl.Input.InterfaceConcrete.efl_input_interface_interface_get(),  seat);
      Eina.Error.RaiseIfUnhandledException();
                  return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Evas)]
    private static extern  void efl_input_seat_event_filter_set(System.IntPtr obj, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Efl.Eo.MarshalTest<Efl.Input.Device, Efl.Eo.NonOwnTag>))]  Efl.Input.Device seat,  [MarshalAs(UnmanagedType.U1)]  bool enable);
   /// <summary>Add or remove a given seat to the filter list. If the filter list is empty this object will report mouse, keyboard and focus events from any seat, otherwise those events will only be reported if the event comes from a seat that is in the list.
   /// 1.19</summary>
   /// <param name="seat">The seat to act on.
   /// 1.19</param>
   ...
   public  void SetSeatEventFilter( Efl.Input.Device seat,  bool enable) {
                                           efl_input_seat_event_filter_set(Efl.Input.InterfaceConcrete.efl_input_interface_interface_get(),  seat,  enable);
      Eina.Error.RaiseIfUnhandledException();
                               }
}
