    ...
    , Efl.Ui.IWidgetFocusManager, Efl.Ui.Focus.IManager
{
    ...
    public System.IntPtr NativeClass {
        get {
            if (((object)this).GetType() == typeof (ILayerConcrete))
                return Efl.Ui.Focus.ILayerNativeInherit.GetEflClassStatic();
            else
...
private static object DirtyLogicFreezeChangedEvtKey = new object();
    ...
    public bool GetEnable() {
         var _ret_var = Efl.Ui.Focus.ILayerNativeInherit.efl_ui_focus_layer_enable_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    /// <summary>Enable property</summary>
    ...
    public void SetEnable( bool v) {
                                 Efl.Ui.Focus.ILayerNativeInherit.efl_ui_focus_layer_enable_set_ptr.Value.Delegate(this.NativeHandle, v);
        Eina.Error.RaiseIfUnhandledException();
                         }
    /// <summary>Constructor for setting the behaviour of the layer</summary>
    /// <param name="enable_on_visible"><c>true</c> means layer will set itself once the inheriting widget becomes visible, <c>false</c> means the layer isn&apos;t enabled automatically</param>
    ...
    public void GetBehaviour( out bool enable_on_visible,  out bool cycle) {
                                                         Efl.Ui.Focus.ILayerNativeInherit.efl_ui_focus_layer_behaviour_get_ptr.Value.Delegate(this.NativeHandle, out enable_on_visible,  out cycle);
        Eina.Error.RaiseIfUnhandledException();
                                         }
    /// <summary>Constructor for setting the behaviour of the layer</summary>
    /// <param name="enable_on_visible"><c>true</c> means layer will set itself once the inheriting widget becomes visible, <c>false</c> means the layer isn&apos;t enabled automatically</param>
    ...
    public void SetBehaviour( bool enable_on_visible,  bool cycle) {
                                                         Efl.Ui.Focus.ILayerNativeInherit.efl_ui_focus_layer_behaviour_set_ptr.Value.Delegate(this.NativeHandle, enable_on_visible,  cycle);
        Eina.Error.RaiseIfUnhandledException();
                                         }
...
public class ILayerNativeInherit  : Efl.Eo.NativeClass{
