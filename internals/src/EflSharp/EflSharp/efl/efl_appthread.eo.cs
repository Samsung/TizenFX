...
/// <summary>This class houses the application&apos;s thread and main loop. It works similarly to <see cref="Efl.App"/> but allows communicating with it from a different thread through the <see cref="Efl.IThreadIO"/>, <see cref="Efl.Io.IReader"/> and <see cref="Efl.Io.IWriter"/> interfaces. Methods can be scheduled to be executed in this thread using <see cref="Efl.IThreadIO.Call"/> and <see cref="Efl.IThreadIO.SyncCall"/>.</summary>
