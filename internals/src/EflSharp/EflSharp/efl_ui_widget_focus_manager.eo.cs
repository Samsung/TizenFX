...
/// <summary></summary>
[WidgetFocusManagerConcreteNativeInherit]
   ...
   public System.IntPtr NativeClass {
      get {
         if (((object)this).GetType() == typeof (WidgetFocusManagerConcrete))
            return Efl.Ui.WidgetFocusManagerConcreteNativeInherit.GetEflClassStatic();
         else
...
public class WidgetFocusManagerConcreteNativeInherit : Efl.Eo.NativeClass{
    ...
    private static Efl.Ui.Focus.Object request_subchild(System.IntPtr obj, System.IntPtr pd,  Efl.Ui.Focus.Object child)
   {
      ...
      if(wrapper != null) {
                                    Efl.Ui.Focus.Object _ret_var = default(Efl.Ui.Focus.Object);
         try {
            _ret_var = ((WidgetFocusManagerConcrete)wrapper).RequestSubchild( child);
         } catch (Exception e) {
            Eina.Log.Warning($"Callback error: {e.ToString()}");
            Eina.Error.Set(Eina.Error.UNHANDLED_EXCEPTION);
         }
