...
namespace Tizen.NUI.Accessibility
{
    ...
    public partial class AccessibilityManager : BaseHandle
    {
        ...
        {
            Interop.AccessibilityManager.AccessibilityManager_EnableAccessibility(swigCPtr, enabled);
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
        }
        ...
        {
            bool ret = Interop.AccessibilityManager.AccessibilityManager_IsEnabled(swigCPtr);
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
            return ret;
        }
