...
public delegate void ScrollableOnShowRegionInternal(IntPtr data, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(Efl.Eo.MarshalTest<Efl.Canvas.Object, Efl.Eo.NonOwnTag>))]  Efl.Canvas.Object obj,   Eina.Rect.NativeStruct region);
internal class ScrollableOnShowRegionWrapper
{
    ...
    internal void ManagedCb( Efl.Canvas.Object obj, Eina.Rect region)
    {
        ...
        internal static void Cb(IntPtr cb_data, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(Efl.Eo.MarshalTest<Efl.Canvas.Object, Efl.Eo.NonOwnTag>))]  Efl.Canvas.Object obj,   Eina.Rect.NativeStruct region)
    {
...
private static object AtspiHighlightedEvtKey = new object();
    ...
    public event EventHandler AtspiHighlightedEvt
    {
        add {
            lock (eventLock) {
                ...
                if (AddNativeEventHandler(efl.Libs.Elementary, key, this.evt_AtspiHighlightedEvt_delegate)) {
        ...
        remove {
            lock (eventLock) {
                string key = "_EFL_UI_WIDGET_EVENT_ATSPI_HIGHLIGHTED";
                if (RemoveNativeEventHandler(key, this.evt_AtspiHighlightedEvt_delegate)) { 
    ...
    private void on_AtspiHighlightedEvt_NativeCallback(System.IntPtr data, ref Efl.Event.NativeStruct evt)
    {
...
private static object AtspiUnhighlightedEvtKey = new object();
    ...
    public event EventHandler AtspiUnhighlightedEvt
    {
        add {
            lock (eventLock) {
                ...
                if (AddNativeEventHandler(efl.Libs.Elementary, key, this.evt_AtspiUnhighlightedEvt_delegate)) {
        ...
        remove {
            lock (eventLock) {
                string key = "_EFL_UI_WIDGET_EVENT_ATSPI_UNHIGHLIGHTED";
                if (RemoveNativeEventHandler(key, this.evt_AtspiUnhighlightedEvt_delegate)) { 
    ...
    private void on_AtspiUnhighlightedEvt_NativeCallback(System.IntPtr data, ref Efl.Event.NativeStruct evt)
    {
        EventArgs args = EventArgs.Empty;
        try {
...
private static object LanguageChangedEvtKey = new object();
    ...
    public event EventHandler LanguageChangedEvt
    {
        add {
            lock (eventLock) {
                ...
                if (AddNativeEventHandler(efl.Libs.Elementary, key, this.evt_LanguageChangedEvt_delegate)) {
        ...
        remove {
            lock (eventLock) {
                string key = "_EFL_UI_WIDGET_EVENT_LANGUAGE_CHANGED";
                if (RemoveNativeEventHandler(key, this.evt_LanguageChangedEvt_delegate)) { 
    ...
    private void on_LanguageChangedEvt_NativeCallback(System.IntPtr data, ref Efl.Event.NativeStruct evt)
    {
        EventArgs args = EventArgs.Empty;
        try {
...
private static object AccessChangedEvtKey = new object();
    ...
    public event EventHandler AccessChangedEvt
    {
        add {
            lock (eventLock) {
                ...
                if (AddNativeEventHandler(efl.Libs.Elementary, key, this.evt_AccessChangedEvt_delegate)) {
        ...
        remove {
            lock (eventLock) {
                string key = "_EFL_UI_WIDGET_EVENT_ACCESS_CHANGED";
                if (RemoveNativeEventHandler(key, this.evt_AccessChangedEvt_delegate)) { 
    ...
    private void on_AccessChangedEvt_NativeCallback(System.IntPtr data, ref Efl.Event.NativeStruct evt)
    {
        EventArgs args = EventArgs.Empty;
        try {
...
private static object DragAcceptEvtKey = new object();
    ...
    public event EventHandler<Efl.Ui.IDndDragAcceptEvt_Args> DragAcceptEvt
    {
        add {
            lock (eventLock) {
                ...
                if (AddNativeEventHandler(efl.Libs.Elementary, key, this.evt_DragAcceptEvt_delegate)) {
        ...
        remove {
            lock (eventLock) {
                string key = "_EFL_UI_DND_EVENT_DRAG_ACCEPT";
                if (RemoveNativeEventHandler(key, this.evt_DragAcceptEvt_delegate)) { 
    ...
    public void On_DragAcceptEvt(Efl.Ui.IDndDragAcceptEvt_Args e)
    {
        EventHandler<Efl.Ui.IDndDragAcceptEvt_Args> evt;
        lock (eventLock) {
        evt = (EventHandler<Efl.Ui.IDndDragAcceptEvt_Args>)eventHandlers[DragAcceptEvtKey];
        }
        evt?.Invoke(this, e);
    }
    Efl.EventCb evt_DragAcceptEvt_delegate;
    private void on_DragAcceptEvt_NativeCallback(System.IntPtr data, ref Efl.Event.NativeStruct evt)
    {
...
private static object DragDoneEvtKey = new object();
    ...
    public event EventHandler DragDoneEvt
    {
        add {
            lock (eventLock) {
                ...
                if (AddNativeEventHandler(efl.Libs.Elementary, key, this.evt_DragDoneEvt_delegate)) {
        ...
        remove {
            lock (eventLock) {
                string key = "_EFL_UI_DND_EVENT_DRAG_DONE";
                if (RemoveNativeEventHandler(key, this.evt_DragDoneEvt_delegate)) { 
    ...
    private void on_DragDoneEvt_NativeCallback(System.IntPtr data, ref Efl.Event.NativeStruct evt)
    {
        EventArgs args = EventArgs.Empty;
        try {
            On_DragDoneEvt(args);
...
private static object DragEnterEvtKey = new object();
    ...
    public event EventHandler DragEnterEvt
    {
        add {
            lock (eventLock) {
                ...
                if (AddNativeEventHandler(efl.Libs.Elementary, key, this.evt_DragEnterEvt_delegate)) {
        ...
        remove {
            lock (eventLock) {
                string key = "_EFL_UI_DND_EVENT_DRAG_ENTER";
                if (RemoveNativeEventHandler(key, this.evt_DragEnterEvt_delegate)) { 
    ...
    private void on_DragEnterEvt_NativeCallback(System.IntPtr data, ref Efl.Event.NativeStruct evt)
    {
        EventArgs args = EventArgs.Empty;
        try {
...
private static object DragLeaveEvtKey = new object();
    ...
    public event EventHandler DragLeaveEvt
    {
        add {
            lock (eventLock) {
                ...
                if (AddNativeEventHandler(efl.Libs.Elementary, key, this.evt_DragLeaveEvt_delegate)) {
        ...
        remove {
            lock (eventLock) {
                string key = "_EFL_UI_DND_EVENT_DRAG_LEAVE";
                if (RemoveNativeEventHandler(key, this.evt_DragLeaveEvt_delegate)) { 
    ...
    private void on_DragLeaveEvt_NativeCallback(System.IntPtr data, ref Efl.Event.NativeStruct evt)
    {
        EventArgs args = EventArgs.Empty;
        try {
...
private static object DragPosEvtKey = new object();
    ...
    public event EventHandler<Efl.Ui.IDndDragPosEvt_Args> DragPosEvt
    {
        add {
            lock (eventLock) {
                ...
                if (AddNativeEventHandler(efl.Libs.Elementary, key, this.evt_DragPosEvt_delegate)) {
        ...
        remove {
            lock (eventLock) {
                string key = "_EFL_UI_DND_EVENT_DRAG_POS";
                if (RemoveNativeEventHandler(key, this.evt_DragPosEvt_delegate)) { 
    ...
    public void On_DragPosEvt(Efl.Ui.IDndDragPosEvt_Args e)
    {
        EventHandler<Efl.Ui.IDndDragPosEvt_Args> evt;
        lock (eventLock) {
        evt = (EventHandler<Efl.Ui.IDndDragPosEvt_Args>)eventHandlers[DragPosEvtKey];
        }
        evt?.Invoke(this, e);
    }
    Efl.EventCb evt_DragPosEvt_delegate;
    private void on_DragPosEvt_NativeCallback(System.IntPtr data, ref Efl.Event.NativeStruct evt)
    {
...
private static object DragDropEvtKey = new object();
    ...
    public event EventHandler<Efl.Ui.IDndDragDropEvt_Args> DragDropEvt
    {
        add {
            lock (eventLock) {
                ...
                if (AddNativeEventHandler(efl.Libs.Elementary, key, this.evt_DragDropEvt_delegate)) {
        ...
        remove {
            lock (eventLock) {
                string key = "_EFL_UI_DND_EVENT_DRAG_DROP";
                if (RemoveNativeEventHandler(key, this.evt_DragDropEvt_delegate)) { 
    ...
    public void On_DragDropEvt(Efl.Ui.IDndDragDropEvt_Args e)
    {
        EventHandler<Efl.Ui.IDndDragDropEvt_Args> evt;
        lock (eventLock) {
        evt = (EventHandler<Efl.Ui.IDndDragDropEvt_Args>)eventHandlers[DragDropEvtKey];
        }
        evt?.Invoke(this, e);
    }
    Efl.EventCb evt_DragDropEvt_delegate;
    private void on_DragDropEvt_NativeCallback(System.IntPtr data, ref Efl.Event.NativeStruct evt)
    {
...
private static object FocusGeometryChangedEvtKey = new object();
    ...
    virtual public bool WidgetInputEventHandler( ref Efl.Event eo_event,  Efl.Canvas.Object source) {
         Efl.Event.NativeStruct _in_eo_event = eo_event;
                                                var _ret_var = Efl.Ui.WidgetNativeInherit.efl_ui_widget_input_event_handler_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), ref _in_eo_event,  source);
        Eina.Error.RaiseIfUnhandledException();
    ...
    virtual public Efl.Object GetPart( System.String name) {
                                 var _ret_var = Efl.IPartNativeInherit.efl_part_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), name);
        Eina.Error.RaiseIfUnhandledException();
                        return _ret_var;
 }
    ...
    virtual public System.String GetActionName( int id) {
                                 var _ret_var = Efl.Access.IActionNativeInherit.efl_access_action_name_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), id);
        Eina.Error.RaiseIfUnhandledException();
                        return _ret_var;
 }
    ...
    virtual public System.String GetActionLocalizedName( int id) {
                                 var _ret_var = Efl.Access.IActionNativeInherit.efl_access_action_localized_name_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), id);
        Eina.Error.RaiseIfUnhandledException();
                        return _ret_var;
 }
    ...
    virtual public Eina.List<Efl.Access.ActionData> GetActions() {
         var _ret_var = Efl.Access.IActionNativeInherit.efl_access_action_actions_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
        Eina.Error.RaiseIfUnhandledException();
    ...
    virtual public bool ActionDo( int id) {
                                 var _ret_var = Efl.Access.IActionNativeInherit.efl_access_action_do_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), id);
        Eina.Error.RaiseIfUnhandledException();
                        return _ret_var;
 }
    ...
    virtual public System.String GetActionKeybinding( int id) {
                                 var _ret_var = Efl.Access.IActionNativeInherit.efl_access_action_keybinding_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), id);
        Eina.Error.RaiseIfUnhandledException();
                        return _ret_var;
 }
    ...
    virtual public int GetZOrder() {
         var _ret_var = Efl.Access.IComponentNativeInherit.efl_access_component_z_order_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    ...
    virtual public Eina.Rect GetExtents( bool screen_coords) {
                                 var _ret_var = Efl.Access.IComponentNativeInherit.efl_access_component_extents_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), screen_coords);
        Eina.Error.RaiseIfUnhandledException();
                        return _ret_var;
 }
    /// <summary>Geometry of accessible widget.</summary>
    ...
    virtual public bool SetExtents( bool screen_coords,  Eina.Rect rect) {
                 Eina.Rect.NativeStruct _in_rect = rect;
                                        var _ret_var = Efl.Access.IComponentNativeInherit.efl_access_component_extents_set_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), screen_coords,  _in_rect);
        Eina.Error.RaiseIfUnhandledException();
                                        return _ret_var;
 }
    ...
    virtual public void GetScreenPosition( out int x,  out int y) {
                                                         Efl.Access.IComponentNativeInherit.efl_access_component_screen_position_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), out x,  out y);
        Eina.Error.RaiseIfUnhandledException();
                                         }
    /// <summary>Position of accessible widget.</summary>
    /// <param name="x">X coordinate</param>
    ...
    virtual public bool SetScreenPosition( int x,  int y) {
                                                         var _ret_var = Efl.Access.IComponentNativeInherit.efl_access_component_screen_position_set_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), x,  y);
        Eina.Error.RaiseIfUnhandledException();
                                        return _ret_var;
 }
    ...
    virtual public void GetSocketOffset( out int x,  out int y) {
                                                         Efl.Access.IComponentNativeInherit.efl_access_component_socket_offset_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), out x,  out y);
        Eina.Error.RaiseIfUnhandledException();
                                         }
    ...
    virtual public void SetSocketOffset( int x,  int y) {
                                                         Efl.Access.IComponentNativeInherit.efl_access_component_socket_offset_set_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), x,  y);
        Eina.Error.RaiseIfUnhandledException();
                                         }
    ...
    virtual public bool Contains( bool screen_coords,  int x,  int y) {
                                                                                 var _ret_var = Efl.Access.IComponentNativeInherit.efl_access_component_contains_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), screen_coords,  x,  y);
        Eina.Error.RaiseIfUnhandledException();
                                                        return _ret_var;
 }
    ...
    virtual public bool GrabFocus() {
         var _ret_var = Efl.Access.IComponentNativeInherit.efl_access_component_focus_grab_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    ...
    virtual public Efl.Object GetAccessibleAtPoint( bool screen_coords,  int x,  int y) {
                                                                                 var _ret_var = Efl.Access.IComponentNativeInherit.efl_access_component_accessible_at_point_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), screen_coords,  x,  y);
        Eina.Error.RaiseIfUnhandledException();
                                                        return _ret_var;
 }
    ...
    virtual public bool GrabHighlight() {
         var _ret_var = Efl.Access.IComponentNativeInherit.efl_access_component_highlight_grab_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    ...
    virtual public bool ClearHighlight() {
         var _ret_var = Efl.Access.IComponentNativeInherit.efl_access_component_highlight_clear_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    ...
    virtual public System.String GetLocalizedRoleName() {
         var _ret_var = Efl.Access.IObjectNativeInherit.efl_access_object_localized_role_name_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    ...
    virtual public System.String GetI18nName() {
         var _ret_var = Efl.Access.IObjectNativeInherit.efl_access_object_i18n_name_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    /// <summary>Accessible name of the object.</summary>
    ...
    virtual public void SetI18nName( System.String i18n_name) {
                                 Efl.Access.IObjectNativeInherit.efl_access_object_i18n_name_set_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), i18n_name);
        Eina.Error.RaiseIfUnhandledException();
                         }
    ...
    virtual public void SetNameCb( Efl.Access.ReadingInfoCb name_cb,  System.IntPtr data) {
                                                         Efl.Access.IObjectNativeInherit.efl_access_object_name_cb_set_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), name_cb,  data);
        Eina.Error.RaiseIfUnhandledException();
                                         }
    ...
    virtual public Efl.Access.RelationSet GetRelationSet() {
         var _ret_var = Efl.Access.IObjectNativeInherit.efl_access_object_relation_set_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    ...
    virtual public Efl.Access.Role GetRole() {
         var _ret_var = Efl.Access.IObjectNativeInherit.efl_access_object_role_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    ...
    virtual public void SetRole( Efl.Access.Role role) {
                                 Efl.Access.IObjectNativeInherit.efl_access_object_role_set_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), role);
        Eina.Error.RaiseIfUnhandledException();
                         }
    ...
    virtual public Efl.Access.IObject GetAccessParent() {
         var _ret_var = Efl.Access.IObjectNativeInherit.efl_access_object_access_parent_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    /// <summary>Gets object&apos;s accessible parent.</summary>
    ...
    virtual public void SetAccessParent( Efl.Access.IObject parent) {
                                 Efl.Access.IObjectNativeInherit.efl_access_object_access_parent_set_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), parent);
        Eina.Error.RaiseIfUnhandledException();
                         }
    ...
    virtual public void SetDescriptionCb( Efl.Access.ReadingInfoCb description_cb,  System.IntPtr data) {
                                                         Efl.Access.IObjectNativeInherit.efl_access_object_description_cb_set_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), description_cb,  data);
        Eina.Error.RaiseIfUnhandledException();
                                         }
    ...
    virtual public void SetGestureCb( Efl.Access.GestureCb gesture_cb,  System.IntPtr data) {
                                                         Efl.Access.IObjectNativeInherit.efl_access_object_gesture_cb_set_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), gesture_cb,  data);
        Eina.Error.RaiseIfUnhandledException();
                                         }
    ...
    virtual public Eina.List<Efl.Access.IObject> GetAccessChildren() {
         var _ret_var = Efl.Access.IObjectNativeInherit.efl_access_object_access_children_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
        Eina.Error.RaiseIfUnhandledException();
    ...
    virtual public System.String GetRoleName() {
         var _ret_var = Efl.Access.IObjectNativeInherit.efl_access_object_role_name_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    ...
    virtual public Eina.List<Efl.Access.Attribute> GetAttributes() {
         var _ret_var = Efl.Access.IObjectNativeInherit.efl_access_object_attributes_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
        Eina.Error.RaiseIfUnhandledException();
    ...
    virtual public Efl.Access.ReadingInfoTypeMask GetReadingInfoType() {
         var _ret_var = Efl.Access.IObjectNativeInherit.efl_access_object_reading_info_type_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    ...
    virtual public void SetReadingInfoType( Efl.Access.ReadingInfoTypeMask reading_info) {
                                 Efl.Access.IObjectNativeInherit.efl_access_object_reading_info_type_set_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), reading_info);
        Eina.Error.RaiseIfUnhandledException();
                         }
    ...
    virtual public int GetIndexInParent() {
         var _ret_var = Efl.Access.IObjectNativeInherit.efl_access_object_index_in_parent_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    ...
    virtual public System.String GetDescription() {
         var _ret_var = Efl.Access.IObjectNativeInherit.efl_access_object_description_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    ...
    virtual public void SetDescription( System.String description) {
                                 Efl.Access.IObjectNativeInherit.efl_access_object_description_set_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), description);
        Eina.Error.RaiseIfUnhandledException();
                         }
    ...
    virtual public Efl.Access.StateSet GetStateSet() {
         var _ret_var = Efl.Access.IObjectNativeInherit.efl_access_object_state_set_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    ...
    virtual public bool GetCanHighlight() {
         var _ret_var = Efl.Access.IObjectNativeInherit.efl_access_object_can_highlight_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    ...
    virtual public void SetCanHighlight( bool can_highlight) {
                                 Efl.Access.IObjectNativeInherit.efl_access_object_can_highlight_set_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), can_highlight);
        Eina.Error.RaiseIfUnhandledException();
                         }
    ...
    virtual public System.String GetTranslationDomain() {
         var _ret_var = Efl.Access.IObjectNativeInherit.efl_access_object_translation_domain_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    /// <summary>The translation domain of &quot;name&quot; and &quot;description&quot; properties.
    ...
    virtual public void SetTranslationDomain( System.String domain) {
                                 Efl.Access.IObjectNativeInherit.efl_access_object_translation_domain_set_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), domain);
        Eina.Error.RaiseIfUnhandledException();
                         }
    ...
    virtual public bool GestureDo( Efl.Access.GestureInfo gesture_info) {
         Efl.Access.GestureInfo.NativeStruct _in_gesture_info = gesture_info;
                        var _ret_var = Efl.Access.IObjectNativeInherit.efl_access_object_gesture_do_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), _in_gesture_info);
        Eina.Error.RaiseIfUnhandledException();
                        return _ret_var;
 }
    ...
    virtual public void AppendAttribute( System.String key,  System.String value) {
                                                         Efl.Access.IObjectNativeInherit.efl_access_object_attribute_append_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), key,  value);
        Eina.Error.RaiseIfUnhandledException();
                                         }
    ...
    virtual public void DelAttribute( System.String key) {
                                 Efl.Access.IObjectNativeInherit.efl_access_object_attribute_del_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), key);
        Eina.Error.RaiseIfUnhandledException();
                         }
    /// <summary>Removes all attributes in accessible object.</summary>
    /// <returns></returns>
    virtual public void ClearAttributes() {
         Efl.Access.IObjectNativeInherit.efl_access_object_attributes_clear_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
        Eina.Error.RaiseIfUnhandledException();
         }
    ...
    virtual public bool AppendRelationship( Efl.Access.RelationType type,  Efl.Access.IObject relation_object) {
                                                         var _ret_var = Efl.Access.IObjectNativeInherit.efl_access_object_relationship_append_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), type,  relation_object);
        Eina.Error.RaiseIfUnhandledException();
                                        return _ret_var;
 }
    ...
    virtual public void RelationshipRemove( Efl.Access.RelationType type,  Efl.Access.IObject relation_object) {
                                                         Efl.Access.IObjectNativeInherit.efl_access_object_relationship_remove_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), type,  relation_object);
        Eina.Error.RaiseIfUnhandledException();
                                         }
    /// <summary>Removes all relationships in accessible object.</summary>
    /// <returns></returns>
    virtual public void ClearRelationships() {
         Efl.Access.IObjectNativeInherit.efl_access_object_relationships_clear_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
        Eina.Error.RaiseIfUnhandledException();
         }
    ...
    virtual public void StateNotify( Efl.Access.StateSet state_types_mask,  bool recursive) {
                                                         Efl.Access.IObjectNativeInherit.efl_access_object_state_notify_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), state_types_mask,  recursive);
        Eina.Error.RaiseIfUnhandledException();
                                         }
    ...
    virtual public Efl.Access.ActionData GetElmActions() {
         var _ret_var = Efl.Access.Widget.IActionNativeInherit.efl_access_widget_action_elm_actions_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    ...
    virtual public void DragStart( Efl.Ui.SelectionFormat format,  Eina.Slice data,  Efl.Ui.SelectionAction action,  Efl.Dnd.DragIconCreate icon_func,  uint seat) {
                ...
                Efl.Ui.IDndNativeInherit.efl_ui_dnd_drag_start_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), format,  data,  action, GCHandle.ToIntPtr(icon_func_handle), Efl.Dnd.DragIconCreateWrapper.Cb, Efl.Eo.Globals.free_gchandle,  seat);
        Eina.Error.RaiseIfUnhandledException();
                                                                                         }
    ...
    virtual public void SetDragAction( Efl.Ui.SelectionAction action,  uint seat) {
                                                         Efl.Ui.IDndNativeInherit.efl_ui_dnd_drag_action_set_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), action,  seat);
        Eina.Error.RaiseIfUnhandledException();
                                         }
    ...
    virtual public void DragCancel( uint seat) {
                                 Efl.Ui.IDndNativeInherit.efl_ui_dnd_drag_cancel_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), seat);
        Eina.Error.RaiseIfUnhandledException();
                         }
    ...
    virtual public void AddDropTarget( Efl.Ui.SelectionFormat format,  uint seat) {
                                                         Efl.Ui.IDndNativeInherit.efl_ui_dnd_drop_target_add_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), format,  seat);
        Eina.Error.RaiseIfUnhandledException();
                                         }
    ...
    virtual public void DelDropTarget( Efl.Ui.SelectionFormat format,  uint seat) {
                                                         Efl.Ui.IDndNativeInherit.efl_ui_dnd_drop_target_del_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), format,  seat);
        Eina.Error.RaiseIfUnhandledException();
                                         }
    ...
    virtual public  Eina.Future SetSelection( Efl.Ui.SelectionType type,  Efl.Ui.SelectionFormat format,  Eina.Slice data,  uint seat) {
                                                                                                         var _ret_var = Efl.Ui.ISelectionNativeInherit.efl_ui_selection_set_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), type,  format,  data,  seat);
        Eina.Error.RaiseIfUnhandledException();
                                                                        return _ret_var;
 }
    ...
    virtual public void GetSelection( Efl.Ui.SelectionType type,  Efl.Ui.SelectionFormat format,  Efl.Ui.SelectionDataReady data_func,  uint seat) {
                ...
                Efl.Ui.ISelectionNativeInherit.efl_ui_selection_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), type,  format, GCHandle.ToIntPtr(data_func_handle), Efl.Ui.SelectionDataReadyWrapper.Cb, Efl.Eo.Globals.free_gchandle,  seat);
        Eina.Error.RaiseIfUnhandledException();
                                                                         }
    ...
    virtual public void ClearSelection( Efl.Ui.SelectionType type,  uint seat) {
                                                         Efl.Ui.ISelectionNativeInherit.efl_ui_selection_clear_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), type,  seat);
        Eina.Error.RaiseIfUnhandledException();
                                         }
    ...
    virtual public bool HasOwner( Efl.Ui.SelectionType type,  uint seat) {
                                                         var _ret_var = Efl.Ui.ISelectionNativeInherit.efl_ui_selection_has_owner_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), type,  seat);
        Eina.Error.RaiseIfUnhandledException();
                                        return _ret_var;
 }
    ...
    virtual public Efl.IModel GetModel() {
         var _ret_var = Efl.Ui.IViewNativeInherit.efl_ui_view_model_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    /// <summary>Model that is/will be</summary>
    ...
    virtual public void SetModel( Efl.IModel model) {
                                 Efl.Ui.IViewNativeInherit.efl_ui_view_model_set_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), model);
        Eina.Error.RaiseIfUnhandledException();
                         }
...
public class WidgetNativeInherit : Efl.Canvas.GroupNativeInherit{
    ...
    public override System.Collections.Generic.List<Efl_Op_Description> GetEoOps(System.Type type)
    {
        ...
        if (methods.FirstOrDefault(m => m.Name == "WidgetInputEventHandler") != null)
            descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.FunctionInterop.LoadFunctionPointer(_Module.Module, "efl_ui_widget_input_event_handler"), func = Marshal.GetFunctionPointerForDelegate(efl_ui_widget_input_event_handler_static_delegate)});
    ...
    private static efl_ui_widget_focus_move_policy_automatic_set_delegate efl_ui_widget_focus_move_policy_automatic_set_static_delegate;
     ...
     [return: MarshalAs(UnmanagedType.U1)] public delegate bool efl_ui_widget_input_event_handler_api_delegate(System.IntPtr obj,   ref Efl.Event.NativeStruct eo_event, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(Efl.Eo.MarshalTest<Efl.Canvas.Object, Efl.Eo.NonOwnTag>))]  Efl.Canvas.Object source);
     public static Efl.Eo.FunctionWrapper<efl_ui_widget_input_event_handler_api_delegate> efl_ui_widget_input_event_handler_ptr = new Efl.Eo.FunctionWrapper<efl_ui_widget_input_event_handler_api_delegate>(_Module, "efl_ui_widget_input_event_handler");
    ...
    private static efl_ui_widget_focus_next_object_get_delegate efl_ui_widget_focus_next_object_get_static_delegate;
     ...
     private delegate void efl_ui_widget_focus_next_item_set_delegate(System.IntPtr obj, System.IntPtr pd, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(Efl.Eo.MarshalTest<Efl.Ui.Widget, Efl.Eo.NonOwnTag>))]  Efl.Ui.Widget next_item,   Efl.Ui.Focus.Direction dir);


     public delegate void efl_ui_widget_focus_next_item_set_api_delegate(System.IntPtr obj, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(Efl.Eo.MarshalTest<Efl.Ui.Widget, Efl.Eo.NonOwnTag>))]  Efl.Ui.Widget next_item,   Efl.Ui.Focus.Direction dir);
    ...
    [return:MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(Efl.Eo.MarshalTest<Efl.Ui.Widget, Efl.Eo.NonOwnTag>))] private delegate Efl.Ui.Widget efl_ui_widget_focus_next_item_get_delegate(System.IntPtr obj, System.IntPtr pd,   Efl.Ui.Focus.Direction dir);


    [return:MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(Efl.Eo.MarshalTest<Efl.Ui.Widget, Efl.Eo.NonOwnTag>))] public delegate Efl.Ui.Widget efl_ui_widget_focus_next_item_get_api_delegate(System.IntPtr obj,   Efl.Ui.Focus.Direction dir);
    ...
    private static efl_ui_widget_focus_custom_chain_unset_delegate efl_ui_widget_focus_custom_chain_unset_static_delegate;
     ...
     private delegate void efl_ui_widget_focus_steal_delegate(System.IntPtr obj, System.IntPtr pd, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(Efl.Eo.MarshalTest<Efl.Ui.Widget, Efl.Eo.NonOwnTag>))]  Efl.Ui.Widget item);


     public delegate void efl_ui_widget_focus_steal_api_delegate(System.IntPtr obj, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(Efl.Eo.MarshalTest<Efl.Ui.Widget, Efl.Eo.NonOwnTag>))]  Efl.Ui.Widget item);
