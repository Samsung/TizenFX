...
#pragma warning disable CS1591
    /// <since_tizen> 6 </since_tizen>
    public static class WidgetPartBgExtensions {
        /// <since_tizen> 6 </since_tizen>
        public static CoreUI.BindableProperty<CoreUI.DataTypes.File> Mmap<T>(this CoreUI.UI.IGenericFactoryExtended<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.WidgetPartBg, T>magic = null) where T : CoreUI.UI.WidgetPartBg {
            return new CoreUI.BindableProperty<CoreUI.DataTypes.File>("mmap", fac.GetPropBind());
        }

        /// <since_tizen> 6 </since_tizen>
        public static CoreUI.BindableProperty<System.String> File<T>(this CoreUI.UI.IGenericFactoryExtended<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.WidgetPartBg, T>magic = null) where T : CoreUI.UI.WidgetPartBg {
            return new CoreUI.BindableProperty<System.String>("file", fac.GetPropBind());
        }

        /// <since_tizen> 6 </since_tizen>
        public static CoreUI.BindableProperty<System.String> Key<T>(this CoreUI.UI.IGenericFactoryExtended<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.WidgetPartBg, T>magic = null) where T : CoreUI.UI.WidgetPartBg {
            return new CoreUI.BindableProperty<System.String>("key", fac.GetPropBind());
        }

        /// <since_tizen> 6 </since_tizen>
        public static CoreUI.BindableProperty<System.String> ColorCode<T>(this CoreUI.UI.IGenericFactoryExtended<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.WidgetPartBg, T>magic = null) where T : CoreUI.UI.WidgetPartBg {
            return new CoreUI.BindableProperty<System.String>("color_code", fac.GetPropBind());
        }

        /// <since_tizen> 6 </since_tizen>
        public static CoreUI.BindableProperty<bool> SmoothScale<T>(this CoreUI.UI.IGenericFactoryExtended<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.WidgetPartBg, T>magic = null) where T : CoreUI.UI.WidgetPartBg {
            return new CoreUI.BindableProperty<bool>("smooth_scale", fac.GetPropBind());
        }

        /// <since_tizen> 6 </since_tizen>
        public static CoreUI.BindableProperty<CoreUI.Gfx.ImageScaleMethod> ScaleMethod<T>(this CoreUI.UI.IGenericFactoryExtended<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.WidgetPartBg, T>magic = null) where T : CoreUI.UI.WidgetPartBg {
            return new CoreUI.BindableProperty<CoreUI.Gfx.ImageScaleMethod>("scale_method", fac.GetPropBind());
        }

        /// <since_tizen> 6 </since_tizen>
        public static CoreUI.BindableProperty<bool> CanUpscale<T>(this CoreUI.UI.IGenericFactoryExtended<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.WidgetPartBg, T>magic = null) where T : CoreUI.UI.WidgetPartBg {
            return new CoreUI.BindableProperty<bool>("can_upscale", fac.GetPropBind());
        }

        /// <since_tizen> 6 </since_tizen>
        public static CoreUI.BindableProperty<bool> CanDownscale<T>(this CoreUI.UI.IGenericFactoryExtended<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.WidgetPartBg, T>magic = null) where T : CoreUI.UI.WidgetPartBg {
            return new CoreUI.BindableProperty<bool>("can_downscale", fac.GetPropBind());
        }

        /// <since_tizen> 6 </since_tizen>
        public static CoreUI.BindableProperty<double> BorderInsetsScale<T>(this CoreUI.UI.IGenericFactoryExtended<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.WidgetPartBg, T>magic = null) where T : CoreUI.UI.WidgetPartBg {
            return new CoreUI.BindableProperty<double>("border_insets_scale", fac.GetPropBind());
        }

        /// <since_tizen> 6 </since_tizen>
        public static CoreUI.BindableProperty<CoreUI.Gfx.CenterFillMode> CenterFillMode<T>(this CoreUI.UI.IGenericFactoryExtended<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.WidgetPartBg, T>magic = null) where T : CoreUI.UI.WidgetPartBg {
            return new CoreUI.BindableProperty<CoreUI.Gfx.CenterFillMode>("center_fill_mode", fac.GetPropBind());
        }

        /// <since_tizen> 6 </since_tizen>
        public static CoreUI.BindableProperty<CoreUI.Gfx.ImageContentHint> ContentHint<T>(this CoreUI.UI.IGenericFactoryExtended<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.WidgetPartBg, T>magic = null) where T : CoreUI.UI.WidgetPartBg {
            return new CoreUI.BindableProperty<CoreUI.Gfx.ImageContentHint>("content_hint", fac.GetPropBind());
        }

        /// <since_tizen> 6 </since_tizen>
        public static CoreUI.BindableProperty<CoreUI.Gfx.ImageScaleHint> ScaleHint<T>(this CoreUI.UI.IGenericFactoryExtended<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.WidgetPartBg, T>magic = null) where T : CoreUI.UI.WidgetPartBg {
