...
/// This factory is designed to build <see cref="Efl.Ui.Widget"/> and optionally set their <see cref="Efl.Ui.Widget.Style"/> if it was connected with <see cref="Efl.Ui.IPropertyBind.BindProperty"/> &quot;<c>style</c>&quot;.</summary>
...
/// <param name="itemClass">Define the class of the item returned by this factory. See <see cref="Efl.Ui.WidgetFactory.SetItemClass" /></param>
    ...
    protected virtual  Eina.Future Create(Eina.Iterator<Efl.IModel> models) {
        var _in_models = models.Handle;
models.Own = false;
var _ret_var = Efl.Ui.FactoryConcrete.NativeMethods.efl_ui_factory_create_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass)),_in_models);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void Release(Eina.Iterator<Efl.Gfx.IEntity> ui_views) {
        var _in_ui_views = ui_views.Handle;
ui_views.Own = false;
Efl.Ui.FactoryConcrete.NativeMethods.efl_ui_factory_release_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass)),_in_ui_views);
        Eina.Error.RaiseIfUnhandledException();
    ...
    public new class NativeMethods : Efl.LoopConsumer.NativeMethods
    {
        ...
        private static  Eina.Future create(System.IntPtr obj, System.IntPtr pd, System.IntPtr models)
        {
            Eina.Log.Debug("function efl_ui_factory_create was called");
            var ws = Efl.Eo.Globals.GetWrapperSupervisor(obj);
            if (ws != null)
            {
                var _in_models = new Eina.Iterator<Efl.IModel>(models, true);
 Eina.Future _ret_var = default( Eina.Future);
            ...
            {
                return efl_ui_factory_create_ptr.Value.Delegate(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)), models);
            }
        }
