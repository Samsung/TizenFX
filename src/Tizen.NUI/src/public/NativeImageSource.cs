...
namespace Tizen.NUI
{
    ...
    public class NativeImageSource : NativeImageInterface
    {
        ...
        [EditorBrowsable(EditorBrowsableState.Never)]
        public bool Acquire(byte[] buffer, ref int width, ref int height, ref int stride) {
            bool ret = Interop.NativeImageSource.Acquire(this.swigCPtr.Handle, buffer, ref width, ref height, ref stride);
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
            return ret;
        }
        ...
        [EditorBrowsable(EditorBrowsableState.Never)]
        public bool Release() {
            bool ret = Interop.NativeImageSource.Release(this.swigCPtr.Handle);
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
            return ret;
        }
    }
