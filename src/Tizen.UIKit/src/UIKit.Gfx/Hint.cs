...
{
    /// <summary>Use with <see cref="UIKit.Gfx.IHint.GetHintWeight"/>.</summary>
...
public partial class Constants
{
    /// <summary>Use with <see cref="UIKit.Gfx.IHint.GetHintAlign"/>.</summary>
...
/// <summary>UIKit graphics hint interface</summary>
/// <since_tizen> 6 </since_tizen>
[UIKit.Gfx.HintConcrete.NativeMethods]
    ...
    UIKit.Wrapper.IWrapper, IDisposable
{
    ...
    void GetHintAspect(out UIKit.Gfx.HintAspect mode, out UIKit.DataTypes.Size2D sz);
    ...
    /// <param name="mode">Mode of interpretation.</param>
    /// <param name="sz">Base size to use for aspecting.</param>
    void SetHintAspect(UIKit.Gfx.HintAspect mode, UIKit.DataTypes.Size2D sz);
    ...
    UIKit.DataTypes.Size2D GetHintSizeMax();
    ...
    void SetHintSizeMax(UIKit.DataTypes.Size2D sz);
    ...
    UIKit.DataTypes.Size2D GetHintSizeRestrictedMax();
    ...
    /// <since_tizen> 6 </since_tizen>
    /// <returns>Maximum size (hint) in pixels.</returns>
    UIKit.DataTypes.Size2D GetHintSizeCombinedMax();
    ...
    UIKit.DataTypes.Size2D GetHintSizeMin();
    ...
    void SetHintSizeMin(UIKit.DataTypes.Size2D sz);

    /// <summary>Get the &quot;intrinsic&quot; minimum size of this object.</summary>
    /// <since_tizen> 6 </since_tizen>
    /// <returns>Minimum size (hint) in pixels.</returns>
    UIKit.DataTypes.Size2D GetHintSizeRestrictedMin();
    ...
    /// <since_tizen> 6 </since_tizen>
    /// <returns>Minimum size (hint) in pixels.</returns>
    UIKit.DataTypes.Size2D GetHintSizeCombinedMin();
    ...
    (UIKit.Gfx.HintAspect, UIKit.DataTypes.Size2D) HintAspect {
        get;
        set;
    }
    ...
    UIKit.DataTypes.Size2D HintSizeMax {
        get;
        set;
    }
    ...
    UIKit.DataTypes.Size2D HintSizeRestrictedMax {
        get;
    }
    ...
    /// <since_tizen> 6 </since_tizen>
    /// <value>Maximum size (hint) in pixels.</value>
    UIKit.DataTypes.Size2D HintSizeCombinedMax {
        get;
    }
    ...
    UIKit.DataTypes.Size2D HintSizeMin {
        get;
        set;
    }
    ...
    /// <since_tizen> 6 </since_tizen>
    /// <value>Minimum size (hint) in pixels.</value>
    UIKit.DataTypes.Size2D HintSizeRestrictedMin {
        get;
    }
    ...
    /// <since_tizen> 6 </since_tizen>
    /// <value>Minimum size (hint) in pixels.</value>
    UIKit.DataTypes.Size2D HintSizeCombinedMin {
        get;
    }
    ...
    
{
    ...
    private HintConcrete(UIKit.Wrapper.Globals.WrappingHandle wh) : base(wh)
    {
    }
...
#pragma warning disable CS0628
    ...
    /// <param name="mode">Mode of interpretation.</param>
    /// <param name="sz">Base size to use for aspecting.</param>
    public void GetHintAspect(out UIKit.Gfx.HintAspect mode, out UIKit.DataTypes.Size2D sz) {
        var _out_sz = new UIKit.DataTypes.Size2D.NativeStruct();
UIKit.Gfx.HintConcrete.NativeMethods.efl_gfx_hint_aspect_get_ptr.Value.Delegate(this.NativeHandle,out mode, out _out_sz);
...
sz = _out_sz;
    ...
    /// <param name="mode">Mode of interpretation.</param>
    /// <param name="sz">Base size to use for aspecting.</param>
    public void SetHintAspect(UIKit.Gfx.HintAspect mode, UIKit.DataTypes.Size2D sz) {
        UIKit.DataTypes.Size2D.NativeStruct _in_sz = sz;
UIKit.Gfx.HintConcrete.NativeMethods.efl_gfx_hint_aspect_set_ptr.Value.Delegate(this.NativeHandle,mode, _in_sz);
        UIKit.DataTypes.Error.RaiseIfUnhandledException();
    ...
    /// <since_tizen> 6 </since_tizen>
    /// <returns>Maximum size (hint) in pixels, (-1, -1) by default for canvas objects).</returns>
    public UIKit.DataTypes.Size2D GetHintSizeMax() {
        var _ret_var = UIKit.Gfx.HintConcrete.NativeMethods.efl_gfx_hint_size_max_get_ptr.Value.Delegate(this.NativeHandle);
        UIKit.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    /// <since_tizen> 6 </since_tizen>
    /// <param name="sz">Maximum size (hint) in pixels, (-1, -1) by default for canvas objects).</param>
    public void SetHintSizeMax(UIKit.DataTypes.Size2D sz) {
        UIKit.DataTypes.Size2D.NativeStruct _in_sz = sz;
UIKit.Gfx.HintConcrete.NativeMethods.efl_gfx_hint_size_max_set_ptr.Value.Delegate(this.NativeHandle,_in_sz);
        UIKit.DataTypes.Error.RaiseIfUnhandledException();
    ...
    /// <since_tizen> 6 </since_tizen>
    /// <returns>Maximum size (hint) in pixels.</returns>
    public UIKit.DataTypes.Size2D GetHintSizeRestrictedMax() {
        var _ret_var = UIKit.Gfx.HintConcrete.NativeMethods.efl_gfx_hint_size_restricted_max_get_ptr.Value.Delegate(this.NativeHandle);
        UIKit.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    protected void SetHintSizeRestrictedMax(UIKit.DataTypes.Size2D sz) {
        UIKit.DataTypes.Size2D.NativeStruct _in_sz = sz;
UIKit.Gfx.HintConcrete.NativeMethods.efl_gfx_hint_size_restricted_max_set_ptr.Value.Delegate(this.NativeHandle,_in_sz);
        UIKit.DataTypes.Error.RaiseIfUnhandledException();
    ...
    /// <since_tizen> 6 </since_tizen>
    /// <returns>Maximum size (hint) in pixels.</returns>
    public UIKit.DataTypes.Size2D GetHintSizeCombinedMax() {
        var _ret_var = UIKit.Gfx.HintConcrete.NativeMethods.efl_gfx_hint_size_combined_max_get_ptr.Value.Delegate(this.NativeHandle);
        UIKit.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    /// <since_tizen> 6 </since_tizen>
    /// <returns>Minimum size (hint) in pixels.</returns>
    public UIKit.DataTypes.Size2D GetHintSizeMin() {
        var _ret_var = UIKit.Gfx.HintConcrete.NativeMethods.efl_gfx_hint_size_min_get_ptr.Value.Delegate(this.NativeHandle);
        UIKit.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    /// <since_tizen> 6 </since_tizen>
    /// <param name="sz">Minimum size (hint) in pixels.</param>
    public void SetHintSizeMin(UIKit.DataTypes.Size2D sz) {
        UIKit.DataTypes.Size2D.NativeStruct _in_sz = sz;
UIKit.Gfx.HintConcrete.NativeMethods.efl_gfx_hint_size_min_set_ptr.Value.Delegate(this.NativeHandle,_in_sz);
        UIKit.DataTypes.Error.RaiseIfUnhandledException();
    ...
    /// <since_tizen> 6 </since_tizen>
    /// <returns>Minimum size (hint) in pixels.</returns>
    public UIKit.DataTypes.Size2D GetHintSizeRestrictedMin() {
        var _ret_var = UIKit.Gfx.HintConcrete.NativeMethods.efl_gfx_hint_size_restricted_min_get_ptr.Value.Delegate(this.NativeHandle);
        UIKit.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    /// <since_tizen> 6 </since_tizen>
    /// <param name="sz">Minimum size (hint) in pixels.</param>
    protected void SetHintSizeRestrictedMin(UIKit.DataTypes.Size2D sz) {
        UIKit.DataTypes.Size2D.NativeStruct _in_sz = sz;
UIKit.Gfx.HintConcrete.NativeMethods.efl_gfx_hint_size_restricted_min_set_ptr.Value.Delegate(this.NativeHandle,_in_sz);
        UIKit.DataTypes.Error.RaiseIfUnhandledException();
    ...
    /// <since_tizen> 6 </since_tizen>
    /// <returns>Minimum size (hint) in pixels.</returns>
    public UIKit.DataTypes.Size2D GetHintSizeCombinedMin() {
        var _ret_var = UIKit.Gfx.HintConcrete.NativeMethods.efl_gfx_hint_size_combined_min_get_ptr.Value.Delegate(this.NativeHandle);
        UIKit.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public void GetHintMargin(out int l, out int r, out int t, out int b) {
        UIKit.Gfx.HintConcrete.NativeMethods.efl_gfx_hint_margin_get_ptr.Value.Delegate(this.NativeHandle,out l, out r, out t, out b);
        UIKit.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public void SetHintMargin(int l, int r, int t, int b) {
        UIKit.Gfx.HintConcrete.NativeMethods.efl_gfx_hint_margin_set_ptr.Value.Delegate(this.NativeHandle,l, r, t, b);
        UIKit.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public void GetHintWeight(out double x, out double y) {
        UIKit.Gfx.HintConcrete.NativeMethods.efl_gfx_hint_weight_get_ptr.Value.Delegate(this.NativeHandle,out x, out y);
        UIKit.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public void SetHintWeight(double x, double y) {
        UIKit.Gfx.HintConcrete.NativeMethods.efl_gfx_hint_weight_set_ptr.Value.Delegate(this.NativeHandle,x, y);
        UIKit.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public void GetHintAlign(out double x, out double y) {
        UIKit.Gfx.HintConcrete.NativeMethods.efl_gfx_hint_align_get_ptr.Value.Delegate(this.NativeHandle,out x, out y);
        UIKit.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public void SetHintAlign(double x, double y) {
        UIKit.Gfx.HintConcrete.NativeMethods.efl_gfx_hint_align_set_ptr.Value.Delegate(this.NativeHandle,x, y);
        UIKit.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public void GetHintFill(out bool x, out bool y) {
        UIKit.Gfx.HintConcrete.NativeMethods.efl_gfx_hint_fill_get_ptr.Value.Delegate(this.NativeHandle,out x, out y);
        UIKit.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public void SetHintFill(bool x, bool y) {
        UIKit.Gfx.HintConcrete.NativeMethods.efl_gfx_hint_fill_set_ptr.Value.Delegate(this.NativeHandle,x, y);
        UIKit.DataTypes.Error.RaiseIfUnhandledException();
...
#pragma warning restore CS0628
    ...
    {
        return UIKit.Gfx.HintConcrete.efl_gfx_hint_interface_get();
    }
    ...
    public new class NativeMethods : UIKit.Wrapper.ObjectWrapper.NativeMethods
    {
        ...
        public override System.Collections.Generic.List<UIKit_Op_Description> GetEoOps(System.Type type, bool includeInherited)
        {
            ...
            {
                descs.Add(new UIKit_Op_Description() {api_func = UIKit.Wrapper.FunctionInterop.LoadFunctionPointer(Module.Module, "efl_gfx_hint_aspect_get"), func = Marshal.GetFunctionPointerForDelegate(efl_gfx_hint_aspect_get_static_delegate) });
            }
            ...
            {
                descs.Add(new UIKit_Op_Description() {api_func = UIKit.Wrapper.FunctionInterop.LoadFunctionPointer(Module.Module, "efl_gfx_hint_aspect_set"), func = Marshal.GetFunctionPointerForDelegate(efl_gfx_hint_aspect_set_static_delegate) });
            }
            ...
            {
                descs.Add(new UIKit_Op_Description() {api_func = UIKit.Wrapper.FunctionInterop.LoadFunctionPointer(Module.Module, "efl_gfx_hint_size_max_get"), func = Marshal.GetFunctionPointerForDelegate(efl_gfx_hint_size_max_get_static_delegate) });
            }
            ...
            {
                descs.Add(new UIKit_Op_Description() {api_func = UIKit.Wrapper.FunctionInterop.LoadFunctionPointer(Module.Module, "efl_gfx_hint_size_max_set"), func = Marshal.GetFunctionPointerForDelegate(efl_gfx_hint_size_max_set_static_delegate) });
            }
            ...
            {
                descs.Add(new UIKit_Op_Description() {api_func = UIKit.Wrapper.FunctionInterop.LoadFunctionPointer(Module.Module, "efl_gfx_hint_size_restricted_max_get"), func = Marshal.GetFunctionPointerForDelegate(efl_gfx_hint_size_restricted_max_get_static_delegate) });
            }
            ...
            {
                descs.Add(new UIKit_Op_Description() {api_func = UIKit.Wrapper.FunctionInterop.LoadFunctionPointer(Module.Module, "efl_gfx_hint_size_combined_max_get"), func = Marshal.GetFunctionPointerForDelegate(efl_gfx_hint_size_combined_max_get_static_delegate) });
            }
            ...
            {
                descs.Add(new UIKit_Op_Description() {api_func = UIKit.Wrapper.FunctionInterop.LoadFunctionPointer(Module.Module, "efl_gfx_hint_size_min_get"), func = Marshal.GetFunctionPointerForDelegate(efl_gfx_hint_size_min_get_static_delegate) });
            }
            ...
            {
                descs.Add(new UIKit_Op_Description() {api_func = UIKit.Wrapper.FunctionInterop.LoadFunctionPointer(Module.Module, "efl_gfx_hint_size_min_set"), func = Marshal.GetFunctionPointerForDelegate(efl_gfx_hint_size_min_set_static_delegate) });
            }
            ...
            {
                descs.Add(new UIKit_Op_Description() {api_func = UIKit.Wrapper.FunctionInterop.LoadFunctionPointer(Module.Module, "efl_gfx_hint_size_restricted_min_get"), func = Marshal.GetFunctionPointerForDelegate(efl_gfx_hint_size_restricted_min_get_static_delegate) });
            }
            ...
            {
                descs.Add(new UIKit_Op_Description() {api_func = UIKit.Wrapper.FunctionInterop.LoadFunctionPointer(Module.Module, "efl_gfx_hint_size_combined_min_get"), func = Marshal.GetFunctionPointerForDelegate(efl_gfx_hint_size_combined_min_get_static_delegate) });
            }
            ...
            {
                descs.Add(new UIKit_Op_Description() {api_func = UIKit.Wrapper.FunctionInterop.LoadFunctionPointer(Module.Module, "efl_gfx_hint_margin_get"), func = Marshal.GetFunctionPointerForDelegate(efl_gfx_hint_margin_get_static_delegate) });
            }
            ...
            {
                descs.Add(new UIKit_Op_Description() {api_func = UIKit.Wrapper.FunctionInterop.LoadFunctionPointer(Module.Module, "efl_gfx_hint_margin_set"), func = Marshal.GetFunctionPointerForDelegate(efl_gfx_hint_margin_set_static_delegate) });
            }
            ...
            {
                descs.Add(new UIKit_Op_Description() {api_func = UIKit.Wrapper.FunctionInterop.LoadFunctionPointer(Module.Module, "efl_gfx_hint_weight_get"), func = Marshal.GetFunctionPointerForDelegate(efl_gfx_hint_weight_get_static_delegate) });
            }
            ...
            {
                descs.Add(new UIKit_Op_Description() {api_func = UIKit.Wrapper.FunctionInterop.LoadFunctionPointer(Module.Module, "efl_gfx_hint_weight_set"), func = Marshal.GetFunctionPointerForDelegate(efl_gfx_hint_weight_set_static_delegate) });
            }
            ...
            {
                descs.Add(new UIKit_Op_Description() {api_func = UIKit.Wrapper.FunctionInterop.LoadFunctionPointer(Module.Module, "efl_gfx_hint_align_get"), func = Marshal.GetFunctionPointerForDelegate(efl_gfx_hint_align_get_static_delegate) });
            }
            ...
            {
                descs.Add(new UIKit_Op_Description() {api_func = UIKit.Wrapper.FunctionInterop.LoadFunctionPointer(Module.Module, "efl_gfx_hint_align_set"), func = Marshal.GetFunctionPointerForDelegate(efl_gfx_hint_align_set_static_delegate) });
            }
            ...
            {
                descs.Add(new UIKit_Op_Description() {api_func = UIKit.Wrapper.FunctionInterop.LoadFunctionPointer(Module.Module, "efl_gfx_hint_fill_get"), func = Marshal.GetFunctionPointerForDelegate(efl_gfx_hint_fill_get_static_delegate) });
            }
            ...
            {
                descs.Add(new UIKit_Op_Description() {api_func = UIKit.Wrapper.FunctionInterop.LoadFunctionPointer(Module.Module, "efl_gfx_hint_fill_set"), func = Marshal.GetFunctionPointerForDelegate(efl_gfx_hint_fill_set_static_delegate) });
            }
        ...
        private delegate void efl_gfx_hint_aspect_get_delegate(System.IntPtr obj, System.IntPtr pd,  out UIKit.Gfx.HintAspect mode,  out UIKit.DataTypes.Size2D.NativeStruct sz);

        
        public delegate void efl_gfx_hint_aspect_get_api_delegate(System.IntPtr obj,  out UIKit.Gfx.HintAspect mode,  out UIKit.DataTypes.Size2D.NativeStruct sz);

        public static UIKit.Wrapper.FunctionWrapper<efl_gfx_hint_aspect_get_api_delegate> efl_gfx_hint_aspect_get_ptr = new UIKit.Wrapper.FunctionWrapper<efl_gfx_hint_aspect_get_api_delegate>(Module, "efl_gfx_hint_aspect_get");

        private static void hint_aspect_get(System.IntPtr obj, System.IntPtr pd, out UIKit.Gfx.HintAspect mode, out UIKit.DataTypes.Size2D.NativeStruct sz)
        {
            UIKit.DataTypes.Log.Debug("function efl_gfx_hint_aspect_get was called");
            var ws = UIKit.Wrapper.Globals.GetWrapperSupervisor(obj);
            if (ws != null)
            {
                mode = default(UIKit.Gfx.HintAspect);UIKit.DataTypes.Size2D _out_sz = default(UIKit.DataTypes.Size2D);
        ...
        sz = _out_sz;
            ...
            {
                efl_gfx_hint_aspect_get_ptr.Value.Delegate(UIKit.Wrapper.Globals.efl_super(obj, UIKit.Wrapper.Globals.efl_class_get(obj)), out mode, out sz);
            }
        }
        ...
        private delegate void efl_gfx_hint_aspect_set_delegate(System.IntPtr obj, System.IntPtr pd,  UIKit.Gfx.HintAspect mode,  UIKit.DataTypes.Size2D.NativeStruct sz);

        
        public delegate void efl_gfx_hint_aspect_set_api_delegate(System.IntPtr obj,  UIKit.Gfx.HintAspect mode,  UIKit.DataTypes.Size2D.NativeStruct sz);

        public static UIKit.Wrapper.FunctionWrapper<efl_gfx_hint_aspect_set_api_delegate> efl_gfx_hint_aspect_set_ptr = new UIKit.Wrapper.FunctionWrapper<efl_gfx_hint_aspect_set_api_delegate>(Module, "efl_gfx_hint_aspect_set");

        private static void hint_aspect_set(System.IntPtr obj, System.IntPtr pd, UIKit.Gfx.HintAspect mode, UIKit.DataTypes.Size2D.NativeStruct sz)
        {
            UIKit.DataTypes.Log.Debug("function efl_gfx_hint_aspect_set was called");
            var ws = UIKit.Wrapper.Globals.GetWrapperSupervisor(obj);
            if (ws != null)
            {
            ...
            {
                efl_gfx_hint_aspect_set_ptr.Value.Delegate(UIKit.Wrapper.Globals.efl_super(obj, UIKit.Wrapper.Globals.efl_class_get(obj)), mode, sz);
            }
        }
        ...
        private delegate UIKit.DataTypes.Size2D.NativeStruct efl_gfx_hint_size_max_get_delegate(System.IntPtr obj, System.IntPtr pd);

        
        public delegate UIKit.DataTypes.Size2D.NativeStruct efl_gfx_hint_size_max_get_api_delegate(System.IntPtr obj);

        public static UIKit.Wrapper.FunctionWrapper<efl_gfx_hint_size_max_get_api_delegate> efl_gfx_hint_size_max_get_ptr = new UIKit.Wrapper.FunctionWrapper<efl_gfx_hint_size_max_get_api_delegate>(Module, "efl_gfx_hint_size_max_get");

        private static UIKit.DataTypes.Size2D.NativeStruct hint_size_max_get(System.IntPtr obj, System.IntPtr pd)
        {
            UIKit.DataTypes.Log.Debug("function efl_gfx_hint_size_max_get was called");
            var ws = UIKit.Wrapper.Globals.GetWrapperSupervisor(obj);
            if (ws != null)
            {
            ...
            {
                return efl_gfx_hint_size_max_get_ptr.Value.Delegate(UIKit.Wrapper.Globals.efl_super(obj, UIKit.Wrapper.Globals.efl_class_get(obj)));
            }
        }
        ...
        private delegate void efl_gfx_hint_size_max_set_delegate(System.IntPtr obj, System.IntPtr pd,  UIKit.DataTypes.Size2D.NativeStruct sz);

        
        public delegate void efl_gfx_hint_size_max_set_api_delegate(System.IntPtr obj,  UIKit.DataTypes.Size2D.NativeStruct sz);

        public static UIKit.Wrapper.FunctionWrapper<efl_gfx_hint_size_max_set_api_delegate> efl_gfx_hint_size_max_set_ptr = new UIKit.Wrapper.FunctionWrapper<efl_gfx_hint_size_max_set_api_delegate>(Module, "efl_gfx_hint_size_max_set");

        private static void hint_size_max_set(System.IntPtr obj, System.IntPtr pd, UIKit.DataTypes.Size2D.NativeStruct sz)
        {
            UIKit.DataTypes.Log.Debug("function efl_gfx_hint_size_max_set was called");
            var ws = UIKit.Wrapper.Globals.GetWrapperSupervisor(obj);
            if (ws != null)
            {
                UIKit.DataTypes.Size2D _in_sz = sz;
            ...
            {
                efl_gfx_hint_size_max_set_ptr.Value.Delegate(UIKit.Wrapper.Globals.efl_super(obj, UIKit.Wrapper.Globals.efl_class_get(obj)), sz);
            }
        }
        ...
        private delegate UIKit.DataTypes.Size2D.NativeStruct efl_gfx_hint_size_restricted_max_get_delegate(System.IntPtr obj, System.IntPtr pd);

        
        public delegate UIKit.DataTypes.Size2D.NativeStruct efl_gfx_hint_size_restricted_max_get_api_delegate(System.IntPtr obj);

        public static UIKit.Wrapper.FunctionWrapper<efl_gfx_hint_size_restricted_max_get_api_delegate> efl_gfx_hint_size_restricted_max_get_ptr = new UIKit.Wrapper.FunctionWrapper<efl_gfx_hint_size_restricted_max_get_api_delegate>(Module, "efl_gfx_hint_size_restricted_max_get");

        private static UIKit.DataTypes.Size2D.NativeStruct hint_size_restricted_max_get(System.IntPtr obj, System.IntPtr pd)
        {
            UIKit.DataTypes.Log.Debug("function efl_gfx_hint_size_restricted_max_get was called");
            var ws = UIKit.Wrapper.Globals.GetWrapperSupervisor(obj);
            if (ws != null)
            {
                UIKit.DataTypes.Size2D _ret_var = default(UIKit.DataTypes.Size2D);
            ...
            {
                return efl_gfx_hint_size_restricted_max_get_ptr.Value.Delegate(UIKit.Wrapper.Globals.efl_super(obj, UIKit.Wrapper.Globals.efl_class_get(obj)));
            }
        }
        ...
        private delegate UIKit.DataTypes.Size2D.NativeStruct efl_gfx_hint_size_combined_max_get_delegate(System.IntPtr obj, System.IntPtr pd);

        
        public delegate UIKit.DataTypes.Size2D.NativeStruct efl_gfx_hint_size_combined_max_get_api_delegate(System.IntPtr obj);

        public static UIKit.Wrapper.FunctionWrapper<efl_gfx_hint_size_combined_max_get_api_delegate> efl_gfx_hint_size_combined_max_get_ptr = new UIKit.Wrapper.FunctionWrapper<efl_gfx_hint_size_combined_max_get_api_delegate>(Module, "efl_gfx_hint_size_combined_max_get");

        private static UIKit.DataTypes.Size2D.NativeStruct hint_size_combined_max_get(System.IntPtr obj, System.IntPtr pd)
        {
            UIKit.DataTypes.Log.Debug("function efl_gfx_hint_size_combined_max_get was called");
            var ws = UIKit.Wrapper.Globals.GetWrapperSupervisor(obj);
            if (ws != null)
            {
                UIKit.DataTypes.Size2D _ret_var = default(UIKit.DataTypes.Size2D);
            ...
            {
                return efl_gfx_hint_size_combined_max_get_ptr.Value.Delegate(UIKit.Wrapper.Globals.efl_super(obj, UIKit.Wrapper.Globals.efl_class_get(obj)));
            }
        }
        ...
        private delegate UIKit.DataTypes.Size2D.NativeStruct efl_gfx_hint_size_min_get_delegate(System.IntPtr obj, System.IntPtr pd);

        
        public delegate UIKit.DataTypes.Size2D.NativeStruct efl_gfx_hint_size_min_get_api_delegate(System.IntPtr obj);

        public static UIKit.Wrapper.FunctionWrapper<efl_gfx_hint_size_min_get_api_delegate> efl_gfx_hint_size_min_get_ptr = new UIKit.Wrapper.FunctionWrapper<efl_gfx_hint_size_min_get_api_delegate>(Module, "efl_gfx_hint_size_min_get");

        private static UIKit.DataTypes.Size2D.NativeStruct hint_size_min_get(System.IntPtr obj, System.IntPtr pd)
        {
            UIKit.DataTypes.Log.Debug("function efl_gfx_hint_size_min_get was called");
            var ws = UIKit.Wrapper.Globals.GetWrapperSupervisor(obj);
            if (ws != null)
            {
                UIKit.DataTypes.Size2D _ret_var = default(UIKit.DataTypes.Size2D);
            ...
            {
                return efl_gfx_hint_size_min_get_ptr.Value.Delegate(UIKit.Wrapper.Globals.efl_super(obj, UIKit.Wrapper.Globals.efl_class_get(obj)));
            }
        }
        ...
        private delegate void efl_gfx_hint_size_min_set_delegate(System.IntPtr obj, System.IntPtr pd,  UIKit.DataTypes.Size2D.NativeStruct sz);

        
        public delegate void efl_gfx_hint_size_min_set_api_delegate(System.IntPtr obj,  UIKit.DataTypes.Size2D.NativeStruct sz);

        public static UIKit.Wrapper.FunctionWrapper<efl_gfx_hint_size_min_set_api_delegate> efl_gfx_hint_size_min_set_ptr = new UIKit.Wrapper.FunctionWrapper<efl_gfx_hint_size_min_set_api_delegate>(Module, "efl_gfx_hint_size_min_set");

        private static void hint_size_min_set(System.IntPtr obj, System.IntPtr pd, UIKit.DataTypes.Size2D.NativeStruct sz)
        {
            UIKit.DataTypes.Log.Debug("function efl_gfx_hint_size_min_set was called");
            var ws = UIKit.Wrapper.Globals.GetWrapperSupervisor(obj);
            if (ws != null)
            {
                UIKit.DataTypes.Size2D _in_sz = sz;
            ...
            {
                efl_gfx_hint_size_min_set_ptr.Value.Delegate(UIKit.Wrapper.Globals.efl_super(obj, UIKit.Wrapper.Globals.efl_class_get(obj)), sz);
            }
        }
        ...
        private delegate UIKit.DataTypes.Size2D.NativeStruct efl_gfx_hint_size_restricted_min_get_delegate(System.IntPtr obj, System.IntPtr pd);

        
        public delegate UIKit.DataTypes.Size2D.NativeStruct efl_gfx_hint_size_restricted_min_get_api_delegate(System.IntPtr obj);

        public static UIKit.Wrapper.FunctionWrapper<efl_gfx_hint_size_restricted_min_get_api_delegate> efl_gfx_hint_size_restricted_min_get_ptr = new UIKit.Wrapper.FunctionWrapper<efl_gfx_hint_size_restricted_min_get_api_delegate>(Module, "efl_gfx_hint_size_restricted_min_get");

        private static UIKit.DataTypes.Size2D.NativeStruct hint_size_restricted_min_get(System.IntPtr obj, System.IntPtr pd)
        {
            UIKit.DataTypes.Log.Debug("function efl_gfx_hint_size_restricted_min_get was called");
            var ws = UIKit.Wrapper.Globals.GetWrapperSupervisor(obj);
            if (ws != null)
            {
                UIKit.DataTypes.Size2D _ret_var = default(UIKit.DataTypes.Size2D);
            ...
            {
                return efl_gfx_hint_size_restricted_min_get_ptr.Value.Delegate(UIKit.Wrapper.Globals.efl_super(obj, UIKit.Wrapper.Globals.efl_class_get(obj)));
            }
        }
        ...
        private delegate UIKit.DataTypes.Size2D.NativeStruct efl_gfx_hint_size_combined_min_get_delegate(System.IntPtr obj, System.IntPtr pd);

        
        public delegate UIKit.DataTypes.Size2D.NativeStruct efl_gfx_hint_size_combined_min_get_api_delegate(System.IntPtr obj);

        public static UIKit.Wrapper.FunctionWrapper<efl_gfx_hint_size_combined_min_get_api_delegate> efl_gfx_hint_size_combined_min_get_ptr = new UIKit.Wrapper.FunctionWrapper<efl_gfx_hint_size_combined_min_get_api_delegate>(Module, "efl_gfx_hint_size_combined_min_get");

        private static UIKit.DataTypes.Size2D.NativeStruct hint_size_combined_min_get(System.IntPtr obj, System.IntPtr pd)
        {
            UIKit.DataTypes.Log.Debug("function efl_gfx_hint_size_combined_min_get was called");
            var ws = UIKit.Wrapper.Globals.GetWrapperSupervisor(obj);
            if (ws != null)
            {
                UIKit.DataTypes.Size2D _ret_var = default(UIKit.DataTypes.Size2D);
            ...
            {
                return efl_gfx_hint_size_combined_min_get_ptr.Value.Delegate(UIKit.Wrapper.Globals.efl_super(obj, UIKit.Wrapper.Globals.efl_class_get(obj)));
            }
        }
        ...
        public static UIKit.Wrapper.FunctionWrapper<efl_gfx_hint_margin_get_api_delegate> efl_gfx_hint_margin_get_ptr = new UIKit.Wrapper.FunctionWrapper<efl_gfx_hint_margin_get_api_delegate>(Module, "efl_gfx_hint_margin_get");

        private static void hint_margin_get(System.IntPtr obj, System.IntPtr pd, out int l, out int r, out int t, out int b)
        {
            UIKit.DataTypes.Log.Debug("function efl_gfx_hint_margin_get was called");
            var ws = UIKit.Wrapper.Globals.GetWrapperSupervisor(obj);
            if (ws != null)
            {
            ...
            {
                efl_gfx_hint_margin_get_ptr.Value.Delegate(UIKit.Wrapper.Globals.efl_super(obj, UIKit.Wrapper.Globals.efl_class_get(obj)), out l, out r, out t, out b);
            }
        }
        ...
        public static UIKit.Wrapper.FunctionWrapper<efl_gfx_hint_margin_set_api_delegate> efl_gfx_hint_margin_set_ptr = new UIKit.Wrapper.FunctionWrapper<efl_gfx_hint_margin_set_api_delegate>(Module, "efl_gfx_hint_margin_set");

        private static void hint_margin_set(System.IntPtr obj, System.IntPtr pd, int l, int r, int t, int b)
        {
            UIKit.DataTypes.Log.Debug("function efl_gfx_hint_margin_set was called");
            var ws = UIKit.Wrapper.Globals.GetWrapperSupervisor(obj);
            if (ws != null)
            {
            ...
            {
                efl_gfx_hint_margin_set_ptr.Value.Delegate(UIKit.Wrapper.Globals.efl_super(obj, UIKit.Wrapper.Globals.efl_class_get(obj)), l, r, t, b);
            }
        }
        ...
        public static UIKit.Wrapper.FunctionWrapper<efl_gfx_hint_weight_get_api_delegate> efl_gfx_hint_weight_get_ptr = new UIKit.Wrapper.FunctionWrapper<efl_gfx_hint_weight_get_api_delegate>(Module, "efl_gfx_hint_weight_get");

        private static void hint_weight_get(System.IntPtr obj, System.IntPtr pd, out double x, out double y)
        {
            UIKit.DataTypes.Log.Debug("function efl_gfx_hint_weight_get was called");
            var ws = UIKit.Wrapper.Globals.GetWrapperSupervisor(obj);
            if (ws != null)
            {
            ...
            {
                efl_gfx_hint_weight_get_ptr.Value.Delegate(UIKit.Wrapper.Globals.efl_super(obj, UIKit.Wrapper.Globals.efl_class_get(obj)), out x, out y);
            }
        }
        ...
        public static UIKit.Wrapper.FunctionWrapper<efl_gfx_hint_weight_set_api_delegate> efl_gfx_hint_weight_set_ptr = new UIKit.Wrapper.FunctionWrapper<efl_gfx_hint_weight_set_api_delegate>(Module, "efl_gfx_hint_weight_set");

        private static void hint_weight_set(System.IntPtr obj, System.IntPtr pd, double x, double y)
        {
            UIKit.DataTypes.Log.Debug("function efl_gfx_hint_weight_set was called");
            var ws = UIKit.Wrapper.Globals.GetWrapperSupervisor(obj);
            if (ws != null)
            {
            ...
            {
                efl_gfx_hint_weight_set_ptr.Value.Delegate(UIKit.Wrapper.Globals.efl_super(obj, UIKit.Wrapper.Globals.efl_class_get(obj)), x, y);
            }
        }
        ...
        public static UIKit.Wrapper.FunctionWrapper<efl_gfx_hint_align_get_api_delegate> efl_gfx_hint_align_get_ptr = new UIKit.Wrapper.FunctionWrapper<efl_gfx_hint_align_get_api_delegate>(Module, "efl_gfx_hint_align_get");

        private static void hint_align_get(System.IntPtr obj, System.IntPtr pd, out double x, out double y)
        {
            UIKit.DataTypes.Log.Debug("function efl_gfx_hint_align_get was called");
            var ws = UIKit.Wrapper.Globals.GetWrapperSupervisor(obj);
            if (ws != null)
            {
                x = default(double);y = default(double);
            ...
            {
                efl_gfx_hint_align_get_ptr.Value.Delegate(UIKit.Wrapper.Globals.efl_super(obj, UIKit.Wrapper.Globals.efl_class_get(obj)), out x, out y);
            }
        }
        ...
        public static UIKit.Wrapper.FunctionWrapper<efl_gfx_hint_align_set_api_delegate> efl_gfx_hint_align_set_ptr = new UIKit.Wrapper.FunctionWrapper<efl_gfx_hint_align_set_api_delegate>(Module, "efl_gfx_hint_align_set");

        private static void hint_align_set(System.IntPtr obj, System.IntPtr pd, double x, double y)
        {
            UIKit.DataTypes.Log.Debug("function efl_gfx_hint_align_set was called");
            var ws = UIKit.Wrapper.Globals.GetWrapperSupervisor(obj);
            if (ws != null)
            {
            ...
            {
                efl_gfx_hint_align_set_ptr.Value.Delegate(UIKit.Wrapper.Globals.efl_super(obj, UIKit.Wrapper.Globals.efl_class_get(obj)), x, y);
            }
        }
        ...
        public static UIKit.Wrapper.FunctionWrapper<efl_gfx_hint_fill_get_api_delegate> efl_gfx_hint_fill_get_ptr = new UIKit.Wrapper.FunctionWrapper<efl_gfx_hint_fill_get_api_delegate>(Module, "efl_gfx_hint_fill_get");

        private static void hint_fill_get(System.IntPtr obj, System.IntPtr pd, out bool x, out bool y)
        {
            UIKit.DataTypes.Log.Debug("function efl_gfx_hint_fill_get was called");
            var ws = UIKit.Wrapper.Globals.GetWrapperSupervisor(obj);
            if (ws != null)
            {
            ...
            {
                efl_gfx_hint_fill_get_ptr.Value.Delegate(UIKit.Wrapper.Globals.efl_super(obj, UIKit.Wrapper.Globals.efl_class_get(obj)), out x, out y);
            }
        }
        ...
        public static UIKit.Wrapper.FunctionWrapper<efl_gfx_hint_fill_set_api_delegate> efl_gfx_hint_fill_set_ptr = new UIKit.Wrapper.FunctionWrapper<efl_gfx_hint_fill_set_api_delegate>(Module, "efl_gfx_hint_fill_set");

        private static void hint_fill_set(System.IntPtr obj, System.IntPtr pd, bool x, bool y)
        {
            UIKit.DataTypes.Log.Debug("function efl_gfx_hint_fill_set was called");
            var ws = UIKit.Wrapper.Globals.GetWrapperSupervisor(obj);
            if (ws != null)
            {
            ...
            {
                efl_gfx_hint_fill_set_ptr.Value.Delegate(UIKit.Wrapper.Globals.efl_super(obj, UIKit.Wrapper.Globals.efl_class_get(obj)), x, y);
            }
        }
...
#if EFL_BETA
#pragma warning disable CS1591
public static class UIKit_GfxHintConcrete_ExtensionMethods {
}
