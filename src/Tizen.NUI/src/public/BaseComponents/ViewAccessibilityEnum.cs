...
namespace Tizen.NUI.BaseComponents
{
    ...
    /// <summary>
    /// A collection of AccessibilityEvent
    /// </summary>
    ...
    {
        [EditorBrowsable(EditorBrowsableState.Never)]
        public AccessibilityEvents(params AccessibilityEvent[] accessibilityEvents)
        {
            foreach (var accessibilityEvent in accessibilityEvents)
            {
                BitMask |= (1U << (int)accessibilityEvent);
            }
        }

        [EditorBrowsable(EditorBrowsableState.Never)]
        internal uint BitMask { get; set; } = 0U;
        ...
        public bool this[AccessibilityEvent accessibilityEvent]
        {
            get
            {
                return Convert.ToBoolean(BitMask & (1U << (int)accessibilityEvent));
            }
            set
            {
                BitMask |= (1U << (int)accessibilityEvent);
