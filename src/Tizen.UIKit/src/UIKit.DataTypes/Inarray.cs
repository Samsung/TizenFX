...
public static class InarrayNativeFunctions
{
    ...
    [DllImport(UIKit.Libs.Eina)] public static extern uint
...
public class Inarray<T> : IEnumerable<T>, IDisposable
{
    ...
    protected virtual void Dispose(bool disposing)
    {
        ...
        if (Own)
        {
            ...
            {
                UIKit.Wrapper.Globals.ThreadSafeFreeCbExec(eina_inarray_free, h);
            }
        }
    }
...
//     }
    ...
    {
        return new UIKit.DataTypes.Iterator<T>(eina_inarray_iterator_new(Handle), true);
    }

    public UIKit.DataTypes.Iterator<T> GetReversedIterator()
    {
        return new UIKit.DataTypes.Iterator<T>(eina_inarray_iterator_reversed_new(Handle), true);
    }
    ...
    {
        return new UIKit.DataTypes.AccessorInArray<T>(eina_inarray_accessor_new(Handle), Ownership.Managed);
    }
}
