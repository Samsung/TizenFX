...
namespace ControlDashboard
{
    class Example : NUIApplication
    {
      ...
      new Item("ItemView", false),    new Item("CheckBox", true)
        ...
        private void _stage_Key(object sender, Stage.KeyEventArgs e)
        {
        ...
        {
            Tizen.Log.Debug("NUI", "control-dashboard app Main()");

            Example example = new Example("/home/owner/apps_rw/NUISample2.Tizen/res/json/control-dashboard-theme.json");
            example.Run(args);
        }
    }
}
