...
/// <summary>This class keeps track of active <see cref="Efl.Canvas.GestureRecognizer"/> objects. For internal use only.
/// This gesture class defines methods that register and unregister a recognizer and get a recognizer according to gesture event type.</summary>
...
public class GestureManager : Efl.Object
{
    ...
    /// <summary>Registers a new <see cref="Efl.Canvas.GestureRecognizer"/>.</summary>
    /// <param name="recognizer">The gesture recognizer object.</param>
    public virtual void RegisterRecognizer(Efl.Canvas.GestureRecognizer recognizer) {
    ...
    /// <summary>Unregisters an existing <see cref="Efl.Canvas.GestureRecognizer"/>.</summary>
    /// <param name="recognizer">The gesture recognizer object.</param>
    public virtual void UnregisterRecognizer(Efl.Canvas.GestureRecognizer recognizer) {
    ...
    /// <summary>Returns the event recognizer object associated with the given <c>gesture_type</c>.</summary>
    /// <param name="gesture_type">The gesture event type.</param>
    ...
    public new class NativeMethods : Efl.Object.NativeMethods
    {
        ...
        public override System.Collections.Generic.List<Efl_Op_Description> GetEoOps(System.Type type, bool includeInherited)
        {
            ...
            if (methods.FirstOrDefault(m => m.Name == "RegisterRecognizer") != null)
            {
            ...
            if (methods.FirstOrDefault(m => m.Name == "UnregisterRecognizer") != null)
            {
        ...
        private static void recognizer_register(System.IntPtr obj, System.IntPtr pd, Efl.Canvas.GestureRecognizer recognizer)
        {
            ...
            if (ws != null)
            {
                ...
                try
                {
                    ((GestureManager)ws.Target).RegisterRecognizer(recognizer);
                }
                catch (Exception e)
                {
                    Eina.Log.Warning($"Callback error: {e.ToString()}");
        ...
        private static void recognizer_unregister(System.IntPtr obj, System.IntPtr pd, Efl.Canvas.GestureRecognizer recognizer)
        {
            ...
            if (ws != null)
            {
                ...
                try
                {
                    ((GestureManager)ws.Target).UnregisterRecognizer(recognizer);
                }
                catch (Exception e)
                {
                    Eina.Log.Warning($"Callback error: {e.ToString()}");
