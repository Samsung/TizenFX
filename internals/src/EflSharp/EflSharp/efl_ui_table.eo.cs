...
public class Table : Efl.Ui.Widget, Efl.Eo.IWrapper,Efl.Container,Efl.Pack,Efl.PackLayout,Efl.PackLinear,Efl.PackTable,Efl.Ui.Direction
{
   ...
   public new delegate void ConstructingMethod(Table obj);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)] internal static extern System.IntPtr
      efl_ui_table_class_get();
   ///<summary>Creates a new instance.</summary>
   ///<param name="parent">Parent instance.</param>
   ///<param name="init_cb">Delegate to call constructing methods that should be run inside the constructor.</param>
   public Table(Efl.Object parent = null, ConstructingMethod init_cb=null) : base("Table", efl_ui_table_class_get(), typeof(Table), parent)
   {
      if (init_cb != null) {
         init_cb(this);
      }
   ...
   protected Table(String klass_name, IntPtr base_klass, System.Type managed_type, Efl.Object parent) : base(klass_name, base_klass, managed_type, parent) {}
...
public class TableNativeInherit : Efl.Ui.WidgetNativeInherit{
    ...
    private static bool content_remove(System.IntPtr obj, System.IntPtr pd,  Efl.Gfx.Entity content)
   {
      ...
      if(wrapper != null) {
         ...
         try {
            _ret_var = ((Table)wrapper).ContentRemove( content);
         } catch (Exception e) {
