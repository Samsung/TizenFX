...
[Efl.PackLinearConcrete.NativeMethods]
    ...
    , Efl.IContainer, Efl.IPack
{
    ...
    private PackLinearConcrete(Efl.Eo.Globals.WrappingHandle wh) : base(wh)
    {
    }
...
#pragma warning disable CS0628
    ...
    public bool PackBegin(Efl.Gfx.IEntity subobj) {
        var _ret_var = Efl.PackLinearConcrete.NativeMethods.efl_pack_begin_ptr.Value.Delegate(this.NativeHandle,subobj);
    ...
    public bool PackEnd(Efl.Gfx.IEntity subobj) {
        var _ret_var = Efl.PackLinearConcrete.NativeMethods.efl_pack_end_ptr.Value.Delegate(this.NativeHandle,subobj);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public bool PackBefore(Efl.Gfx.IEntity subobj, Efl.Gfx.IEntity existing) {
        var _ret_var = Efl.PackLinearConcrete.NativeMethods.efl_pack_before_ptr.Value.Delegate(this.NativeHandle,subobj, existing);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public bool PackAfter(Efl.Gfx.IEntity subobj, Efl.Gfx.IEntity existing) {
        var _ret_var = Efl.PackLinearConcrete.NativeMethods.efl_pack_after_ptr.Value.Delegate(this.NativeHandle,subobj, existing);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public bool PackAt(Efl.Gfx.IEntity subobj, int index) {
        var _ret_var = Efl.PackLinearConcrete.NativeMethods.efl_pack_at_ptr.Value.Delegate(this.NativeHandle,subobj, index);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public Efl.Gfx.IEntity GetPackContent(int index) {
        var _ret_var = Efl.PackLinearConcrete.NativeMethods.efl_pack_content_get_ptr.Value.Delegate(this.NativeHandle,index);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public int GetPackIndex(Efl.Gfx.IEntity subobj) {
        var _ret_var = Efl.PackLinearConcrete.NativeMethods.efl_pack_index_get_ptr.Value.Delegate(this.NativeHandle,subobj);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public Efl.Gfx.IEntity PackUnpackAt(int index) {
        var _ret_var = Efl.PackLinearConcrete.NativeMethods.efl_pack_unpack_at_ptr.Value.Delegate(this.NativeHandle,index);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
...
#if EFL_BETA
#pragma warning disable CS1591
public static class EflPackLinearConcrete_ExtensionMethods {
}
