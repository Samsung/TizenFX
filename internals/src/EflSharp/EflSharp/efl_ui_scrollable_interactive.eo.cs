...
/// <summary></summary>
[ScrollableInteractiveConcreteNativeInherit]
   ...
   public System.IntPtr NativeClass {
      get {
         if (((object)this).GetType() == typeof (ScrollableInteractiveConcrete))
            return Efl.Ui.ScrollableInteractiveConcreteNativeInherit.GetEflClassStatic();
         else
...
private static object ScrollDragStopEvtKey = new object();
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    private static extern Eina.Position2D_StructInternal efl_ui_scrollable_content_pos_get(System.IntPtr obj);
   /// <summary>The content position</summary>
   /// <returns>The position is virtual value, (0, 0) starting at the top-left.</returns>
   public Eina.Position2D GetContentPos() {
       var _ret_var = efl_ui_scrollable_content_pos_get(Efl.Ui.ScrollableInteractiveConcrete.efl_ui_scrollable_interactive_interface_get());
      Eina.Error.RaiseIfUnhandledException();
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    private static extern  void efl_ui_scrollable_content_pos_set(System.IntPtr obj,   Eina.Position2D_StructInternal pos);
   /// <summary>The content position</summary>
   /// <param name="pos">The position is virtual value, (0, 0) starting at the top-left.</param>
   /// <returns></returns>
   public  void SetContentPos( Eina.Position2D pos) {
       var _in_pos = Eina.Position2D_StructConversion.ToInternal(pos);
                  efl_ui_scrollable_content_pos_set(Efl.Ui.ScrollableInteractiveConcrete.efl_ui_scrollable_interactive_interface_get(),  _in_pos);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    private static extern Eina.Size2D_StructInternal efl_ui_scrollable_content_size_get(System.IntPtr obj);
   /// <summary>The content size</summary>
   /// <returns>The content size in pixels.</returns>
   public Eina.Size2D GetContentSize() {
       var _ret_var = efl_ui_scrollable_content_size_get(Efl.Ui.ScrollableInteractiveConcrete.efl_ui_scrollable_interactive_interface_get());
      Eina.Error.RaiseIfUnhandledException();
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    private static extern Eina.Rect_StructInternal efl_ui_scrollable_viewport_geometry_get(System.IntPtr obj);
   /// <summary>The viewport geometry</summary>
   /// <returns>It is absolute geometry.</returns>
   public Eina.Rect GetViewportGeometry() {
       var _ret_var = efl_ui_scrollable_viewport_geometry_get(Efl.Ui.ScrollableInteractiveConcrete.efl_ui_scrollable_interactive_interface_get());
      Eina.Error.RaiseIfUnhandledException();
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    private static extern  void efl_ui_scrollable_bounce_enabled_get(System.IntPtr obj,  [MarshalAs(UnmanagedType.U1)]  out bool horiz,  [MarshalAs(UnmanagedType.U1)]  out bool vert);
   /// <summary>Bouncing behavior
   /// When scrolling, the scroller may &quot;bounce&quot; when reaching the edge of the content object. This is a visual way to indicate the end has been reached. This is enabled by default for both axes. This API will determine if it&apos;s enabled for the given axis with the boolean parameters for each one.</summary>
   /// <param name="horiz">Horizontal bounce policy.</param>
   /// <param name="vert">Vertical bounce policy.</param>
   ...
   public  void GetBounceEnabled( out bool horiz,  out bool vert) {
                                           efl_ui_scrollable_bounce_enabled_get(Efl.Ui.ScrollableInteractiveConcrete.efl_ui_scrollable_interactive_interface_get(),  out horiz,  out vert);
      Eina.Error.RaiseIfUnhandledException();
                               }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    private static extern  void efl_ui_scrollable_bounce_enabled_set(System.IntPtr obj,  [MarshalAs(UnmanagedType.U1)]  bool horiz,  [MarshalAs(UnmanagedType.U1)]  bool vert);
   /// <summary>Bouncing behavior
   /// When scrolling, the scroller may &quot;bounce&quot; when reaching the edge of the content object. This is a visual way to indicate the end has been reached. This is enabled by default for both axes. This API will determine if it&apos;s enabled for the given axis with the boolean parameters for each one.</summary>
   /// <param name="horiz">Horizontal bounce policy.</param>
   /// <param name="vert">Vertical bounce policy.</param>
   ...
   public  void SetBounceEnabled( bool horiz,  bool vert) {
                                           efl_ui_scrollable_bounce_enabled_set(Efl.Ui.ScrollableInteractiveConcrete.efl_ui_scrollable_interactive_interface_get(),  horiz,  vert);
      Eina.Error.RaiseIfUnhandledException();
                               }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    [return: MarshalAs(UnmanagedType.U1)] private static extern bool efl_ui_scrollable_scroll_freeze_get(System.IntPtr obj);
   /// <summary>Freeze property This function will freeze scrolling movement (by input of a user). Unlike efl_ui_scrollable_movement_block_set, this function freezes bidirectionally. If you want to freeze in only one direction, See <see cref="Efl.Ui.ScrollableInteractive.SetMovementBlock"/>.</summary>
   /// <returns><c>true</c> if freeze, <c>false</c> otherwise</returns>
   public bool GetScrollFreeze() {
       var _ret_var = efl_ui_scrollable_scroll_freeze_get(Efl.Ui.ScrollableInteractiveConcrete.efl_ui_scrollable_interactive_interface_get());
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    private static extern  void efl_ui_scrollable_scroll_freeze_set(System.IntPtr obj,  [MarshalAs(UnmanagedType.U1)]  bool freeze);
   /// <summary>Freeze property This function will freeze scrolling movement (by input of a user). Unlike efl_ui_scrollable_movement_block_set, this function freezes bidirectionally. If you want to freeze in only one direction, See <see cref="Efl.Ui.ScrollableInteractive.SetMovementBlock"/>.</summary>
   /// <param name="freeze"><c>true</c> if freeze, <c>false</c> otherwise</param>
   /// <returns></returns>
   public  void SetScrollFreeze( bool freeze) {
                         efl_ui_scrollable_scroll_freeze_set(Efl.Ui.ScrollableInteractiveConcrete.efl_ui_scrollable_interactive_interface_get(),  freeze);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    [return: MarshalAs(UnmanagedType.U1)] private static extern bool efl_ui_scrollable_scroll_hold_get(System.IntPtr obj);
   /// <summary>Hold property When hold turns on, it only scrolls by holding action.</summary>
   /// <returns><c>true</c> if hold, <c>false</c> otherwise</returns>
   public bool GetScrollHold() {
       var _ret_var = efl_ui_scrollable_scroll_hold_get(Efl.Ui.ScrollableInteractiveConcrete.efl_ui_scrollable_interactive_interface_get());
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    private static extern  void efl_ui_scrollable_scroll_hold_set(System.IntPtr obj,  [MarshalAs(UnmanagedType.U1)]  bool hold);
   /// <summary>Hold property When hold turns on, it only scrolls by holding action.</summary>
   /// <param name="hold"><c>true</c> if hold, <c>false</c> otherwise</param>
   /// <returns></returns>
   public  void SetScrollHold( bool hold) {
                         efl_ui_scrollable_scroll_hold_set(Efl.Ui.ScrollableInteractiveConcrete.efl_ui_scrollable_interactive_interface_get(),  hold);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    private static extern  void efl_ui_scrollable_looping_get(System.IntPtr obj,  [MarshalAs(UnmanagedType.U1)]  out bool loop_h,  [MarshalAs(UnmanagedType.U1)]  out bool loop_v);
   /// <summary>Controls an infinite loop for a scroller.</summary>
   /// <param name="loop_h">The scrolling horizontal loop</param>
   /// <param name="loop_v">The Scrolling vertical loop</param>
   /// <returns></returns>
   public  void GetLooping( out bool loop_h,  out bool loop_v) {
                                           efl_ui_scrollable_looping_get(Efl.Ui.ScrollableInteractiveConcrete.efl_ui_scrollable_interactive_interface_get(),  out loop_h,  out loop_v);
      Eina.Error.RaiseIfUnhandledException();
                               }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    private static extern  void efl_ui_scrollable_looping_set(System.IntPtr obj,  [MarshalAs(UnmanagedType.U1)]  bool loop_h,  [MarshalAs(UnmanagedType.U1)]  bool loop_v);
   /// <summary>Controls an infinite loop for a scroller.</summary>
   /// <param name="loop_h">The scrolling horizontal loop</param>
   /// <param name="loop_v">The Scrolling vertical loop</param>
   /// <returns></returns>
   public  void SetLooping( bool loop_h,  bool loop_v) {
                                           efl_ui_scrollable_looping_set(Efl.Ui.ScrollableInteractiveConcrete.efl_ui_scrollable_interactive_interface_get(),  loop_h,  loop_v);
      Eina.Error.RaiseIfUnhandledException();
                               }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    private static extern Efl.Ui.ScrollBlock efl_ui_scrollable_movement_block_get(System.IntPtr obj);
   /// <summary>Blocking of scrolling (per axis)
   /// This function will block scrolling movement (by input of a user) in a given direction. You can disable movements in the X axis, the Y axis or both. The default value is <c>none</c>, where movements are allowed in both directions.</summary>
   /// <returns>Which axis (or axes) to block</returns>
   public Efl.Ui.ScrollBlock GetMovementBlock() {
       var _ret_var = efl_ui_scrollable_movement_block_get(Efl.Ui.ScrollableInteractiveConcrete.efl_ui_scrollable_interactive_interface_get());
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    private static extern  void efl_ui_scrollable_movement_block_set(System.IntPtr obj,   Efl.Ui.ScrollBlock block);
   /// <summary>Blocking of scrolling (per axis)
   /// This function will block scrolling movement (by input of a user) in a given direction. You can disable movements in the X axis, the Y axis or both. The default value is <c>none</c>, where movements are allowed in both directions.</summary>
   /// <param name="block">Which axis (or axes) to block</param>
   /// <returns></returns>
   public  void SetMovementBlock( Efl.Ui.ScrollBlock block) {
                         efl_ui_scrollable_movement_block_set(Efl.Ui.ScrollableInteractiveConcrete.efl_ui_scrollable_interactive_interface_get(),  block);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    private static extern  void efl_ui_scrollable_gravity_get(System.IntPtr obj,   out double x,   out double y);
   /// <summary>Control scrolling gravity on the scrollable
   /// The gravity defines how the scroller will adjust its view when the size of the scroller contents increases.
   /// 
   /// The scroller will adjust the view to glue itself as follows.
   ...
   public  void GetGravity( out double x,  out double y) {
                                           efl_ui_scrollable_gravity_get(Efl.Ui.ScrollableInteractiveConcrete.efl_ui_scrollable_interactive_interface_get(),  out x,  out y);
      Eina.Error.RaiseIfUnhandledException();
                               }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    private static extern  void efl_ui_scrollable_gravity_set(System.IntPtr obj,   double x,   double y);
   /// <summary>Control scrolling gravity on the scrollable
   /// The gravity defines how the scroller will adjust its view when the size of the scroller contents increases.
   /// 
   /// The scroller will adjust the view to glue itself as follows.
   ...
   public  void SetGravity( double x,  double y) {
                                           efl_ui_scrollable_gravity_set(Efl.Ui.ScrollableInteractiveConcrete.efl_ui_scrollable_interactive_interface_get(),  x,  y);
      Eina.Error.RaiseIfUnhandledException();
                               }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    private static extern  void efl_ui_scrollable_match_content_set(System.IntPtr obj,  [MarshalAs(UnmanagedType.U1)]  bool w,  [MarshalAs(UnmanagedType.U1)]  bool h);
   /// <summary>Prevent the scrollable from being smaller than the minimum size of the content.
   /// By default the scroller will be as small as its design allows, irrespective of its content. This will make the scroller minimum size the right size horizontally and/or vertically to perfectly fit its content in that direction.</summary>
   /// <param name="w">Whether to limit the minimum horizontal size</param>
   /// <param name="h">Whether to limit the minimum vertical size</param>
   ...
   public  void SetMatchContent( bool w,  bool h) {
                                           efl_ui_scrollable_match_content_set(Efl.Ui.ScrollableInteractiveConcrete.efl_ui_scrollable_interactive_interface_get(),  w,  h);
      Eina.Error.RaiseIfUnhandledException();
                               }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    private static extern  void efl_ui_scrollable_scroll(System.IntPtr obj,   Eina.Rect_StructInternal rect,  [MarshalAs(UnmanagedType.U1)]  bool animation);
   /// <summary>Show a specific virtual region within the scroller content object.
   /// This will ensure all (or part if it does not fit) of the designated region in the virtual content object (0, 0 starting at the top-left of the virtual content object) is shown within the scroller. This allows the scroller to &quot;smoothly slide&quot; to this location (if configuration in general calls for transitions). It may not jump immediately to the new location and make take a while and show other content along the way.</summary>
   /// <param name="rect">The position where to scroll. and The size user want to see</param>
   /// <param name="animation">Whether to scroll with animation or not</param>
   ...
   public  void Scroll( Eina.Rect rect,  bool animation) {
       var _in_rect = Eina.Rect_StructConversion.ToInternal(rect);
                                    efl_ui_scrollable_scroll(Efl.Ui.ScrollableInteractiveConcrete.efl_ui_scrollable_interactive_interface_get(),  _in_rect,  animation);
      Eina.Error.RaiseIfUnhandledException();
                               }
   /// <summary>The content position</summary>
...
public class ScrollableInteractiveConcreteNativeInherit : Efl.Eo.NativeClass{
