...
public class Panel : Efl.Ui.LayoutBase, Efl.IContent, Efl.Ui.IScrollable, Efl.Ui.IWidgetFocusManager, Efl.Ui.Focus.ILayer, Efl.Ui.Focus.IManager
{
    ...
    public new class NativeMethods : Efl.Ui.LayoutBase.NativeMethods
    {
        ...
        private static Efl.Ui.Focus.IManager focus_manager_create(System.IntPtr obj, System.IntPtr pd, Efl.Ui.Focus.IObject root)
        {
            ...
            if (ws != null)
            {
                ...
                try
                {
                    _ret_var = ((Panel)ws.Target).CreateFocusManager(root);
                }
                catch (Exception e)
                {
                    Eina.Log.Warning($"Callback error: {e.ToString()}");
