...
namespace CoreUI.UI {
    /// <summary>Event argument wrapper for event <see cref="CoreUI.UI.CollectionView.ItemRealized"/>.
    /// </summary>
    ...
    /// <summary>Event argument wrapper for event <see cref="CoreUI.UI.CollectionView.ItemUnrealized"/>.
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    [CoreUI.Wrapper.BindingEntity]
    ...
    /// <param name="style">The widget style to use. See <see cref="CoreUI.UI.Widget.SetStyle" /></param>
        ...
        public event EventHandler<CoreUI.UI.CollectionViewItemRealizedEventArgs> ItemRealized
        {
            add
            {
        ...
        /// <summary>Method to raise event ItemRealized.
        /// </summary>
        /// <param name="e">Event to raise.</param>
        /// <since_tizen> 6 </since_tizen>
        protected virtual void OnItemRealized(CoreUI.UI.CollectionViewItemRealizedEventArgs e)
        {
        ...
        public event EventHandler<CoreUI.UI.CollectionViewItemUnrealizedEventArgs> ItemUnrealized
        {
            add
            {
        ...
        /// <summary>Method to raise event ItemUnrealized.
        /// </summary>
        /// <param name="e">Event to raise.</param>
        /// <since_tizen> 6 </since_tizen>
        protected virtual void OnItemUnrealized(CoreUI.UI.CollectionViewItemUnrealizedEventArgs e)
        {
            Contract.Requires(e != null, nameof(e));
            IntPtr info = e.Arg.NativeHandle;
        ...
        public virtual IEnumerable<uint> NewSelectedNdxIterator() {
            var _ret_var = CoreUI.UI.IMultiSelectableIndexRangeNativeMethods.efl_ui_multi_selectable_selected_ndx_iterator_new_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
            CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        ...
        public virtual IEnumerable<uint> NewUnselectedNdxIterator() {
            var _ret_var = CoreUI.UI.IMultiSelectableIndexRangeNativeMethods.efl_ui_multi_selectable_unselected_ndx_iterator_new_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
            CoreUI.DataTypes.Error.RaiseIfUnhandledException();
            return CoreUI.Wrapper.Globals.IteratorToIEnumerable<uint>(_ret_var);
        }
...
#pragma warning disable CS1591
    ...
    public static class CollectionViewExtensions {
        /// <since_tizen> 6 </since_tizen>
        public static CoreUI.BindableProperty<CoreUI.UI.IFactory> Factory<T>(this CoreUI.UI.IGenericFactoryExtended<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.CollectionView, T>magic = null) where T : CoreUI.UI.CollectionView {
            return new CoreUI.BindableProperty<CoreUI.UI.IFactory>("factory", fac.GetPropBind());
        }

        /// <since_tizen> 6 </since_tizen>
        public static CoreUI.BindableProperty<CoreUI.UI.PositionManager.IEntity> PositionManager<T>(this CoreUI.UI.IGenericFactoryExtended<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.CollectionView, T>magic = null) where T : CoreUI.UI.CollectionView {
            return new CoreUI.BindableProperty<CoreUI.UI.PositionManager.IEntity>("position_manager", fac.GetPropBind());
        }

        /// <since_tizen> 6 </since_tizen>
        public static CoreUI.BindableProperty<CoreUI.UI.LayoutOrientation> Orientation<T>(this CoreUI.UI.IGenericFactoryExtended<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.CollectionView, T>magic = null) where T : CoreUI.UI.CollectionView {
            return new CoreUI.BindableProperty<CoreUI.UI.LayoutOrientation>("orientation", fac.GetPropBind());
        }

        /// <since_tizen> 6 </since_tizen>
        public static CoreUI.BindableProperty<CoreUI.UI.SelectMode> SelectMode<T>(this CoreUI.UI.IGenericFactoryExtended<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.CollectionView, T>magic = null) where T : CoreUI.UI.CollectionView {
            return new CoreUI.BindableProperty<CoreUI.UI.SelectMode>("select_mode", fac.GetPropBind());
        }

        /// <since_tizen> 6 </since_tizen>
        public static CoreUI.BindableProperty<CoreUI.DataTypes.Position2D> ContentPos<T>(this CoreUI.UI.IGenericFactoryExtended<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.CollectionView, T>magic = null) where T : CoreUI.UI.CollectionView {
            return new CoreUI.BindableProperty<CoreUI.DataTypes.Position2D>("content_pos", fac.GetPropBind());
        }

        /// <since_tizen> 6 </since_tizen>
        public static CoreUI.BindableProperty<bool> ScrollFreeze<T>(this CoreUI.UI.IGenericFactoryExtended<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.CollectionView, T>magic = null) where T : CoreUI.UI.CollectionView {
            return new CoreUI.BindableProperty<bool>("scroll_freeze", fac.GetPropBind());
        }

        /// <since_tizen> 6 </since_tizen>
        public static CoreUI.BindableProperty<bool> ScrollHold<T>(this CoreUI.UI.IGenericFactoryExtended<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.CollectionView, T>magic = null) where T : CoreUI.UI.CollectionView {
            return new CoreUI.BindableProperty<bool>("scroll_hold", fac.GetPropBind());
        }

        /// <since_tizen> 6 </since_tizen>
        public static CoreUI.BindableProperty<CoreUI.UI.LayoutOrientation> MovementBlock<T>(this CoreUI.UI.IGenericFactoryExtended<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.CollectionView, T>magic = null) where T : CoreUI.UI.CollectionView {
            return new CoreUI.BindableProperty<CoreUI.UI.LayoutOrientation>("movement_block", fac.GetPropBind());
        }

        /// <since_tizen> 6 </since_tizen>
        public static CoreUI.BindableProperty<CoreUI.DataTypes.Position2D> StepSize<T>(this CoreUI.UI.IGenericFactoryExtended<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.CollectionView, T>magic = null) where T : CoreUI.UI.CollectionView {
            return new CoreUI.BindableProperty<CoreUI.DataTypes.Position2D>("step_size", fac.GetPropBind());
        }

        /// <since_tizen> 6 </since_tizen>
        public static CoreUI.BindableProperty<CoreUI.UI.ISelectable> FallbackSelection<T>(this CoreUI.UI.IGenericFactoryExtended<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.CollectionView, T>magic = null) where T : CoreUI.UI.CollectionView {
            return new CoreUI.BindableProperty<CoreUI.UI.ISelectable>("fallback_selection", fac.GetPropBind());
        }

        /// <since_tizen> 6 </since_tizen>
        public static CoreUI.BindableProperty<bool> AllowManualDeselection<T>(this CoreUI.UI.IGenericFactoryExtended<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.CollectionView, T>magic = null) where T : CoreUI.UI.CollectionView {
