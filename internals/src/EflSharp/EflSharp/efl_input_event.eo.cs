   ...
   , Efl.Duplicate
{
   ...
   public System.IntPtr NativeClass {
      get {
         if (((object)this).GetType() == typeof (EventConcrete))
            return Efl.Input.EventConcreteNativeInherit.GetEflClassStatic();
         else
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Evas)]
    private static extern double efl_input_timestamp_get(System.IntPtr obj);
   /// <summary>The time at which an event was generated.
   /// If the event is generated by a server (eg. X.org or Wayland), then the time may be set by the server. Usually this time will be based on the monotonic clock, if available, but this class can not guarantee it.
   /// 1.19</summary>
   /// <returns>Time in milliseconds when the event happened.
   ...
   public double GetTimestamp() {
       var _ret_var = efl_input_timestamp_get(Efl.Input.EventConcrete.efl_input_event_mixin_get());
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Evas)]
    private static extern  void efl_input_timestamp_set(System.IntPtr obj,   double ms);
   /// <summary>Call this when generating events manually.
   /// 1.19</summary>
   /// <param name="ms">Time in milliseconds when the event happened.
   /// 1.19</param>
   ...
   public  void SetTimestamp( double ms) {
                         efl_input_timestamp_set(Efl.Input.EventConcrete.efl_input_event_mixin_get(),  ms);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Evas)]
   [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Efl.Eo.MarshalTest<Efl.Input.Device, Efl.Eo.NonOwnTag>))] private static extern Efl.Input.Device efl_input_device_get(System.IntPtr obj);
   /// <summary>Input device that originated this event.
   /// 1.19</summary>
   /// <returns>Input device origin
   /// 1.19</returns>
   public Efl.Input.Device GetDevice() {
       var _ret_var = efl_input_device_get(Efl.Input.EventConcrete.efl_input_event_mixin_get());
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Evas)]
    private static extern  void efl_input_device_set(System.IntPtr obj, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Efl.Eo.MarshalTest<Efl.Input.Device, Efl.Eo.NonOwnTag>))]  Efl.Input.Device dev);
   /// <summary>Input device that originated this event.
   /// 1.19</summary>
   /// <param name="dev">Input device origin
   /// 1.19</param>
   ...
   public  void SetDevice( Efl.Input.Device dev) {
                         efl_input_device_set(Efl.Input.EventConcrete.efl_input_event_mixin_get(),  dev);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Evas)]
    private static extern Efl.Input.Flags efl_input_event_flags_get(System.IntPtr obj);
   /// <summary>Extra flags for this event, may be changed by the user.
   /// 1.19</summary>
   /// <returns>Input event flags
   /// 1.19</returns>
   public Efl.Input.Flags GetEventFlags() {
       var _ret_var = efl_input_event_flags_get(Efl.Input.EventConcrete.efl_input_event_mixin_get());
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Evas)]
    private static extern  void efl_input_event_flags_set(System.IntPtr obj,   Efl.Input.Flags flags);
   /// <summary>Extra flags for this event, may be changed by the user.
   /// 1.19</summary>
   /// <param name="flags">Input event flags
   /// 1.19</param>
   ...
   public  void SetEventFlags( Efl.Input.Flags flags) {
                         efl_input_event_flags_set(Efl.Input.EventConcrete.efl_input_event_mixin_get(),  flags);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Evas)]
    [return: MarshalAs(UnmanagedType.U1)] private static extern bool efl_input_processed_get(System.IntPtr obj);
   /// <summary><c>true</c> if <see cref="Efl.Input.Event.EventFlags"/> indicates the event is on hold.
   /// 1.19</summary>
   /// <returns><c>true</c> if the event is on hold, <c>false</c> otherwise
   /// 1.19</returns>
   public bool GetProcessed() {
       var _ret_var = efl_input_processed_get(Efl.Input.EventConcrete.efl_input_event_mixin_get());
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Evas)]
    private static extern  void efl_input_processed_set(System.IntPtr obj,  [MarshalAs(UnmanagedType.U1)]  bool val);
   /// <summary><c>true</c> if <see cref="Efl.Input.Event.EventFlags"/> indicates the event is on hold.
   /// 1.19</summary>
   /// <param name="val"><c>true</c> if the event is on hold, <c>false</c> otherwise
   /// 1.19</param>
   ...
   public  void SetProcessed( bool val) {
                         efl_input_processed_set(Efl.Input.EventConcrete.efl_input_event_mixin_get(),  val);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Evas)]
    [return: MarshalAs(UnmanagedType.U1)] private static extern bool efl_input_scrolling_get(System.IntPtr obj);
   /// <summary><c>true</c> if <see cref="Efl.Input.Event.EventFlags"/> indicates the event happened while scrolling.
   /// 1.19</summary>
   /// <returns><c>true</c> if the event happened while scrolling, <c>false</c> otherwise
   /// 1.19</returns>
   public bool GetScrolling() {
       var _ret_var = efl_input_scrolling_get(Efl.Input.EventConcrete.efl_input_event_mixin_get());
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Evas)]
    private static extern  void efl_input_scrolling_set(System.IntPtr obj,  [MarshalAs(UnmanagedType.U1)]  bool val);
   /// <summary><c>true</c> if <see cref="Efl.Input.Event.EventFlags"/> indicates the event happened while scrolling.
   /// 1.19</summary>
   /// <param name="val"><c>true</c> if the event happened while scrolling, <c>false</c> otherwise
   /// 1.19</param>
   ...
   public  void SetScrolling( bool val) {
                         efl_input_scrolling_set(Efl.Input.EventConcrete.efl_input_event_mixin_get(),  val);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Evas)]
    [return: MarshalAs(UnmanagedType.U1)] private static extern bool efl_input_fake_get(System.IntPtr obj);
   /// <summary><c>true</c> if the event was fake, not triggered by real hardware.
   /// 1.19</summary>
   /// <returns><c>true</c> if the event was not from real hardware, <c>false</c> otherwise
   /// 1.19</returns>
   public bool GetFake() {
       var _ret_var = efl_input_fake_get(Efl.Input.EventConcrete.efl_input_event_mixin_get());
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Evas)]
    private static extern  void efl_input_reset(System.IntPtr obj);
   /// <summary>Resets the internal data to 0 or default values.
   /// 1.19</summary>
   /// <returns></returns>
   public  void Reset() {
       efl_input_reset(Efl.Input.EventConcrete.efl_input_event_mixin_get());
      Eina.Error.RaiseIfUnhandledException();
       }
...
public class EventConcreteNativeInherit : Efl.Eo.NativeClass{
