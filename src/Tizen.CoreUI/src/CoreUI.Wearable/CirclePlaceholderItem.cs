...
namespace CoreUI.Wearable {
    /// <summary>Wearable Circle Placeholder Item class. This item have only one swallow space, thus user can decorate item by filling the swallow with any kind of container.</summary>
    /// <since_tizen> 6 </since_tizen>
    [CoreUI.Wearable.CirclePlaceholderItem.NativeMethods]
    [CoreUI.Wrapper.BindingEntity]
    [SuppressMessage("Microsoft.Naming", "CA1724:TypeNamesShouldNotMatchNamespaces")]
    public class CirclePlaceholderItem : CoreUI.Wearable.CircleItem, CoreUI.IContent
    {
        ...
        public override System.IntPtr NativeClass
        {
            get
            {
                if (((object)this).GetType() == typeof(CirclePlaceholderItem))
                {
        ...
        [System.Runtime.InteropServices.DllImport(CoreUI.Libs.Elementary)] internal static extern System.IntPtr
            efl_wearable_circle_placeholder_item_class_get();

        /// <summary>Initializes a new instance of the <see cref="CirclePlaceholderItem"/> class.
        /// </summary>
        /// <param name="parent">Parent instance.</param>
    /// <param name="style">The widget style to use. See <see cref="CoreUI.UI.Widget.SetStyle" /></param>
        public CirclePlaceholderItem(CoreUI.Object parent, System.String style = null) : base(efl_wearable_circle_placeholder_item_class_get(), parent)
        {
        ...
        protected CirclePlaceholderItem(ConstructingHandle ch) : base(ch)
        {
        }
        ...
        internal CirclePlaceholderItem(CoreUI.Wrapper.WrappingHandle wh) : base(wh)
        {
        }
        ...
        protected CirclePlaceholderItem(IntPtr baseKlass, CoreUI.Object parent) : base(baseKlass, parent)
        {
        }
        ...
        {
            return CoreUI.Wearable.CirclePlaceholderItem.efl_wearable_circle_placeholder_item_class_get();
        }
...
#pragma warning disable CS1591
    /// <since_tizen> 6 </since_tizen>
    public static class CirclePlaceholderItemExtensions {
        /// <since_tizen> 6 </since_tizen>
        public static CoreUI.BindableProperty<CoreUI.Gfx.IEntity> Content<T>(this CoreUI.UI.IGenericFactoryExtended<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Wearable.CirclePlaceholderItem, T>magic = null) where T : CoreUI.Wearable.CirclePlaceholderItem {
            return new CoreUI.BindableProperty<CoreUI.Gfx.IEntity>("content", fac.GetPropBind());
        }

        /// <since_tizen> 6 </since_tizen>
        public static CoreUI.BindableFactoryPart<CoreUI.UI.LayoutPartContent> ContentPart<T>(this CoreUI.UI.IGenericFactoryPartExtended<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Wearable.CirclePlaceholderItem, T> x=null) where T : CoreUI.Wearable.CirclePlaceholderItem
        {
            return new CoreUI.BindableFactoryPart<CoreUI.UI.LayoutPartContent>("content", fac.GetFactoryBind());
        }
