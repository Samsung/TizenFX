...
public class Rectangle : Efl.Canvas.Object, Efl.Eo.IWrapper
{
   ...
   public new delegate void ConstructingMethod(Rectangle obj);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Evas)] internal static extern System.IntPtr
      efl_canvas_rectangle_class_get();
   ///<summary>Creates a new instance.</summary>
   ///<param name="parent">Parent instance.</param>
   ///<param name="init_cb">Delegate to call constructing methods that should be run inside the constructor.</param>
   public Rectangle(Efl.Object parent = null, ConstructingMethod init_cb=null) : base("Rectangle", efl_canvas_rectangle_class_get(), typeof(Rectangle), parent)
   {
      if (init_cb != null) {
         init_cb(this);
      }
   ...
   protected Rectangle(String klass_name, IntPtr base_klass, System.Type managed_type, Efl.Object parent) : base(klass_name, base_klass, managed_type, parent) {}
