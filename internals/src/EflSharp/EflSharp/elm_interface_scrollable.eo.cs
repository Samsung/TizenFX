...
[InterfaceScrollableConcreteNativeInherit]
   ...
   public System.IntPtr NativeClass {
      get {
         if (((object)this).GetType() == typeof (InterfaceScrollableConcrete))
            return Elm.InterfaceScrollableConcreteNativeInherit.GetEflClassStatic();
         else
...
private static object Dirty_logic_freezeChangedEvtKey = new object();
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_gravity_get(System.IntPtr obj,   out double x,   out double y);
   /// <summary>Control scrolling gravity on the scrollable
   /// The gravity defines how the scroller will adjust its view when the size of the scroller contents increases.
   /// 
   /// The scroller will adjust the view to glue itself as follows.
   ...
   public  void GetGravity( out double x,  out double y) {
                                           elm_interface_scrollable_gravity_get(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  out x,  out y);
      Eina.Error.RaiseIfUnhandledException();
                               }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_gravity_set(System.IntPtr obj,   double x,   double y);
   /// <summary>Control scrolling gravity on the scrollable
   /// The gravity defines how the scroller will adjust its view when the size of the scroller contents increases.
   /// 
   /// The scroller will adjust the view to glue itself as follows.
   ...
   public  void SetGravity( double x,  double y) {
                                           elm_interface_scrollable_gravity_set(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  x,  y);
      Eina.Error.RaiseIfUnhandledException();
                               }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_bounce_allow_get(System.IntPtr obj,  [MarshalAs(UnmanagedType.U1)]  out bool horiz,  [MarshalAs(UnmanagedType.U1)]  out bool vert);
   /// <summary>Bouncing behavior
   /// When scrolling, the scroller may &quot;bounce&quot; when reaching an edge of the content object. This is a visual way to indicate the end has been reached. This is enabled by default for both axis. This API will set if it is enabled for the given axis with the boolean parameters for each axis.</summary>
   /// <param name="horiz">Horizontal bounce policy.</param>
   /// <param name="vert">Vertical bounce policy.</param>
   ...
   public  void GetBounceAllow( out bool horiz,  out bool vert) {
                                           elm_interface_scrollable_bounce_allow_get(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  out horiz,  out vert);
      Eina.Error.RaiseIfUnhandledException();
                               }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_bounce_allow_set(System.IntPtr obj,  [MarshalAs(UnmanagedType.U1)]  bool horiz,  [MarshalAs(UnmanagedType.U1)]  bool vert);
   /// <summary>Bouncing behavior
   /// When scrolling, the scroller may &quot;bounce&quot; when reaching an edge of the content object. This is a visual way to indicate the end has been reached. This is enabled by default for both axis. This API will set if it is enabled for the given axis with the boolean parameters for each axis.</summary>
   /// <param name="horiz">Horizontal bounce policy.</param>
   /// <param name="vert">Vertical bounce policy.</param>
   ...
   public  void SetBounceAllow( bool horiz,  bool vert) {
                                           elm_interface_scrollable_bounce_allow_set(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  horiz,  vert);
      Eina.Error.RaiseIfUnhandledException();
                               }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    [return: MarshalAs(UnmanagedType.U1)] private static extern bool elm_interface_scrollable_wheel_disabled_get(System.IntPtr obj);
   /// <summary>Control Wheel disable Enable or disable mouse wheel to be used to scroll the scroller content. heel is enabled by default.</summary>
   /// <returns><c>true</c> if wheel is disabled, <c>false</c> otherwise</returns>
   public bool GetWheelDisabled() {
       var _ret_var = elm_interface_scrollable_wheel_disabled_get(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get());
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_wheel_disabled_set(System.IntPtr obj,  [MarshalAs(UnmanagedType.U1)]  bool disabled);
   /// <summary>Control Wheel disable Enable or disable mouse wheel to be used to scroll the scroller content. heel is enabled by default.</summary>
   /// <param name="disabled"><c>true</c> if wheel is disabled, <c>false</c> otherwise</param>
   /// <returns></returns>
   public  void SetWheelDisabled( bool disabled) {
                         elm_interface_scrollable_wheel_disabled_set(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  disabled);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern Efl.Ui.ScrollBlock elm_interface_scrollable_movement_block_get(System.IntPtr obj);
   /// <summary>Blocking of scrolling (per axis)
   /// This function will block scrolling movement (by input of a user) in a given direction. One can disable movements in the X axis, the Y axis or both. The default value is <c>none</c>, where movements are allowed in both directions.
   /// 
   /// What makes this function different from freeze_push(), hold_push() and lock_x_set() (or lock_y_set()) is that it doesn&apos;t propagate its effects to any parent or child widget of <c>obj</c>. Only the target scrollable widget will be locked with regard to scrolling.</summary>
   ...
   public Efl.Ui.ScrollBlock GetMovementBlock() {
       var _ret_var = elm_interface_scrollable_movement_block_get(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get());
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_movement_block_set(System.IntPtr obj,   Efl.Ui.ScrollBlock block);
   /// <summary>Blocking of scrolling (per axis)
   /// This function will block scrolling movement (by input of a user) in a given direction. One can disable movements in the X axis, the Y axis or both. The default value is <c>none</c>, where movements are allowed in both directions.
   /// 
   /// What makes this function different from freeze_push(), hold_push() and lock_x_set() (or lock_y_set()) is that it doesn&apos;t propagate its effects to any parent or child widget of <c>obj</c>. Only the target scrollable widget will be locked with regard to scrolling.</summary>
   ...
   public  void SetMovementBlock( Efl.Ui.ScrollBlock block) {
                         elm_interface_scrollable_movement_block_set(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  block);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    [return: MarshalAs(UnmanagedType.U1)] private static extern bool elm_interface_scrollable_momentum_animator_disabled_get(System.IntPtr obj);
   /// <summary>Momentum animator</summary>
   /// <returns><c>true</c> if disabled, <c>false</c> otherwise</returns>
   public bool GetMomentumAnimatorDisabled() {
       var _ret_var = elm_interface_scrollable_momentum_animator_disabled_get(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get());
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_momentum_animator_disabled_set(System.IntPtr obj,  [MarshalAs(UnmanagedType.U1)]  bool disabled);
   /// <summary>Momentum animator</summary>
   /// <param name="disabled"><c>true</c> if disabled, <c>false</c> otherwise</param>
   /// <returns></returns>
   public  void SetMomentumAnimatorDisabled( bool disabled) {
                         elm_interface_scrollable_momentum_animator_disabled_set(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  disabled);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_policy_get(System.IntPtr obj,   out Elm.Scroller.Policy hbar,   out Elm.Scroller.Policy vbar);
   /// <summary>Scrollbar visibility policy
   /// #ELM_SCROLLER_POLICY_AUTO means the scrollbar is made visible if it is needed, and otherwise kept hidden. #ELM_SCROLLER_POLICY_ON turns it on all the time, and #ELM_SCROLLER_POLICY_OFF always keeps it off. This applies respectively for the horizontal and vertical scrollbars.</summary>
   /// <param name="hbar">Horizontal scrollbar policy</param>
   /// <param name="vbar">Vertical scrollbar policy</param>
   ...
   public  void GetPolicy( out Elm.Scroller.Policy hbar,  out Elm.Scroller.Policy vbar) {
                                           elm_interface_scrollable_policy_get(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  out hbar,  out vbar);
      Eina.Error.RaiseIfUnhandledException();
                               }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_policy_set(System.IntPtr obj,   Elm.Scroller.Policy hbar,   Elm.Scroller.Policy vbar);
   /// <summary>Scrollbar visibility policy
   /// #ELM_SCROLLER_POLICY_AUTO means the scrollbar is made visible if it is needed, and otherwise kept hidden. #ELM_SCROLLER_POLICY_ON turns it on all the time, and #ELM_SCROLLER_POLICY_OFF always keeps it off. This applies respectively for the horizontal and vertical scrollbars.</summary>
   /// <param name="hbar">Horizontal scrollbar policy</param>
   /// <param name="vbar">Vertical scrollbar policy</param>
   ...
   public  void SetPolicy( Elm.Scroller.Policy hbar,  Elm.Scroller.Policy vbar) {
                                           elm_interface_scrollable_policy_set(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  hbar,  vbar);
      Eina.Error.RaiseIfUnhandledException();
                               }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_content_region_get(System.IntPtr obj,   out  int x,   out  int y,   out  int w,   out  int h);
   /// <summary>Currently visible content region
   /// This gets the current region in the content object that is visible through the scroller. The region co-ordinates are returned in the <c>x</c>, <c>y</c>, <c>w</c>, <c>h</c> values pointed to.
   /// 
   /// Note: All coordinates are relative to the content.
   ...
   public  void GetContentRegion( out  int x,  out  int y,  out  int w,  out  int h) {
                                                                               elm_interface_scrollable_content_region_get(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  out x,  out y,  out w,  out h);
      Eina.Error.RaiseIfUnhandledException();
                                                       }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_content_region_set(System.IntPtr obj,    int x,    int y,    int w,    int h);
   /// <summary>Currently visible content region
   /// This gets the current region in the content object that is visible through the scroller. The region co-ordinates are returned in the <c>x</c>, <c>y</c>, <c>w</c>, <c>h</c> values pointed to.
   /// 
   /// Note: All coordinates are relative to the content.
   ...
   public  void SetContentRegion(  int x,   int y,   int w,   int h) {
                                                                               elm_interface_scrollable_content_region_set(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  x,  y,  w,  h);
      Eina.Error.RaiseIfUnhandledException();
                                                       }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    [return: MarshalAs(UnmanagedType.U1)] private static extern bool elm_interface_scrollable_content_events_get(System.IntPtr obj);
   /// <summary>It decides whether the scrollable object propagates the events to content object or not.</summary>
   /// <returns><c>true</c> if events are propagated, <c>false</c> otherwise</returns>
   public bool GetContentEvents() {
       var _ret_var = elm_interface_scrollable_content_events_get(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get());
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_content_events_set(System.IntPtr obj,  [MarshalAs(UnmanagedType.U1)]  bool repeat_events);
   /// <summary>It decides whether the scrollable object propagates the events to content object or not.</summary>
   /// <param name="repeat_events"><c>true</c> if events are propagated, <c>false</c> otherwise</param>
   /// <returns></returns>
   public  void SetContentEvents( bool repeat_events) {
                         elm_interface_scrollable_content_events_set(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  repeat_events);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_page_size_get(System.IntPtr obj,   out  int x,   out  int y);
   /// <summary>Scroll page size relative to viewport size.
   /// The scroller is capable of limiting scrolling by the user to &quot;pages&quot;. That is to jump by and only show a &quot;whole page&quot; at a time as if the continuous area of the scroller content is split into page sized pieces. This sets the size of a page relative to the viewport of the scroller. 1.0 is &quot;1 viewport&quot; is size (horizontally or vertically). 0.0 turns it off in that axis. This is mutually exclusive with page size (see <see cref="Elm.InterfaceScrollable.GetPageSize"/> for more information). Likewise 0.5 is &quot;half a viewport&quot;. Sane usable values are normally between 0.0 and 1.0 including 1.0. If you only want 1 axis to be page &quot;limited&quot;, use 0.0 for the other axis.</summary>
   /// <param name="x">The horizontal page relative size</param>
   /// <param name="y">The vertical page relative size</param>
   ...
   public  void GetPageSize( out  int x,  out  int y) {
                                           elm_interface_scrollable_page_size_get(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  out x,  out y);
      Eina.Error.RaiseIfUnhandledException();
                               }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_page_size_set(System.IntPtr obj,    int x,    int y);
   /// <summary>Scroll page size relative to viewport size.
   /// The scroller is capable of limiting scrolling by the user to &quot;pages&quot;. That is to jump by and only show a &quot;whole page&quot; at a time as if the continuous area of the scroller content is split into page sized pieces. This sets the size of a page relative to the viewport of the scroller. 1.0 is &quot;1 viewport&quot; is size (horizontally or vertically). 0.0 turns it off in that axis. This is mutually exclusive with page size (see <see cref="Elm.InterfaceScrollable.GetPageSize"/> for more information). Likewise 0.5 is &quot;half a viewport&quot;. Sane usable values are normally between 0.0 and 1.0 including 1.0. If you only want 1 axis to be page &quot;limited&quot;, use 0.0 for the other axis.</summary>
   /// <param name="x">The horizontal page relative size</param>
   /// <param name="y">The vertical page relative size</param>
   ...
   public  void SetPageSize(  int x,   int y) {
                                           elm_interface_scrollable_page_size_set(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  x,  y);
      Eina.Error.RaiseIfUnhandledException();
                               }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    [return: MarshalAs(UnmanagedType.U1)] private static extern bool elm_interface_scrollable_bounce_animator_disabled_get(System.IntPtr obj);
   /// <summary>Bounce animator</summary>
   /// <returns><c>true</c> if bounce animation is disabled, <c>false</c> otherwise</returns>
   public bool GetBounceAnimatorDisabled() {
       var _ret_var = elm_interface_scrollable_bounce_animator_disabled_get(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get());
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_bounce_animator_disabled_set(System.IntPtr obj,  [MarshalAs(UnmanagedType.U1)]  bool disabled);
   /// <summary>Bounce animator</summary>
   /// <param name="disabled"><c>true</c> if bounce animation is disabled, <c>false</c> otherwise</param>
   /// <returns></returns>
   public  void SetBounceAnimatorDisabled( bool disabled) {
                         elm_interface_scrollable_bounce_animator_disabled_set(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  disabled);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_page_scroll_limit_get(System.IntPtr obj,   out  int page_limit_h,   out  int page_limit_v);
   /// <summary>Page scroll limit</summary>
   /// <param name="page_limit_h">Page limit horizontal</param>
   /// <param name="page_limit_v">Page limit vertical</param>
   /// <returns></returns>
   public  void GetPageScrollLimit( out  int page_limit_h,  out  int page_limit_v) {
                                           elm_interface_scrollable_page_scroll_limit_get(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  out page_limit_h,  out page_limit_v);
      Eina.Error.RaiseIfUnhandledException();
                               }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_page_scroll_limit_set(System.IntPtr obj,    int page_limit_h,    int page_limit_v);
   /// <summary>Page scroll limit</summary>
   /// <param name="page_limit_h">Page limit horizontal</param>
   /// <param name="page_limit_v">Page limit vertical</param>
   /// <returns></returns>
   public  void SetPageScrollLimit(  int page_limit_h,   int page_limit_v) {
                                           elm_interface_scrollable_page_scroll_limit_set(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  page_limit_h,  page_limit_v);
      Eina.Error.RaiseIfUnhandledException();
                               }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_page_snap_allow_get(System.IntPtr obj,  [MarshalAs(UnmanagedType.U1)]  out bool horiz,  [MarshalAs(UnmanagedType.U1)]  out bool vert);
   /// <summary>Page snapping behavior
   /// When scrolling, if a scroller is paged (see elm_scroller_page_size_set() and elm_scroller_page_relative_set()), the scroller may snap to pages when being scrolled, i.e., even if it had momentum to scroll further, it will stop at the next page boundaries. This is disabled, by default, for both axis. This function will set if it that is enabled or not, for each axis.
   /// 
   /// Note: If <c>obj</c> is not set to have pages, nothing will happen after this call.
   ...
   public  void GetPageSnapAllow( out bool horiz,  out bool vert) {
                                           elm_interface_scrollable_page_snap_allow_get(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  out horiz,  out vert);
      Eina.Error.RaiseIfUnhandledException();
                               }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_page_snap_allow_set(System.IntPtr obj,  [MarshalAs(UnmanagedType.U1)]  bool horiz,  [MarshalAs(UnmanagedType.U1)]  bool vert);
   /// <summary>Page snapping behavior
   /// When scrolling, if a scroller is paged (see elm_scroller_page_size_set() and elm_scroller_page_relative_set()), the scroller may snap to pages when being scrolled, i.e., even if it had momentum to scroll further, it will stop at the next page boundaries. This is disabled, by default, for both axis. This function will set if it that is enabled or not, for each axis.
   /// 
   /// Note: If <c>obj</c> is not set to have pages, nothing will happen after this call.
   ...
   public  void SetPageSnapAllow( bool horiz,  bool vert) {
                                           elm_interface_scrollable_page_snap_allow_set(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  horiz,  vert);
      Eina.Error.RaiseIfUnhandledException();
                               }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_paging_get(System.IntPtr obj,   out double pagerel_h,   out double pagerel_v,   out  int pagesize_h,   out  int pagesize_v);
   /// <summary>Pagin property</summary>
   /// <param name="pagerel_h">Page relation horizontal</param>
   /// <param name="pagerel_v">Page relation vertical</param>
   /// <param name="pagesize_h">Page size horizontal</param>
   ...
   public  void GetPaging( out double pagerel_h,  out double pagerel_v,  out  int pagesize_h,  out  int pagesize_v) {
                                                                               elm_interface_scrollable_paging_get(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  out pagerel_h,  out pagerel_v,  out pagesize_h,  out pagesize_v);
      Eina.Error.RaiseIfUnhandledException();
                                                       }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_paging_set(System.IntPtr obj,   double pagerel_h,   double pagerel_v,    int pagesize_h,    int pagesize_v);
   /// <summary>Pagin property</summary>
   /// <param name="pagerel_h">Page relation horizontal</param>
   /// <param name="pagerel_v">Page relation vertical</param>
   /// <param name="pagesize_h">Page size horizontal</param>
   ...
   public  void SetPaging( double pagerel_h,  double pagerel_v,   int pagesize_h,   int pagesize_v) {
                                                                               elm_interface_scrollable_paging_set(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  pagerel_h,  pagerel_v,  pagesize_h,  pagesize_v);
      Eina.Error.RaiseIfUnhandledException();
                                                       }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern Elm.Scroller.SingleDirection elm_interface_scrollable_single_direction_get(System.IntPtr obj);
   /// <summary>Single direction scroll configuration
   /// This makes it possible to restrict scrolling to a single direction, with a &quot;soft&quot; or &quot;hard&quot; behavior.
   /// 
   /// The hard behavior restricts the scrolling to a single direction all of the time while the soft one will restrict depending on factors such as the movement angle. If the user scrolls roughly in one direction only, it will only move according to it while if the move was clearly wanted on both axes, it will happen on both of them.
   ...
   public Elm.Scroller.SingleDirection GetSingleDirection() {
       var _ret_var = elm_interface_scrollable_single_direction_get(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get());
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_single_direction_set(System.IntPtr obj,   Elm.Scroller.SingleDirection single_dir);
   /// <summary>Single direction scroll configuration
   /// This makes it possible to restrict scrolling to a single direction, with a &quot;soft&quot; or &quot;hard&quot; behavior.
   /// 
   /// The hard behavior restricts the scrolling to a single direction all of the time while the soft one will restrict depending on factors such as the movement angle. If the user scrolls roughly in one direction only, it will only move according to it while if the move was clearly wanted on both axes, it will happen on both of them.
   ...
   public  void SetSingleDirection( Elm.Scroller.SingleDirection single_dir) {
                         elm_interface_scrollable_single_direction_set(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  single_dir);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_step_size_get(System.IntPtr obj,   out  int x,   out  int y);
   /// <summary>Step size</summary>
   /// <param name="x">X coordinate</param>
   /// <param name="y">Y coordinate</param>
   /// <returns></returns>
   public  void GetStepSize( out  int x,  out  int y) {
                                           elm_interface_scrollable_step_size_get(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  out x,  out y);
      Eina.Error.RaiseIfUnhandledException();
                               }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_step_size_set(System.IntPtr obj,    int x,    int y);
   /// <summary>Step size</summary>
   /// <param name="x">X coordinate</param>
   /// <param name="y">Y coordinate</param>
   /// <returns></returns>
   public  void SetStepSize(  int x,   int y) {
                                           elm_interface_scrollable_step_size_set(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  x,  y);
      Eina.Error.RaiseIfUnhandledException();
                               }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_content_loop_get(System.IntPtr obj,  [MarshalAs(UnmanagedType.U1)]  out bool loop_h,  [MarshalAs(UnmanagedType.U1)]  out bool loop_v);
   /// <summary>Controls an infinite loop for a scroller.
   /// 1.14</summary>
   /// <param name="loop_h">The scrolling horizontal loop</param>
   /// <param name="loop_v">The scrolling vertical loop</param>
   ...
   public  void GetContentLoop( out bool loop_h,  out bool loop_v) {
                                           elm_interface_scrollable_content_loop_get(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  out loop_h,  out loop_v);
      Eina.Error.RaiseIfUnhandledException();
                               }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_content_loop_set(System.IntPtr obj,  [MarshalAs(UnmanagedType.U1)]  bool loop_h,  [MarshalAs(UnmanagedType.U1)]  bool loop_v);
   /// <summary>Controls an infinite loop for a scroller.
   /// 1.14</summary>
   /// <param name="loop_h">The scrolling horizontal loop</param>
   /// <param name="loop_v">The scrolling vertical loop</param>
   ...
   public  void SetContentLoop( bool loop_h,  bool loop_v) {
                                           elm_interface_scrollable_content_loop_set(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  loop_h,  loop_v);
      Eina.Error.RaiseIfUnhandledException();
                               }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_scroll_up_cb_set(System.IntPtr obj,   ElmInterfaceScrollableCb scroll_up_cb);
   /// <summary>Set the callback to run when the content has been moved up.</summary>
   /// <param name="scroll_up_cb">The callback</param>
   /// <returns></returns>
   public  void SetScrollUpCb( ElmInterfaceScrollableCb scroll_up_cb) {
                         elm_interface_scrollable_scroll_up_cb_set(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  scroll_up_cb);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_hbar_drag_cb_set(System.IntPtr obj,   ElmInterfaceScrollableCb hbar_drag_cb);
   /// <summary>Set the callback to run when the horizontal scrollbar is dragged.</summary>
   /// <param name="hbar_drag_cb">The callback</param>
   /// <returns></returns>
   public  void SetHbarDragCb( ElmInterfaceScrollableCb hbar_drag_cb) {
                         elm_interface_scrollable_hbar_drag_cb_set(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  hbar_drag_cb);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_drag_start_cb_set(System.IntPtr obj,   ElmInterfaceScrollableCb drag_start_cb);
   /// <summary>Set the callback to run when dragging of the contents has started.</summary>
   /// <param name="drag_start_cb">The callback</param>
   /// <returns></returns>
   public  void SetDragStartCb( ElmInterfaceScrollableCb drag_start_cb) {
                         elm_interface_scrollable_drag_start_cb_set(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  drag_start_cb);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_freeze_set(System.IntPtr obj,  [MarshalAs(UnmanagedType.U1)]  bool freeze);
   /// <summary>Freeze property</summary>
   /// <param name="freeze"><c>true</c> if freeze, <c>false</c> otherwise</param>
   /// <returns></returns>
   public  void SetFreeze( bool freeze) {
                         elm_interface_scrollable_freeze_set(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  freeze);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_content_viewport_resize_cb_set(System.IntPtr obj,   ElmInterfaceScrollableResizeCb viewport_resize_cb);
   /// <summary>When the viewport is resized, the callback is called.</summary>
   /// <param name="viewport_resize_cb">The callback</param>
   /// <returns></returns>
   public  void SetContentViewportResizeCb( ElmInterfaceScrollableResizeCb viewport_resize_cb) {
                         elm_interface_scrollable_content_viewport_resize_cb_set(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  viewport_resize_cb);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_scroll_left_cb_set(System.IntPtr obj,   ElmInterfaceScrollableCb scroll_left_cb);
   /// <summary>Set the callback to run when the content has been moved to the left</summary>
   /// <param name="scroll_left_cb">The callback</param>
   /// <returns></returns>
   public  void SetScrollLeftCb( ElmInterfaceScrollableCb scroll_left_cb) {
                         elm_interface_scrollable_scroll_left_cb_set(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  scroll_left_cb);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_vbar_press_cb_set(System.IntPtr obj,   ElmInterfaceScrollableCb vbar_press_cb);
   /// <summary>Set the callback to run when the vertical scrollbar is pressed.</summary>
   /// <param name="vbar_press_cb">The callback</param>
   /// <returns></returns>
   public  void SetVbarPressCb( ElmInterfaceScrollableCb vbar_press_cb) {
                         elm_interface_scrollable_vbar_press_cb_set(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  vbar_press_cb);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_hbar_press_cb_set(System.IntPtr obj,   ElmInterfaceScrollableCb hbar_press_cb);
   /// <summary>Set the callback to run when the horizontal scrollbar is pressed.</summary>
   /// <param name="hbar_press_cb">The callback</param>
   /// <returns></returns>
   public  void SetHbarPressCb( ElmInterfaceScrollableCb hbar_press_cb) {
                         elm_interface_scrollable_hbar_press_cb_set(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  hbar_press_cb);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_hbar_unpress_cb_set(System.IntPtr obj,   ElmInterfaceScrollableCb hbar_unpress_cb);
   /// <summary>Set the callback to run when the horizontal scrollbar is unpressed.</summary>
   /// <param name="hbar_unpress_cb">The callback</param>
   /// <returns></returns>
   public  void SetHbarUnpressCb( ElmInterfaceScrollableCb hbar_unpress_cb) {
                         elm_interface_scrollable_hbar_unpress_cb_set(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  hbar_unpress_cb);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_drag_stop_cb_set(System.IntPtr obj,   ElmInterfaceScrollableCb drag_stop_cb);
   /// <summary>Set the callback to run when dragging of the contents has stopped.</summary>
   /// <param name="drag_stop_cb">The callback</param>
   /// <returns></returns>
   public  void SetDragStopCb( ElmInterfaceScrollableCb drag_stop_cb) {
                         elm_interface_scrollable_drag_stop_cb_set(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  drag_stop_cb);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_extern_pan_set(System.IntPtr obj, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Efl.Eo.MarshalTest<Efl.Canvas.Object, Efl.Eo.NonOwnTag>))]  Efl.Canvas.Object pan);
   /// <summary>Extern pan</summary>
   /// <param name="pan">Pan object</param>
   /// <returns></returns>
   public  void SetExternPan( Efl.Canvas.Object pan) {
                         elm_interface_scrollable_extern_pan_set(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  pan);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_page_change_cb_set(System.IntPtr obj,   ElmInterfaceScrollableCb page_change_cb);
   /// <summary>Set the callback to run when the visible page changes.</summary>
   /// <param name="page_change_cb">The callback</param>
   /// <returns></returns>
   public  void SetPageChangeCb( ElmInterfaceScrollableCb page_change_cb) {
                         elm_interface_scrollable_page_change_cb_set(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  page_change_cb);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_hold_set(System.IntPtr obj,  [MarshalAs(UnmanagedType.U1)]  bool hold);
   /// <summary>Hold property</summary>
   /// <param name="hold"><c>true</c> if hold, <c>false</c> otherwise</param>
   /// <returns></returns>
   public  void SetHold( bool hold) {
                         elm_interface_scrollable_hold_set(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  hold);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_animate_start_cb_set(System.IntPtr obj,   ElmInterfaceScrollableCb animate_start_cb);
   /// <summary>Set the callback to run when the scrolling animation has started.</summary>
   /// <param name="animate_start_cb">The callback</param>
   /// <returns></returns>
   public  void SetAnimateStartCb( ElmInterfaceScrollableCb animate_start_cb) {
                         elm_interface_scrollable_animate_start_cb_set(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  animate_start_cb);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_scroll_down_cb_set(System.IntPtr obj,   ElmInterfaceScrollableCb scroll_down_cb);
   /// <summary>Set the callback to run when the content has been moved down.</summary>
   /// <param name="scroll_down_cb">The callback</param>
   /// <returns></returns>
   public  void SetScrollDownCb( ElmInterfaceScrollableCb scroll_down_cb) {
                         elm_interface_scrollable_scroll_down_cb_set(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  scroll_down_cb);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_page_relative_set(System.IntPtr obj,   double h_pagerel,   double v_pagerel);
   /// <summary>Set scroll page size relative to viewport size.</summary>
   /// <param name="h_pagerel">Page relation horizontal</param>
   /// <param name="v_pagerel">Page relation vertical</param>
   /// <returns></returns>
   public  void SetPageRelative( double h_pagerel,  double v_pagerel) {
                                           elm_interface_scrollable_page_relative_set(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  h_pagerel,  v_pagerel);
      Eina.Error.RaiseIfUnhandledException();
                               }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_scroll_cb_set(System.IntPtr obj,   ElmInterfaceScrollableCb scroll_cb);
   /// <summary>Set the callback to run when the content has been moved.</summary>
   /// <param name="scroll_cb">The callback</param>
   /// <returns></returns>
   public  void SetScrollCb( ElmInterfaceScrollableCb scroll_cb) {
                         elm_interface_scrollable_scroll_cb_set(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  scroll_cb);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_animate_stop_cb_set(System.IntPtr obj,   ElmInterfaceScrollableCb animate_stop_cb);
   /// <summary>Set the callback to run when the scrolling animation has stopped.</summary>
   /// <param name="animate_stop_cb">The callback</param>
   /// <returns></returns>
   public  void SetAnimateStopCb( ElmInterfaceScrollableCb animate_stop_cb) {
                         elm_interface_scrollable_animate_stop_cb_set(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  animate_stop_cb);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_content_min_limit_cb_set(System.IntPtr obj,   ElmInterfaceScrollableMinLimitCb min_limit_cb);
   /// <summary>set the callback to run on minimal limit content</summary>
   /// <param name="min_limit_cb">The callback</param>
   /// <returns></returns>
   public  void SetContentMinLimitCb( ElmInterfaceScrollableMinLimitCb min_limit_cb) {
                         elm_interface_scrollable_content_min_limit_cb_set(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  min_limit_cb);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_scroll_right_cb_set(System.IntPtr obj,   ElmInterfaceScrollableCb scroll_right_cb);
   /// <summary>Set the callback to run when the content has been moved to the right.</summary>
   /// <param name="scroll_right_cb">The callback</param>
   /// <returns></returns>
   public  void SetScrollRightCb( ElmInterfaceScrollableCb scroll_right_cb) {
                         elm_interface_scrollable_scroll_right_cb_set(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  scroll_right_cb);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_content_set(System.IntPtr obj, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Efl.Eo.MarshalTest<Efl.Canvas.Object, Efl.Eo.NonOwnTag>))]  Efl.Canvas.Object content);
   /// <summary>Content property</summary>
   /// <param name="content">Content object</param>
   /// <returns></returns>
   public  void SetScrollableContent( Efl.Canvas.Object content) {
                         elm_interface_scrollable_content_set(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  content);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_edge_left_cb_set(System.IntPtr obj,   ElmInterfaceScrollableCb edge_left_cb);
   /// <summary>Set the callback to run when the left edge of the content has been reached.</summary>
   /// <param name="edge_left_cb">The callback</param>
   /// <returns></returns>
   public  void SetEdgeLeftCb( ElmInterfaceScrollableCb edge_left_cb) {
                         elm_interface_scrollable_edge_left_cb_set(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  edge_left_cb);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_vbar_drag_cb_set(System.IntPtr obj,   ElmInterfaceScrollableCb vbar_drag_cb);
   /// <summary>Set the callback to run when the horizontal scrollbar is dragged.</summary>
   /// <param name="vbar_drag_cb">The callback</param>
   /// <returns></returns>
   public  void SetVbarDragCb( ElmInterfaceScrollableCb vbar_drag_cb) {
                         elm_interface_scrollable_vbar_drag_cb_set(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  vbar_drag_cb);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_vbar_unpress_cb_set(System.IntPtr obj,   ElmInterfaceScrollableCb vbar_unpress_cb);
   /// <summary>Set the callback to run when the horizontal scrollbar is unpressed.</summary>
   /// <param name="vbar_unpress_cb">The callback</param>
   /// <returns></returns>
   public  void SetVbarUnpressCb( ElmInterfaceScrollableCb vbar_unpress_cb) {
                         elm_interface_scrollable_vbar_unpress_cb_set(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  vbar_unpress_cb);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_edge_bottom_cb_set(System.IntPtr obj,   ElmInterfaceScrollableCb edge_bottom_cb);
   /// <summary>Set the callback to run when the bottom edge of the content has been reached.</summary>
   /// <param name="edge_bottom_cb">The callback</param>
   /// <returns></returns>
   public  void SetEdgeBottomCb( ElmInterfaceScrollableCb edge_bottom_cb) {
                         elm_interface_scrollable_edge_bottom_cb_set(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  edge_bottom_cb);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_edge_right_cb_set(System.IntPtr obj,   ElmInterfaceScrollableCb edge_right_cb);
   /// <summary>Set the callback to run when the right edge of the content has been reached.</summary>
   /// <param name="edge_right_cb">The callback</param>
   /// <returns></returns>
   public  void SetEdgeRightCb( ElmInterfaceScrollableCb edge_right_cb) {
                         elm_interface_scrollable_edge_right_cb_set(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  edge_right_cb);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_edge_top_cb_set(System.IntPtr obj,   ElmInterfaceScrollableCb edge_top_cb);
   /// <summary>Set the callback to run when the top edge of the content has been reached.</summary>
   /// <param name="edge_top_cb">The callback</param>
   /// <returns></returns>
   public  void SetEdgeTopCb( ElmInterfaceScrollableCb edge_top_cb) {
                         elm_interface_scrollable_edge_top_cb_set(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  edge_top_cb);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_objects_set(System.IntPtr obj, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Efl.Eo.MarshalTest<Efl.Canvas.Object, Efl.Eo.NonOwnTag>))]  Efl.Canvas.Object edje_object, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Efl.Eo.MarshalTest<Efl.Canvas.Object, Efl.Eo.NonOwnTag>))]  Efl.Canvas.Object hit_rectangle);
   /// <summary>Object property</summary>
   /// <param name="edje_object">Edje object</param>
   /// <param name="hit_rectangle">Evas object</param>
   /// <returns></returns>
   public  void SetObjects( Efl.Canvas.Object edje_object,  Efl.Canvas.Object hit_rectangle) {
                                           elm_interface_scrollable_objects_set(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  edje_object,  hit_rectangle);
      Eina.Error.RaiseIfUnhandledException();
                               }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_last_page_get(System.IntPtr obj,   out  int pagenumber_h,   out  int pagenumber_v);
   /// <summary>Get scroll last page number.
   /// The page number starts from 0. 0 is the first page. This returns the last page number among the pages.
   /// 
   /// See: <see cref="Elm.InterfaceScrollable.GetCurrentPage"/>, <see cref="Elm.InterfaceScrollable.ShowPage"/> and <see cref="Elm.InterfaceScrollable.PageBringIn"/>.</summary>
   ...
   public  void GetLastPage( out  int pagenumber_h,  out  int pagenumber_v) {
                                           elm_interface_scrollable_last_page_get(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  out pagenumber_h,  out pagenumber_v);
      Eina.Error.RaiseIfUnhandledException();
                               }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_current_page_get(System.IntPtr obj,   out  int pagenumber_h,   out  int pagenumber_v);
   /// <summary>Get scroll current page number.
   /// The page number starts from 0. 0 is the first page. Current page means the page which meets the top-left of the viewport. If there are two or more pages in the viewport, it returns the number of the page which meets the top-left of the viewport.
   /// 
   /// See: <see cref="Elm.InterfaceScrollable.GetLastPage"/>, <see cref="Elm.InterfaceScrollable.ShowPage"/> and <see cref="Elm.InterfaceScrollable.PageBringIn"/>.</summary>
   ...
   public  void GetCurrentPage( out  int pagenumber_h,  out  int pagenumber_v) {
                                           elm_interface_scrollable_current_page_get(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  out pagenumber_h,  out pagenumber_v);
      Eina.Error.RaiseIfUnhandledException();
                               }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_content_viewport_geometry_get(System.IntPtr obj,   out  int x,   out  int y,   out  int w,   out  int h);
   /// <summary>Content viewport geometry</summary>
   /// <param name="x">X coordinate</param>
   /// <param name="y">Y coordinate</param>
   /// <param name="w">Width</param>
   ...
   public  void GetContentViewportGeometry( out  int x,  out  int y,  out  int w,  out  int h) {
                                                                               elm_interface_scrollable_content_viewport_geometry_get(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  out x,  out y,  out w,  out h);
      Eina.Error.RaiseIfUnhandledException();
                                                       }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_content_size_get(System.IntPtr obj,   out  int w,   out  int h);
   /// <summary>Get the size of the content object
   /// This gets the size of the content object of the scroller.</summary>
   /// <param name="w">Width of the content object.</param>
   /// <param name="h">Height of the content object.</param>
   ...
   public  void GetContentSize( out  int w,  out  int h) {
                                           elm_interface_scrollable_content_size_get(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  out w,  out h);
      Eina.Error.RaiseIfUnhandledException();
                               }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    [return: MarshalAs(UnmanagedType.U1)] private static extern bool elm_interface_scrollable_item_loop_enabled_get(System.IntPtr obj);
   /// <summary>Whether scrolling should loop around.</summary>
   /// <returns>True to enable looping.</returns>
   public bool GetItemLoopEnabled() {
       var _ret_var = elm_interface_scrollable_item_loop_enabled_get(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get());
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_item_loop_enabled_set(System.IntPtr obj,  [MarshalAs(UnmanagedType.U1)]  bool enable);
   /// <summary>Whether scrolling should loop around.</summary>
   /// <param name="enable">True to enable looping.</param>
   /// <returns></returns>
   public  void SetItemLoopEnabled( bool enable) {
                         elm_interface_scrollable_item_loop_enabled_set(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  enable);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_content_pos_set(System.IntPtr obj,    int x,    int y,  [MarshalAs(UnmanagedType.U1)]  bool sig);
   /// <summary>Set the content position</summary>
   /// <param name="x">X coordinate</param>
   /// <param name="y">Y coordinate</param>
   /// <param name="sig">Send signals to the theme corresponding to the scroll direction, or if an edge was reached.</param>
   ...
   public  void SetContentPos(  int x,   int y,  bool sig) {
                                                             elm_interface_scrollable_content_pos_set(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  x,  y,  sig);
      Eina.Error.RaiseIfUnhandledException();
                                           }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_content_pos_get(System.IntPtr obj,   out  int x,   out  int y);
   /// <summary>Get content position</summary>
   /// <param name="x">X coordinate</param>
   /// <param name="y">Y coordinate</param>
   /// <returns></returns>
   public  void GetContentPos( out  int x,  out  int y) {
                                           elm_interface_scrollable_content_pos_get(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  out x,  out y);
      Eina.Error.RaiseIfUnhandledException();
                               }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_page_show(System.IntPtr obj,    int pagenumber_h,    int pagenumber_v);
   /// <summary>Show a specific virtual region within the scroller content object by page number.
   /// 0, 0 of the indicated page is located at the top-left of the viewport. This will jump to the page directly without animation.
   /// 
   /// See <see cref="Elm.InterfaceScrollable.PageBringIn"/>.</summary>
   ...
   public  void ShowPage(  int pagenumber_h,   int pagenumber_v) {
                                           elm_interface_scrollable_page_show(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  pagenumber_h,  pagenumber_v);
      Eina.Error.RaiseIfUnhandledException();
                               }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_region_bring_in(System.IntPtr obj,    int x,    int y,    int w,    int h);
   /// <summary>Show a specific virtual region within the scroller content object.
   /// This will ensure all (or part if it does not fit) of the designated region in the virtual content object (0, 0 starting at the top-left of the virtual content object) is shown within the scroller. Unlike elm_scroller_region_show(), this allows the scroller to &quot;smoothly slide&quot; to this location (if configuration in general calls for transitions). It may not jump immediately to the new location and make take a while and show other content along the way.
   /// 
   /// See <see cref="Elm.InterfaceScrollable.ShowContentRegion"/></summary>
   ...
   public  void RegionBringIn(  int x,   int y,   int w,   int h) {
                                                                               elm_interface_scrollable_region_bring_in(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  x,  y,  w,  h);
      Eina.Error.RaiseIfUnhandledException();
                                                       }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_page_bring_in(System.IntPtr obj,    int pagenumber_h,    int pagenumber_v);
   /// <summary>Show a specific virtual region within the scroller content object by page number.
   /// 0, 0 of the indicated page is located at the top-left of the viewport. This will slide to the page with animation.
   /// 
   /// <see cref="Elm.InterfaceScrollable.ShowPage"/></summary>
   ...
   public  void PageBringIn(  int pagenumber_h,   int pagenumber_v) {
                                           elm_interface_scrollable_page_bring_in(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  pagenumber_h,  pagenumber_v);
      Eina.Error.RaiseIfUnhandledException();
                               }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_content_region_show(System.IntPtr obj,    int x,    int y,    int w,    int h);
   /// <summary>Show a specific virtual region within the scroller content object
   /// This will ensure all (or part if it does not fit) of the designated region in the virtual content object (0, 0 starting at the top-left of the virtual content object) is shown within the scroller.</summary>
   /// <param name="x">X coordinate of the region</param>
   /// <param name="y">Y coordinate of the region</param>
   ...
   public  void ShowContentRegion(  int x,   int y,   int w,   int h) {
                                                                               elm_interface_scrollable_content_region_show(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  x,  y,  w,  h);
      Eina.Error.RaiseIfUnhandledException();
                                                       }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_content_min_limit(System.IntPtr obj,  [MarshalAs(UnmanagedType.U1)]  bool w,  [MarshalAs(UnmanagedType.U1)]  bool h);
   /// <summary>Prevent the scrollable from being smaller than the minimum size of the content.
   /// By default the scroller will be as small as its design allows, irrespective of its content. This will make the scroller minimum size the right size horizontally and/or vertically to perfectly fit its content in that direction.</summary>
   /// <param name="w">Whether to limit the minimum horizontal size</param>
   /// <param name="h">Whether to limit the minimum vertical size</param>
   ...
   public  void ContentMinLimit( bool w,  bool h) {
                                           elm_interface_scrollable_content_min_limit(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  w,  h);
      Eina.Error.RaiseIfUnhandledException();
                               }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_wanted_region_set(System.IntPtr obj,    int x,    int y);
   /// <summary></summary>
   /// <param name="x"></param>
   /// <param name="y"></param>
   /// <returns></returns>
   public  void SetWantedRegion(  int x,   int y) {
                                           elm_interface_scrollable_wanted_region_set(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  x,  y);
      Eina.Error.RaiseIfUnhandledException();
                               }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void elm_interface_scrollable_custom_pan_pos_adjust(System.IntPtr obj,    System.IntPtr x,    System.IntPtr y);
   /// <summary></summary>
   /// <param name="x"></param>
   /// <param name="y"></param>
   /// <returns></returns>
   public  void CustomPanPosAdjust(  int x,   int y) {
      ...
      var _in_y = Eina.PrimitiveConversion.ManagedToPointerAlloc(y);
                              elm_interface_scrollable_custom_pan_pos_adjust(Elm.InterfaceScrollableConcrete.elm_interface_scrollable_mixin_get(),  _in_x,  _in_y);
      Eina.Error.RaiseIfUnhandledException();
                               }
   ...
   public Efl.Ui.Focus.Manager FocusManagerCreate( Efl.Ui.Focus.Object root) {
                         var _ret_var = efl_ui_widget_focus_manager_create(Efl.Ui.WidgetFocusManagerConcrete.efl_ui_widget_focus_manager_mixin_get(),  root);
      Eina.Error.RaiseIfUnhandledException();
                  return _ret_var;
 }
...
public class InterfaceScrollableConcreteNativeInherit : Efl.Eo.NativeClass{
    ...
    private static Efl.Ui.Focus.Object request_subchild(System.IntPtr obj, System.IntPtr pd,  Efl.Ui.Focus.Object child)
   {
      ...
      if(wrapper != null) {
                                    Efl.Ui.Focus.Object _ret_var = default(Efl.Ui.Focus.Object);
         try {
            _ret_var = ((InterfaceScrollableConcrete)wrapper).RequestSubchild( child);
         } catch (Exception e) {
            Eina.Log.Warning($"Callback error: {e.ToString()}");
            Eina.Error.Set(Eina.Error.UNHANDLED_EXCEPTION);
         }
