...
namespace NUILayout
{
    internal class AbsoluteBoundsPropMinMax : View, IExample
    {
        public AbsoluteBoundsPropMinMax()
        {
        ...
        public void Activate()
        {
            ...
            {
                AppBar = new AppBar() { Title = "BoundsProp Min Max", BackgroundColor = Color.White },
                Content = this,
                WidthSpecification = LayoutParamPolicies.MatchParent,
                HeightSpecification = LayoutParamPolicies.MatchParent,
