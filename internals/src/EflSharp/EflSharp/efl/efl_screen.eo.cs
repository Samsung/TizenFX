    ...
    
{
    ...
    public System.IntPtr NativeClass {
        get {
            if (((object)this).GetType() == typeof (IScreenConcrete))
                return Efl.IScreenNativeInherit.GetEflClassStatic();
            else
    ...
    public Eina.Size2D GetScreenSizeInPixels() {
         var _ret_var = Efl.IScreenNativeInherit.efl_screen_size_in_pixels_get_ptr.Value.Delegate(this.NativeHandle);
    ...
    public float GetScreenScaleFactor() {
         var _ret_var = Efl.IScreenNativeInherit.efl_screen_scale_factor_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    /// <summary>Get the rotation of the screen.
    ...
    public int GetScreenRotation() {
         var _ret_var = Efl.IScreenNativeInherit.efl_screen_rotation_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    /// <summary>Get the pixel density in DPI (Dots Per Inch) for the screen that a window is on.
    ...
    public void GetScreenDpi( out int xdpi,  out int ydpi) {
                                                         Efl.IScreenNativeInherit.efl_screen_dpi_get_ptr.Value.Delegate(this.NativeHandle, out xdpi,  out ydpi);
        Eina.Error.RaiseIfUnhandledException();
                                         }
    /// <summary>Get screen size (in pixels) for the screen.
/// Note that on some display systems this information is not available and a value of 0x0 will be returned.
...
public class IScreenNativeInherit  : Efl.Eo.NativeClass{
