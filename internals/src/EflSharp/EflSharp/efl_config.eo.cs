   ...
   
{
   ...
   public System.IntPtr NativeClass {
      get {
         if (((object)this).GetType() == typeof (ConfigConcrete))
            return Efl.ConfigConcreteNativeInherit.GetEflClassStatic();
         else
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(Eina.ValueMarshalerOwn))] private static extern  Eina.Value efl_config_get(System.IntPtr obj,  [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(Efl.Eo.StringKeepOwnershipMarshaler))]   System.String name);
   /// <summary>A generic configuration value, refered to by name.</summary>
   /// <param name="name">Configuration option name.</param>
   /// <returns>The value. It will be empty if it doesn&apos;t exist. The caller must free it after use (using <c>eina_value_free</c>() in C).</returns>
   public  Eina.Value GetConfig(  System.String name) {
                         var _ret_var = efl_config_get(Efl.ConfigConcrete.efl_config_interface_get(),  name);
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    [return: MarshalAs(UnmanagedType.U1)] private static extern bool efl_config_set(System.IntPtr obj,  [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(Efl.Eo.StringKeepOwnershipMarshaler))]   System.String name,  [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(Eina.ValueMarshaler))]   Eina.Value value);
   /// <summary>A generic configuration value, refered to by name.</summary>
   /// <param name="name">Configuration option name.</param>
   /// <param name="value">Configuration option value. May be <c>null</c> if not found.</param>
   /// <returns><c>false</c> in case of error: value type was invalid, the config can&apos;t be changed, config does not exist...</returns>
   public bool SetConfig(  System.String name,   Eina.Value value) {
                                           var _ret_var = efl_config_set(Efl.ConfigConcrete.efl_config_interface_get(),  name,  value);
      Eina.Error.RaiseIfUnhandledException();
                              return _ret_var;
 }
}
public class ConfigConcreteNativeInherit : Efl.Eo.NativeClass{
