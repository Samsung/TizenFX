...
namespace Tizen.NUI
{
    ...
    public class NativeImageQueue : NativeImageInterface
    {
        ...
        internal NativeImageQueue(IntPtr cPtr, bool cMemoryOwn) : base(Interop.NativeImageQueue.New(cPtr), cMemoryOwn)
        {
            handle = cPtr;
        }
        ...
        /// {
        ///   var buffer = queue.DequeueBuffer(ref _width,ref _height,_stride);
        ///   /* use buffer */
