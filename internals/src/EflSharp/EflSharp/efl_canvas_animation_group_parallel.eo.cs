...
public class AnimationGroupParallel : Efl.Canvas.AnimationGroup, Efl.Eo.IWrapper
{
   ...
   public new delegate void ConstructingMethod(AnimationGroupParallel obj);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Evas)] internal static extern System.IntPtr
      efl_canvas_animation_group_parallel_class_get();
   ///<summary>Creates a new instance.</summary>
   ///<param name="parent">Parent instance.</param>
   ///<param name="init_cb">Delegate to call constructing methods that should be run inside the constructor.</param>
   public AnimationGroupParallel(Efl.Object parent = null, ConstructingMethod init_cb=null) : base("AnimationGroupParallel", efl_canvas_animation_group_parallel_class_get(), typeof(AnimationGroupParallel), parent)
   {
      if (init_cb != null) {
         init_cb(this);
      }
   ...
   protected AnimationGroupParallel(String klass_name, IntPtr base_klass, System.Type managed_type, Efl.Object parent) : base(klass_name, base_klass, managed_type, parent) {}
