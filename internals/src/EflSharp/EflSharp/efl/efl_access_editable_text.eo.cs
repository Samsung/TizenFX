    ...
    
{
    ...
    public System.IntPtr NativeClass {
        get {
            if (((object)this).GetType() == typeof (ITextConcrete))
                return Efl.Access.Editable.ITextNativeInherit.GetEflClassStatic();
            else
    ...
    public bool SetTextContent( System.String kw_string) {
                                 var _ret_var = Efl.Access.Editable.ITextNativeInherit.efl_access_editable_text_content_set_ptr.Value.Delegate(this.NativeHandle, kw_string);
    ...
    public bool Insert( System.String kw_string,  int position) {
                                                         var _ret_var = Efl.Access.Editable.ITextNativeInherit.efl_access_editable_text_insert_ptr.Value.Delegate(this.NativeHandle, kw_string,  position);
        Eina.Error.RaiseIfUnhandledException();
                                        return _ret_var;
 }
    /// <summary>Copy text between start and end parameter</summary>
    ...
    public bool Copy( int start,  int end) {
                                                         var _ret_var = Efl.Access.Editable.ITextNativeInherit.efl_access_editable_text_copy_ptr.Value.Delegate(this.NativeHandle, start,  end);
        Eina.Error.RaiseIfUnhandledException();
                                        return _ret_var;
 }
    /// <summary>Cut text between start and end parameter</summary>
    ...
    public bool Cut( int start,  int end) {
                                                         var _ret_var = Efl.Access.Editable.ITextNativeInherit.efl_access_editable_text_cut_ptr.Value.Delegate(this.NativeHandle, start,  end);
        Eina.Error.RaiseIfUnhandledException();
                                        return _ret_var;
 }
    /// <summary>Delete text between start and end parameter</summary>
    ...
    public bool Delete( int start,  int end) {
                                                         var _ret_var = Efl.Access.Editable.ITextNativeInherit.efl_access_editable_text_delete_ptr.Value.Delegate(this.NativeHandle, start,  end);
        Eina.Error.RaiseIfUnhandledException();
                                        return _ret_var;
 }
    /// <summary>Paste text at given position</summary>
    ...
    public bool Paste( int position) {
                                 var _ret_var = Efl.Access.Editable.ITextNativeInherit.efl_access_editable_text_paste_ptr.Value.Delegate(this.NativeHandle, position);
        Eina.Error.RaiseIfUnhandledException();
                        return _ret_var;
 }
    /// <summary>Editable content property</summary>
