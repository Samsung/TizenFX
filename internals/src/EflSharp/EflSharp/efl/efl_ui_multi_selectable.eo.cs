    ...
    
{
    ...
    public System.IntPtr NativeClass {
        get {
            if (((object)this).GetType() == typeof (IMultiSelectableConcrete))
                return Efl.Ui.IMultiSelectableNativeInherit.GetEflClassStatic();
            else
    ...
    public Efl.Ui.SelectMode GetSelectMode() {
         var _ret_var = Efl.Ui.IMultiSelectableNativeInherit.efl_ui_select_mode_get_ptr.Value.Delegate(this.NativeHandle);
    ...
    public void SetSelectMode( Efl.Ui.SelectMode mode) {
                                 Efl.Ui.IMultiSelectableNativeInherit.efl_ui_select_mode_set_ptr.Value.Delegate(this.NativeHandle, mode);
        Eina.Error.RaiseIfUnhandledException();
                         }
    /// <summary>The mode type for children selection.</summary>
/// <value>Type of selection of children</value>
...
public class IMultiSelectableNativeInherit  : Efl.Eo.NativeClass{
