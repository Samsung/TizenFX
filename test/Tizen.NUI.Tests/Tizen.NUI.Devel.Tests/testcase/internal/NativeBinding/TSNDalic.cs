...
namespace Tizen.NUI.Devel.Tests
{
    ...
    public class InternalNDalicTest
    {
        ...
        [Property("SPEC", "Tizen.NUI.Interop.NDalic.DaliAssertMessage M")]
        [Property("SPEC_URL", "-")]
        [Property("CRITERIA", "MR")]
        [Property("AUTHOR", "guowei.wang@samsung.com")]
        public void NDalicDaliAssertMessage()
        {
            ...
            try
            {
                Interop.NDalic.DaliAssertMessage("true", " arg > 0");
            }
            catch (Exception e)
            {
        ...
        [Property("SPEC", "Tizen.NUI.Interop.NDalic.WrapInDomain M")]
        [Property("SPEC_URL", "-")]
        [Property("CRITERIA", "MR")]
        [Property("AUTHOR", "guowei.wang@samsung.com")]
        public void NDalicWrapInDomain()
        {
            ...
            var result = Interop.NDalic.WrapInDomain(0.3f, 0.0f, 1.0f);
        ...
        [Property("SPEC", "Tizen.NUI.Interop.NDalic.ShortestDistanceInDomain M")]
        [Property("SPEC_URL", "-")]
        [Property("CRITERIA", "MR")]
        [Property("AUTHOR", "guowei.wang@samsung.com")]
        public void NDalicShortestDistanceInDomain()
        {
            ...
            var result = Interop.NDalic.ShortestDistanceInDomain(0.1f, 0.3f, 0.0f, 1.0f);
            tlog.Debug(tag, "WrapInDomain : " + result);
        ...
        [Property("SPEC", "Tizen.NUI.Interop.NDalic.HasAlpha M")]
        [Property("SPEC_URL", "-")]
        [Property("CRITERIA", "MR")]
        [Property("AUTHOR", "guowei.wang@samsung.com")]
        public void NDalicHasAlpha()
        {
            ...
            var result = Interop.NDalic.HasAlpha(8);
            tlog.Debug(tag, "FIRST_VALID_PIXEL_FORMAT : " + result);
        ...
        [Property("SPEC", "Tizen.NUI.Interop.NDalic.GetBytesPerPixel M")]
        [Property("SPEC_URL", "-")]
        [Property("CRITERIA", "MR")]
        [Property("AUTHOR", "guowei.wang@samsung.com")]
        public void NDalicGetBytesPerPixel()
        {
            ...
            var result = Interop.NDalic.GetBytesPerPixel(8);
            tlog.Debug(tag, "FIRST_VALID_PIXEL_FORMAT : " + result);
        ...
        [Property("SPEC", "Tizen.NUI.Interop.NDalic.Raise M")]
        [Property("SPEC_URL", "-")]
        [Property("CRITERIA", "MR")]
        [Property("AUTHOR", "guowei.wang@samsung.com")]
        public void NDalicRaise()
        {
            ...
            using (View view = new View() { Size = new Size(100, 50) })
            {
                try
                {
                    Interop.NDalic.Raise(view.SwigCPtr);
                }
                catch (Exception e)
                {
                    tlog.Debug(tag, e.Message.ToString());
        ...
        [Property("SPEC", "Tizen.NUI.Interop.NDalic.RaiseToTop M")]
        [Property("SPEC_URL", "-")]
        [Property("CRITERIA", "MR")]
        [Property("AUTHOR", "guowei.wang@samsung.com")]
        public void NDalicRaiseToTop()
        {
            ...
            using (View view = new View() { Size = new Size(100, 50) })
            {
                try
                {
                    Interop.NDalic.RaiseToTop(view.SwigCPtr);
                }
                catch (Exception e)
                {
                    tlog.Debug(tag, e.Message.ToString());
        ...
        [Property("SPEC", "Tizen.NUI.Interop.NDalic.LowerToBottom M")]
        [Property("SPEC_URL", "-")]
        [Property("CRITERIA", "MR")]
        [Property("AUTHOR", "guowei.wang@samsung.com")]
        public void NDalicLowerToBottom()
        {
            ...
            using (View view = new View() { Size = new Size(100, 50) })
            {
                try
                {
                    Interop.NDalic.LowerToBottom(view.SwigCPtr);
                }
                catch (Exception e)
                {
                    tlog.Debug(tag, e.Message.ToString());
        ...
        public void NDalicRaiseAbove()
        {
            ...
            using (View view = new View() { Size = new Size(100, 50) })
            {
                using (View target = new View() { Size = new Size(100, 50) })
                {
                    try
                    {
                        Interop.NDalic.RaiseAbove(view.SwigCPtr, target.SwigCPtr);
                        Interop.NDalic.LowerBelow(target.SwigCPtr, view.SwigCPtr);
                    }
                    catch (Exception e)
                    {
                        tlog.Debug(tag, e.Message.ToString());
        ...
        [Property("SPEC", "Tizen.NUI.Interop.NDalic.GetImplementation M")]
        [Property("SPEC_URL", "-")]
        [Property("CRITERIA", "MR")]
        [Property("AUTHOR", "guowei.wang@samsung.com")]
        public void NDalicGetImplementation()
        {
            ...
            using (View view = new View() { Size = new Size(100, 50) })
            {
                try
                {
                    Interop.NDalic.GetImplementation(view.SwigCPtr);
                }
                catch (Exception e)
                {
                    tlog.Debug(tag, e.Message.ToString());
        ...
        [Property("SPEC", "Tizen.NUI.Interop.NDalic.GetAlphaOffsetAndMask M")]
        [Property("SPEC_URL", "-")]
        [Property("CRITERIA", "MR")]
        [Property("AUTHOR", "guowei.wang@samsung.com")]
        public void NDalicGetAlphaOffsetAndMask()
        {
            ...
            try
            {
                Interop.NDalic.GetAlphaOffsetAndMask((int)PixelFormat.BGR8888, new HandleRef(IntPtr.Zero, 0), new HandleRef(IntPtr.Zero, 0));
            }
            catch (Exception e)
            {
                tlog.Debug(tag, e.Message.ToString());
        ...
        [Property("SPEC", "Tizen.NUI.Interop.NDalic.IsPowerOfTwo M")]
        [Property("SPEC_URL", "-")]
        [Property("CRITERIA", "MR")]
        [Property("AUTHOR", "guowei.wang@samsung.com")]
        public void NDalicIsPowerOfTwo()
        {
            ...
            var result = Interop.NDalic.IsPowerOfTwo(1);
        ...
        [Property("SPEC", "Tizen.NUI.Interop.NDalic.NextPowerOfTwo M")]
        [Property("SPEC_URL", "-")]
        [Property("CRITERIA", "MR")]
        [Property("AUTHOR", "guowei.wang@samsung.com")]
        public void NDalicNextPowerOfTwo()
        {
            ...
            var result = Interop.NDalic.NextPowerOfTwo(1);
        ...
        [Property("SPEC", "Tizen.NUI.Interop.NDalic.GetName M")]
        [Property("SPEC_URL", "-")]
        [Property("CRITERIA", "MR")]
        [Property("AUTHOR", "guowei.wang@samsung.com")]
        public void NDalicGetName()
        {
            ...
            var result = Interop.NDalic.GetName((int)PropertyType.Float);
        ...
        [Property("SPEC", "Tizen.NUI.Interop.NDalic.GetDeviceClass M")]
        [Property("SPEC_URL", "-")]
        [Property("CRITERIA", "MR")]
        [Property("AUTHOR", "guowei.wang@samsung.com")]
        public void NDalicGetDeviceClass()
        {
            ...
            {
                var type = Interop.NDalic.GetDeviceClass(key.SwigCPtr);
