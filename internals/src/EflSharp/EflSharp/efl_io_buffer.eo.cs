...
public class Buffer : Efl.Object, Efl.Eo.IWrapper,Efl.Io.Closer,Efl.Io.Positioner,Efl.Io.Reader,Efl.Io.Sizer,Efl.Io.Writer
{
   ...
   public new delegate void ConstructingMethod(Buffer obj);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)] internal static extern System.IntPtr
      efl_io_buffer_class_get();
   ///<summary>Creates a new instance.</summary>
   ///<param name="parent">Parent instance.</param>
   ///<param name="init_cb">Delegate to call constructing methods that should be run inside the constructor.</param>
   public Buffer(Efl.Object parent = null, ConstructingMethod init_cb=null) : base("Buffer", efl_io_buffer_class_get(), typeof(Buffer), parent)
   {
      if (init_cb != null) {
         init_cb(this);
      }
   ...
   protected Buffer(String klass_name, IntPtr base_klass, System.Type managed_type, Efl.Object parent) : base(klass_name, base_klass, managed_type, parent) {}
   ...
   public event EventHandler Position_readChangedEvt
   {
      add {
         lock (eventLock) {
            ...
            if (add_cpp_event_handler(key, this.evt_Position_readChangedEvt_delegate)) {
   ...
   public event EventHandler Position_writeChangedEvt
   {
      add {
         lock (eventLock) {
            ...
            if (add_cpp_event_handler(key, this.evt_Position_writeChangedEvt_delegate)) {
   ...
   public event EventHandler ReallocatedEvt
   {
      add {
         lock (eventLock) {
            ...
            if (add_cpp_event_handler(key, this.evt_ReallocatedEvt_delegate)) {
...
private static object Can_writeChangedEvtKey = new object();
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    protected static extern  uint efl_io_buffer_limit_get(System.IntPtr obj);
   ...
   virtual public  uint GetLimit() {
       var _ret_var = efl_io_buffer_limit_get((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    protected static extern  void efl_io_buffer_limit_set(System.IntPtr obj,    uint size);
   ...
   virtual public  void SetLimit(  uint size) {
                         efl_io_buffer_limit_set((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle),  size);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    protected static extern  ulong efl_io_buffer_position_read_get(System.IntPtr obj);
   ...
   virtual public  ulong GetPositionRead() {
       var _ret_var = efl_io_buffer_position_read_get((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    [return: MarshalAs(UnmanagedType.U1)] protected static extern bool efl_io_buffer_position_read_set(System.IntPtr obj,    ulong position);
   /// <summary>The position used by <see cref="Efl.Io.Reader.Read"/>.
   /// Note that <see cref="Efl.Io.Positioner.Seek"/> or <see cref="Efl.Io.Positioner.SetPosition"/> will affect this property and <see cref="Efl.Io.Buffer.PositionWrite"/>.
   /// 
   /// <see cref="Efl.Io.Positioner.GetPosition"/> will return the greatest of <see cref="Efl.Io.Buffer.PositionRead"/> and <see cref="Efl.Io.Buffer.PositionWrite"/>.
   ...
   virtual public bool SetPositionRead(  ulong position) {
                         var _ret_var = efl_io_buffer_position_read_set((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle),  position);
      Eina.Error.RaiseIfUnhandledException();
                  return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    protected static extern  ulong efl_io_buffer_position_write_get(System.IntPtr obj);
   ...
   virtual public  ulong GetPositionWrite() {
       var _ret_var = efl_io_buffer_position_write_get((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    [return: MarshalAs(UnmanagedType.U1)] protected static extern bool efl_io_buffer_position_write_set(System.IntPtr obj,    ulong position);
   /// <summary>The position used by <see cref="Efl.Io.Writer.Write"/>.
   /// Note that <see cref="Efl.Io.Positioner.Seek"/> or <see cref="Efl.Io.Positioner.SetPosition"/> will affect this property and <see cref="Efl.Io.Buffer.PositionRead"/>.
   /// 
   /// <see cref="Efl.Io.Positioner.GetPosition"/> will return the greatest of <see cref="Efl.Io.Buffer.PositionRead"/> and <see cref="Efl.Io.Buffer.PositionWrite"/>.
   ...
   virtual public bool SetPositionWrite(  ulong position) {
                         var _ret_var = efl_io_buffer_position_write_set((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle),  position);
      Eina.Error.RaiseIfUnhandledException();
                  return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    protected static extern Eina.Slice efl_io_buffer_slice_get(System.IntPtr obj);
   ...
   virtual public Eina.Slice GetSlice() {
       var _ret_var = efl_io_buffer_slice_get((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    protected static extern  void efl_io_buffer_preallocate(System.IntPtr obj,    uint size);
   ...
   virtual public  void Preallocate(  uint size) {
                         efl_io_buffer_preallocate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle),  size);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    protected static extern  void efl_io_buffer_adopt_readonly(System.IntPtr obj,   Eina.Slice slice);
   ...
   virtual public  void AdoptReadonly( Eina.Slice slice) {
                         efl_io_buffer_adopt_readonly((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle),  slice);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    protected static extern  void efl_io_buffer_adopt_readwrite(System.IntPtr obj,   Eina.RwSlice slice);
   ...
   virtual public  void AdoptReadwrite( Eina.RwSlice slice) {
                         efl_io_buffer_adopt_readwrite((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle),  slice);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    protected static extern  System.IntPtr efl_io_buffer_binbuf_steal(System.IntPtr obj);
   ...
   virtual public Eina.Binbuf BinbufSteal() {
       var _ret_var = efl_io_buffer_binbuf_steal((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
      Eina.Error.RaiseIfUnhandledException();
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    protected static extern  ulong efl_io_positioner_position_get(System.IntPtr obj);
   /// <summary>Position property
   /// 1.19</summary>
   /// <returns>Position in file or buffer
   /// 1.19</returns>
   virtual public  ulong GetPosition() {
       var _ret_var = efl_io_positioner_position_get((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    [return: MarshalAs(UnmanagedType.U1)] protected static extern bool efl_io_positioner_position_set(System.IntPtr obj,    ulong position);
   ...
   virtual public bool SetPosition(  ulong position) {
                         var _ret_var = efl_io_positioner_position_set((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle),  position);
      Eina.Error.RaiseIfUnhandledException();
                  return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    protected static extern  Eina.Error efl_io_positioner_seek(System.IntPtr obj,    long offset,   Efl.Io.PositionerWhence whence);
   ...
   virtual public  Eina.Error Seek(  long offset,  Efl.Io.PositionerWhence whence) {
                                           var _ret_var = efl_io_positioner_seek((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle),  offset,  whence);
      Eina.Error.RaiseIfUnhandledException();
                              return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    protected static extern  ulong efl_io_sizer_size_get(System.IntPtr obj);
   /// <summary>Size property
   /// 1.19</summary>
   /// <returns>Object size
   /// 1.19</returns>
   virtual public  ulong GetSize() {
       var _ret_var = efl_io_sizer_size_get((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    [return: MarshalAs(UnmanagedType.U1)] protected static extern bool efl_io_sizer_size_set(System.IntPtr obj,    ulong size);
   ...
   virtual public bool SetSize(  ulong size) {
                         var _ret_var = efl_io_sizer_size_set((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle),  size);
      Eina.Error.RaiseIfUnhandledException();
                  return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    protected static extern  Eina.Error efl_io_sizer_resize(System.IntPtr obj,    ulong size);
   ...
   virtual public  Eina.Error Resize(  ulong size) {
                         var _ret_var = efl_io_sizer_resize((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle),  size);
      Eina.Error.RaiseIfUnhandledException();
                  return _ret_var;
 }
...
public class BufferNativeInherit : Efl.ObjectNativeInherit{
   public override System.Collections.Generic.List<Efl_Op_Description> GetEoOps(System.Type type)
   {
      ...
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_io_buffer_limit_get"), func = Marshal.GetFunctionPointerForDelegate(efl_io_buffer_limit_get_static_delegate)});
      efl_io_buffer_limit_set_static_delegate = new efl_io_buffer_limit_set_delegate(limit_set);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_io_buffer_limit_set"), func = Marshal.GetFunctionPointerForDelegate(efl_io_buffer_limit_set_static_delegate)});
      efl_io_buffer_position_read_get_static_delegate = new efl_io_buffer_position_read_get_delegate(position_read_get);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_io_buffer_position_read_get"), func = Marshal.GetFunctionPointerForDelegate(efl_io_buffer_position_read_get_static_delegate)});
      efl_io_buffer_position_read_set_static_delegate = new efl_io_buffer_position_read_set_delegate(position_read_set);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_io_buffer_position_read_set"), func = Marshal.GetFunctionPointerForDelegate(efl_io_buffer_position_read_set_static_delegate)});
      efl_io_buffer_position_write_get_static_delegate = new efl_io_buffer_position_write_get_delegate(position_write_get);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_io_buffer_position_write_get"), func = Marshal.GetFunctionPointerForDelegate(efl_io_buffer_position_write_get_static_delegate)});
      efl_io_buffer_position_write_set_static_delegate = new efl_io_buffer_position_write_set_delegate(position_write_set);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_io_buffer_position_write_set"), func = Marshal.GetFunctionPointerForDelegate(efl_io_buffer_position_write_set_static_delegate)});
      efl_io_buffer_slice_get_static_delegate = new efl_io_buffer_slice_get_delegate(slice_get);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_io_buffer_slice_get"), func = Marshal.GetFunctionPointerForDelegate(efl_io_buffer_slice_get_static_delegate)});
      efl_io_buffer_preallocate_static_delegate = new efl_io_buffer_preallocate_delegate(preallocate);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_io_buffer_preallocate"), func = Marshal.GetFunctionPointerForDelegate(efl_io_buffer_preallocate_static_delegate)});
      efl_io_buffer_adopt_readonly_static_delegate = new efl_io_buffer_adopt_readonly_delegate(adopt_readonly);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_io_buffer_adopt_readonly"), func = Marshal.GetFunctionPointerForDelegate(efl_io_buffer_adopt_readonly_static_delegate)});
      efl_io_buffer_adopt_readwrite_static_delegate = new efl_io_buffer_adopt_readwrite_delegate(adopt_readwrite);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_io_buffer_adopt_readwrite"), func = Marshal.GetFunctionPointerForDelegate(efl_io_buffer_adopt_readwrite_static_delegate)});
      efl_io_buffer_binbuf_steal_static_delegate = new efl_io_buffer_binbuf_steal_delegate(binbuf_steal);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_io_buffer_binbuf_steal"), func = Marshal.GetFunctionPointerForDelegate(efl_io_buffer_binbuf_steal_static_delegate)});
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]  private static extern  uint efl_io_buffer_limit_get(System.IntPtr obj);
    private static  uint limit_get(System.IntPtr obj, System.IntPtr pd)
   {
      ...
      return _ret_var;
         ...
         return efl_io_buffer_limit_get(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)));
      }
   }
   private efl_io_buffer_limit_get_delegate efl_io_buffer_limit_get_static_delegate;


    private delegate  void efl_io_buffer_limit_set_delegate(System.IntPtr obj, System.IntPtr pd,    uint size);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]  private static extern  void efl_io_buffer_limit_set(System.IntPtr obj,    uint size);
    private static  void limit_set(System.IntPtr obj, System.IntPtr pd,   uint size)
   {
      ...
      if(wrapper != null) {
         ...
         efl_io_buffer_limit_set(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)),  size);
      }
   }
   private efl_io_buffer_limit_set_delegate efl_io_buffer_limit_set_static_delegate;


    private delegate  ulong efl_io_buffer_position_read_get_delegate(System.IntPtr obj, System.IntPtr pd);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]  private static extern  ulong efl_io_buffer_position_read_get(System.IntPtr obj);
    private static  ulong position_read_get(System.IntPtr obj, System.IntPtr pd)
   {
      ...
      return _ret_var;
         ...
         return efl_io_buffer_position_read_get(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)));
      }
   }
   private efl_io_buffer_position_read_get_delegate efl_io_buffer_position_read_get_static_delegate;
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]  [return: MarshalAs(UnmanagedType.U1)] private static extern bool efl_io_buffer_position_read_set(System.IntPtr obj,    ulong position);
    private static bool position_read_set(System.IntPtr obj, System.IntPtr pd,   ulong position)
   {
      ...
      if(wrapper != null) {
         ...
         return efl_io_buffer_position_read_set(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)),  position);
      }
   }
   private efl_io_buffer_position_read_set_delegate efl_io_buffer_position_read_set_static_delegate;


    private delegate  ulong efl_io_buffer_position_write_get_delegate(System.IntPtr obj, System.IntPtr pd);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]  private static extern  ulong efl_io_buffer_position_write_get(System.IntPtr obj);
    private static  ulong position_write_get(System.IntPtr obj, System.IntPtr pd)
   {
      ...
      return _ret_var;
         ...
         return efl_io_buffer_position_write_get(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)));
      }
   }
   private efl_io_buffer_position_write_get_delegate efl_io_buffer_position_write_get_static_delegate;
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]  [return: MarshalAs(UnmanagedType.U1)] private static extern bool efl_io_buffer_position_write_set(System.IntPtr obj,    ulong position);
    private static bool position_write_set(System.IntPtr obj, System.IntPtr pd,   ulong position)
   {
      ...
      if(wrapper != null) {
         ...
         return efl_io_buffer_position_write_set(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)),  position);
      }
   }
   private efl_io_buffer_position_write_set_delegate efl_io_buffer_position_write_set_static_delegate;


    private delegate Eina.Slice efl_io_buffer_slice_get_delegate(System.IntPtr obj, System.IntPtr pd);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]  private static extern Eina.Slice efl_io_buffer_slice_get(System.IntPtr obj);
    private static Eina.Slice slice_get(System.IntPtr obj, System.IntPtr pd)
   {
      ...
      return _ret_var;
         ...
         return efl_io_buffer_slice_get(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)));
      }
   }
   private efl_io_buffer_slice_get_delegate efl_io_buffer_slice_get_static_delegate;


    private delegate  void efl_io_buffer_preallocate_delegate(System.IntPtr obj, System.IntPtr pd,    uint size);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]  private static extern  void efl_io_buffer_preallocate(System.IntPtr obj,    uint size);
    private static  void preallocate(System.IntPtr obj, System.IntPtr pd,   uint size)
   {
      ...
      if(wrapper != null) {
         ...
         efl_io_buffer_preallocate(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)),  size);
      }
   }
   private efl_io_buffer_preallocate_delegate efl_io_buffer_preallocate_static_delegate;


    private delegate  void efl_io_buffer_adopt_readonly_delegate(System.IntPtr obj, System.IntPtr pd,   Eina.Slice slice);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]  private static extern  void efl_io_buffer_adopt_readonly(System.IntPtr obj,   Eina.Slice slice);
    private static  void adopt_readonly(System.IntPtr obj, System.IntPtr pd,  Eina.Slice slice)
   {
      ...
      if(wrapper != null) {
         ...
         efl_io_buffer_adopt_readonly(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)),  slice);
      }
   }
   private efl_io_buffer_adopt_readonly_delegate efl_io_buffer_adopt_readonly_static_delegate;


    private delegate  void efl_io_buffer_adopt_readwrite_delegate(System.IntPtr obj, System.IntPtr pd,   Eina.RwSlice slice);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]  private static extern  void efl_io_buffer_adopt_readwrite(System.IntPtr obj,   Eina.RwSlice slice);
    private static  void adopt_readwrite(System.IntPtr obj, System.IntPtr pd,  Eina.RwSlice slice)
   {
      ...
      if(wrapper != null) {
         ...
         efl_io_buffer_adopt_readwrite(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)),  slice);
      }
   }
   private efl_io_buffer_adopt_readwrite_delegate efl_io_buffer_adopt_readwrite_static_delegate;


    private delegate  System.IntPtr efl_io_buffer_binbuf_steal_delegate(System.IntPtr obj, System.IntPtr pd);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]  private static extern  System.IntPtr efl_io_buffer_binbuf_steal(System.IntPtr obj);
    private static  System.IntPtr binbuf_steal(System.IntPtr obj, System.IntPtr pd)
   {
      ...
      _ret_var.Own = false; return _ret_var.Handle;
         ...
         return efl_io_buffer_binbuf_steal(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)));
      }
   }
   private efl_io_buffer_binbuf_steal_delegate efl_io_buffer_binbuf_steal_static_delegate;
