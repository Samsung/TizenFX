...
public abstract class Widget : Efl.Canvas.Group, Efl.IPart, Efl.Access.IAction, Efl.Access.IComponent, Efl.Access.IObject, Efl.Access.Widget.IAction, Efl.Ui.IDnd, Efl.Ui.II18n, Efl.Ui.IL10n, Efl.Ui.IPropertyBind, Efl.Ui.ISelection, Efl.Ui.IView, Efl.Ui.Focus.IObject
{
    ...
    protected virtual Eina.Error ThemeApply() {
    ...
    public virtual void FocusCustomChainPrepend(Efl.Canvas.Object child, Efl.Canvas.Object relative_child) {
    ...
    public virtual void FocusSteal(Efl.Ui.Widget item) {
    ...
    protected virtual bool FocusStateApply(Efl.Ui.WidgetFocusState current_state, ref Efl.Ui.WidgetFocusState configured_state, Efl.Ui.Widget redirect) {
    ...
    protected virtual bool ActionDo(int id) {
    ...
    protected virtual bool GestureDo(Efl.Access.GestureInfo gesture_info) {
    ...
    public virtual void RelationshipRemove(Efl.Access.RelationType type, Efl.Access.IObject relation_object) {
    ...
    /// <param name="seat">Specified seat for multiple seats case.</param>
    public virtual void DragCancel(uint seat) {
    ...
    /// <summary>Whether the widget is currently focused or not.
    /// (Since EFL 1.22)</summary>
    ...
    /// <summary>This is the focus manager where this focus object is registered in. The element which is the <c>root</c> of an <see cref="Efl.Ui.Focus.IManager"/> will not have this focus manager as this object, but rather the focus manager where that is registered in.
    /// (Since EFL 1.22)</summary>
    ...
    /// <summary>The logical parent used by this object.
    /// (Since EFL 1.22)</summary>
    ...
    /// <summary>Tells the object that its children will be queried soon by the focus manager. Overwrite this to have a chance to update the order of the children. Deleting items in this call will result in undefined behaviour and may cause your system to crash.
    /// (Since EFL 1.22)</summary>
