...
public class Hold : Efl.Object, Efl.Eo.IWrapper,Efl.Duplicate,Efl.Input.Event
{
   ...
   public new delegate void ConstructingMethod(Hold obj);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Evas)] internal static extern System.IntPtr
      efl_input_hold_class_get();
   ///<summary>Creates a new instance.</summary>
   ///<param name="parent">Parent instance.</param>
   ///<param name="init_cb">Delegate to call constructing methods that should be run inside the constructor.</param>
   public Hold(Efl.Object parent = null, ConstructingMethod init_cb=null) : base("Hold", efl_input_hold_class_get(), typeof(Hold), parent)
   {
      if (init_cb != null) {
         init_cb(this);
      }
   ...
   protected Hold(String klass_name, IntPtr base_klass, System.Type managed_type, Efl.Object parent) : base(klass_name, base_klass, managed_type, parent) {}
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Evas)]
    [return: MarshalAs(UnmanagedType.U1)] protected static extern bool efl_input_hold_get(System.IntPtr obj);
   ...
   virtual public bool GetHold() {
       var _ret_var = efl_input_hold_get((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Evas)]
    protected static extern  void efl_input_hold_set(System.IntPtr obj,  [MarshalAs(UnmanagedType.U1)]  bool val);
   /// <summary>Property to show if inputs are now on hold.</summary>
   /// <param name="val"><c>true</c> if inputs are on hold, <c>false</c> otherwise</param>
   /// <returns></returns>
   virtual public  void SetHold( bool val) {
                         efl_input_hold_set((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle),  val);
      Eina.Error.RaiseIfUnhandledException();
                   }
...
public class HoldNativeInherit : Efl.ObjectNativeInherit{
   public override System.Collections.Generic.List<Efl_Op_Description> GetEoOps(System.Type type)
   {
      ...
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_input_hold_get"), func = Marshal.GetFunctionPointerForDelegate(efl_input_hold_get_static_delegate)});
      efl_input_hold_set_static_delegate = new efl_input_hold_set_delegate(hold_set);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_input_hold_set"), func = Marshal.GetFunctionPointerForDelegate(efl_input_hold_set_static_delegate)});
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Evas)]  [return: MarshalAs(UnmanagedType.U1)] private static extern bool efl_input_hold_get(System.IntPtr obj);
    private static bool hold_get(System.IntPtr obj, System.IntPtr pd)
   {
      ...
      return _ret_var;
         ...
         return efl_input_hold_get(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)));
      }
   }
   private efl_input_hold_get_delegate efl_input_hold_get_static_delegate;


    private delegate  void efl_input_hold_set_delegate(System.IntPtr obj, System.IntPtr pd,  [MarshalAs(UnmanagedType.U1)]  bool val);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Evas)]  private static extern  void efl_input_hold_set(System.IntPtr obj,  [MarshalAs(UnmanagedType.U1)]  bool val);
    private static  void hold_set(System.IntPtr obj, System.IntPtr pd,  bool val)
   {
      ...
      if(wrapper != null) {
         ...
         efl_input_hold_set(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)),  val);
      }
   }
   private efl_input_hold_set_delegate efl_input_hold_set_static_delegate;
