    ...
    , Efl.Gfx.IPath
{
    ...
    public System.IntPtr NativeClass {
        get {
            if (((object)this).GetType() == typeof (IShapeConcrete))
                return Efl.Gfx.IShapeNativeInherit.GetEflClassStatic();
            else
    ...
    public double GetStrokeScale() {
         var _ret_var = Efl.Gfx.IShapeNativeInherit.efl_gfx_shape_stroke_scale_get_ptr.Value.Delegate(this.NativeHandle);
    ...
    public void SetStrokeScale( double s) {
                                 Efl.Gfx.IShapeNativeInherit.efl_gfx_shape_stroke_scale_set_ptr.Value.Delegate(this.NativeHandle, s);
        Eina.Error.RaiseIfUnhandledException();
                         }
    /// <summary>The color to be used for stroking the path.</summary>
    /// <param name="r">The red component of the given color.</param>
    ...
    public void GetStrokeColor( out int r,  out int g,  out int b,  out int a) {
                                                                                                         Efl.Gfx.IShapeNativeInherit.efl_gfx_shape_stroke_color_get_ptr.Value.Delegate(this.NativeHandle, out r,  out g,  out b,  out a);
        Eina.Error.RaiseIfUnhandledException();
                                                                         }
    /// <summary>The color to be used for stroking the path.</summary>
    /// <param name="r">The red component of the given color.</param>
    ...
    public void SetStrokeColor( int r,  int g,  int b,  int a) {
                                                                                                         Efl.Gfx.IShapeNativeInherit.efl_gfx_shape_stroke_color_set_ptr.Value.Delegate(this.NativeHandle, r,  g,  b,  a);
        Eina.Error.RaiseIfUnhandledException();
                                                                         }
    /// <summary>The stroke width to be used for stroking the path.</summary>
    /// <returns>Stroke width to be used</returns>
    public double GetStrokeWidth() {
         var _ret_var = Efl.Gfx.IShapeNativeInherit.efl_gfx_shape_stroke_width_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    /// <summary>The stroke width to be used for stroking the path.</summary>
    ...
    public void SetStrokeWidth( double w) {
                                 Efl.Gfx.IShapeNativeInherit.efl_gfx_shape_stroke_width_set_ptr.Value.Delegate(this.NativeHandle, w);
        Eina.Error.RaiseIfUnhandledException();
                         }
    /// <summary>Not implemented</summary>
    /// <returns>Centered stroke location</returns>
    public double GetStrokeLocation() {
         var _ret_var = Efl.Gfx.IShapeNativeInherit.efl_gfx_shape_stroke_location_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    /// <summary>Not implemented</summary>
    ...
    public void SetStrokeLocation( double centered) {
                                 Efl.Gfx.IShapeNativeInherit.efl_gfx_shape_stroke_location_set_ptr.Value.Delegate(this.NativeHandle, centered);
        Eina.Error.RaiseIfUnhandledException();
                         }
    /// <summary>Set stroke dash pattern. A dash pattern is specified by dashes, an array of <see cref="Efl.Gfx.Dash"/>. <see cref="Efl.Gfx.Dash"/> values(length, gap) must be positive.
    /// See also <see cref="Efl.Gfx.Dash"/></summary>
    ...
    public void GetStrokeDash( out Efl.Gfx.Dash dash,  out uint length) {
                         var _out_dash = new System.IntPtr();
                                Efl.Gfx.IShapeNativeInherit.efl_gfx_shape_stroke_dash_get_ptr.Value.Delegate(this.NativeHandle, out _out_dash,  out length);
        Eina.Error.RaiseIfUnhandledException();
    ...
    public void SetStrokeDash( ref Efl.Gfx.Dash dash,  uint length) {
         Efl.Gfx.Dash.NativeStruct _in_dash = dash;
                                                Efl.Gfx.IShapeNativeInherit.efl_gfx_shape_stroke_dash_set_ptr.Value.Delegate(this.NativeHandle, ref _in_dash,  length);
        Eina.Error.RaiseIfUnhandledException();
                        dash = _in_dash;
                 }
    /// <summary>The cap style to be used for stroking the path. The cap will be used for capping the end point of a open subpath.
    ...
    public Efl.Gfx.Cap GetStrokeCap() {
         var _ret_var = Efl.Gfx.IShapeNativeInherit.efl_gfx_shape_stroke_cap_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    /// <summary>The cap style to be used for stroking the path. The cap will be used for capping the end point of a open subpath.
    ...
    public void SetStrokeCap( Efl.Gfx.Cap c) {
                                 Efl.Gfx.IShapeNativeInherit.efl_gfx_shape_stroke_cap_set_ptr.Value.Delegate(this.NativeHandle, c);
        Eina.Error.RaiseIfUnhandledException();
                         }
    /// <summary>The join style to be used for stroking the path. The join style will be used for joining the two line segment while stroking the path.
    /// See also <see cref="Efl.Gfx.Join"/>.</summary>
    ...
    public Efl.Gfx.Join GetStrokeJoin() {
         var _ret_var = Efl.Gfx.IShapeNativeInherit.efl_gfx_shape_stroke_join_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    /// <summary>The join style to be used for stroking the path. The join style will be used for joining the two line segment while stroking the path.
    ...
    public void SetStrokeJoin( Efl.Gfx.Join j) {
                                 Efl.Gfx.IShapeNativeInherit.efl_gfx_shape_stroke_join_set_ptr.Value.Delegate(this.NativeHandle, j);
        Eina.Error.RaiseIfUnhandledException();
                         }
    /// <summary>The fill rule of the given shape object. <see cref="Efl.Gfx.FillRule.Winding"/> or <see cref="Efl.Gfx.FillRule.OddEven"/>.</summary>
    /// <returns>The current fill rule of the shape object. One of <see cref="Efl.Gfx.FillRule.Winding"/> or <see cref="Efl.Gfx.FillRule.OddEven"/></returns>
    public Efl.Gfx.FillRule GetFillRule() {
         var _ret_var = Efl.Gfx.IShapeNativeInherit.efl_gfx_shape_fill_rule_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    /// <summary>The fill rule of the given shape object. <see cref="Efl.Gfx.FillRule.Winding"/> or <see cref="Efl.Gfx.FillRule.OddEven"/>.</summary>
    ...
    public void SetFillRule( Efl.Gfx.FillRule fill_rule) {
                                 Efl.Gfx.IShapeNativeInherit.efl_gfx_shape_fill_rule_set_ptr.Value.Delegate(this.NativeHandle, fill_rule);
        Eina.Error.RaiseIfUnhandledException();
                         }
...
public class IShapeNativeInherit  : Efl.Eo.NativeClass{
