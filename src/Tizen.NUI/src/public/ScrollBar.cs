...
namespace Tizen.NUI
{
    ...
    public class ScrollBar : View
    {
        ...
        private delegate void PanFinishedEventCallback();
        private PanFinishedEventCallback _scrollBarPanFinishedEventCallback;
        private EventHandler<PanFinishedEventArgs> _scrollBarPanFinishedEventHandler;

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        private delegate void ScrollPositionIntervalReachedEventCallback();
        private ScrollPositionIntervalReachedEventCallback _scrollBarScrollPositionIntervalReachedEventCallback;
        ...
        public event EventHandler<PanFinishedEventArgs> PanFinished
        {
            add
            {
                if (_scrollBarPanFinishedEventCallback == null)
                {
                    _scrollBarPanFinishedEventCallback = OnScrollBarPanFinished;
                    PanFinishedSignal().Connect(_scrollBarPanFinishedEventCallback);
                }
            ...
            remove
            {
                if (_scrollBarPanFinishedEventCallback != null)
                {
                    PanFinishedSignal().Disconnect(_scrollBarPanFinishedEventCallback);
                }
                _scrollBarPanFinishedEventHandler -= value;
            }
        }
        ...
        public event EventHandler<ScrollPositionIntervalReachedEventArgs> ScrollPositionIntervalReached
        {
            add
            {
                ...
                {
                    _scrollBarScrollPositionIntervalReachedEventCallback = OnScrollBarScrollPositionIntervalReached;
                    ScrollPositionIntervalReachedSignal().Connect(_scrollBarScrollPositionIntervalReachedEventCallback);
                }
            ...
            remove
            {
                if (_scrollBarScrollPositionIntervalReachedEventHandler != null)
                {
                    ScrollPositionIntervalReachedSignal().Disconnect(_scrollBarScrollPositionIntervalReachedEventCallback);
                }
                _scrollBarScrollPositionIntervalReachedEventHandler -= value;
            }
        }
