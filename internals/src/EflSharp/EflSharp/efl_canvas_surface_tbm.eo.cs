...
public class SurfaceTbm : Efl.Canvas.Surface, Efl.Eo.IWrapper
{
   ...
   public new delegate void ConstructingMethod(SurfaceTbm obj);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Evas)] internal static extern System.IntPtr
      efl_canvas_surface_tbm_class_get();
   ///<summary>Creates a new instance.</summary>
   ///<param name="parent">Parent instance.</param>
   ///<param name="init_cb">Delegate to call constructing methods that should be run inside the constructor.</param>
   public SurfaceTbm(Efl.Object parent = null, ConstructingMethod init_cb=null) : base("SurfaceTbm", efl_canvas_surface_tbm_class_get(), typeof(SurfaceTbm), parent)
   {
      if (init_cb != null) {
         init_cb(this);
      }
   ...
   protected SurfaceTbm(String klass_name, IntPtr base_klass, System.Type managed_type, Efl.Object parent) : base(klass_name, base_klass, managed_type, parent) {}
