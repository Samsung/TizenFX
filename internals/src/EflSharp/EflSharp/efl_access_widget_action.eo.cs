   ...
   public System.IntPtr NativeClass {
      get {
         if (((object)this).GetType() == typeof (ActionConcrete))
            return Efl.Access.Widget.ActionConcreteNativeInherit.GetEflClassStatic();
         else
...
private static object ReadingStateChangedEvtKey = new object();
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern Efl.Access.ActionData efl_access_widget_action_elm_actions_get(System.IntPtr obj);
   /// <summary>Elementary actions</summary>
   /// <returns>NULL-terminated array of Efl.Access.Action_Data.</returns>
   public Efl.Access.ActionData GetElmActions() {
       var _ret_var = efl_access_widget_action_elm_actions_get(Efl.Access.Widget.ActionConcrete.efl_access_widget_action_mixin_get());
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
