...
private static object ChangedUserEvtKey = new object();
    ...
    public event EventHandler<Efl.Ui.TextChangedUserEvt_Args> ChangedUserEvt
    {
        add {
            lock (eventLock) {
                ...
                if (AddNativeEventHandler(efl.Libs.Elementary, key, this.evt_ChangedUserEvt_delegate)) {
        ...
        remove {
            lock (eventLock) {
                string key = "_EFL_UI_TEXT_EVENT_CHANGED_USER";
                if (RemoveNativeEventHandler(key, this.evt_ChangedUserEvt_delegate)) { 
    ...
    private void on_ChangedUserEvt_NativeCallback(System.IntPtr data, ref Efl.Event.NativeStruct evt)
    {
...
private static object ValidateEvtKey = new object();
    ...
    public event EventHandler<Efl.Ui.TextValidateEvt_Args> ValidateEvt
    {
        add {
            lock (eventLock) {
                ...
                if (AddNativeEventHandler(efl.Libs.Elementary, key, this.evt_ValidateEvt_delegate)) {
        ...
        remove {
            lock (eventLock) {
                string key = "_EFL_UI_TEXT_EVENT_VALIDATE";
                if (RemoveNativeEventHandler(key, this.evt_ValidateEvt_delegate)) { 
    ...
    private void on_ValidateEvt_NativeCallback(System.IntPtr data, ref Efl.Event.NativeStruct evt)
    {
...
private static object ContextOpenEvtKey = new object();
    ...
    private void on_ContextOpenEvt_NativeCallback(System.IntPtr data, ref Efl.Event.NativeStruct evt)
    {
        EventArgs args = EventArgs.Empty;
        try {
...
private static object PreeditChangedEvtKey = new object();
    ...
    public event EventHandler PreeditChangedEvt
    {
        add {
            lock (eventLock) {
                ...
                if (AddNativeEventHandler(efl.Libs.Elementary, key, this.evt_PreeditChangedEvt_delegate)) {
        ...
        remove {
            lock (eventLock) {
                string key = "_EFL_UI_TEXT_EVENT_PREEDIT_CHANGED";
                if (RemoveNativeEventHandler(key, this.evt_PreeditChangedEvt_delegate)) { 
    ...
    private void on_PreeditChangedEvt_NativeCallback(System.IntPtr data, ref Efl.Event.NativeStruct evt)
    {
        EventArgs args = EventArgs.Empty;
        try {
...
private static object RedoRequestEvtKey = new object();
    ...
    public event EventHandler RedoRequestEvt
    {
        add {
            lock (eventLock) {
                ...
                if (AddNativeEventHandler(efl.Libs.Elementary, key, this.evt_RedoRequestEvt_delegate)) {
        ...
        remove {
            lock (eventLock) {
                string key = "_EFL_UI_TEXT_EVENT_REDO_REQUEST";
                if (RemoveNativeEventHandler(key, this.evt_RedoRequestEvt_delegate)) { 
    ...
    private void on_RedoRequestEvt_NativeCallback(System.IntPtr data, ref Efl.Event.NativeStruct evt)
    {
        EventArgs args = EventArgs.Empty;
        try {
...
private static object UndoRequestEvtKey = new object();
    ...
    public event EventHandler UndoRequestEvt
    {
        add {
            lock (eventLock) {
                ...
                if (AddNativeEventHandler(efl.Libs.Elementary, key, this.evt_UndoRequestEvt_delegate)) {
        ...
        remove {
            lock (eventLock) {
                string key = "_EFL_UI_TEXT_EVENT_UNDO_REQUEST";
                if (RemoveNativeEventHandler(key, this.evt_UndoRequestEvt_delegate)) { 
    ...
    private void on_UndoRequestEvt_NativeCallback(System.IntPtr data, ref Efl.Event.NativeStruct evt)
    {
        EventArgs args = EventArgs.Empty;
        try {
...
private static object AbortedEvtKey = new object();
    ...
    public event EventHandler AbortedEvt
    {
        add {
            lock (eventLock) {
                ...
                if (AddNativeEventHandler(efl.Libs.Elementary, key, this.evt_AbortedEvt_delegate)) {
        ...
        remove {
            lock (eventLock) {
                string key = "_EFL_UI_TEXT_EVENT_ABORTED";
                if (RemoveNativeEventHandler(key, this.evt_AbortedEvt_delegate)) { 
    ...
    private void on_AbortedEvt_NativeCallback(System.IntPtr data, ref Efl.Event.NativeStruct evt)
    {
        EventArgs args = EventArgs.Empty;
        try {
            On_AbortedEvt(args);
...
private static object AnchorDownEvtKey = new object();
    ...
    public event EventHandler<Efl.Ui.TextAnchorDownEvt_Args> AnchorDownEvt
    {
        add {
            lock (eventLock) {
                ...
                if (AddNativeEventHandler(efl.Libs.Elementary, key, this.evt_AnchorDownEvt_delegate)) {
        ...
        remove {
            lock (eventLock) {
                string key = "_EFL_UI_TEXT_EVENT_ANCHOR_DOWN";
                if (RemoveNativeEventHandler(key, this.evt_AnchorDownEvt_delegate)) { 
    ...
    private void on_AnchorDownEvt_NativeCallback(System.IntPtr data, ref Efl.Event.NativeStruct evt)
    {
...
private static object AnchorHoverOpenedEvtKey = new object();
    ...
    public event EventHandler<Efl.Ui.TextAnchorHoverOpenedEvt_Args> AnchorHoverOpenedEvt
    {
        add {
            lock (eventLock) {
                ...
                if (AddNativeEventHandler(efl.Libs.Elementary, key, this.evt_AnchorHoverOpenedEvt_delegate)) {
        ...
        remove {
            lock (eventLock) {
                string key = "_EFL_UI_TEXT_EVENT_ANCHOR_HOVER_OPENED";
                if (RemoveNativeEventHandler(key, this.evt_AnchorHoverOpenedEvt_delegate)) { 
    ...
    private void on_AnchorHoverOpenedEvt_NativeCallback(System.IntPtr data, ref Efl.Event.NativeStruct evt)
    {
...
private static object AnchorInEvtKey = new object();
    ...
    public event EventHandler<Efl.Ui.TextAnchorInEvt_Args> AnchorInEvt
    {
        add {
            lock (eventLock) {
                ...
                if (AddNativeEventHandler(efl.Libs.Elementary, key, this.evt_AnchorInEvt_delegate)) {
        ...
        remove {
            lock (eventLock) {
                string key = "_EFL_UI_TEXT_EVENT_ANCHOR_IN";
                if (RemoveNativeEventHandler(key, this.evt_AnchorInEvt_delegate)) { 
    ...
    private void on_AnchorInEvt_NativeCallback(System.IntPtr data, ref Efl.Event.NativeStruct evt)
    {
...
private static object AnchorOutEvtKey = new object();
    ...
    public event EventHandler<Efl.Ui.TextAnchorOutEvt_Args> AnchorOutEvt
    {
        add {
            lock (eventLock) {
                ...
                if (AddNativeEventHandler(efl.Libs.Elementary, key, this.evt_AnchorOutEvt_delegate)) {
        ...
        remove {
            lock (eventLock) {
                string key = "_EFL_UI_TEXT_EVENT_ANCHOR_OUT";
                if (RemoveNativeEventHandler(key, this.evt_AnchorOutEvt_delegate)) { 
    ...
    private void on_AnchorOutEvt_NativeCallback(System.IntPtr data, ref Efl.Event.NativeStruct evt)
    {
...
private static object AnchorUpEvtKey = new object();
    ...
    public event EventHandler<Efl.Ui.TextAnchorUpEvt_Args> AnchorUpEvt
    {
        add {
            lock (eventLock) {
                ...
                if (AddNativeEventHandler(efl.Libs.Elementary, key, this.evt_AnchorUpEvt_delegate)) {
        ...
        remove {
            lock (eventLock) {
                string key = "_EFL_UI_TEXT_EVENT_ANCHOR_UP";
                if (RemoveNativeEventHandler(key, this.evt_AnchorUpEvt_delegate)) { 
    ...
    private void on_AnchorUpEvt_NativeCallback(System.IntPtr data, ref Efl.Event.NativeStruct evt)
    {
...
private static object CursorChangedManualEvtKey = new object();
    ...
    public event EventHandler CursorChangedManualEvt
    {
        add {
            lock (eventLock) {
                ...
                if (AddNativeEventHandler(efl.Libs.Elementary, key, this.evt_CursorChangedManualEvt_delegate)) {
        ...
        remove {
            lock (eventLock) {
                string key = "_EFL_UI_TEXT_EVENT_CURSOR_CHANGED_MANUAL";
                if (RemoveNativeEventHandler(key, this.evt_CursorChangedManualEvt_delegate)) { 
    ...
    private void on_CursorChangedManualEvt_NativeCallback(System.IntPtr data, ref Efl.Event.NativeStruct evt)
    {
        EventArgs args = EventArgs.Empty;
        try {
...
private static object AccessTextCaretMovedEvtKey = new object();
    ...
    private void on_AccessTextCaretMovedEvt_NativeCallback(System.IntPtr data, ref Efl.Event.NativeStruct evt)
    {
        EventArgs args = EventArgs.Empty;
        try {
...
private static object AccessTextInsertedEvtKey = new object();
    ...
    public event EventHandler<Efl.Access.ITextAccessTextInsertedEvt_Args> AccessTextInsertedEvt
    {
        add {
            lock (eventLock) {
                ...
                if (AddNativeEventHandler(efl.Libs.Elementary, key, this.evt_AccessTextInsertedEvt_delegate)) {
        ...
        remove {
            lock (eventLock) {
                string key = "_EFL_ACCESS_TEXT_EVENT_ACCESS_TEXT_INSERTED";
                if (RemoveNativeEventHandler(key, this.evt_AccessTextInsertedEvt_delegate)) { 
    ...
    public void On_AccessTextInsertedEvt(Efl.Access.ITextAccessTextInsertedEvt_Args e)
    {
        EventHandler<Efl.Access.ITextAccessTextInsertedEvt_Args> evt;
        lock (eventLock) {
        evt = (EventHandler<Efl.Access.ITextAccessTextInsertedEvt_Args>)eventHandlers[AccessTextInsertedEvtKey];
        }
        evt?.Invoke(this, e);
    }
    Efl.EventCb evt_AccessTextInsertedEvt_delegate;
    private void on_AccessTextInsertedEvt_NativeCallback(System.IntPtr data, ref Efl.Event.NativeStruct evt)
    {
...
private static object AccessTextRemovedEvtKey = new object();
    ...
    public event EventHandler<Efl.Access.ITextAccessTextRemovedEvt_Args> AccessTextRemovedEvt
    {
        add {
            lock (eventLock) {
                ...
                if (AddNativeEventHandler(efl.Libs.Elementary, key, this.evt_AccessTextRemovedEvt_delegate)) {
        ...
        remove {
            lock (eventLock) {
                string key = "_EFL_ACCESS_TEXT_EVENT_ACCESS_TEXT_REMOVED";
                if (RemoveNativeEventHandler(key, this.evt_AccessTextRemovedEvt_delegate)) { 
    ...
    public void On_AccessTextRemovedEvt(Efl.Access.ITextAccessTextRemovedEvt_Args e)
    {
        EventHandler<Efl.Access.ITextAccessTextRemovedEvt_Args> evt;
        lock (eventLock) {
        evt = (EventHandler<Efl.Access.ITextAccessTextRemovedEvt_Args>)eventHandlers[AccessTextRemovedEvtKey];
        }
        evt?.Invoke(this, e);
    }
    Efl.EventCb evt_AccessTextRemovedEvt_delegate;
    private void on_AccessTextRemovedEvt_NativeCallback(System.IntPtr data, ref Efl.Event.NativeStruct evt)
    {
...
private static object AccessTextSelectionChangedEvtKey = new object();
    ...
    public event EventHandler AccessTextSelectionChangedEvt
    {
        add {
            lock (eventLock) {
                ...
                if (AddNativeEventHandler(efl.Libs.Elementary, key, this.evt_AccessTextSelectionChangedEvt_delegate)) {
        ...
        remove {
            lock (eventLock) {
                string key = "_EFL_ACCESS_TEXT_EVENT_ACCESS_TEXT_SELECTION_CHANGED";
                if (RemoveNativeEventHandler(key, this.evt_AccessTextSelectionChangedEvt_delegate)) { 
    ...
    private void on_AccessTextSelectionChangedEvt_NativeCallback(System.IntPtr data, ref Efl.Event.NativeStruct evt)
    {
        EventArgs args = EventArgs.Empty;
        try {
...
private static object SelectionClearedEvtKey = new object();
    ...
    virtual public bool GetSelectionAllowed() {
         var _ret_var = Efl.ITextInteractiveNativeInherit.efl_text_interactive_selection_allowed_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    /// <summary>Whether or not selection is allowed on this object</summary>
    ...
    virtual public void SetSelectionAllowed( bool allowed) {
                                 Efl.ITextInteractiveNativeInherit.efl_text_interactive_selection_allowed_set_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), allowed);
        Eina.Error.RaiseIfUnhandledException();
                         }
    ...
    virtual public void GetSelectionCursors( out Efl.TextCursorCursor start,  out Efl.TextCursorCursor end) {
                                                         Efl.ITextInteractiveNativeInherit.efl_text_interactive_selection_cursors_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), out start,  out end);
        Eina.Error.RaiseIfUnhandledException();
                                         }
    ...
    virtual public bool GetEditable() {
         var _ret_var = Efl.ITextInteractiveNativeInherit.efl_text_interactive_editable_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    /// <summary>Whether the entry is editable.
    ...
    virtual public void SetEditable( bool editable) {
                                 Efl.ITextInteractiveNativeInherit.efl_text_interactive_editable_set_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), editable);
        Eina.Error.RaiseIfUnhandledException();
                         }
    /// <summary>Clears the selection.</summary>
    /// <returns></returns>
    virtual public void SelectNone() {
         Efl.ITextInteractiveNativeInherit.efl_text_interactive_select_none_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
        Eina.Error.RaiseIfUnhandledException();
         }
    ...
    virtual public Eina.Unicode GetCharacter( int offset) {
                                 var _ret_var = Efl.Access.ITextNativeInherit.efl_access_text_character_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), offset);
        Eina.Error.RaiseIfUnhandledException();
                        return _ret_var;
 }
    ...
    virtual public System.String GetString( Efl.Access.TextGranularity granularity,  int start_offset,  int end_offset) {
        ...
        var _in_end_offset = Eina.PrimitiveConversion.ManagedToPointerAlloc(end_offset);
                                                        var _ret_var = Efl.Access.ITextNativeInherit.efl_access_text_string_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), granularity,  _in_start_offset,  _in_end_offset);
        Eina.Error.RaiseIfUnhandledException();
                                                        return _ret_var;
 }
    ...
    virtual public System.String GetAccessText( int start_offset,  int end_offset) {
                                                         var _ret_var = Efl.Access.ITextNativeInherit.efl_access_text_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), start_offset,  end_offset);
        Eina.Error.RaiseIfUnhandledException();
                                        return _ret_var;
 }
    ...
    virtual public int GetCaretOffset() {
         var _ret_var = Efl.Access.ITextNativeInherit.efl_access_text_caret_offset_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    ...
    virtual public bool SetCaretOffset( int offset) {
                                 var _ret_var = Efl.Access.ITextNativeInherit.efl_access_text_caret_offset_set_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), offset);
        Eina.Error.RaiseIfUnhandledException();
                        return _ret_var;
 }
    ...
    virtual public bool GetAttribute( System.String name,  int start_offset,  int end_offset,  out System.String value) {
                 var _in_start_offset = Eina.PrimitiveConversion.ManagedToPointerAlloc(start_offset);
        var _in_end_offset = Eina.PrimitiveConversion.ManagedToPointerAlloc(end_offset);
                                                                                var _ret_var = Efl.Access.ITextNativeInherit.efl_access_text_attribute_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), name,  _in_start_offset,  _in_end_offset,  out value);
        Eina.Error.RaiseIfUnhandledException();
                                                                        return _ret_var;
 }
    ...
    virtual public Eina.List<Efl.Access.TextAttribute> GetTextAttributes( int start_offset,  int end_offset) {
         var _in_start_offset = Eina.PrimitiveConversion.ManagedToPointerAlloc(start_offset);
        var _in_end_offset = Eina.PrimitiveConversion.ManagedToPointerAlloc(end_offset);
                                        var _ret_var = Efl.Access.ITextNativeInherit.efl_access_text_attributes_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), _in_start_offset,  _in_end_offset);
        Eina.Error.RaiseIfUnhandledException();
    ...
    virtual public Eina.List<Efl.Access.TextAttribute> GetDefaultAttributes() {
         var _ret_var = Efl.Access.ITextNativeInherit.efl_access_text_default_attributes_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
        Eina.Error.RaiseIfUnhandledException();
        return new Eina.List<Efl.Access.TextAttribute>(_ret_var, true, true);
 }
    ...
    virtual public bool GetCharacterExtents( int offset,  bool screen_coords,  out Eina.Rect rect) {
                                ...
                                var _ret_var = Efl.Access.ITextNativeInherit.efl_access_text_character_extents_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), offset,  screen_coords,  out _out_rect);
        Eina.Error.RaiseIfUnhandledException();
                        rect = _out_rect;
                                return _ret_var;
 }
    ...
    virtual public int GetCharacterCount() {
         var _ret_var = Efl.Access.ITextNativeInherit.efl_access_text_character_count_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    ...
    virtual public int GetOffsetAtPoint( bool screen_coords,  int x,  int y) {
                                                                                 var _ret_var = Efl.Access.ITextNativeInherit.efl_access_text_offset_at_point_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), screen_coords,  x,  y);
        Eina.Error.RaiseIfUnhandledException();
                                                        return _ret_var;
 }
    ...
    virtual public Eina.List<Efl.Access.TextRange> GetBoundedRanges( bool screen_coords,  Eina.Rect rect,  Efl.Access.TextClipType xclip,  Efl.Access.TextClipType yclip) {
                 Eina.Rect.NativeStruct _in_rect = rect;
                                                                                        var _ret_var = Efl.Access.ITextNativeInherit.efl_access_text_bounded_ranges_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), screen_coords,  _in_rect,  xclip,  yclip);
        Eina.Error.RaiseIfUnhandledException();
    ...
    virtual public bool GetRangeExtents( bool screen_coords,  int start_offset,  int end_offset,  out Eina.Rect rect) {
                                                                 var _out_rect = new Eina.Rect.NativeStruct();
                                        var _ret_var = Efl.Access.ITextNativeInherit.efl_access_text_range_extents_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), screen_coords,  start_offset,  end_offset,  out _out_rect);
        Eina.Error.RaiseIfUnhandledException();
                                rect = _out_rect;
                                        return _ret_var;
 }
    ...
    virtual public int GetSelectionsCount() {
         var _ret_var = Efl.Access.ITextNativeInherit.efl_access_text_selections_count_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    ...
    virtual public void GetAccessSelection( int selection_number,  out int start_offset,  out int end_offset) {
                                                                                 Efl.Access.ITextNativeInherit.efl_access_text_access_selection_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), selection_number,  out start_offset,  out end_offset);
        Eina.Error.RaiseIfUnhandledException();
                                                         }
    /// <summary>Selection property</summary>
    /// <param name="selection_number">Selection number for identification</param>
    ...
    virtual public bool SetAccessSelection( int selection_number,  int start_offset,  int end_offset) {
                                                                                 var _ret_var = Efl.Access.ITextNativeInherit.efl_access_text_access_selection_set_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), selection_number,  start_offset,  end_offset);
        Eina.Error.RaiseIfUnhandledException();
                                                        return _ret_var;
 }
    ...
    virtual public bool AddSelection( int start_offset,  int end_offset) {
                                                         var _ret_var = Efl.Access.ITextNativeInherit.efl_access_text_selection_add_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), start_offset,  end_offset);
        Eina.Error.RaiseIfUnhandledException();
                                        return _ret_var;
 }
    ...
    virtual public bool SelectionRemove( int selection_number) {
                                 var _ret_var = Efl.Access.ITextNativeInherit.efl_access_text_selection_remove_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), selection_number);
        Eina.Error.RaiseIfUnhandledException();
                        return _ret_var;
 }
    ...
    virtual public bool SetTextContent( System.String kw_string) {
                                 var _ret_var = Efl.Access.Editable.ITextNativeInherit.efl_access_editable_text_content_set_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), kw_string);
        Eina.Error.RaiseIfUnhandledException();
                        return _ret_var;
 }
    ...
    virtual public bool Insert( System.String kw_string,  int position) {
                                                         var _ret_var = Efl.Access.Editable.ITextNativeInherit.efl_access_editable_text_insert_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), kw_string,  position);
        Eina.Error.RaiseIfUnhandledException();
                                        return _ret_var;
 }
    ...
    virtual public bool Copy( int start,  int end) {
                                                         var _ret_var = Efl.Access.Editable.ITextNativeInherit.efl_access_editable_text_copy_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), start,  end);
        Eina.Error.RaiseIfUnhandledException();
                                        return _ret_var;
 }
    ...
    virtual public bool Cut( int start,  int end) {
                                                         var _ret_var = Efl.Access.Editable.ITextNativeInherit.efl_access_editable_text_cut_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), start,  end);
        Eina.Error.RaiseIfUnhandledException();
                                        return _ret_var;
 }
    ...
    virtual public bool Delete( int start,  int end) {
                                                         var _ret_var = Efl.Access.Editable.ITextNativeInherit.efl_access_editable_text_delete_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), start,  end);
        Eina.Error.RaiseIfUnhandledException();
                                        return _ret_var;
 }
    ...
    virtual public bool Paste( int position) {
                                 var _ret_var = Efl.Access.Editable.ITextNativeInherit.efl_access_editable_text_paste_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), position);
        Eina.Error.RaiseIfUnhandledException();
                        return _ret_var;
 }
    /// <summary>Get the scrollable state of the entry
...
public class TextNativeInherit : Efl.Ui.LayoutBaseNativeInherit{
    ...
    [return:MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(Efl.Eo.MarshalTest<Efl.Canvas.ITextFactoryConcrete, Efl.Eo.NonOwnTag>))] private delegate Efl.Canvas.ITextFactory efl_ui_text_item_factory_get_delegate(System.IntPtr obj, System.IntPtr pd);


    [return:MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(Efl.Eo.MarshalTest<Efl.Canvas.ITextFactoryConcrete, Efl.Eo.NonOwnTag>))] public delegate Efl.Canvas.ITextFactory efl_ui_text_item_factory_get_api_delegate(System.IntPtr obj);
    ...
    private static efl_ui_text_item_factory_get_delegate efl_ui_text_item_factory_get_static_delegate;
     ...
     private delegate void efl_ui_text_item_factory_set_delegate(System.IntPtr obj, System.IntPtr pd, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(Efl.Eo.MarshalTest<Efl.Canvas.ITextFactoryConcrete, Efl.Eo.NonOwnTag>))]  Efl.Canvas.ITextFactory item_factory);


     public delegate void efl_ui_text_item_factory_set_api_delegate(System.IntPtr obj, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(Efl.Eo.MarshalTest<Efl.Canvas.ITextFactoryConcrete, Efl.Eo.NonOwnTag>))]  Efl.Canvas.ITextFactory item_factory);
    ...
    private static efl_access_text_default_attributes_get_delegate efl_access_text_default_attributes_get_static_delegate;
     ...
     [return: MarshalAs(UnmanagedType.U1)] private delegate bool efl_access_text_character_extents_get_delegate(System.IntPtr obj, System.IntPtr pd,   int offset,  [MarshalAs(UnmanagedType.U1)]  bool screen_coords,   out Eina.Rect.NativeStruct rect);


     [return: MarshalAs(UnmanagedType.U1)] public delegate bool efl_access_text_character_extents_get_api_delegate(System.IntPtr obj,   int offset,  [MarshalAs(UnmanagedType.U1)]  bool screen_coords,   out Eina.Rect.NativeStruct rect);
    ...
    private static efl_access_text_bounded_ranges_get_delegate efl_access_text_bounded_ranges_get_static_delegate;
     ...
     [return: MarshalAs(UnmanagedType.U1)] private delegate bool efl_access_text_range_extents_get_delegate(System.IntPtr obj, System.IntPtr pd,  [MarshalAs(UnmanagedType.U1)]  bool screen_coords,   int start_offset,   int end_offset,   out Eina.Rect.NativeStruct rect);


     [return: MarshalAs(UnmanagedType.U1)] public delegate bool efl_access_text_range_extents_get_api_delegate(System.IntPtr obj,  [MarshalAs(UnmanagedType.U1)]  bool screen_coords,   int start_offset,   int end_offset,   out Eina.Rect.NativeStruct rect);
