...
private static object CanWriteChangedEvtKey = new object();
    ...
    virtual public System.IntPtr GetIndata() {
         var _ret_var = Efl.IThreadIONativeInherit.efl_threadio_indata_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
    ...
    virtual public void SetIndata( System.IntPtr data) {
                                 Efl.IThreadIONativeInherit.efl_threadio_indata_set_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), data);
        Eina.Error.RaiseIfUnhandledException();
                         }
    /// <summary></summary>
    /// <returns>No description supplied.</returns>
    virtual public System.IntPtr GetOutdata() {
         var _ret_var = Efl.IThreadIONativeInherit.efl_threadio_outdata_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    /// <summary></summary>
    ...
    virtual public void SetOutdata( System.IntPtr data) {
                                 Efl.IThreadIONativeInherit.efl_threadio_outdata_set_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), data);
        Eina.Error.RaiseIfUnhandledException();
                         }
    /// <summary></summary>
    ...
    virtual public void Call( EFlThreadIOCall func) {
        ...
        Efl.IThreadIONativeInherit.efl_threadio_call_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle),GCHandle.ToIntPtr(func_handle), EFlThreadIOCallWrapper.Cb, Efl.Eo.Globals.free_gchandle);
        Eina.Error.RaiseIfUnhandledException();
                         }
    /// <summary></summary>
    /// <param name="func">No description supplied.</param>
    ...
    virtual public System.IntPtr CallSync( EFlThreadIOCallSync func) {
                         GCHandle func_handle = GCHandle.Alloc(func);
        var _ret_var = Efl.IThreadIONativeInherit.efl_threadio_call_sync_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle),GCHandle.ToIntPtr(func_handle), EFlThreadIOCallSyncWrapper.Cb, Efl.Eo.Globals.free_gchandle);
        Eina.Error.RaiseIfUnhandledException();
                        return _ret_var;
 }
