...
namespace Tizen.NUI
{
    ...
    public class Adaptor : Disposable
    {
        ...
        {
            Interop.Adaptor.AdaptorFeedWheelEvent(swigCPtr, Wheel.getCPtr(wheelEvent));
        ...
        {
            Interop.Adaptor.AdaptorFeedKeyEvent(swigCPtr, Key.getCPtr(keyEvent));
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
        }

        internal static Adaptor Get()
        {
            Adaptor ret = new Adaptor(Interop.Adaptor.AdaptorGet(), false);
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
            return ret;
        }
        ...
        {
            Interop.Adaptor.AdaptorSetRenderRefreshRate(swigCPtr, numberOfVSyncsPerRender);
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
        }
