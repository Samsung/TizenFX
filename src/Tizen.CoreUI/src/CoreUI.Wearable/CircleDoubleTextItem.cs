...
namespace CoreUI.Wearable {
    /// <summary>Wearable Circle Double Text Item Class.</summary>
    /// <since_tizen> 6 </since_tizen>
    [CoreUI.Wearable.CircleDoubleTextItem.NativeMethods]
    [CoreUI.Wrapper.BindingEntity]
    [SuppressMessage("Microsoft.Naming", "CA1724:TypeNamesShouldNotMatchNamespaces")]
    public class CircleDoubleTextItem : CoreUI.Wearable.CircleItem, CoreUI.IContent, CoreUI.IText, CoreUI.ITextMarkup
    {
        ...
        public override System.IntPtr NativeClass
        {
            get
            {
                if (((object)this).GetType() == typeof(CircleDoubleTextItem))
                {
        ...
        [System.Runtime.InteropServices.DllImport(CoreUI.Libs.Elementary)] internal static extern System.IntPtr
            efl_wearable_circle_double_text_item_class_get();

        /// <summary>Initializes a new instance of the <see cref="CircleDoubleTextItem"/> class.
        /// </summary>
        /// <param name="parent">Parent instance.</param>
    /// <param name="style">The widget style to use. See <see cref="CoreUI.UI.Widget.SetStyle" /></param>
        public CircleDoubleTextItem(CoreUI.Object parent, System.String style = null) : base(efl_wearable_circle_double_text_item_class_get(), parent)
        {
        ...
        protected CircleDoubleTextItem(ConstructingHandle ch) : base(ch)
        {
        }
        ...
        internal CircleDoubleTextItem(CoreUI.Wrapper.WrappingHandle wh) : base(wh)
        {
        }
        ...
        protected CircleDoubleTextItem(IntPtr baseKlass, CoreUI.Object parent) : base(baseKlass, parent)
        {
        }
        ...
        {
            return CoreUI.Wearable.CircleDoubleTextItem.efl_wearable_circle_double_text_item_class_get();
        }
        ...
        internal new class NativeMethods : CoreUI.Wearable.CircleItem.NativeMethods
        {
...
#pragma warning disable CS1591
    /// <since_tizen> 6 </since_tizen>
    public static class CircleDoubleTextItemExtensions {
        /// <since_tizen> 6 </since_tizen>
        public static CoreUI.BindableProperty<CoreUI.Gfx.IEntity> Content<T>(this CoreUI.UI.IGenericFactoryExtended<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Wearable.CircleDoubleTextItem, T>magic = null) where T : CoreUI.Wearable.CircleDoubleTextItem {
            return new CoreUI.BindableProperty<CoreUI.Gfx.IEntity>("content", fac.GetPropBind());
        }

        /// <since_tizen> 6 </since_tizen>
        public static CoreUI.BindableProperty<System.String> Text<T>(this CoreUI.UI.IGenericFactoryExtended<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Wearable.CircleDoubleTextItem, T>magic = null) where T : CoreUI.Wearable.CircleDoubleTextItem {
            return new CoreUI.BindableProperty<System.String>("text", fac.GetPropBind());
        }

        /// <since_tizen> 6 </since_tizen>
        public static CoreUI.BindableProperty<System.String> Markup<T>(this CoreUI.UI.IGenericFactoryExtended<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Wearable.CircleDoubleTextItem, T>magic = null) where T : CoreUI.Wearable.CircleDoubleTextItem {
            return new CoreUI.BindableProperty<System.String>("markup", fac.GetPropBind());
        }

        /// <since_tizen> 6 </since_tizen>
        public static CoreUI.BindableFactoryPart<CoreUI.UI.LayoutPartContent> ExtraPart<T>(this CoreUI.UI.IGenericFactoryPartExtended<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Wearable.CircleDoubleTextItem, T> x=null) where T : CoreUI.Wearable.CircleDoubleTextItem
        {
            return new CoreUI.BindableFactoryPart<CoreUI.UI.LayoutPartContent>("extra", fac.GetFactoryBind());
        }

        /// <since_tizen> 6 </since_tizen>
        public static CoreUI.BindableFactoryPart<CoreUI.UI.LayoutPartContent> IconPart<T>(this CoreUI.UI.IGenericFactoryPartExtended<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Wearable.CircleDoubleTextItem, T> x=null) where T : CoreUI.Wearable.CircleDoubleTextItem
        {
            return new CoreUI.BindableFactoryPart<CoreUI.UI.LayoutPartContent>("icon", fac.GetFactoryBind());
        }

        /// <since_tizen> 6 </since_tizen>
        public static CoreUI.BindablePart<CoreUI.UI.LayoutPartText> SubTextPart<T>(this CoreUI.UI.IGenericFactoryPartExtended<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Wearable.CircleDoubleTextItem, T> x=null) where T : CoreUI.Wearable.CircleDoubleTextItem
        {
            return new CoreUI.BindablePart<CoreUI.UI.LayoutPartText>("sub_text", fac.GetPropBind());
        }

        /// <since_tizen> 6 </since_tizen>
        public static CoreUI.BindablePart<CoreUI.UI.LayoutPartText> TextPart<T>(this CoreUI.UI.IGenericFactoryPartExtended<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Wearable.CircleDoubleTextItem, T> x=null) where T : CoreUI.Wearable.CircleDoubleTextItem
        {
