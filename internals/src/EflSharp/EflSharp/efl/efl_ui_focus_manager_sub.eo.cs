...
/// This sub manager will register its border elements on the parent manager. The parent manager is found with the <see cref="Efl.Ui.Focus.IObject"/> interface of the <see cref="Efl.Object.Parent"/>.
/// 
...
[Efl.Ui.Focus.ManagerSubConcrete.NativeMethods]
...
/// You can filter the border elements by overriding the property <see cref="Efl.Ui.Focus.IManager.GetBorderElements"/>.</summary>
/// <remarks>This is a <b>BETA</b> class. It can be modified or removed in the future. Do not use it for product development.</remarks>
public sealed class ManagerSubConcrete :
    Efl.Eo.EoWrapper
    , IManagerSub
    , Efl.Ui.Focus.IManager
{
    ...
    private ManagerSubConcrete(ConstructingHandle ch) : base(ch)
    {
    }
    ...
    private ManagerSubConcrete(Efl.Eo.Globals.WrappingHandle wh) : base(wh)
    {
    }
...
#if EFL_BETA
#pragma warning disable CS1591
public static class Efl_Ui_FocusManagerSubConcrete_ExtensionMethods {
