...
/// <summary></summary>
[IListViewRelayoutNativeInherit]
public interface IListViewRelayout : 
...
Eina.List<Efl.Gfx.IEntity> GetElements();
    /// <summary></summary>
/// <param name="modeler"></param>
/// <param name="first"></param>
/// <param name="children"></param>
/// <returns></returns>
void LayoutDo( Efl.Ui.IListViewModel modeler,  int first,  EflUiListViewSegArray children);
    /// <summary></summary>
...
/// <value>The order to use</value>
    Eina.List<Efl.Gfx.IEntity> Elements {
        get ;
    }
}
/// <summary></summary>
sealed public class IListViewRelayoutConcrete : 
    ...
    
{
    ...
    public System.IntPtr NativeClass {
        get {
            if (((object)this).GetType() == typeof (IListViewRelayoutConcrete))
                return Efl.Ui.IListViewRelayoutNativeInherit.GetEflClassStatic();
            else
    ...
    private IListViewRelayoutConcrete(System.IntPtr raw)
    {
        handle = raw;
        RegisterEventProxies();
    }
    ///<summary>Destructor.</summary>
    ~IListViewRelayoutConcrete()
    {
        Dispose(false);
    }
    ...
    public void SetModel( Efl.IModel model) {
                                 Efl.Ui.IListViewRelayoutNativeInherit.efl_ui_list_view_relayout_model_set_ptr.Value.Delegate(this.NativeHandle, model);
        Eina.Error.RaiseIfUnhandledException();
                         }
    /// <summary></summary>
    /// <returns>The order to use</returns>
    public Eina.List<Efl.Gfx.IEntity> GetElements() {
         var _ret_var = Efl.Ui.IListViewRelayoutNativeInherit.efl_ui_list_view_relayout_elements_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
...
/// <value>The order to use</value>
    ...
    {
        return Efl.Ui.IListViewRelayoutConcrete.efl_ui_list_view_relayout_interface_get();
    }
}
public class IListViewRelayoutNativeInherit  : Efl.Eo.NativeClass{
     ...
     private static void model_set(System.IntPtr obj, System.IntPtr pd,  Efl.IModel model)
    {
        ...
        if(wrapper != null) {
            ...
            try {
                ((IListViewRelayout)wrapper).SetModel( model);
            } catch (Exception e) {
     ...
     private static System.IntPtr elements_get(System.IntPtr obj, System.IntPtr pd)
    {
        ...
        if(wrapper != null) {
            ...
            try {
                _ret_var = ((IListViewRelayout)wrapper).GetElements();
            } catch (Exception e) {
                Eina.Log.Warning($"Callback error: {e.ToString()}");
                Eina.Error.Set(Eina.Error.UNHANDLED_EXCEPTION);
            }
     ...
     private static void content_created(System.IntPtr obj, System.IntPtr pd,  ref Efl.Ui.ListViewLayoutItem.NativeStruct item)
    {
        ...
        if(wrapper != null) {
            ...
            try {
                ((IListViewRelayout)wrapper).ContentCreated( ref _in_item);
            } catch (Exception e) {
                Eina.Log.Warning($"Callback error: {e.ToString()}");
                Eina.Error.Set(Eina.Error.UNHANDLED_EXCEPTION);
            }
