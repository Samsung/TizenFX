        ...
        public class CircleListView : CoreUI.UI.ListView, ICircleWidget
        {
            ...
            public CircleListView(CoreUI.Object parent) : base(parent)
            {
                ...
                this.ScrollDestinationFinalized += (object sender, CoreUI.UI.ScrollableScrollDestinationFinalizedEventArgs e) =>
                {
                    ...
                    int idx = ((PositionManager.CircleList)list.GetPositionManager()).GetPositionedItem(new CoreUI.DataTypes.Position2D(e.Arg.X, (view.H / 2)));
                    iPos = list.GetPositionManager().PositionSingleItem(idx);
                    ix = iPos.X;
