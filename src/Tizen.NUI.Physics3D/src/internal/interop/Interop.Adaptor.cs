...
namespace Tizen.NUI.Physics3D
{
    internal static partial class Interop
    {
        ...
        {
            [DllImport(Libraries.Physics3D, EntryPoint = "CSharp_Dali_PhysicsAdaptor_New")]
            internal static extern global::System.IntPtr PhysicsAdaptorNew(HandleRef matrix, HandleRef size);

            [DllImport(Libraries.Physics3D, EntryPoint = "CSharp_Dali_new_PhysicsAdaptor__SWIG_0")]
            internal static extern global::System.IntPtr NewPhysicsAdaptor();

            [DllImport(Libraries.Physics3D, EntryPoint = "CSharp_Dali_new_PhysicsAdaptor__SWIG_1")]
            internal static extern global::System.IntPtr NewPhysicsAdaptor(HandleRef rhs);

            [DllImport(Libraries.Physics3D, EntryPoint = "CSharp_Dali_delete_PhysicsAdaptor")]
            internal static extern void DeletePhysicsAdaptor(HandleRef handle);

            [DllImport(Libraries.Physics3D, EntryPoint = "CSharp_Dali_PhysicsAdaptor_DownCast")]
            internal static extern global::System.IntPtr DownCast(HandleRef handle);

            [DllImport(Libraries.Physics3D, EntryPoint = "CSharp_Dali_PhysicsAdaptor_Assign")]
            internal static extern global::System.IntPtr Assign(HandleRef destination, HandleRef source);

            [DllImport(Libraries.Physics3D, EntryPoint = "CSharp_Dali_PhysicsAdaptor_SetTimestep")]
            internal static extern void SetTimestep(HandleRef adaptor, float timestep);

            [DllImport(Libraries.Physics3D, EntryPoint = "CSharp_Dali_PhysicsAdaptor_GetTimestep")]
            ...
            [DllImport(Libraries.Physics3D, EntryPoint = "CSharp_Dali_PhysicsAdaptor_SetIntegrationState")]
            internal static extern void SetIntegrationState(HandleRef adaptor, int integrationState);

            [DllImport(Libraries.Physics3D, EntryPoint = "CSharp_Dali_PhysicsAdaptor_GetIntegrationState")]
            internal static extern int GetIntegrationState(HandleRef adaptor);

            [DllImport(Libraries.Physics3D, EntryPoint = "CSharp_Dali_PhysicsAdaptor_SetDebugState")]
            internal static extern void SetDebugState(HandleRef adaptor, int integrationState);

            [DllImport(Libraries.Physics3D, EntryPoint = "CSharp_Dali_PhysicsAdaptor_GetDebugState")]
            ...
            [DllImport(Libraries.Physics3D, EntryPoint = "CSharp_Dali_PhysicsAdaptor_GetPhysicsWorld")]
