...
public class LayoutPartTable : Efl.Canvas.LayoutPart, Efl.Eo.IWrapper,Efl.Container,Efl.Pack,Efl.PackLinear,Efl.PackTable
{
   ...
   public LayoutPartTable(Efl.Object parent = null, ConstructingMethod init_cb=null) : base("LayoutPartTable", efl_canvas_layout_part_table_class_get(), typeof(LayoutPartTable), parent)
   {
      if (init_cb != null) {
         init_cb(this);
      }
