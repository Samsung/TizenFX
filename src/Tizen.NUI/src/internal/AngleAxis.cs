...
namespace Tizen.NUI
{
    internal class AngleAxis : Disposable
    {
        ...
        public Radian angle
        {
            set
            {
                Interop.AngleAxis.AngleAxisAngleSet(swigCPtr, Radian.getCPtr(value));
                if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
            }
            get
            {
                global::System.IntPtr cPtr = Interop.AngleAxis.AngleAxisAngleGet(swigCPtr);
        ...
        public Vector3 axis
        {
            set
            {
                Interop.AngleAxis.AngleAxisAxisSet(swigCPtr, Vector3.getCPtr(value));
                if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
            }
            get
            {
                global::System.IntPtr cPtr = Interop.AngleAxis.AngleAxisAxisGet(swigCPtr);
