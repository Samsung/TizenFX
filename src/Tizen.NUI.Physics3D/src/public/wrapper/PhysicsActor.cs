...
{
    /// <summary>
    /// Class to associate a physics body (such as Bullet.RigidBody) with a View
    /// for rendering.
    ///
...
#pragma warning restore IDE0032
        ...
        /// </summary>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public PhysicsActor(View view, Bullet.RigidBody body, PhysicsAdaptor adaptor)
            : this(Interop.Actor.PhysicsActorNew(View.getCPtr(view), body.Native, PhysicsAdaptor.getCPtr(adaptor)), true)
        {
            this._view = view;
        ...
        /// </summary>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public Bullet.RigidBody GetBody()
        {
        ...
        /// Queue is processed when the next SyncPoint is reached (in Update
        /// thread), so requires PhysicsAdaptor.CreateSyncPoint() to be called
        /// afterwards.
        /// </summary>
        [EditorBrowsable(EditorBrowsableState.Never)]
