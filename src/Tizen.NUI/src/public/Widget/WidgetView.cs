    ...
    public class WidgetView : View
    {
        ...
        public bool WidgetStateFaulted
        {
            get
            {
                ...
                {
                    return InternalWidgetStateFaulted;
                }
            }
            set
            {
        ...
        public bool PermanentDelete
        {
            get
            {
                ...
                {
                    return InternalPermanentDelete;
                }
            }
            set
            {
