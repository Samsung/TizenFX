...
namespace Tizen.NUI.Components
{
    ...
    public class TabButton : SelectButton
    {
        ...
        /// <summary>
        /// Set the control state of a TabButton.
        /// TabButton needs to support this API
        /// since 'View.ControlState' is protected and can't be reached by TabButtonGroup.
        /// </summary>
        [EditorBrowsable(EditorBrowsableState.Never)]
        ...
        /// <summary>
        /// Set Button.IsSelected to true after selecting TabButton
        /// since it is set to false when re-selected according to Button's logic.
        /// </summary>
        [EditorBrowsable(EditorBrowsableState.Never)]
