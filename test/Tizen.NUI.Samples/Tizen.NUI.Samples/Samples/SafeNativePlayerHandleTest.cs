...
namespace Tizen.NUI.Samples
{
    ...
    public class VideoViewSafeNativePlayerHandleTest : IExample
    {
        ...
        public void Activate()
        {
            ...
            win.BackgroundColor = new Color(0, 0, 0, 0);
        ...
        private void Win_TouchEvent(object sender, Window.TouchEventArgs e)
        {
            if (e.Touch.GetState(0) == PointStateType.Down)
            {
                ...
                else
                {
                    ...
                    {
                        player.Start();
                        tlog.Fatal(tag, $"player start! vol={player.Volume} state={player.State}");
                    }
                }
            }
        }
        ...
        {
            tlog.Fatal(tag, $"NUIVideoViewTest !  SafeNativePlayerHandle !");
