...
public class Transition : Efl.Object, Efl.Eo.IWrapper
{
   ...
   public new delegate void ConstructingMethod(Transition obj);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)] internal static extern System.IntPtr
      efl_page_transition_class_get();
   ///<summary>Creates a new instance.</summary>
   ///<param name="parent">Parent instance.</param>
   ///<param name="init_cb">Delegate to call constructing methods that should be run inside the constructor.</param>
   public Transition(Efl.Object parent = null, ConstructingMethod init_cb=null) : base("Transition", efl_page_transition_class_get(), typeof(Transition), parent)
   {
      if (init_cb != null) {
         init_cb(this);
      }
   ...
   protected Transition(String klass_name, IntPtr base_klass, System.Type managed_type, Efl.Object parent) : base(klass_name, base_klass, managed_type, parent) {}
   ...
   virtual public  void Bind( Efl.Ui.Pager pager,  Efl.Canvas.Group group) {
                                           efl_page_transition_bind((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle),  pager,  group);
...
public class TransitionNativeInherit : Efl.ObjectNativeInherit{
   public override System.Collections.Generic.List<Efl_Op_Description> GetEoOps(System.Type type)
   {
      ...
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_page_transition_bind"), func = Marshal.GetFunctionPointerForDelegate(efl_page_transition_bind_static_delegate)});
    ...
    private static  void bind(System.IntPtr obj, System.IntPtr pd,  Efl.Ui.Pager pager,  Efl.Canvas.Group group)
   {
      ...
      if(wrapper != null) {
         ...
         efl_page_transition_bind(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)),  pager,  group);
      }
   }
   private efl_page_transition_bind_delegate efl_page_transition_bind_static_delegate;
}
} } 
