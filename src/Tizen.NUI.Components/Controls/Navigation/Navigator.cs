...
namespace Tizen.NUI.Components
{
    ...
    public class Navigator : Control
    {
        ...
        public void Push(Page page)
        {
            ...
            _curAnimation.AnimateTo(curTop, "Scale", new Vector3(0.0f, 0.0f, 1.0f), 0, 1000);
            _curAnimation.AnimateTo(curTop, "Opacity", 0.0f, 0, 1000);
            _curAnimation.EndAction = Animation.EndActions.Discard;
            _curAnimation.Play();

            Tizen.NUI.Object.SetProperty(page.SwigCPtr, Page.Property.SCALE, new Tizen.NUI.PropertyValue(new Vector3(0.0f, 0.0f, 1.0f)));
            Tizen.NUI.Object.SetProperty(page.SwigCPtr, Page.Property.OPACITY, new Tizen.NUI.PropertyValue(0.0f));
            _newAnimation = new Animation(1000);
            _newAnimation.AnimateTo(page, "Scale", new Vector3(1.0f, 1.0f, 1.0f), 0, 1000);
        ...
        public Page Pop()
        {
            ...
            Tizen.NUI.Object.SetProperty(newTop.SwigCPtr, Page.Property.SCALE, new Tizen.NUI.PropertyValue(new Vector3(0.0f, 0.0f, 1.0f)));
            Tizen.NUI.Object.SetProperty(newTop.SwigCPtr, Page.Property.OPACITY, new Tizen.NUI.PropertyValue(0.0f));
            _newAnimation = new Animation(1000);
            _newAnimation.AnimateTo(newTop, "Scale", new Vector3(1.0f, 1.0f, 1.0f), 0, 1000);
        ...
        public void InsertBefore(Page before, Page page)
        {
            ...
            if (beforeIndex == -1)
            {
                throw new ArgumentException(nameof(before), "before does not exist in Navigator.");
            }
