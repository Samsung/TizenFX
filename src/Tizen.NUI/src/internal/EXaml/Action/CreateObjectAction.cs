    ...
    internal class CreateObjectAction : Action
    {
        ...
        public void OnActive()
        {
            if (null != getTypeIndexOp)
            {
                ...
                {
                    LoadEXaml.Operations.Add(new CreateInstances(typeIndex));
                }
                else
                {
                    LoadEXaml.Operations.Add(new CreateInstances(typeIndex, getParamListOp.ValueList));
                }
                getParamListOp = null;
            }
        ...
        internal static object Root
        {
            get
            {
                return CreateInstances.Root;
            }
            set
            {
                CreateInstances.Root = value;
            }
        }
    }
}
