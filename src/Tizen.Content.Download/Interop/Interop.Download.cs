...
internal static partial class Interop
{
    internal static partial class Download
    {
        ...
        [LibraryImport(Libraries.Download, EntryPoint = "download_create")]
        internal static partial int CreateRequest(out int requestId);
        [LibraryImport(Libraries.Download, EntryPoint = "download_destroy")]
        ...
        [LibraryImport(Libraries.Download, EntryPoint = "download_set_network_type")]
        internal static partial int SetNetworkType(int requestId, int networkType);
        [LibraryImport(Libraries.Download, EntryPoint = "download_get_network_type")]
        ...
        [LibraryImport(Libraries.Download, EntryPoint = "download_set_auto_download")]
        internal static partial int SetAutoDownload(int requestId, [MarshalAs(UnmanagedType.U1)] bool value);
        [LibraryImport(Libraries.Download, EntryPoint = "download_get_auto_download")]
        ...
        [LibraryImport(Libraries.Download, EntryPoint = "download_get_state")]
        ...
        [LibraryImport(Libraries.Download, EntryPoint = "download_get_content_size")]
        internal static partial int GetContentSize(int requestId, out ulong size);
        [LibraryImport(Libraries.Download, EntryPoint = "download_get_http_status")]
        ...
        [LibraryImport(Libraries.Download, EntryPoint = "download_start")]
        internal static partial int StartDownload(int requestId);
        [LibraryImport(Libraries.Download, EntryPoint = "download_pause")]
        internal static partial int PauseDownload(int requestId);
        [LibraryImport(Libraries.Download, EntryPoint = "download_cancel")]
        internal static partial int CancelDownload(int requestId);
        [LibraryImport(Libraries.Download, EntryPoint = "download_set_state_changed_cb")]
        internal static partial int SetStateChangedCallback(int requestId, StateChangedCallback callback, IntPtr userData);
        [LibraryImport(Libraries.Download, EntryPoint = "download_unset_state_changed_cb")]
        internal static partial int UnsetStateChangedCallback(int requestId);
        [LibraryImport(Libraries.Download, EntryPoint = "download_set_progress_cb")]
        internal static partial int SetProgressCallback(int requestId, ProgressChangedCallback callback, IntPtr userData);
        [LibraryImport(Libraries.Download, EntryPoint = "download_unset_progress_cb")]
        ...
        [LibraryImport(Libraries.Download, EntryPoint = "download_set_cache_lifecycle")]
        internal static partial int SetDownloadCacheLifeCycle(uint time);
        [LibraryImport(Libraries.Download, EntryPoint = "download_get_cache_lifecycle")]
