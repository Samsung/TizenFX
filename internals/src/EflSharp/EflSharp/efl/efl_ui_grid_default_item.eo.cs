...
private static object ContentChangedEvtKey = new object();
    ...
    public Efl.Ui.GridDefaultItemPartEnd End
    {
        get
        {
            return Efl.IPartNativeInherit.efl_part_get_ptr.Value.Delegate(NativeHandle, "end") as Efl.Ui.GridDefaultItemPartEnd;
        }
    }
    /// <summary>No description supplied.</summary>
    public Efl.Ui.GridDefaultItemPartIcon Icon
    {
        get
        {
            return Efl.IPartNativeInherit.efl_part_get_ptr.Value.Delegate(NativeHandle, "icon") as Efl.Ui.GridDefaultItemPartIcon;
        }
    }
