...
namespace UIControlSample
{
    ...
    class MainSample : NUIApplication
    {
        ...
        {
            Window.Instance.WindowSize = new Size2D(1920, 1080);
            ...
            ushort uBtnPageMargin = Convert.ToUInt16(buttonsPageMargin);
            scrollView.Padding = new Extents(uBtnPageMargin, uBtnPageMargin, 0, 0);
        ...
        private void CreateFocusEffect()
        {
            ...
            for (uint i = 0; i < 2; i++)
            {
                mFocusEffect[i].view = new ImageView("./res/images/tile-focus.9.png");
        ...
        {
            Console.WriteLine("---------Print Main Sample---------\n");
