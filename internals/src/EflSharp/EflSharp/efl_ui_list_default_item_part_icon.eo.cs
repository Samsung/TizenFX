...
public class ListDefaultItemPartIcon : Efl.Ui.LayoutPart, Efl.Eo.IWrapper,Efl.Content
{
   ...
   public new delegate void ConstructingMethod(ListDefaultItemPartIcon obj);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)] internal static extern System.IntPtr
      efl_ui_list_default_item_part_icon_class_get();
   ///<summary>Creates a new instance.</summary>
   ///<param name="parent">Parent instance.</param>
   ///<param name="init_cb">Delegate to call constructing methods that should be run inside the constructor.</param>
   public ListDefaultItemPartIcon(Efl.Object parent = null, ConstructingMethod init_cb=null) : base("ListDefaultItemPartIcon", efl_ui_list_default_item_part_icon_class_get(), typeof(ListDefaultItemPartIcon), parent)
   {
      if (init_cb != null) {
         init_cb(this);
      }
   ...
   protected ListDefaultItemPartIcon(String klass_name, IntPtr base_klass, System.Type managed_type, Efl.Object parent) : base(klass_name, base_klass, managed_type, parent) {}
