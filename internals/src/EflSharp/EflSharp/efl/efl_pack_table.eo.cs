...
[Efl.PackTableConcrete.NativeMethods]
    ...
    , Efl.IContainer, Efl.IPack
{
    ...
    private PackTableConcrete(Efl.Eo.Globals.WrappingHandle wh) : base(wh)
    {
    }
...
#pragma warning disable CS0628
    ...
    public bool GetTableCellColumn(Efl.Gfx.IEntity subobj, out int col, out int colspan) {
        var _ret_var = Efl.PackTableConcrete.NativeMethods.efl_pack_table_cell_column_get_ptr.Value.Delegate(this.NativeHandle,subobj, out col, out colspan);
    ...
    public void SetTableCellColumn(Efl.Gfx.IEntity subobj, int col, int colspan) {
        Efl.PackTableConcrete.NativeMethods.efl_pack_table_cell_column_set_ptr.Value.Delegate(this.NativeHandle,subobj, col, colspan);
        Eina.Error.RaiseIfUnhandledException();
    ...
    public bool GetTableCellRow(Efl.Gfx.IEntity subobj, out int row, out int rowspan) {
        var _ret_var = Efl.PackTableConcrete.NativeMethods.efl_pack_table_cell_row_get_ptr.Value.Delegate(this.NativeHandle,subobj, out row, out rowspan);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public void SetTableCellRow(Efl.Gfx.IEntity subobj, int row, int rowspan) {
        Efl.PackTableConcrete.NativeMethods.efl_pack_table_cell_row_set_ptr.Value.Delegate(this.NativeHandle,subobj, row, rowspan);
        Eina.Error.RaiseIfUnhandledException();
    ...
    public void GetTableSize(out int cols, out int rows) {
        Efl.PackTableConcrete.NativeMethods.efl_pack_table_size_get_ptr.Value.Delegate(this.NativeHandle,out cols, out rows);
        Eina.Error.RaiseIfUnhandledException();
    ...
    public void SetTableSize(int cols, int rows) {
        Efl.PackTableConcrete.NativeMethods.efl_pack_table_size_set_ptr.Value.Delegate(this.NativeHandle,cols, rows);
        Eina.Error.RaiseIfUnhandledException();
    ...
    public int GetTableColumns() {
        var _ret_var = Efl.PackTableConcrete.NativeMethods.efl_pack_table_columns_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public void SetTableColumns(int cols) {
        Efl.PackTableConcrete.NativeMethods.efl_pack_table_columns_set_ptr.Value.Delegate(this.NativeHandle,cols);
        Eina.Error.RaiseIfUnhandledException();
    ...
    public int GetTableRows() {
        var _ret_var = Efl.PackTableConcrete.NativeMethods.efl_pack_table_rows_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public void SetTableRows(int rows) {
        Efl.PackTableConcrete.NativeMethods.efl_pack_table_rows_set_ptr.Value.Delegate(this.NativeHandle,rows);
        Eina.Error.RaiseIfUnhandledException();
    ...
    public bool PackTable(Efl.Gfx.IEntity subobj, int col, int row, int colspan, int rowspan) {
        var _ret_var = Efl.PackTableConcrete.NativeMethods.efl_pack_table_ptr.Value.Delegate(this.NativeHandle,subobj, col, row, colspan, rowspan);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public Eina.Iterator<Efl.Gfx.IEntity> GetTableContents(int col, int row, bool below) {
        var _ret_var = Efl.PackTableConcrete.NativeMethods.efl_pack_table_contents_get_ptr.Value.Delegate(this.NativeHandle,col, row, below);
        Eina.Error.RaiseIfUnhandledException();
    ...
    public Efl.Gfx.IEntity GetTableContent(int col, int row) {
        var _ret_var = Efl.PackTableConcrete.NativeMethods.efl_pack_table_content_get_ptr.Value.Delegate(this.NativeHandle,col, row);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public Eina.Iterator<Efl.Gfx.IEntity> IterateContent() {
    ...
    public bool ClearPack() {
        var _ret_var = Efl.PackConcrete.NativeMethods.efl_pack_clear_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public bool UnpackAll() {
        var _ret_var = Efl.PackConcrete.NativeMethods.efl_pack_unpack_all_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public bool Unpack(Efl.Gfx.IEntity subobj) {
        var _ret_var = Efl.PackConcrete.NativeMethods.efl_pack_unpack_ptr.Value.Delegate(this.NativeHandle,subobj);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public bool Pack(Efl.Gfx.IEntity subobj) {
        var _ret_var = Efl.PackConcrete.NativeMethods.efl_pack_ptr.Value.Delegate(this.NativeHandle,subobj);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
...
#if EFL_BETA
#pragma warning disable CS1591
public static class EflPackTableConcrete_ExtensionMethods {
