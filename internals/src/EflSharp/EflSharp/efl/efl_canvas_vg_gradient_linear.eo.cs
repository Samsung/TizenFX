...
public class GradientLinear : Efl.Canvas.Vg.Gradient, Efl.Eo.IWrapper,Efl.Gfx.IGradientLinear
{
    ...
    virtual public void GetStart( out double x,  out double y) {
                                                         Efl.Gfx.IGradientLinearNativeInherit.efl_gfx_gradient_linear_start_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), out x,  out y);
    ...
    virtual public void SetStart( double x,  double y) {
                                                         Efl.Gfx.IGradientLinearNativeInherit.efl_gfx_gradient_linear_start_set_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), x,  y);
        Eina.Error.RaiseIfUnhandledException();
                                         }
    ...
    virtual public void GetEnd( out double x,  out double y) {
                                                         Efl.Gfx.IGradientLinearNativeInherit.efl_gfx_gradient_linear_end_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), out x,  out y);
        Eina.Error.RaiseIfUnhandledException();
                                         }
    ...
    virtual public void SetEnd( double x,  double y) {
                                                         Efl.Gfx.IGradientLinearNativeInherit.efl_gfx_gradient_linear_end_set_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), x,  y);
        Eina.Error.RaiseIfUnhandledException();
                                         }
