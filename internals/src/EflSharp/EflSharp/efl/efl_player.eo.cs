    ...
    
{
    ...
    public System.IntPtr NativeClass {
        get {
            if (((object)this).GetType() == typeof (IPlayerConcrete))
                return Efl.IPlayerNativeInherit.GetEflClassStatic();
            else
    ...
    public bool GetPlayable() {
         var _ret_var = Efl.IPlayerNativeInherit.efl_player_playable_get_ptr.Value.Delegate(this.NativeHandle);
    ...
    /// <returns><c>true</c> if playing, <c>false</c> otherwise.</returns>
    public bool GetPlay() {
         var _ret_var = Efl.IPlayerNativeInherit.efl_player_play_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    /// <summary>Set play/pause state of the media file.
    ...
    public void SetPlay( bool play) {
                                 Efl.IPlayerNativeInherit.efl_player_play_set_ptr.Value.Delegate(this.NativeHandle, play);
        Eina.Error.RaiseIfUnhandledException();
                         }
    /// <summary>Get the position in the media file.
    /// The position is returned as the number of seconds since the beginning of the media file.</summary>
    ...
    public double GetPos() {
         var _ret_var = Efl.IPlayerNativeInherit.efl_player_pos_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    /// <summary>Set the position in the media file.
    ...
    public void SetPos( double sec) {
                                 Efl.IPlayerNativeInherit.efl_player_pos_set_ptr.Value.Delegate(this.NativeHandle, sec);
        Eina.Error.RaiseIfUnhandledException();
                         }
    /// <summary>Get how much of the file has been played.
    /// This function gets the progress in playing the file, the return value is in the [0, 1] range.</summary>
    ...
    public double GetProgress() {
         var _ret_var = Efl.IPlayerNativeInherit.efl_player_progress_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    /// <summary>Control the play speed of the media file.
    ...
    public double GetPlaySpeed() {
         var _ret_var = Efl.IPlayerNativeInherit.efl_player_play_speed_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    /// <summary>Control the play speed of the media file.
    ...
    public void SetPlaySpeed( double speed) {
                                 Efl.IPlayerNativeInherit.efl_player_play_speed_set_ptr.Value.Delegate(this.NativeHandle, speed);
        Eina.Error.RaiseIfUnhandledException();
                         }
    /// <summary>Control the audio volume.
    /// Controls the audio volume of the stream being played. This has nothing to do with the system volume. This volume will be multiplied by the system volume. e.g.: if the current volume level is 0.5, and the system volume is 50%, it will be 0.5 * 0.5 = 0.25.</summary>
    ...
    public double GetVolume() {
         var _ret_var = Efl.IPlayerNativeInherit.efl_player_volume_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    /// <summary>Control the audio volume.
    ...
    public void SetVolume( double volume) {
                                 Efl.IPlayerNativeInherit.efl_player_volume_set_ptr.Value.Delegate(this.NativeHandle, volume);
        Eina.Error.RaiseIfUnhandledException();
                         }
    /// <summary>This property controls the audio mute state.</summary>
    /// <returns>The mute state. <c>true</c> or <c>false</c>.</returns>
    public bool GetMute() {
         var _ret_var = Efl.IPlayerNativeInherit.efl_player_mute_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    /// <summary>This property controls the audio mute state.</summary>
    ...
    public void SetMute( bool mute) {
                                 Efl.IPlayerNativeInherit.efl_player_mute_set_ptr.Value.Delegate(this.NativeHandle, mute);
        Eina.Error.RaiseIfUnhandledException();
                         }
    /// <summary>Get the length of play for the media file.</summary>
    /// <returns>The length of the stream in seconds.</returns>
    public double GetLength() {
         var _ret_var = Efl.IPlayerNativeInherit.efl_player_length_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    /// <summary>Get whether the media file is seekable.</summary>
    ...
    public bool GetSeekable() {
         var _ret_var = Efl.IPlayerNativeInherit.efl_player_seekable_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    /// <summary>Start a playing playable object.</summary>
    /// <returns></returns>
    public void Start() {
         Efl.IPlayerNativeInherit.efl_player_start_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
         }
    /// <summary>Stop playable object.</summary>
    /// <returns></returns>
    public void Stop() {
         Efl.IPlayerNativeInherit.efl_player_stop_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
         }
    /// <summary>Whether or not the playable can be played.</summary>
/// <value><c>true</c> if the object have playable data, <c>false</c> otherwise</value>
...
public class IPlayerNativeInherit  : Efl.Eo.NativeClass{
