...
namespace CoreUI.Wearable {
    /// <summary>Wearable Circle Default Item Class.
    /// 
    ...
    [CoreUI.Wearable.CircleDefaultItem.NativeMethods]
    [CoreUI.Wrapper.BindingEntity]
    [SuppressMessage("Microsoft.Naming", "CA1724:TypeNamesShouldNotMatchNamespaces")]
    public abstract class CircleDefaultItem : CoreUI.Wearable.CircleItem, CoreUI.IContent, CoreUI.IText, CoreUI.ITextMarkup
    {
        ...
        public override System.IntPtr NativeClass
        {
            get
            {
                if (((object)this).GetType() == typeof(CircleDefaultItem))
                {
        ...
        [System.Runtime.InteropServices.DllImport(CoreUI.Libs.Elementary)] internal static extern System.IntPtr
            efl_wearable_circle_default_item_class_get();

        /// <summary>Initializes a new instance of the <see cref="CircleDefaultItem"/> class.
        /// </summary>
        /// <param name="parent">Parent instance.</param>
    /// <param name="style">The widget style to use. See <see cref="CoreUI.UI.Widget.SetStyle" /></param>
        public CircleDefaultItem(CoreUI.Object parent, System.String style = null) : base(efl_wearable_circle_default_item_class_get(), parent)
        {
        ...
        protected CircleDefaultItem(ConstructingHandle ch) : base(ch)
        {
        }
        ...
        internal CircleDefaultItem(CoreUI.Wrapper.WrappingHandle wh) : base(wh)
        {
        }

        [CoreUI.Wrapper.PrivateNativeClass]
        private class CircleDefaultItemRealized : CircleDefaultItem
        {
            private CircleDefaultItemRealized(CoreUI.Wrapper.WrappingHandle wh) : base(wh)
            {
            }
        }
        /// <summary>Initializes a new instance of the <see cref="CircleDefaultItem"/> class.
        ...
        protected CircleDefaultItem(IntPtr baseKlass, CoreUI.Object parent) : base(baseKlass, parent)
        {
        }
        ...
        {
            return CoreUI.Wearable.CircleDefaultItem.efl_wearable_circle_default_item_class_get();
        }
...
#pragma warning disable CS1591
    /// <since_tizen> 6 </since_tizen>
    public static class CircleDefaultItemExtensions {
        /// <since_tizen> 6 </since_tizen>
        public static CoreUI.BindableProperty<CoreUI.Gfx.IEntity> Content<T>(this CoreUI.UI.IGenericFactoryExtended<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Wearable.CircleDefaultItem, T>magic = null) where T : CoreUI.Wearable.CircleDefaultItem {
            return new CoreUI.BindableProperty<CoreUI.Gfx.IEntity>("content", fac.GetPropBind());
        }

        /// <since_tizen> 6 </since_tizen>
        public static CoreUI.BindableProperty<System.String> Text<T>(this CoreUI.UI.IGenericFactoryExtended<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Wearable.CircleDefaultItem, T>magic = null) where T : CoreUI.Wearable.CircleDefaultItem {
            return new CoreUI.BindableProperty<System.String>("text", fac.GetPropBind());
        }

        /// <since_tizen> 6 </since_tizen>
        public static CoreUI.BindableProperty<System.String> Markup<T>(this CoreUI.UI.IGenericFactoryExtended<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Wearable.CircleDefaultItem, T>magic = null) where T : CoreUI.Wearable.CircleDefaultItem {
            return new CoreUI.BindableProperty<System.String>("markup", fac.GetPropBind());
        }

        /// <since_tizen> 6 </since_tizen>
        public static CoreUI.BindableFactoryPart<CoreUI.UI.LayoutPartContent> ExtraPart<T>(this CoreUI.UI.IGenericFactoryPartExtended<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Wearable.CircleDefaultItem, T> x=null) where T : CoreUI.Wearable.CircleDefaultItem
        {
            return new CoreUI.BindableFactoryPart<CoreUI.UI.LayoutPartContent>("extra", fac.GetFactoryBind());
        }

        /// <since_tizen> 6 </since_tizen>
        public static CoreUI.BindableFactoryPart<CoreUI.UI.LayoutPartContent> IconPart<T>(this CoreUI.UI.IGenericFactoryPartExtended<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Wearable.CircleDefaultItem, T> x=null) where T : CoreUI.Wearable.CircleDefaultItem
        {
            return new CoreUI.BindableFactoryPart<CoreUI.UI.LayoutPartContent>("icon", fac.GetFactoryBind());
        }

        /// <since_tizen> 6 </since_tizen>
        public static CoreUI.BindablePart<CoreUI.UI.LayoutPartText> TextPart<T>(this CoreUI.UI.IGenericFactoryPartExtended<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Wearable.CircleDefaultItem, T> x=null) where T : CoreUI.Wearable.CircleDefaultItem
        {
