...
[Efl.Access.ComponentConcrete.NativeMethods]
...
/// <summary>AT-SPI component mixin</summary>
/// <remarks>This is a <b>BETA</b> class. It can be modified or removed in the future. Do not use it for product development.</remarks>
public sealed class ComponentConcrete :
    Efl.Eo.EoWrapper
    , IComponent
    , Efl.Gfx.IEntity, Efl.Gfx.IStack
{
    ...
    private ComponentConcrete(ConstructingHandle ch) : base(ch)
    {
    }
    ...
    private ComponentConcrete(Efl.Eo.Globals.WrappingHandle wh) : base(wh)
    {
    }
...
#pragma warning disable CS0628
    ...
    protected int GetZOrder() {
        var _ret_var = Efl.Access.ComponentConcrete.NativeMethods.efl_access_component_z_order_get_ptr.Value.Delegate(this.NativeHandle);
    ...
    protected Eina.Rect GetExtents(bool screen_coords) {
        var _ret_var = Efl.Access.ComponentConcrete.NativeMethods.efl_access_component_extents_get_ptr.Value.Delegate(this.NativeHandle,screen_coords);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    protected bool SetExtents(bool screen_coords, Eina.Rect rect) {
        Eina.Rect.NativeStruct _in_rect = rect;
var _ret_var = Efl.Access.ComponentConcrete.NativeMethods.efl_access_component_extents_set_ptr.Value.Delegate(this.NativeHandle,screen_coords, _in_rect);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    protected void GetScreenPosition(out int x, out int y) {
        Efl.Access.ComponentConcrete.NativeMethods.efl_access_component_screen_position_get_ptr.Value.Delegate(this.NativeHandle,out x, out y);
        Eina.Error.RaiseIfUnhandledException();
    ...
    protected bool SetScreenPosition(int x, int y) {
        var _ret_var = Efl.Access.ComponentConcrete.NativeMethods.efl_access_component_screen_position_set_ptr.Value.Delegate(this.NativeHandle,x, y);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }

    /// <summary>Gets position of socket offset.</summary>
    protected void GetSocketOffset(out int x, out int y) {
        Efl.Access.ComponentConcrete.NativeMethods.efl_access_component_socket_offset_get_ptr.Value.Delegate(this.NativeHandle,out x, out y);
        Eina.Error.RaiseIfUnhandledException();
        
    }

    /// <summary>Sets position of socket offset.</summary>
    protected void SetSocketOffset(int x, int y) {
        Efl.Access.ComponentConcrete.NativeMethods.efl_access_component_socket_offset_set_ptr.Value.Delegate(this.NativeHandle,x, y);
        Eina.Error.RaiseIfUnhandledException();
    ...
    protected bool Contains(bool screen_coords, int x, int y) {
        var _ret_var = Efl.Access.ComponentConcrete.NativeMethods.efl_access_component_contains_ptr.Value.Delegate(this.NativeHandle,screen_coords, x, y);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    protected bool GrabFocus() {
        var _ret_var = Efl.Access.ComponentConcrete.NativeMethods.efl_access_component_focus_grab_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    protected Efl.Object GetAccessibleAtPoint(bool screen_coords, int x, int y) {
        var _ret_var = Efl.Access.ComponentConcrete.NativeMethods.efl_access_component_accessible_at_point_get_ptr.Value.Delegate(this.NativeHandle,screen_coords, x, y);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    protected bool GrabHighlight() {
        var _ret_var = Efl.Access.ComponentConcrete.NativeMethods.efl_access_component_highlight_grab_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    /// if MOBILE since_tizen 4.0 elseif WEARABLE since_tizen 3.0 endif</summary>
    protected bool ClearHighlight() {
        var _ret_var = Efl.Access.ComponentConcrete.NativeMethods.efl_access_component_highlight_clear_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public Eina.Position2D GetPosition() {
        var _ret_var = Efl.Gfx.EntityConcrete.NativeMethods.efl_gfx_entity_position_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
...
Efl.Gfx.EntityConcrete.NativeMethods.efl_gfx_entity_position_set_ptr.Value.Delegate(this.NativeHandle,_in_pos);
        Eina.Error.RaiseIfUnhandledException();
    ...
    public Eina.Size2D GetSize() {
        var _ret_var = Efl.Gfx.EntityConcrete.NativeMethods.efl_gfx_entity_size_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
...
Efl.Gfx.EntityConcrete.NativeMethods.efl_gfx_entity_size_set_ptr.Value.Delegate(this.NativeHandle,_in_size);
        Eina.Error.RaiseIfUnhandledException();
    ...
    public Eina.Rect GetGeometry() {
        var _ret_var = Efl.Gfx.EntityConcrete.NativeMethods.efl_gfx_entity_geometry_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public void SetGeometry(Eina.Rect rect) {
        Eina.Rect.NativeStruct _in_rect = rect;
Efl.Gfx.EntityConcrete.NativeMethods.efl_gfx_entity_geometry_set_ptr.Value.Delegate(this.NativeHandle,_in_rect);
        Eina.Error.RaiseIfUnhandledException();
    ...
    public bool GetVisible() {
        var _ret_var = Efl.Gfx.EntityConcrete.NativeMethods.efl_gfx_entity_visible_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public void SetVisible(bool v) {
        Efl.Gfx.EntityConcrete.NativeMethods.efl_gfx_entity_visible_set_ptr.Value.Delegate(this.NativeHandle,v);
        Eina.Error.RaiseIfUnhandledException();
    ...
    public double GetScale() {
        var _ret_var = Efl.Gfx.EntityConcrete.NativeMethods.efl_gfx_entity_scale_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public void SetScale(double scale) {
        Efl.Gfx.EntityConcrete.NativeMethods.efl_gfx_entity_scale_set_ptr.Value.Delegate(this.NativeHandle,scale);
        Eina.Error.RaiseIfUnhandledException();
    ...
    /// 
    /// See also <see cref="Efl.Gfx.IStack.Layer"/>.</summary>
    /// <since_tizen> 6 </since_tizen>
    ...
    /// 
    /// See also <see cref="Efl.Gfx.IStack.Layer"/> and <see cref="Efl.Gfx.IStack.GetBelow"/></summary>
    /// <since_tizen> 6 </since_tizen>
    /// <returns>The <see cref="Efl.Gfx.IStack"/> object directly below <c>obj</c>, if any, or <c>null</c>, if none.</returns>
    ...
    /// 
    /// See also <see cref="Efl.Gfx.IStack.GetLayer"/>, <see cref="Efl.Gfx.IStack.SetLayer"/> and <see cref="Efl.Gfx.IStack.StackBelow"/></summary>
    /// <since_tizen> 6 </since_tizen>
    ...
    /// 
    /// See also <see cref="Efl.Gfx.IStack.StackAbove"/>, <see cref="Efl.Gfx.IStack.StackBelow"/> and <see cref="Efl.Gfx.IStack.LowerToBottom"/></summary>
    /// <since_tizen> 6 </since_tizen>
    ...
    /// 
    /// See also <see cref="Efl.Gfx.IStack.StackAbove"/>, <see cref="Efl.Gfx.IStack.StackBelow"/> and <see cref="Efl.Gfx.IStack.RaiseToTop"/></summary>
    /// <since_tizen> 6 </since_tizen>
...
#if EFL_BETA
#pragma warning disable CS1591
public static class Efl_AccessComponentConcrete_ExtensionMethods {
