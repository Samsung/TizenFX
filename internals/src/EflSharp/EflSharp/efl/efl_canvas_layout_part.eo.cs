...
private static object SizeChangedEvtKey = new object();
    ...
    virtual public bool GetDragValue( out double dx,  out double dy) {
                                                         var _ret_var = Efl.Ui.IDragNativeInherit.efl_ui_drag_value_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), out dx,  out dy);
        Eina.Error.RaiseIfUnhandledException();
                                        return _ret_var;
 }
    ...
    virtual public bool SetDragValue( double dx,  double dy) {
                                                         var _ret_var = Efl.Ui.IDragNativeInherit.efl_ui_drag_value_set_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), dx,  dy);
        Eina.Error.RaiseIfUnhandledException();
                                        return _ret_var;
 }
    ...
    virtual public bool GetDragSize( out double dw,  out double dh) {
                                                         var _ret_var = Efl.Ui.IDragNativeInherit.efl_ui_drag_size_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), out dw,  out dh);
        Eina.Error.RaiseIfUnhandledException();
                                        return _ret_var;
 }
    ...
    virtual public bool SetDragSize( double dw,  double dh) {
                                                         var _ret_var = Efl.Ui.IDragNativeInherit.efl_ui_drag_size_set_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), dw,  dh);
        Eina.Error.RaiseIfUnhandledException();
                                        return _ret_var;
 }
    ...
    virtual public Efl.Ui.DragDir GetDragDir() {
         var _ret_var = Efl.Ui.IDragNativeInherit.efl_ui_drag_dir_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    ...
    virtual public bool GetDragStep( out double dx,  out double dy) {
                                                         var _ret_var = Efl.Ui.IDragNativeInherit.efl_ui_drag_step_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), out dx,  out dy);
        Eina.Error.RaiseIfUnhandledException();
                                        return _ret_var;
 }
    ...
    virtual public bool SetDragStep( double dx,  double dy) {
                                                         var _ret_var = Efl.Ui.IDragNativeInherit.efl_ui_drag_step_set_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), dx,  dy);
        Eina.Error.RaiseIfUnhandledException();
                                        return _ret_var;
 }
    ...
    virtual public bool GetDragPage( out double dx,  out double dy) {
                                                         var _ret_var = Efl.Ui.IDragNativeInherit.efl_ui_drag_page_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), out dx,  out dy);
        Eina.Error.RaiseIfUnhandledException();
                                        return _ret_var;
 }
    ...
    virtual public bool SetDragPage( double dx,  double dy) {
                                                         var _ret_var = Efl.Ui.IDragNativeInherit.efl_ui_drag_page_set_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), dx,  dy);
        Eina.Error.RaiseIfUnhandledException();
                                        return _ret_var;
 }
    ...
    virtual public bool MoveDragStep( double dx,  double dy) {
                                                         var _ret_var = Efl.Ui.IDragNativeInherit.efl_ui_drag_step_move_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), dx,  dy);
        Eina.Error.RaiseIfUnhandledException();
                                        return _ret_var;
 }
    ...
    virtual public bool MoveDragPage( double dx,  double dy) {
                                                         var _ret_var = Efl.Ui.IDragNativeInherit.efl_ui_drag_page_move_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), dx,  dy);
        Eina.Error.RaiseIfUnhandledException();
                                        return _ret_var;
 }
