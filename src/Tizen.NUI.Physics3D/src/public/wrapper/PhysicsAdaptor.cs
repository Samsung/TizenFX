...
namespace Tizen.NUI.Physics3D
{
    ...
    public class PhysicsAdaptor : NUI.BaseHandle
    {
        ...
        /// </summary>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public PhysicsActor AddViewToBody(View view, Bullet.RigidBody body)
        {
            // @todo Converting a View to an Actor internally _should_ be OK?!
            global::System.IntPtr cPtr = Interop.Adaptor.AddActorBody(SwigCPtr, View.getCPtr(view), body.Native);
            if(NDalicPINVOKE.SWIGPendingException.Pending)
                throw NDalicPINVOKE.SWIGPendingException.Retrieve();
        ...
        /// </summary>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public PhysicsActor GetPhysicsActor(Bullet.RigidBody body)
        {
            global::System.IntPtr cPtr = Interop.Adaptor.GetPhysicsActor(SwigCPtr, body.Native);
            if(NDalicPINVOKE.SWIGPendingException.Pending)
                throw NDalicPINVOKE.SWIGPendingException.Retrieve();
