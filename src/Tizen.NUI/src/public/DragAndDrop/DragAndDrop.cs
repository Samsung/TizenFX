...
namespace Tizen.NUI
{
    ...
    public class DragAndDrop : BaseHandle
    {
        ...
        {            
            ...
            Tizen.Log.Fatal("NUI", "Start Drag And Drop 1");
            ...
            Tizen.Log.Fatal("NUI", "Start Drag And Drop 2");
            ...
            if (mDragWindow)
            {
                ...
                Tizen.Log.Fatal("NUI", "Start Drag And Drop 3");
                if (mDragWindow)
                {
                    mDragWindow.Show();
                }
            ...
            Tizen.Log.Fatal("NUI", "Start Drag And Drop Finished");
            initDrag = false;
