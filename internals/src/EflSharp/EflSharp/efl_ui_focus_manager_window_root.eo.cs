...
[ManagerWindowRootConcreteNativeInherit]
   ...
   public System.IntPtr NativeClass {
      get {
         if (((object)this).GetType() == typeof (ManagerWindowRootConcrete))
            return Efl.Ui.Focus.ManagerWindowRootConcreteNativeInherit.GetEflClassStatic();
         else
...
public class ManagerWindowRootConcreteNativeInherit : Efl.Eo.NativeClass{
