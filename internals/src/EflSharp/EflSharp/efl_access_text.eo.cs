   ...
   public System.IntPtr NativeClass {
      get {
         if (((object)this).GetType() == typeof (TextConcrete))
            return Efl.Access.TextConcreteNativeInherit.GetEflClassStatic();
         else
...
private static object AccessTextSelectionChangedEvtKey = new object();
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern Eina.Unicode efl_access_text_character_get(System.IntPtr obj,    int offset);
   /// <summary>Gets single character present in accessible widget&apos;s text at given offset.</summary>
   /// <param name="offset">Position in text.</param>
   /// <returns>Character at offset. 0 when out-of bounds offset has been given. Codepoints between DC80 and DCFF indicates that string includes invalid UTF8 chars.</returns>
   public Eina.Unicode GetCharacter(  int offset) {
                         var _ret_var = efl_access_text_character_get(Efl.Access.TextConcrete.efl_access_text_interface_get(),  offset);
      Eina.Error.RaiseIfUnhandledException();
                  return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(Efl.Eo.StringPassOwnershipMarshaler))] private static extern  System.String efl_access_text_string_get(System.IntPtr obj,   Efl.Access.TextGranularity granularity,    System.IntPtr start_offset,    System.IntPtr end_offset);
   /// <summary>Gets string, start and end offset in text according to given initial offset and granularity.</summary>
   /// <param name="granularity">Text granularity</param>
   /// <param name="start_offset">Offset indicating start of string according to given granularity.  -1 in case of error.</param>
   /// <param name="end_offset">Offset indicating end of string according to given granularity. -1 in case of error.</param>
   ...
   public  System.String GetString( Efl.Access.TextGranularity granularity,   int start_offset,   int end_offset) {
      ...
      var _in_end_offset = Eina.PrimitiveConversion.ManagedToPointerAlloc(end_offset);
                                          var _ret_var = efl_access_text_string_get(Efl.Access.TextConcrete.efl_access_text_interface_get(),  granularity,  _in_start_offset,  _in_end_offset);
      Eina.Error.RaiseIfUnhandledException();
                                          return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(Efl.Eo.StringPassOwnershipMarshaler))] private static extern  System.String efl_access_text_get(System.IntPtr obj,    int start_offset,    int end_offset);
   /// <summary>Gets text of accessible widget.</summary>
   /// <param name="start_offset">Position in text.</param>
   /// <param name="end_offset">End offset of text.</param>
   /// <returns>UTF-8 encoded text.</returns>
   public  System.String GetAccessText(  int start_offset,   int end_offset) {
                                           var _ret_var = efl_access_text_get(Efl.Access.TextConcrete.efl_access_text_interface_get(),  start_offset,  end_offset);
      Eina.Error.RaiseIfUnhandledException();
                              return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  int efl_access_text_caret_offset_get(System.IntPtr obj);
   /// <summary>Gets offset position of caret (cursor)</summary>
   /// <returns>Offset</returns>
   public  int GetCaretOffset() {
       var _ret_var = efl_access_text_caret_offset_get(Efl.Access.TextConcrete.efl_access_text_interface_get());
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    [return: MarshalAs(UnmanagedType.U1)] private static extern bool efl_access_text_caret_offset_set(System.IntPtr obj,    int offset);
   /// <summary>Caret offset property</summary>
   /// <param name="offset">Offset</param>
   /// <returns><c>true</c> if caret was successfully moved, <c>false</c> otherwise.</returns>
   public bool SetCaretOffset(  int offset) {
                         var _ret_var = efl_access_text_caret_offset_set(Efl.Access.TextConcrete.efl_access_text_interface_get(),  offset);
      Eina.Error.RaiseIfUnhandledException();
                  return _ret_var;
 }
   ...
   public bool GetAttribute(  System.String name,   int start_offset,   int end_offset,  out  System.String value) {
             var _in_start_offset = Eina.PrimitiveConversion.ManagedToPointerAlloc(start_offset);
      var _in_end_offset = Eina.PrimitiveConversion.ManagedToPointerAlloc(end_offset);
                                                            var _ret_var = efl_access_text_attribute_get(Efl.Access.TextConcrete.efl_access_text_interface_get(),  name,  _in_start_offset,  _in_end_offset,  out value);
      Eina.Error.RaiseIfUnhandledException();
                                                      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  System.IntPtr efl_access_text_attributes_get(System.IntPtr obj,    System.IntPtr start_offset,    System.IntPtr end_offset);
   /// <summary>Gets list of all text attributes.</summary>
   /// <param name="start_offset">Start offset</param>
   /// <param name="end_offset">End offset</param>
   /// <returns>List of text attributes</returns>
   public Eina.List<Efl.Access.TextAttribute> GetTextAttributes(  int start_offset,   int end_offset) {
       var _in_start_offset = Eina.PrimitiveConversion.ManagedToPointerAlloc(start_offset);
      var _in_end_offset = Eina.PrimitiveConversion.ManagedToPointerAlloc(end_offset);
                              var _ret_var = efl_access_text_attributes_get(Efl.Access.TextConcrete.efl_access_text_interface_get(),  _in_start_offset,  _in_end_offset);
      Eina.Error.RaiseIfUnhandledException();
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  System.IntPtr efl_access_text_default_attributes_get(System.IntPtr obj);
   /// <summary>Default attributes</summary>
   /// <returns>List of default attributes</returns>
   public Eina.List<Efl.Access.TextAttribute> GetDefaultAttributes() {
       var _ret_var = efl_access_text_default_attributes_get(Efl.Access.TextConcrete.efl_access_text_interface_get());
      Eina.Error.RaiseIfUnhandledException();
      return new Eina.List<Efl.Access.TextAttribute>(_ret_var, true, true);
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    [return: MarshalAs(UnmanagedType.U1)] private static extern bool efl_access_text_character_extents_get(System.IntPtr obj,    int offset,  [MarshalAs(UnmanagedType.U1)]  bool screen_coords,   out Eina.Rect_StructInternal rect);
   /// <summary>Character extents</summary>
   /// <param name="offset">Offset</param>
   /// <param name="screen_coords">If <c>true</c>, x and y values will be relative to screen origin, otherwise relative to canvas</param>
   /// <param name="rect">Extents rectangle</param>
   ...
   public bool GetCharacterExtents(  int offset,  bool screen_coords,  out Eina.Rect rect) {
                        ...
                        var _ret_var = efl_access_text_character_extents_get(Efl.Access.TextConcrete.efl_access_text_interface_get(),  offset,  screen_coords,  out _out_rect);
      Eina.Error.RaiseIfUnhandledException();
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  int efl_access_text_character_count_get(System.IntPtr obj);
   /// <summary>Character count</summary>
   /// <returns>Character count</returns>
   public  int GetCharacterCount() {
       var _ret_var = efl_access_text_character_count_get(Efl.Access.TextConcrete.efl_access_text_interface_get());
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  int efl_access_text_offset_at_point_get(System.IntPtr obj,  [MarshalAs(UnmanagedType.U1)]  bool screen_coords,    int x,    int y);
   /// <summary>Offset at given point</summary>
   /// <param name="screen_coords">If <c>true</c>, x and y values will be relative to screen origin, otherwise relative to canvas</param>
   /// <param name="x">X coordinate</param>
   /// <param name="y">Y coordinate</param>
   ...
   public  int GetOffsetAtPoint( bool screen_coords,   int x,   int y) {
                                                             var _ret_var = efl_access_text_offset_at_point_get(Efl.Access.TextConcrete.efl_access_text_interface_get(),  screen_coords,  x,  y);
      Eina.Error.RaiseIfUnhandledException();
                                          return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  System.IntPtr efl_access_text_bounded_ranges_get(System.IntPtr obj,  [MarshalAs(UnmanagedType.U1)]  bool screen_coords,   Eina.Rect_StructInternal rect,   Efl.Access.TextClipType xclip,   Efl.Access.TextClipType yclip);
   /// <summary>Bounded ranges</summary>
   /// <param name="screen_coords">If <c>true</c>, x and y values will be relative to screen origin, otherwise relative to canvas</param>
   /// <param name="rect">Bounding box</param>
   /// <param name="xclip">xclip</param>
   ...
   public Eina.List<Efl.Access.TextRange> GetBoundedRanges( bool screen_coords,  Eina.Rect rect,  Efl.Access.TextClipType xclip,  Efl.Access.TextClipType yclip) {
             var _in_rect = Eina.Rect_StructConversion.ToInternal(rect);
                                                                  var _ret_var = efl_access_text_bounded_ranges_get(Efl.Access.TextConcrete.efl_access_text_interface_get(),  screen_coords,  _in_rect,  xclip,  yclip);
      Eina.Error.RaiseIfUnhandledException();
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    [return: MarshalAs(UnmanagedType.U1)] private static extern bool efl_access_text_range_extents_get(System.IntPtr obj,  [MarshalAs(UnmanagedType.U1)]  bool screen_coords,    int start_offset,    int end_offset,   out Eina.Rect_StructInternal rect);
   /// <summary>Range extents</summary>
   /// <param name="screen_coords">If <c>true</c>, x and y values will be relative to screen origin, otherwise relative to canvas</param>
   /// <param name="start_offset">Start offset</param>
   /// <param name="end_offset">End offset</param>
   ...
   public bool GetRangeExtents( bool screen_coords,   int start_offset,   int end_offset,  out Eina.Rect rect) {
                                                 var _out_rect = new Eina.Rect_StructInternal();
                              var _ret_var = efl_access_text_range_extents_get(Efl.Access.TextConcrete.efl_access_text_interface_get(),  screen_coords,  start_offset,  end_offset,  out _out_rect);
      Eina.Error.RaiseIfUnhandledException();
                        rect = Eina.Rect_StructConversion.ToManaged(_out_rect);
                              return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  int efl_access_text_selections_count_get(System.IntPtr obj);
   /// <summary>Selection count property</summary>
   /// <returns>Selection counter</returns>
   public  int GetSelectionsCount() {
       var _ret_var = efl_access_text_selections_count_get(Efl.Access.TextConcrete.efl_access_text_interface_get());
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void efl_access_text_access_selection_get(System.IntPtr obj,    int selection_number,   out  int start_offset,   out  int end_offset);
   /// <summary>Selection property</summary>
   /// <param name="selection_number">Selection number for identification</param>
   /// <param name="start_offset">Selection start offset</param>
   /// <param name="end_offset">Selection end offset</param>
   ...
   public  void GetAccessSelection(  int selection_number,  out  int start_offset,  out  int end_offset) {
                                                             efl_access_text_access_selection_get(Efl.Access.TextConcrete.efl_access_text_interface_get(),  selection_number,  out start_offset,  out end_offset);
      Eina.Error.RaiseIfUnhandledException();
                                           }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    [return: MarshalAs(UnmanagedType.U1)] private static extern bool efl_access_text_access_selection_set(System.IntPtr obj,    int selection_number,    int start_offset,    int end_offset);
   /// <summary>Selection property</summary>
   /// <param name="selection_number">Selection number for identification</param>
   /// <param name="start_offset">Selection start offset</param>
   /// <param name="end_offset">Selection end offset</param>
   ...
   public bool SetAccessSelection(  int selection_number,   int start_offset,   int end_offset) {
                                                             var _ret_var = efl_access_text_access_selection_set(Efl.Access.TextConcrete.efl_access_text_interface_get(),  selection_number,  start_offset,  end_offset);
      Eina.Error.RaiseIfUnhandledException();
                                          return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    [return: MarshalAs(UnmanagedType.U1)] private static extern bool efl_access_text_selection_add(System.IntPtr obj,    int start_offset,    int end_offset);
   /// <summary>Add selection</summary>
   /// <param name="start_offset">Start selection from this offset</param>
   /// <param name="end_offset">End selection at this offset</param>
   /// <returns><c>true</c> if selection was added, <c>false</c> otherwise</returns>
   public bool AddSelection(  int start_offset,   int end_offset) {
                                           var _ret_var = efl_access_text_selection_add(Efl.Access.TextConcrete.efl_access_text_interface_get(),  start_offset,  end_offset);
      Eina.Error.RaiseIfUnhandledException();
                              return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    [return: MarshalAs(UnmanagedType.U1)] private static extern bool efl_access_text_selection_remove(System.IntPtr obj,    int selection_number);
   /// <summary>Remove selection</summary>
   /// <param name="selection_number">Selection number to be removed</param>
   /// <returns><c>true</c> if selection was removed, <c>false</c> otherwise</returns>
   public bool SelectionRemove(  int selection_number) {
                         var _ret_var = efl_access_text_selection_remove(Efl.Access.TextConcrete.efl_access_text_interface_get(),  selection_number);
      Eina.Error.RaiseIfUnhandledException();
                  return _ret_var;
 }
   /// <summary>Caret offset property</summary>
...
public static class TextChangeInfo_StructConversion
{
   internal static TextChangeInfo_StructInternal ToInternal(TextChangeInfo _external_struct)
   {
      ...
      _internal_struct.Inserted = _external_struct.Inserted;
   ...
   internal static TextChangeInfo ToManaged(TextChangeInfo_StructInternal _internal_struct)
   {
      ...
      _external_struct.Inserted = _internal_struct.Inserted;
