...
[IRangeInteractiveNativeInherit]
    ...
    , Efl.Ui.IRangeDisplay
{
    ...
    public System.IntPtr NativeClass {
        get {
            if (((object)this).GetType() == typeof (IRangeInteractiveConcrete))
                return Efl.Ui.IRangeInteractiveNativeInherit.GetEflClassStatic();
            else
    ...
    public double GetRangeStep() {
         var _ret_var = Efl.Ui.IRangeInteractiveNativeInherit.efl_ui_range_step_get_ptr.Value.Delegate(this.NativeHandle);
    ...
    public void SetRangeStep( double step) {
                                 Efl.Ui.IRangeInteractiveNativeInherit.efl_ui_range_step_set_ptr.Value.Delegate(this.NativeHandle, step);
        Eina.Error.RaiseIfUnhandledException();
                         }
    ...
    public double GetRangeValue() {
         var _ret_var = Efl.Ui.IRangeDisplayNativeInherit.efl_ui_range_value_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    /// <summary>Control the range value (in percentage) on a given range widget
    ...
    public void SetRangeValue( double val) {
                                 Efl.Ui.IRangeDisplayNativeInherit.efl_ui_range_value_set_ptr.Value.Delegate(this.NativeHandle, val);
        Eina.Error.RaiseIfUnhandledException();
                         }
    ...
    public void GetRangeMinMax( out double min,  out double max) {
                                                         Efl.Ui.IRangeDisplayNativeInherit.efl_ui_range_min_max_get_ptr.Value.Delegate(this.NativeHandle, out min,  out max);
        Eina.Error.RaiseIfUnhandledException();
                                         }
    ...
    public void SetRangeMinMax( double min,  double max) {
                                                         Efl.Ui.IRangeDisplayNativeInherit.efl_ui_range_min_max_set_ptr.Value.Delegate(this.NativeHandle, min,  max);
        Eina.Error.RaiseIfUnhandledException();
                                         }
    /// <summary>Control the step used to increment or decrement values for given widget.
/// This value will be incremented or decremented to the displayed value.
...
public class IRangeInteractiveNativeInherit  : Efl.Eo.NativeClass{
