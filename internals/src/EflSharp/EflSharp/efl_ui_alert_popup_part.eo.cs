...
public class AlertPopupPart : Efl.Ui.LayoutPartText, Efl.Eo.IWrapper
{
   ...
   public new delegate void ConstructingMethod(AlertPopupPart obj);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)] internal static extern System.IntPtr
      efl_ui_alert_popup_part_class_get();
   ///<summary>Creates a new instance.</summary>
   ///<param name="parent">Parent instance.</param>
   ///<param name="init_cb">Delegate to call constructing methods that should be run inside the constructor.</param>
   public AlertPopupPart(Efl.Object parent = null, ConstructingMethod init_cb=null) : base("AlertPopupPart", efl_ui_alert_popup_part_class_get(), typeof(AlertPopupPart), parent)
   {
      if (init_cb != null) {
         init_cb(this);
      }
   ...
   protected AlertPopupPart(String klass_name, IntPtr base_klass, System.Type managed_type, Efl.Object parent) : base(klass_name, base_klass, managed_type, parent) {}
