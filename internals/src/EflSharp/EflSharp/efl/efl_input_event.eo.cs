...
[Efl.Input.EventConcrete.NativeMethods]
    ...
    , Efl.IDuplicate
{
    ...
    private EventConcrete(Efl.Eo.Globals.WrappingHandle wh) : base(wh)
    {
    }
...
#pragma warning disable CS0628
    ...
    public double GetTimestamp() {
         var _ret_var = Efl.Input.EventConcrete.NativeMethods.efl_input_timestamp_get_ptr.Value.Delegate(this.NativeHandle);
    ...
    public void SetTimestamp(double ms) {
                                 Efl.Input.EventConcrete.NativeMethods.efl_input_timestamp_set_ptr.Value.Delegate(this.NativeHandle,ms);
        Eina.Error.RaiseIfUnhandledException();
                         }
    /// <summary>Input device that originated this event.</summary>
    /// <returns>Input device origin</returns>
    public Efl.Input.Device GetDevice() {
         var _ret_var = Efl.Input.EventConcrete.NativeMethods.efl_input_device_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    /// <summary>Input device that originated this event.</summary>
    ...
    public void SetDevice(Efl.Input.Device dev) {
                                 Efl.Input.EventConcrete.NativeMethods.efl_input_device_set_ptr.Value.Delegate(this.NativeHandle,dev);
        Eina.Error.RaiseIfUnhandledException();
                         }
    /// <summary>Extra flags for this event, may be changed by the user.</summary>
    /// <returns>Input event flags</returns>
    public Efl.Input.Flags GetEventFlags() {
         var _ret_var = Efl.Input.EventConcrete.NativeMethods.efl_input_event_flags_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    /// <summary>Extra flags for this event, may be changed by the user.</summary>
    ...
    public void SetEventFlags(Efl.Input.Flags flags) {
                                 Efl.Input.EventConcrete.NativeMethods.efl_input_event_flags_set_ptr.Value.Delegate(this.NativeHandle,flags);
        Eina.Error.RaiseIfUnhandledException();
                         }
    /// <summary><c>true</c> if <see cref="Efl.Input.IEvent.EventFlags"/> indicates the event is on hold.</summary>
    /// <returns><c>true</c> if the event is on hold, <c>false</c> otherwise</returns>
    public bool GetProcessed() {
         var _ret_var = Efl.Input.EventConcrete.NativeMethods.efl_input_processed_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    /// <summary><c>true</c> if <see cref="Efl.Input.IEvent.EventFlags"/> indicates the event is on hold.</summary>
    ...
    public void SetProcessed(bool val) {
                                 Efl.Input.EventConcrete.NativeMethods.efl_input_processed_set_ptr.Value.Delegate(this.NativeHandle,val);
        Eina.Error.RaiseIfUnhandledException();
                         }
    /// <summary><c>true</c> if <see cref="Efl.Input.IEvent.EventFlags"/> indicates the event happened while scrolling.</summary>
    /// <returns><c>true</c> if the event happened while scrolling, <c>false</c> otherwise</returns>
    public bool GetScrolling() {
         var _ret_var = Efl.Input.EventConcrete.NativeMethods.efl_input_scrolling_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    /// <summary><c>true</c> if <see cref="Efl.Input.IEvent.EventFlags"/> indicates the event happened while scrolling.</summary>
    ...
    public void SetScrolling(bool val) {
                                 Efl.Input.EventConcrete.NativeMethods.efl_input_scrolling_set_ptr.Value.Delegate(this.NativeHandle,val);
        Eina.Error.RaiseIfUnhandledException();
                         }
    /// <summary><c>true</c> if the event was fake, not triggered by real hardware.</summary>
    /// <returns><c>true</c> if the event was not from real hardware, <c>false</c> otherwise</returns>
    public bool GetFake() {
         var _ret_var = Efl.Input.EventConcrete.NativeMethods.efl_input_fake_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    /// <summary>Resets the internal data to 0 or default values.</summary>
    public void Reset() {
         Efl.Input.EventConcrete.NativeMethods.efl_input_reset_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
         }
...
#if EFL_BETA
#pragma warning disable CS1591
public static class Efl_InputEventConcrete_ExtensionMethods {
