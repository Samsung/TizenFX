...
namespace Efl { 
/// <summary>Used as a child of <see cref="Efl.ModelContainer"/>.
/// Provides the <see cref="Efl.Model"/> API for elements of <see cref="Efl.ModelContainer"/>. Should not be used in another context, so do not manually create objects of this class.</summary>
[ModelContainerItemNativeInherit]
public class ModelContainerItem : Efl.Object, Efl.Eo.IWrapper,Efl.Model
{
   public new static System.IntPtr klass = System.IntPtr.Zero;
   public new static Efl.ModelContainerItemNativeInherit nativeInherit = new Efl.ModelContainerItemNativeInherit();
   ///<summary>Pointer to the native class description.</summary>
   public override System.IntPtr NativeClass {
      get {
         if (((object)this).GetType() == typeof (ModelContainerItem))
            return Efl.ModelContainerItemNativeInherit.GetEflClassStatic();
         else
            return Efl.Eo.Globals.klasses[((object)this).GetType()];
      }
   }
   ///<summary>Delegate for function to be called from inside the native constructor.</summary>
   public new delegate void ConstructingMethod(ModelContainerItem obj);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Ecore)] internal static extern System.IntPtr
      efl_model_container_item_class_get();
   ///<summary>Creates a new instance.</summary>
   ///<param name="parent">Parent instance.</param>
   ///<param name="init_cb">Delegate to call constructing methods that should be run inside the constructor.</param>
   public ModelContainerItem(Efl.Object parent = null, ConstructingMethod init_cb=null) : base("ModelContainerItem", efl_model_container_item_class_get(), typeof(ModelContainerItem), parent)
   {
      if (init_cb != null) {
         init_cb(this);
      }
   ...
   protected ModelContainerItem(String klass_name, IntPtr base_klass, System.Type managed_type, Efl.Object parent) : base(klass_name, base_klass, managed_type, parent) {}
   ///<summary>Constructs an instance from a native pointer.</summary>
   public ModelContainerItem(System.IntPtr raw) : base(raw)
   {
            register_event_proxies();
   }
   ///<summary>Casts obj into an instance of this type.</summary>
   public new static ModelContainerItem static_cast(Efl.Object obj)
   {
      if (obj == null)
         throw new System.ArgumentNullException("obj");
      return new ModelContainerItem(obj.NativeHandle);
   }
...
private static object ChildrenCountChangedEvtKey = new object();
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Ecore)]
    protected static extern  void efl_model_container_item_define(System.IntPtr obj,    System.IntPtr parent_data,    uint index);
   /// <summary>Defines <see cref="Efl.ModelContainerItem"/> internal data.</summary>
   /// <param name="parent_data">Pointer to the private data of the <see cref="Efl.ModelContainer"/> parent object.</param>
   /// <param name="index">Index of this item within the <see cref="Efl.ModelContainer"/> children.</param>
   /// <returns></returns>
   virtual public  void Define(  System.IntPtr parent_data,   uint index) {
                                           efl_model_container_item_define((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle),  parent_data,  index);
...
public class ModelContainerItemNativeInherit : Efl.ObjectNativeInherit{
   public override System.Collections.Generic.List<Efl_Op_Description> GetEoOps(System.Type type)
   {
      var descs = new System.Collections.Generic.List<Efl_Op_Description>();
      efl_model_container_item_define_static_delegate = new efl_model_container_item_define_delegate(define);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_model_container_item_define"), func = Marshal.GetFunctionPointerForDelegate(efl_model_container_item_define_static_delegate)});
   ...
   {
      return Efl.ModelContainerItem.efl_model_container_item_class_get();
   }
   public static new  IntPtr GetEflClassStatic()
   {
    ...
    private delegate  void efl_model_container_item_define_delegate(System.IntPtr obj, System.IntPtr pd,    System.IntPtr parent_data,    uint index);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Ecore)]  private static extern  void efl_model_container_item_define(System.IntPtr obj,    System.IntPtr parent_data,    uint index);
    private static  void define(System.IntPtr obj, System.IntPtr pd,   System.IntPtr parent_data,   uint index)
   {
      Eina.Log.Debug("function efl_model_container_item_define was called");
      Efl.Eo.IWrapper wrapper = Efl.Eo.Globals.data_get(pd);
      if(wrapper != null) {
                                                      
         try {
            ((ModelContainerItem)wrapper).Define( parent_data,  index);
         } catch (Exception e) {
            Eina.Log.Warning($"Callback error: {e.ToString()}");
            Eina.Error.Set(Eina.Error.UNHANDLED_EXCEPTION);
         }
                                    } else {
         efl_model_container_item_define(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)),  parent_data,  index);
      }
   }
   private efl_model_container_item_define_delegate efl_model_container_item_define_static_delegate;
    ...
    private static  System.IntPtr properties_get(System.IntPtr obj, System.IntPtr pd)
   {
      ...
      if(wrapper != null) {
         ...
         try {
            _ret_var = ((ModelContainerItem)wrapper).GetProperties();
         } catch (Exception e) {
            Eina.Log.Warning($"Callback error: {e.ToString()}");
            Eina.Error.Set(Eina.Error.UNHANDLED_EXCEPTION);
         }
    ...
    private static  Eina.Value property_get(System.IntPtr obj, System.IntPtr pd,   System.String property)
   {
      ...
      if(wrapper != null) {
         ...
         try {
            _ret_var = ((ModelContainerItem)wrapper).GetProperty( property);
         } catch (Exception e) {
            Eina.Log.Warning($"Callback error: {e.ToString()}");
            Eina.Error.Set(Eina.Error.UNHANDLED_EXCEPTION);
         }
    ...
    private static  Eina.Future property_set(System.IntPtr obj, System.IntPtr pd,   System.String property,   Eina.Value value)
   {
      ...
      if(wrapper != null) {
         ...
         try {
            _ret_var = ((ModelContainerItem)wrapper).SetProperty( property,  value);
         } catch (Exception e) {
            Eina.Log.Warning($"Callback error: {e.ToString()}");
            Eina.Error.Set(Eina.Error.UNHANDLED_EXCEPTION);
         }
    ...
    private static  uint children_count_get(System.IntPtr obj, System.IntPtr pd)
   {
      ...
      if(wrapper != null) {
         ...
         try {
            _ret_var = ((ModelContainerItem)wrapper).GetChildrenCount();
         } catch (Exception e) {
            Eina.Log.Warning($"Callback error: {e.ToString()}");
            Eina.Error.Set(Eina.Error.UNHANDLED_EXCEPTION);
         }
    ...
    private static  Eina.Future property_ready_get(System.IntPtr obj, System.IntPtr pd,   System.String property)
   {
      ...
      if(wrapper != null) {
                                     Eina.Future _ret_var = default( Eina.Future);
         try {
            _ret_var = ((ModelContainerItem)wrapper).GetPropertyReady( property);
         } catch (Exception e) {
            Eina.Log.Warning($"Callback error: {e.ToString()}");
            Eina.Error.Set(Eina.Error.UNHANDLED_EXCEPTION);
         }
    ...
    private static  Eina.Future children_slice_get(System.IntPtr obj, System.IntPtr pd,   uint start,   uint count)
   {
      ...
      if(wrapper != null) {
                                                       Eina.Future _ret_var = default( Eina.Future);
         try {
            _ret_var = ((ModelContainerItem)wrapper).GetChildrenSlice( start,  count);
         } catch (Exception e) {
            Eina.Log.Warning($"Callback error: {e.ToString()}");
            Eina.Error.Set(Eina.Error.UNHANDLED_EXCEPTION);
         }
    ...
    private static Efl.Object child_add(System.IntPtr obj, System.IntPtr pd)
   {
      ...
      if(wrapper != null) {
         ...
         try {
            _ret_var = ((ModelContainerItem)wrapper).AddChild();
         } catch (Exception e) {
            Eina.Log.Warning($"Callback error: {e.ToString()}");
            Eina.Error.Set(Eina.Error.UNHANDLED_EXCEPTION);
         }
    ...
    private static  void child_del(System.IntPtr obj, System.IntPtr pd,  Efl.Object child)
   {
      ...
      if(wrapper != null) {
         ...
         try {
            ((ModelContainerItem)wrapper).DelChild( child);
         } catch (Exception e) {
            Eina.Log.Warning($"Callback error: {e.ToString()}");
            Eina.Error.Set(Eina.Error.UNHANDLED_EXCEPTION);
         }
