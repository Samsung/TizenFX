...
internal static partial class Interop
{
    ...
    {
        [LibraryImport(Libraries.PackageManagerInfoInternal, EntryPoint = "pkgmgrinfo_pkginfo_create_certinfo")]
        internal static partial int PkgmgrinfoPkginfoCreateCertinfo(out IntPtr handle);

        [LibraryImport(Libraries.PackageManagerInfoInternal, EntryPoint = "pkgmgrinfo_pkginfo_destroy_certinfo")]
        ...
        [LibraryImport(Libraries.PackageManagerInfoInternal, EntryPoint = "pkgmgrinfo_pkginfo_get_cert_value")]
