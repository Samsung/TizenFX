...
namespace Tizen.NUI
{
    ...
    public class AutofillContainer : BaseHandle
    {
        ...
        /// This will be public opened in tizen_5.5 after ACR done. Before ACR, need to be hidden as inhouse API.
        [EditorBrowsable(EditorBrowsableState.Never)]
        public AutofillContainer(string name) : this(Interop.AutofillContainer.AutofillContainerNew(name), true)
        {
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();

        }

        internal AutofillContainer(global::System.IntPtr cPtr, bool cMemoryOwn) : base(Interop.AutofillContainer.AutofillContainerUpcast(cPtr), cMemoryOwn)
        {
        }
        ...
        {
            AutofillContainer ret = new AutofillContainer(Interop.AutofillContainer.AutofillContainerAssign(swigCPtr, AutofillContainer.getCPtr(autofillContainer)), false);
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
            return ret;
        }
        ...
        {
            AutofillContainer ret = new AutofillContainer(Interop.AutofillContainer.AutofillContainerDownCast(BaseHandle.getCPtr(handle)), true);
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
            return ret;
        }
        ...
        {
            Interop.AutofillContainer.AutofillContainerAddAutofillView(swigCPtr, BaseComponents.View.getCPtr(view), propertyIndex, id, label, (uint)hint, isSensitive);
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
        }
        ...
        {
            Interop.AutofillContainer.AutofillContainerRemoveAutofillItem(swigCPtr, BaseComponents.View.getCPtr(view));
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
        }
        ...
        {
            Interop.AutofillContainer.AutofillContainerSaveAutofillData(swigCPtr);
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
        }
        ...
        {
            Interop.AutofillContainer.AutofillContainerRequestFillData(swigCPtr);
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
        }
        ...
        {
            string ret = Interop.AutofillContainer.AutofillContainerGetAutofillServiceName(swigCPtr);
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
            return ret;
        }
        ...
        {
            string ret = Interop.AutofillContainer.AutofillContainerGetAutofillServiceMessage(swigCPtr);
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
            return ret;
        }
        ...
        {
            string ret = Interop.AutofillContainer.AutofillContainerGetAutofillServiceImagePath(swigCPtr);
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
            return ret;
        }
        ...
        {
            uint ret = Interop.AutofillContainer.AutofillContainerGetListItemCount(swigCPtr);
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
            return ret;
        }
        ...
        {
            string ret = Interop.AutofillContainer.AutofillContainerGetListItem(swigCPtr, index);
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
            return ret;
        }
        ...
        {
            Interop.AutofillContainer.AutofillContainerSetSelectedItem(swigCPtr, selected);
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
        }
        ...
        internal AuthenticationSignalType AutofillServiceEventSignal()
        {
            ...
            AuthenticationSignalType ret = new AuthenticationSignalType(Interop.AutofillContainer.AutofillContainerAutofillServiceEventSignal(swigCPtr), false);
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
            return ret;
        }
        ...
        {
            ListEventSignalType ret = new ListEventSignalType(Interop.AutofillContainer.AutofillContainerAutofillListEventSignal(swigCPtr), false);
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
            return ret;
        }
