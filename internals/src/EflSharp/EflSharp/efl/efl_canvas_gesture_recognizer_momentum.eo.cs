...
/// <summary>This is the recognizer for Momentum gestures. See <see cref="Efl.Canvas.GestureMomentum"/> and <see cref="Efl.Canvas.GestureRecognizer"/>. For internal use only.</summary>
