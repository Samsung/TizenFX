...
[SelectableConcreteNativeInherit]
   ...
   public System.IntPtr NativeClass {
      get {
         if (((object)this).GetType() == typeof (SelectableConcrete))
            return Efl.Ui.SelectableConcreteNativeInherit.GetEflClassStatic();
         else
...
public class SelectableConcreteNativeInherit : Efl.Eo.NativeClass{
