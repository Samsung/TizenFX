...
{
    //use {}
    internal class EXamlCreateObjectByFactoryMethod : EXamlCreateObject
    {
        ...
        public EXamlCreateObjectByFactoryMethod(EXamlContext context, TypeReference type, MethodDefinition xFactoryMethod, object[] @params = null)
            : base(context, type)
        {
