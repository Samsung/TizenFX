...
/// <summary>A standard <see cref="Efl.Ui.Box"/> container which automatically handles grouping of any <see cref="Efl.Ui.Radio"/> widget added to it in addition to regular widgets.
...
public class RadioBox : Efl.Ui.Box, Efl.Ui.IRadioGroup, Efl.Ui.ISingleSelectable
{
...
public static class Efl_UiRadioBox_ExtensionMethods {
    ...
    public static Efl.BindableProperty<Efl.Ui.ISelectable> FallbackSelection<T>(this Efl.Ui.ItemFactory<T> fac, Efl.Csharp.ExtensionTag<Efl.Ui.RadioBox, T>magic = null) where T : Efl.Ui.RadioBox {
