...
namespace CoreUI
{
    namespace Wearable
    {
        ...
        public class CircleTimePicker : CoreUI.UI.TimePicker, ICircleWidget
        {
            IntPtr _handle;
            ...
            /// </summary>
            /// <param name="parent">The CoreUI.UI.Widget to which the new CircleTimePicker will be attached as a child.</param>
            /// <since_tizen> 6 </since_tizen>
            public CircleTimePicker(CoreUI.Object parent) : base(parent)
            {
