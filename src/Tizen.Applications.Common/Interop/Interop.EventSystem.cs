...
{
    internal static partial class EventSystem
    {
        ...
        internal static extern ErrorCode AddEventHandler(string eventName, EventCallback callback, IntPtr userData, out IntPtr handler);

        [DllImport(Libraries.AppEvent, EntryPoint = "event_remove_event_handler")]
        internal static extern ErrorCode RemoveEventHandler(IntPtr handler);
    }
}
