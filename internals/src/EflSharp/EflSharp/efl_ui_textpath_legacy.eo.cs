...
public class TextpathLegacy : Efl.Ui.Textpath, Efl.Eo.IWrapper,Efl.Interface,Efl.Ui.Legacy
{
   ...
   public new delegate void ConstructingMethod(TextpathLegacy obj);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)] internal static extern System.IntPtr
      efl_ui_textpath_legacy_class_get();
   ///<summary>Creates a new instance.</summary>
   ///<param name="parent">Parent instance.</param>
   ///<param name="init_cb">Delegate to call constructing methods that should be run inside the constructor.</param>
   public TextpathLegacy(Efl.Object parent = null, ConstructingMethod init_cb=null) : base("TextpathLegacy", efl_ui_textpath_legacy_class_get(), typeof(TextpathLegacy), parent)
   {
      if (init_cb != null) {
         init_cb(this);
      }
   ...
   protected TextpathLegacy(String klass_name, IntPtr base_klass, System.Type managed_type, Efl.Object parent) : base(klass_name, base_klass, managed_type, parent) {}
