...
namespace Tizen.Network.Tethering
{
    ...
    internal partial class TetheringExtManagerImpl {
        ...
        private void RegisterEnabledEvent()
        {
            ...
            if (ret != (int)TetheringExtError.None)
            {
                Log.Error(Globals.LogTag, "Failed to set tethering extension enabled callback, Error - " + (TetheringExtError)ret);
            }
        }
        ...
        private void UnregisterEnabledEvent()
        {
            ...
            if (ret != (int)TetheringExtError.None)
            {
                Log.Error(Globals.LogTag, "Failed to unset tethering extension enabled callback, Error - " + (TetheringExtError)ret);
            }
        }
        ...
        private void RegisterDisabledEvent()
        {
            ...
            if (ret != (int)TetheringExtError.None)
            {
                Log.Error(Globals.LogTag, "Failed to set tethering extension disabled callback, Error - " + (TetheringExtError)ret);
            }
        }
        ...
        private void UnregisterDisabledEvent()
        {
            ...
            if (ret != (int)TetheringExtError.None)
            {
                Log.Error(Globals.LogTag, "Failed to unset tethering extension disabled callback, Error - " + (TetheringExtError)ret);
            }
        }
        ...
        private void RegisterConnectionStateChangedEvent()
        {
            ...
            if (ret != (int)TetheringExtError.None)
            {
                Log.Error(Globals.LogTag, "Failed to set connection state changed callback, Error - " + (TetheringExtError)ret);
            }
        }
        ...
        private void UnregisterConnectionStatechangedEvent()
        {
            ...
            if (ret != (int)TetheringExtError.None)
            {
                Log.Error(Globals.LogTag, "Failed to unset connection state changed callback, Error - " + (TetheringExtError)ret);
            }
        }
