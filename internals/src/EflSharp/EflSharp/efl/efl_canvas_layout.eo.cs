...
[Efl.Eo.BindingEntity]
public class Layout : Efl.Canvas.Group, Efl.IContainer, Efl.IFile, Efl.IObserver, Efl.IPart, Efl.IPlayable, Efl.IPlayer, Efl.Gfx.IColorClass, Efl.Gfx.ISizeClass, Efl.Gfx.ITextClass, Efl.Layout.ICalc, Efl.Layout.IGroup, Efl.Layout.ISignal, Efl.Ui.II18n
{
    ...
    /// 
    /// If animations are disabled, transitions between states (as defined in EDC) are then instantaneous. This is conceptually similar to setting the <see cref="Efl.IPlayer.PlaybackSpeed"/> to an infinitely high value.</summary>
    ...
    public virtual Eina.Iterator<System.String> IterateAccessPart() {
    ...
    public virtual bool RemoveContent(Efl.Gfx.IEntity content) {
...
var _ret_var = Efl.Layout.SignalConcrete.NativeMethods.efl_layout_signal_callback_del_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass)),emission, source, GCHandle.ToIntPtr(func_handle), EflLayoutSignalCbWrapper.Cb, Efl.Eo.Globals.free_gchandle);
    ...
    public new class NativeMethods : Efl.Canvas.Group.NativeMethods
    {
        ...
        public override System.Collections.Generic.List<Efl_Op_Description> GetEoOps(System.Type type, bool includeInherited)
        {
            ...
            if (methods.FirstOrDefault(m => m.Name == "IterateAccessPart") != null)
            {
            ...
            if (methods.FirstOrDefault(m => m.Name == "RemoveContent") != null)
            {
        ...
        private static System.IntPtr access_part_iterate(System.IntPtr obj, System.IntPtr pd)
        {
            ...
            if (ws != null)
            {
                ...
                try
                {
                    _ret_var = ((Layout)ws.Target).IterateAccessPart();
                }
                catch (Exception e)
                {
                    Eina.Log.Warning($"Callback error: {e.ToString()}");
        ...
        private static bool content_remove(System.IntPtr obj, System.IntPtr pd, Efl.Gfx.IEntity content)
        {
            ...
            if (ws != null)
            {
                ...
                try
                {
                    _ret_var = ((Layout)ws.Target).RemoveContent(content);
                }
                catch (Exception e)
                {
                    Eina.Log.Warning($"Callback error: {e.ToString()}");
...
public static class Efl_CanvasLayout_ExtensionMethods {
    ...
    public static Efl.BindableProperty<bool> Playing<T>(this Efl.Ui.ItemFactory<T> fac, Efl.Csharp.ExtensionTag<Efl.Canvas.Layout, T>magic = null) where T : Efl.Canvas.Layout {
        return new Efl.BindableProperty<bool>("playing", fac);
    }

    public static Efl.BindableProperty<bool> Paused<T>(this Efl.Ui.ItemFactory<T> fac, Efl.Csharp.ExtensionTag<Efl.Canvas.Layout, T>magic = null) where T : Efl.Canvas.Layout {
        return new Efl.BindableProperty<bool>("paused", fac);
    }

    public static Efl.BindableProperty<double> PlaybackSpeed<T>(this Efl.Ui.ItemFactory<T> fac, Efl.Csharp.ExtensionTag<Efl.Canvas.Layout, T>magic = null) where T : Efl.Canvas.Layout {
