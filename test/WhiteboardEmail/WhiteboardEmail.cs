...
namespace WhiteboardEmail
{
    ...
    {
        float fontScale = 4.4f;
        class CustomBorder : DefaultBorder
        {
            private float titleFontScale = 4.0f;
...
*/
        ...
        static void Main(string[] args)
        {
            ...
            app = new Program("", new Size2D(400, 350), new Position2D(1100, 550), customBorder);
            app.Run(args);
        }
    }
}
