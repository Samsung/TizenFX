    ...
    , Efl.Ui.Focus.IManager
{
    ...
    public System.IntPtr NativeClass {
        get {
            if (((object)this).GetType() == typeof (IManagerSubConcrete))
                return Efl.Ui.Focus.IManagerSubNativeInherit.GetEflClassStatic();
            else
...
public class IManagerSubNativeInherit  : Efl.Eo.NativeClass{
