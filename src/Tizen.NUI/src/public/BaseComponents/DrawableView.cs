...
namespace Tizen.NUI.BaseComponents
{
    ...
    /// DrawableView creates a context.
    /// </summary>
    ...
    public class DrawableView : View
    {
        ...
        public class RenderCallbackInput
        {
            ...
            /// <summary>
            /// The area of DrawableView. You can use this for glScissor()
            /// </summary>
        ...
        /// <summary>
        /// Creates an initialized DrawableView.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the rendering mode of the DrawableView.
        /// </summary>
