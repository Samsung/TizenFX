...
public class Queue : Efl.Object, Efl.Eo.IWrapper,Efl.Io.Closer,Efl.Io.Reader,Efl.Io.Writer
{
   ...
   public new delegate void ConstructingMethod(Queue obj);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)] internal static extern System.IntPtr
      efl_io_queue_class_get();
   ///<summary>Creates a new instance.</summary>
   ///<param name="parent">Parent instance.</param>
   ///<param name="init_cb">Delegate to call constructing methods that should be run inside the constructor.</param>
   public Queue(Efl.Object parent = null, ConstructingMethod init_cb=null) : base("Queue", efl_io_queue_class_get(), typeof(Queue), parent)
   {
      if (init_cb != null) {
         init_cb(this);
      }
   ...
   protected Queue(String klass_name, IntPtr base_klass, System.Type managed_type, Efl.Object parent) : base(klass_name, base_klass, managed_type, parent) {}
   ...
   public event EventHandler SliceChangedEvt
   {
      add {
         lock (eventLock) {
            ...
            if (add_cpp_event_handler(key, this.evt_SliceChangedEvt_delegate)) {
...
private static object Can_writeChangedEvtKey = new object();
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    protected static extern  uint efl_io_queue_limit_get(System.IntPtr obj);
   ...
   virtual public  uint GetLimit() {
       var _ret_var = efl_io_queue_limit_get((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    protected static extern  void efl_io_queue_limit_set(System.IntPtr obj,    uint size);
   ...
   virtual public  void SetLimit(  uint size) {
                         efl_io_queue_limit_set((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle),  size);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    protected static extern  uint efl_io_queue_usage_get(System.IntPtr obj);
   /// <summary>How many bytes are available for read
   /// 1.19</summary>
   /// <returns>Bytes available to read
   /// 1.19</returns>
   virtual public  uint GetUsage() {
       var _ret_var = efl_io_queue_usage_get((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    protected static extern Eina.Slice efl_io_queue_slice_get(System.IntPtr obj);
   ...
   virtual public Eina.Slice GetSlice() {
       var _ret_var = efl_io_queue_slice_get((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    protected static extern  void efl_io_queue_preallocate(System.IntPtr obj,    uint size);
   ...
   virtual public  void Preallocate(  uint size) {
                         efl_io_queue_preallocate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle),  size);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    protected static extern  void efl_io_queue_discard(System.IntPtr obj,    uint amount);
   ...
   virtual public  void Discard(  uint amount) {
                         efl_io_queue_discard((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle),  amount);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    protected static extern  void efl_io_queue_clear(System.IntPtr obj);
   ...
   virtual public  void Clear() {
       efl_io_queue_clear((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
      Eina.Error.RaiseIfUnhandledException();
       }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    protected static extern  void efl_io_queue_eos_mark(System.IntPtr obj);
   ...
   virtual public  void EosMark() {
       efl_io_queue_eos_mark((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
      Eina.Error.RaiseIfUnhandledException();
       }
...
public class QueueNativeInherit : Efl.ObjectNativeInherit{
   public override System.Collections.Generic.List<Efl_Op_Description> GetEoOps(System.Type type)
   {
      ...
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_io_queue_limit_get"), func = Marshal.GetFunctionPointerForDelegate(efl_io_queue_limit_get_static_delegate)});
      efl_io_queue_limit_set_static_delegate = new efl_io_queue_limit_set_delegate(limit_set);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_io_queue_limit_set"), func = Marshal.GetFunctionPointerForDelegate(efl_io_queue_limit_set_static_delegate)});
      efl_io_queue_usage_get_static_delegate = new efl_io_queue_usage_get_delegate(usage_get);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_io_queue_usage_get"), func = Marshal.GetFunctionPointerForDelegate(efl_io_queue_usage_get_static_delegate)});
      efl_io_queue_slice_get_static_delegate = new efl_io_queue_slice_get_delegate(slice_get);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_io_queue_slice_get"), func = Marshal.GetFunctionPointerForDelegate(efl_io_queue_slice_get_static_delegate)});
      efl_io_queue_preallocate_static_delegate = new efl_io_queue_preallocate_delegate(preallocate);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_io_queue_preallocate"), func = Marshal.GetFunctionPointerForDelegate(efl_io_queue_preallocate_static_delegate)});
      efl_io_queue_discard_static_delegate = new efl_io_queue_discard_delegate(discard);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_io_queue_discard"), func = Marshal.GetFunctionPointerForDelegate(efl_io_queue_discard_static_delegate)});
      efl_io_queue_clear_static_delegate = new efl_io_queue_clear_delegate(clear);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_io_queue_clear"), func = Marshal.GetFunctionPointerForDelegate(efl_io_queue_clear_static_delegate)});
      efl_io_queue_eos_mark_static_delegate = new efl_io_queue_eos_mark_delegate(eos_mark);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_io_queue_eos_mark"), func = Marshal.GetFunctionPointerForDelegate(efl_io_queue_eos_mark_static_delegate)});
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]  private static extern  uint efl_io_queue_limit_get(System.IntPtr obj);
    private static  uint limit_get(System.IntPtr obj, System.IntPtr pd)
   {
      ...
      return _ret_var;
         ...
         return efl_io_queue_limit_get(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)));
      }
   }
   private efl_io_queue_limit_get_delegate efl_io_queue_limit_get_static_delegate;


    private delegate  void efl_io_queue_limit_set_delegate(System.IntPtr obj, System.IntPtr pd,    uint size);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]  private static extern  void efl_io_queue_limit_set(System.IntPtr obj,    uint size);
    private static  void limit_set(System.IntPtr obj, System.IntPtr pd,   uint size)
   {
      ...
      if(wrapper != null) {
         ...
         efl_io_queue_limit_set(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)),  size);
      }
   }
   private efl_io_queue_limit_set_delegate efl_io_queue_limit_set_static_delegate;


    private delegate  uint efl_io_queue_usage_get_delegate(System.IntPtr obj, System.IntPtr pd);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]  private static extern  uint efl_io_queue_usage_get(System.IntPtr obj);
    private static  uint usage_get(System.IntPtr obj, System.IntPtr pd)
   {
      ...
      return _ret_var;
         ...
         return efl_io_queue_usage_get(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)));
      }
   }
   private efl_io_queue_usage_get_delegate efl_io_queue_usage_get_static_delegate;


    private delegate Eina.Slice efl_io_queue_slice_get_delegate(System.IntPtr obj, System.IntPtr pd);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]  private static extern Eina.Slice efl_io_queue_slice_get(System.IntPtr obj);
    private static Eina.Slice slice_get(System.IntPtr obj, System.IntPtr pd)
   {
      ...
      return _ret_var;
         ...
         return efl_io_queue_slice_get(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)));
      }
   }
   private efl_io_queue_slice_get_delegate efl_io_queue_slice_get_static_delegate;


    private delegate  void efl_io_queue_preallocate_delegate(System.IntPtr obj, System.IntPtr pd,    uint size);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]  private static extern  void efl_io_queue_preallocate(System.IntPtr obj,    uint size);
    private static  void preallocate(System.IntPtr obj, System.IntPtr pd,   uint size)
   {
      ...
      if(wrapper != null) {
         ...
         efl_io_queue_preallocate(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)),  size);
      }
   }
   private efl_io_queue_preallocate_delegate efl_io_queue_preallocate_static_delegate;


    private delegate  void efl_io_queue_discard_delegate(System.IntPtr obj, System.IntPtr pd,    uint amount);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]  private static extern  void efl_io_queue_discard(System.IntPtr obj,    uint amount);
    private static  void discard(System.IntPtr obj, System.IntPtr pd,   uint amount)
   {
      ...
      if(wrapper != null) {
         ...
         efl_io_queue_discard(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)),  amount);
      }
   }
   private efl_io_queue_discard_delegate efl_io_queue_discard_static_delegate;


    private delegate  void efl_io_queue_clear_delegate(System.IntPtr obj, System.IntPtr pd);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]  private static extern  void efl_io_queue_clear(System.IntPtr obj);
    private static  void clear(System.IntPtr obj, System.IntPtr pd)
   {
      ...
      if(wrapper != null) {
         ...
         efl_io_queue_clear(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)));
      }
   }
   private efl_io_queue_clear_delegate efl_io_queue_clear_static_delegate;


    private delegate  void efl_io_queue_eos_mark_delegate(System.IntPtr obj, System.IntPtr pd);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]  private static extern  void efl_io_queue_eos_mark(System.IntPtr obj);
    private static  void eos_mark(System.IntPtr obj, System.IntPtr pd)
   {
      ...
      if(wrapper != null) {
         ...
         efl_io_queue_eos_mark(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)));
      }
   }
   private efl_io_queue_eos_mark_delegate efl_io_queue_eos_mark_static_delegate;
