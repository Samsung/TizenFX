...
public class TextAlertPopupPart : Efl.Ui.LayoutPart, Efl.Eo.IWrapper,Efl.Content,Efl.Text
{
   ...
   public new delegate void ConstructingMethod(TextAlertPopupPart obj);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)] internal static extern System.IntPtr
      efl_ui_text_alert_popup_part_class_get();
   ///<summary>Creates a new instance.</summary>
   ///<param name="parent">Parent instance.</param>
   ///<param name="init_cb">Delegate to call constructing methods that should be run inside the constructor.</param>
   public TextAlertPopupPart(Efl.Object parent = null, ConstructingMethod init_cb=null) : base("TextAlertPopupPart", efl_ui_text_alert_popup_part_class_get(), typeof(TextAlertPopupPart), parent)
   {
      if (init_cb != null) {
         init_cb(this);
      }
   ...
   protected TextAlertPopupPart(String klass_name, IntPtr base_klass, System.Type managed_type, Efl.Object parent) : base(klass_name, base_klass, managed_type, parent) {}
...
public class TextAlertPopupPartNativeInherit : Efl.Ui.LayoutPartNativeInherit{
    ...
    private static  System.IntPtr text_get(System.IntPtr obj, System.IntPtr pd)
   {
      ...
      return Efl.Eo.Globals.cached_string_to_intptr(((TextAlertPopupPart)wrapper).cached_strings, _ret_var);
      } else {
