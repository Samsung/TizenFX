...
internal static partial class Interop
{
	internal static partial class MetadataExtractor
	{
		...
		internal static extern int GetSynclyrics(IntPtr handle, int index, out ulong timeStamp, out string lyrics);

		[DllImport(Libraries.MetadataExtractor, EntryPoint = "metadata_extractor_get_frame_at_time")]
		internal static extern int GetFrameAtTime(IntPtr handle, ulong timeStamp, bool isAccurate, out IntPtr frame, out int size);
	}
}
