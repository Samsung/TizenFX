...
namespace Tizen.NUI.Avatar
{
    ...
    public class AvatarJointTransformIndex : MotionTransformIndex
    {
        ...
        [EditorBrowsable(EditorBrowsableState.Never)]
        public AvatarJointTransformIndex(AvatarPropertyNameMapper mapper) : base()
        {
            nameMapper = mapper;
        }
        ...
        [EditorBrowsable(EditorBrowsableState.Never)]
        public AvatarJointTransformIndex(AvatarPropertyNameMapper mapper, PropertyKey modelNodeId, TransformTypes transformType) : base(new PropertyKey(GetPropertyNameFromMapper(mapper, modelNodeId)), transformType)
        {
            nameMapper = mapper;
        }
        ...
        /// <param name="transformType">Transform property type for this motion index</param>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public AvatarJointTransformIndex(AvatarPropertyNameMapper mapper, JointType jointType, TransformTypes transformType) : this(mapper, (uint)jointType, transformType)
        {
        }
        ...
        /// <param name="transformType">Transform property type for this motion index</param>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public AvatarJointTransformIndex(AvatarPropertyNameMapper mapper, uint jointType, TransformTypes transformType) : base(new PropertyKey(GetPropertyNameFromMapper(mapper, jointType)), transformType)
        {
            nameMapper = mapper;
        ...
        /// <returns>Name, or null if invalid</returns>
        private static string GetPropertyNameFromMapper(AvatarPropertyNameMapper mapper, uint jointType)
        {
