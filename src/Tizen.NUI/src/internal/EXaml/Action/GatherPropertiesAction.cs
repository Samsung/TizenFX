...
{
    internal class GatherPropertiesAction : Action
    {
        public GatherPropertiesAction(Action parent)
        {
            this.parent = parent;
        }
        ...
        public void OnActive()
        {
            ...
            LoadEXaml.Operations.Add(new GatherProperties(typeIndex, propertyName));
        }
    }
}
