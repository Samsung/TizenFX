...
public class BounceInterpolator : Efl.Object, Efl.Eo.IWrapper,Efl.Interpolator
{
   ...
   public new delegate void ConstructingMethod(BounceInterpolator obj);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Ecore)] internal static extern System.IntPtr
      efl_bounce_interpolator_class_get();
   ///<summary>Creates a new instance.</summary>
   ///<param name="parent">Parent instance.</param>
   ///<param name="init_cb">Delegate to call constructing methods that should be run inside the constructor.</param>
   public BounceInterpolator(Efl.Object parent = null, ConstructingMethod init_cb=null) : base("BounceInterpolator", efl_bounce_interpolator_class_get(), typeof(BounceInterpolator), parent)
   {
      if (init_cb != null) {
         init_cb(this);
      }
   ...
   protected BounceInterpolator(String klass_name, IntPtr base_klass, System.Type managed_type, Efl.Object parent) : base(klass_name, base_klass, managed_type, parent) {}
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Ecore)]
    protected static extern  void efl_bounce_interpolator_factors_get(System.IntPtr obj,   out double factor1,   out double factor2);
   ...
   virtual public  void GetFactors( out double factor1,  out double factor2) {
                                           efl_bounce_interpolator_factors_get((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle),  out factor1,  out factor2);
      Eina.Error.RaiseIfUnhandledException();
                               }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Ecore)]
    protected static extern  void efl_bounce_interpolator_factors_set(System.IntPtr obj,   double factor1,   double factor2);
   /// <summary>Factors property</summary>
   /// <param name="factor1">First factor of the interpolation function.</param>
   /// <param name="factor2">Second factor of the interpolation function.</param>
   /// <returns></returns>
   virtual public  void SetFactors( double factor1,  double factor2) {
                                           efl_bounce_interpolator_factors_set((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle),  factor1,  factor2);
      Eina.Error.RaiseIfUnhandledException();
                               }
...
public class BounceInterpolatorNativeInherit : Efl.ObjectNativeInherit{
   public override System.Collections.Generic.List<Efl_Op_Description> GetEoOps(System.Type type)
   {
      ...
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_bounce_interpolator_factors_get"), func = Marshal.GetFunctionPointerForDelegate(efl_bounce_interpolator_factors_get_static_delegate)});
      efl_bounce_interpolator_factors_set_static_delegate = new efl_bounce_interpolator_factors_set_delegate(factors_set);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_bounce_interpolator_factors_set"), func = Marshal.GetFunctionPointerForDelegate(efl_bounce_interpolator_factors_set_static_delegate)});
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Ecore)]  private static extern  void efl_bounce_interpolator_factors_get(System.IntPtr obj,   out double factor1,   out double factor2);
    private static  void factors_get(System.IntPtr obj, System.IntPtr pd,  out double factor1,  out double factor2)
   {
      ...
      if(wrapper != null) {
         ...
         efl_bounce_interpolator_factors_get(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)),  out factor1,  out factor2);
      }
   }
   private efl_bounce_interpolator_factors_get_delegate efl_bounce_interpolator_factors_get_static_delegate;
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Ecore)]  private static extern  void efl_bounce_interpolator_factors_set(System.IntPtr obj,   double factor1,   double factor2);
    private static  void factors_set(System.IntPtr obj, System.IntPtr pd,  double factor1,  double factor2)
   {
      ...
      if(wrapper != null) {
         ...
         efl_bounce_interpolator_factors_set(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)),  factor1,  factor2);
      }
   }
   private efl_bounce_interpolator_factors_set_delegate efl_bounce_interpolator_factors_set_static_delegate;
