...
#region IDisposable Support
        ...
        public T Get<T>(uint propertyId)
        {
            ...
            else if (typeof(T) == typeof(CalendarTime))
            {
                ...
                if (CalendarError.None != (CalendarError)error)
                {
                    Log.Error(Globals.LogTag, $"Get CalendarTime Failed [{error}]{propertyId:X}");
                    throw CalendarErrorFactory.GetException(error);
                }
        ...
        public void Set<T>(uint propertyId, T value)
        {
            if (typeof(T) == typeof(string))
            {
                ...
                if (CalendarError.None != (CalendarError)error)
                {
                    Log.Error(Globals.LogTag, $"Set String Failed [{error}]{propertyId:X}");
                    throw CalendarErrorFactory.GetException(error);
                }
            }
            else if (typeof(T) == typeof(int))
            {
                ...
                if (CalendarError.None != (CalendarError)error)
                {
                    Log.Error(Globals.LogTag, $"Set Integer Failed [{error}]{propertyId:X}");
                    throw CalendarErrorFactory.GetException(error);
                }
            }
            else if (typeof(T) == typeof(long))
            {
                ...
                if (CalendarError.None != (CalendarError)error)
                {
                    Log.Error(Globals.LogTag, $"Set Long Failed [{error}]{propertyId:X}");
                    throw CalendarErrorFactory.GetException(error);
                }
            }
            else if (typeof(T) == typeof(double))
            {
                ...
                if (CalendarError.None != (CalendarError)error)
                {
                    Log.Error(Globals.LogTag, $"Set Double Failed [{error}]{propertyId:X}");
                    throw CalendarErrorFactory.GetException(error);
                }
            }
            else if (typeof(T) == typeof(CalendarTime))
            {
                ...
                if (CalendarError.None != (CalendarError)error)
                {
                    Log.Error(Globals.LogTag, $"Set CalendarTime Failed [{error}]{propertyId:X}");
                    throw CalendarErrorFactory.GetException(error);
                }
            }
            else
        ...
        public void AddChildRecord(uint propertyId, CalendarRecord childRecord)
        {
            ...
            if (CalendarError.None != (CalendarError)error)
            {
                Log.Error(Globals.LogTag, $"AddChildRecord Failed [{error}]{propertyId:X}");
                throw CalendarErrorFactory.GetException(error);
            }
        ...
        public void RemoveChildRecord(uint propertyId, CalendarRecord childRecord)
        {
            ...
            if (CalendarError.None != (CalendarError)error)
            {
                Log.Error(Globals.LogTag, $"RemoveChildRecord Failed [{error}]{propertyId:X}");
                throw CalendarErrorFactory.GetException(error);
            }
        ...
        public int GetChildRecordCount(uint propertyId)
        {
            ...
            if (CalendarError.None != (CalendarError)error)
            {
                Log.Error(Globals.LogTag, $"GetChildRecordCount Failed [{error}]{propertyId:X}");
                throw CalendarErrorFactory.GetException(error);
            }
            return count;
        }
        ...
        public CalendarRecord GetChildRecord(uint propertyId, int index)
        {
            ...
            if (CalendarError.None != (CalendarError)error)
            {
                Log.Error(Globals.LogTag, $"GetChildRecord Failed [{error}]{propertyId:X}");
                throw CalendarErrorFactory.GetException(error);
            }
        ...
        public CalendarList CloneChildRecordList(uint propertyId)
        {
            ...
            if (CalendarError.None != (CalendarError)error)
            {
                Log.Error(Globals.LogTag, $"CloneChildRecordList Failed with [{error}]{propertyId:X}");
                throw CalendarErrorFactory.GetException(error);
            }
