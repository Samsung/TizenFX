...
public enum Components
{
    ...
    Basic,
    ///<summary>The same components of <see cref="UIKit.Csharp.Components.Basic"/> and the Elementary widget toolkit.</summary>
    Ui,
}
...
public abstract class Application
{
    ...
    private static void Init(UIKit.Csharp.Components component)
    {
...
//            UIKit.Ui.Win.ExitOnAllWindowsClosed = new UIKit.DataTypes.Value(0);
    ...
    /// </remarks>
    protected virtual void OnArguments(UIKit.LoopArguments args)
    {
    }
    ...
    /// </summary>
    public void Launch(UIKit.Csharp.Components components = Components.Ui)
    {
        Init(components);
        UIKit.App app = UIKit.App.AppMain;
        var command_line = new UIKit.DataTypes.Array<UIKit.DataTypes.Stringshare>();
        command_line.Append(Array.ConvertAll(Environment.GetCommandLineArgs(), s => (UIKit.DataTypes.Stringshare)s));
#if EFL_BETA
