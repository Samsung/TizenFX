...
{
    /// <summary>
    /// The ILottieButton provides interfaces that will be needed by a Button to play Lottie animation when state changed.
    /// </summary>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public interface ILottieButton
    {
        /// <summary>
        ...
        [EditorBrowsable(EditorBrowsableState.Never)]
        LottieFrameInfo GetFrameInfoOnCreate();
        ...
        /// <return>The information of the Lottie frames</return>
        [EditorBrowsable(EditorBrowsableState.Never)]
        LottieFrameInfo GetFrameInfoOnDisable();
        ...
        /// <return>The information of the Lottie frames</return>
        [EditorBrowsable(EditorBrowsableState.Never)]
        LottieFrameInfo GetFrameInfoOnPress();
        ...
        /// <return>The information of the Lottie frames</return>
        [EditorBrowsable(EditorBrowsableState.Never)]
        LottieFrameInfo GetFrameInfoOnClick();
    }
}
