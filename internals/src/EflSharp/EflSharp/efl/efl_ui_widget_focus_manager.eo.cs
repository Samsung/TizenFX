...
/// <summary>Helper mixin for widgets which also can act as focus managers.</summary>
/// <since_tizen> 6 </since_tizen>
[Efl.Ui.WidgetFocusManagerConcrete.NativeMethods]
...
/// <summary>Helper mixin for widgets which also can act as focus managers.</summary>
/// <since_tizen> 6 </since_tizen>
public sealed class WidgetFocusManagerConcrete :
    Efl.Eo.EoWrapper
    , IWidgetFocusManager
    , Efl.Ui.Focus.IManager
{
    ...
    private WidgetFocusManagerConcrete(ConstructingHandle ch) : base(ch)
    {
    }
    ...
    private WidgetFocusManagerConcrete(Efl.Eo.Globals.WrappingHandle wh) : base(wh)
    {
    }
...
#pragma warning disable CS0628
    ...
    protected Efl.Ui.Focus.IManager CreateFocusManager(Efl.Ui.Focus.IObject root) {
...
#if EFL_BETA
#pragma warning disable CS1591
public static class Efl_UiWidgetFocusManagerConcrete_ExtensionMethods {
