...
public class WidgetPartShadow : Efl.Ui.WidgetPart, Efl.Eo.IWrapper,Efl.Gfx.IBlur,Efl.Gfx.IColor,Efl.Gfx.IFilter
{
    ...
    virtual public void GetRadius( out double rx,  out double ry) {
                                                         Efl.Gfx.IBlurNativeInherit.efl_gfx_blur_radius_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), out rx,  out ry);
    ...
    virtual public void SetRadius( double rx,  double ry) {
                                                         Efl.Gfx.IBlurNativeInherit.efl_gfx_blur_radius_set_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), rx,  ry);
        Eina.Error.RaiseIfUnhandledException();
                                         }
    ...
    virtual public void GetOffset( out double ox,  out double oy) {
                                                         Efl.Gfx.IBlurNativeInherit.efl_gfx_blur_offset_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), out ox,  out oy);
        Eina.Error.RaiseIfUnhandledException();
                                         }
    /// <summary>An offset relative to the original pixels.
    /// This property allows for drop shadow effects.</summary>
    ...
    virtual public void SetOffset( double ox,  double oy) {
                                                         Efl.Gfx.IBlurNativeInherit.efl_gfx_blur_offset_set_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), ox,  oy);
        Eina.Error.RaiseIfUnhandledException();
                                         }
    ...
    virtual public double GetGrow() {
         var _ret_var = Efl.Gfx.IBlurNativeInherit.efl_gfx_blur_grow_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    /// <summary>How much the original image should be &quot;grown&quot; before blurring.
    ...
    virtual public void SetGrow( double radius) {
                                 Efl.Gfx.IBlurNativeInherit.efl_gfx_blur_grow_set_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), radius);
        Eina.Error.RaiseIfUnhandledException();
                         }
