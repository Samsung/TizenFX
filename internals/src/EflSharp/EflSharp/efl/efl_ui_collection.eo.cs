...
/// <summary>Event argument wrapper for event <see cref="Efl.Ui.Collection.ItemPressedEvent"/>.</summary>
[Efl.Eo.BindingEntity]
public class CollectionItemPressedEventArgs : EventArgs {
    /// <summary>Actual event payload.</summary>
    /// <value>A <c>press</c> event occurred over an item.</value>
    public Efl.Ui.Item arg { get; set; }
}
/// <summary>Event argument wrapper for event <see cref="Efl.Ui.Collection.ItemUnpressedEvent"/>.</summary>
[Efl.Eo.BindingEntity]
public class CollectionItemUnpressedEventArgs : EventArgs {
    /// <summary>Actual event payload.</summary>
    /// <value>An <c>unpress</c> event occurred over an item.</value>
    public Efl.Ui.Item arg { get; set; }
}
/// <summary>Event argument wrapper for event <see cref="Efl.Ui.Collection.ItemLongpressedEvent"/>.</summary>
[Efl.Eo.BindingEntity]
public class CollectionItemLongpressedEventArgs : EventArgs {
    /// <summary>Actual event payload.</summary>
    /// <value>A <c>longpressed</c> event occurred over an item.</value>
    public Efl.Ui.Item arg { get; set; }
}
/// <summary>Event argument wrapper for event <see cref="Efl.Ui.Collection.ItemClickedEvent"/>.</summary>
[Efl.Eo.BindingEntity]
public class CollectionItemClickedEventArgs : EventArgs {
    /// <summary>Actual event payload.</summary>
    /// <value>A <c>clicked</c> event occurred over an item.</value>
    public Efl.Ui.Item arg { get; set; }
}
/// <summary>Event argument wrapper for event <see cref="Efl.Ui.Collection.ItemClickedAnyEvent"/>.</summary>
[Efl.Eo.BindingEntity]
public class CollectionItemClickedAnyEventArgs : EventArgs {
    /// <summary>Actual event payload.</summary>
    /// <value>A <c>clicked</c>,any event occurred over an item.</value>
    public Efl.Ui.Item arg { get; set; }
}
/// <summary>This widget displays a list of items in an arrangement controlled by an external <see cref="Efl.Ui.Collection.PositionManager"/> object. By using different <see cref="Efl.Ui.Collection.PositionManager"/> objects this widget can show unidimensional lists or two-dimensional grids of items, for example.
/// This class is intended to act as a base for widgets like <see cref="Efl.Ui.List"/> or <see cref="Efl.Ui.Grid"/>, which hide this complexity from the user.
/// 
/// Items are added using the <see cref="Efl.IPackLinear"/> interface and must be of <see cref="Efl.Ui.Item"/> type.
/// 
/// The direction of the arrangement can be controlled through <see cref="Efl.Ui.ILayoutOrientable.Orientation"/>.
/// 
/// If all items do not fit in the current widget size scrolling facilities are provided.
/// 
/// Items inside this widget can be selected according to the <see cref="Efl.Ui.IMultiSelectable.SelectMode"/> policy, and the selection can be retrieved with <see cref="Efl.Ui.IMultiSelectable.GetSelectedItems"/>.</summary>
...
public class Collection : Efl.Ui.LayoutBase, Efl.IPack, Efl.IPackLayout, Efl.IPackLinear, Efl.Ui.ILayoutOrientable, Efl.Ui.IMultiSelectable, Efl.Ui.IScrollable, Efl.Ui.IScrollableInteractive, Efl.Ui.IScrollbar, Efl.Ui.ISingleSelectable, Efl.Ui.IWidgetFocusManager, Efl.Ui.Focus.IManager, Efl.Ui.Focus.IManagerSub
{
    ...
    /// <value><see cref="Efl.Ui.CollectionItemPressedEventArgs"/></value>
    public event EventHandler<Efl.Ui.CollectionItemPressedEventArgs> ItemPressedEvent
    {
        add
        {
            lock (eflBindingEventLock)
            {
                Efl.EventCb callerCb = (IntPtr data, ref Efl.Event.NativeStruct evt) =>
                {
                    ...
                    if (obj != null)
                    {
                        Efl.Ui.CollectionItemPressedEventArgs args = new Efl.Ui.CollectionItemPressedEventArgs();
    ...
    public void OnItemPressedEvent(Efl.Ui.CollectionItemPressedEventArgs e)
    {
    ...
    /// <summary>An <c>unpress</c> event occurred over an item.</summary>
    /// <value><see cref="Efl.Ui.CollectionItemUnpressedEventArgs"/></value>
    public event EventHandler<Efl.Ui.CollectionItemUnpressedEventArgs> ItemUnpressedEvent
    {
        add
        {
            lock (eflBindingEventLock)
            {
                Efl.EventCb callerCb = (IntPtr data, ref Efl.Event.NativeStruct evt) =>
                {
                    ...
                    if (obj != null)
                    {
                        Efl.Ui.CollectionItemUnpressedEventArgs args = new Efl.Ui.CollectionItemUnpressedEventArgs();
                        args.arg = (Efl.Eo.Globals.CreateWrapperFor(evt.Info) as Efl.Ui.Item);
                        try
                        {
                            value?.Invoke(obj, args);
    ...
    /// <param name="e">Event to raise.</param>
    public void OnItemUnpressedEvent(Efl.Ui.CollectionItemUnpressedEventArgs e)
    {
    ...
    /// <value><see cref="Efl.Ui.CollectionItemLongpressedEventArgs"/></value>
    public event EventHandler<Efl.Ui.CollectionItemLongpressedEventArgs> ItemLongpressedEvent
    {
        add
        {
            lock (eflBindingEventLock)
            {
                Efl.EventCb callerCb = (IntPtr data, ref Efl.Event.NativeStruct evt) =>
                {
                    ...
                    if (obj != null)
                    {
                        Efl.Ui.CollectionItemLongpressedEventArgs args = new Efl.Ui.CollectionItemLongpressedEventArgs();
                        args.arg = (Efl.Eo.Globals.CreateWrapperFor(evt.Info) as Efl.Ui.Item);
                        try
                        {
                            value?.Invoke(obj, args);
    ...
    /// <param name="e">Event to raise.</param>
    public void OnItemLongpressedEvent(Efl.Ui.CollectionItemLongpressedEventArgs e)
    {
    ...
    /// <value><see cref="Efl.Ui.CollectionItemClickedEventArgs"/></value>
    public event EventHandler<Efl.Ui.CollectionItemClickedEventArgs> ItemClickedEvent
    {
        add
        {
            lock (eflBindingEventLock)
            {
                Efl.EventCb callerCb = (IntPtr data, ref Efl.Event.NativeStruct evt) =>
                {
                    ...
                    if (obj != null)
                    {
                        Efl.Ui.CollectionItemClickedEventArgs args = new Efl.Ui.CollectionItemClickedEventArgs();
                        args.arg = (Efl.Eo.Globals.CreateWrapperFor(evt.Info) as Efl.Ui.Item);
                        try
                        {
                            value?.Invoke(obj, args);
    ...
    /// <param name="e">Event to raise.</param>
    public void OnItemClickedEvent(Efl.Ui.CollectionItemClickedEventArgs e)
    {
    ...
    /// <value><see cref="Efl.Ui.CollectionItemClickedAnyEventArgs"/></value>
    public event EventHandler<Efl.Ui.CollectionItemClickedAnyEventArgs> ItemClickedAnyEvent
    {
        add
        {
            lock (eflBindingEventLock)
            {
                Efl.EventCb callerCb = (IntPtr data, ref Efl.Event.NativeStruct evt) =>
                {
                    ...
                    if (obj != null)
                    {
                        Efl.Ui.CollectionItemClickedAnyEventArgs args = new Efl.Ui.CollectionItemClickedAnyEventArgs();
                        args.arg = (Efl.Eo.Globals.CreateWrapperFor(evt.Info) as Efl.Ui.Item);
                        try
                        {
                            value?.Invoke(obj, args);
    ...
    /// <param name="e">Event to raise.</param>
    public void OnItemClickedAnyEvent(Efl.Ui.CollectionItemClickedAnyEventArgs e)
    {
    ...
    /// <returns>Ownership is passed to the item container.</returns>
    public virtual Efl.Ui.PositionManager.IEntity GetPositionManager() {
    ...
    public virtual void SetPositionManager(Efl.Ui.PositionManager.IEntity position_manager) {
    ...
    public virtual void ItemScroll(Efl.Ui.Item item, bool animation) {
    ...
    /// <param name="animation">If you want to have an animated transition.</param>
    public virtual void ItemScrollAlign(Efl.Ui.Item item, double align, bool animation) {
    ...
    public virtual Efl.Ui.SelectMode GetSelectMode() {
         var _ret_var = Efl.Ui.MultiSelectableConcrete.NativeMethods.efl_ui_select_mode_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass)));
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    /// <summary>The mode type for children selection.</summary>
    ...
    public virtual void SetSelectMode(Efl.Ui.SelectMode mode) {
                                 Efl.Ui.MultiSelectableConcrete.NativeMethods.efl_ui_select_mode_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass)),mode);
        Eina.Error.RaiseIfUnhandledException();
                         }
    ...
    public virtual Eina.Iterator<Efl.Ui.ISelectable> GetSelectedItems() {
         var _ret_var = Efl.Ui.MultiSelectableConcrete.NativeMethods.efl_ui_selected_items_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass)));
        Eina.Error.RaiseIfUnhandledException();
    ...
    public virtual void SelectRange(Efl.Ui.ISelectable a, Efl.Ui.ISelectable b) {
                                                         Efl.Ui.MultiSelectableConcrete.NativeMethods.efl_ui_select_range_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass)),a, b);
        Eina.Error.RaiseIfUnhandledException();
                                         }
    ...
    /// <param name="a">One side of the range.</param>
    /// <param name="b">The other side of the range.</param>
    public virtual void UnselectRange(Efl.Ui.ISelectable a, Efl.Ui.ISelectable b) {
                                                         Efl.Ui.MultiSelectableConcrete.NativeMethods.efl_ui_unselect_range_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass)),a, b);
        Eina.Error.RaiseIfUnhandledException();
                                         }
    /// <summary>Select all <see cref="Efl.Ui.ISelectable"/></summary>
    public virtual void SelectAll() {
         Efl.Ui.MultiSelectableConcrete.NativeMethods.efl_ui_select_all_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass)));
        Eina.Error.RaiseIfUnhandledException();
         }
    /// <summary>Unselect all <see cref="Efl.Ui.ISelectable"/></summary>
    public virtual void UnselectAll() {
         Efl.Ui.MultiSelectableConcrete.NativeMethods.efl_ui_unselect_all_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass)));
        Eina.Error.RaiseIfUnhandledException();
         }
...
public static class Efl_UiCollection_ExtensionMethods {
    ...
    public static Efl.BindableProperty<Efl.Ui.LayoutOrientation> MovementBlock<T>(this Efl.Ui.ItemFactory<T> fac, Efl.Csharp.ExtensionTag<Efl.Ui.Collection, T>magic = null) where T : Efl.Ui.Collection {
