   ...
   , Efl.Gfx.Filter
{
   ...
   public System.IntPtr NativeClass {
      get {
         if (((object)this).GetType() == typeof (InternalConcrete))
            return Efl.Canvas.Filter.InternalConcreteNativeInherit.GetEflClassStatic();
         else
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Evas)]
    private static extern  void evas_filter_changed_set(System.IntPtr obj,  [MarshalAs(UnmanagedType.U1)]  bool val);
   /// <summary>Marks this filter as changed.</summary>
   /// <param name="val"><c>true</c> if filter changed, <c>false</c> otherwise</param>
   /// <returns></returns>
   public  void SetFilterChanged( bool val) {
                         evas_filter_changed_set(Efl.Canvas.Filter.InternalConcrete.efl_canvas_filter_internal_mixin_get(),  val);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Evas)]
    private static extern  void evas_filter_invalid_set(System.IntPtr obj,  [MarshalAs(UnmanagedType.U1)]  bool val);
   /// <summary>Marks this filter as invalid.</summary>
   /// <param name="val"><c>true</c> if filter is invalid, <c>false</c> otherwise</param>
   /// <returns></returns>
   public  void SetFilterInvalid( bool val) {
                         evas_filter_invalid_set(Efl.Canvas.Filter.InternalConcrete.efl_canvas_filter_internal_mixin_get(),  val);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Evas)]
    private static extern  System.IntPtr evas_filter_output_buffer_get(System.IntPtr obj);
   /// <summary>Retrieve cached output buffer, if any.
   /// Does not increment the reference count.</summary>
   /// <returns>Output buffer</returns>
   public  System.IntPtr GetFilterOutputBuffer() {
       var _ret_var = evas_filter_output_buffer_get(Efl.Canvas.Filter.InternalConcrete.efl_canvas_filter_internal_mixin_get());
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Evas)]
    [return: MarshalAs(UnmanagedType.U1)] private static extern bool evas_filter_input_alpha(System.IntPtr obj);
   /// <summary>Called by Efl.Canvas.Filter.Internal to determine whether the input is alpha or rgba.</summary>
   /// <returns><c>true</c> on success, <c>false</c> otherwise</returns>
   public bool FilterInputAlpha() {
       var _ret_var = evas_filter_input_alpha(Efl.Canvas.Filter.InternalConcrete.efl_canvas_filter_internal_mixin_get());
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Evas)]
    private static extern  void evas_filter_state_prepare(System.IntPtr obj,   out Efl.Canvas.Filter.State_StructInternal state,    System.IntPtr data);
   /// <summary>Called by Efl.Canvas.Filter.Internal to request the parent class for state information (color, etc...).</summary>
   /// <param name="state">State info to fill in</param>
   /// <param name="data">Private data for the class</param>
   /// <returns></returns>
   public  void FilterStatePrepare( out Efl.Canvas.Filter.State state,   System.IntPtr data) {
                   var _out_state = new Efl.Canvas.Filter.State_StructInternal();
                        evas_filter_state_prepare(Efl.Canvas.Filter.InternalConcrete.efl_canvas_filter_internal_mixin_get(),  out _out_state,  data);
      Eina.Error.RaiseIfUnhandledException();
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Evas)]
    [return: MarshalAs(UnmanagedType.U1)] private static extern bool evas_filter_input_render(System.IntPtr obj,    System.IntPtr filter,    System.IntPtr engine,    System.IntPtr output,    System.IntPtr drawctx,    System.IntPtr data,    int l,    int r,    int t,    int b,    int x,    int y,  [MarshalAs(UnmanagedType.U1)]  bool do_async);
   /// <summary>Called by Efl.Canvas.Filter.Internal when the parent class must render the input.</summary>
   /// <param name="filter">Current filter context</param>
   /// <param name="engine">Engine context</param>
   /// <param name="output">Output context</param>
   ...
   public bool FilterInputRender(  System.IntPtr filter,   System.IntPtr engine,   System.IntPtr output,   System.IntPtr drawctx,   System.IntPtr data,   int l,   int r,   int t,   int b,   int x,   int y,  bool do_async) {
                                                                                                                                                                                                                               var _ret_var = evas_filter_input_render(Efl.Canvas.Filter.InternalConcrete.efl_canvas_filter_internal_mixin_get(),  filter,  engine,  output,  drawctx,  data,  l,  r,  t,  b,  x,  y,  do_async);
      Eina.Error.RaiseIfUnhandledException();
                                                                                                                                                      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Evas)]
    private static extern  void evas_filter_dirty(System.IntPtr obj);
   /// <summary>Called when filter changes must trigger a redraw of the object.
   /// Virtual, to be implemented in the parent class.</summary>
   /// <returns></returns>
   public  void FilterDirty() {
       evas_filter_dirty(Efl.Canvas.Filter.InternalConcrete.efl_canvas_filter_internal_mixin_get());
      Eina.Error.RaiseIfUnhandledException();
       }
...
public class InternalConcreteNativeInherit : Efl.Eo.NativeClass{
    ...
    private static  void filter_program_get(System.IntPtr obj, System.IntPtr pd,  out  System.IntPtr code,  out  System.IntPtr name)
   {
      ...
      code= Efl.Eo.Globals.cached_string_to_intptr(((InternalConcrete)wrapper).cached_strings, _out_code);
      name= Efl.Eo.Globals.cached_string_to_intptr(((InternalConcrete)wrapper).cached_strings, _out_name);
                        } else {
    ...
    private static  void filter_state_get(System.IntPtr obj, System.IntPtr pd,  out  System.IntPtr cur_state,  out double cur_val,  out  System.IntPtr next_state,  out double next_val,  out double pos)
   {
      ...
      cur_state= Efl.Eo.Globals.cached_string_to_intptr(((InternalConcrete)wrapper).cached_strings, _out_cur_state);
            next_state= Efl.Eo.Globals.cached_string_to_intptr(((InternalConcrete)wrapper).cached_strings, _out_next_state);
                                                      } else {
    ...
    private static  void filter_data_get(System.IntPtr obj, System.IntPtr pd,   System.String name,  out  System.IntPtr value,  out bool execute)
   {
      ...
      execute = default(bool);                           
         try {
            ...
            value= Efl.Eo.Globals.cached_string_to_intptr(((InternalConcrete)wrapper).cached_strings, _out_value);
                                    } else {
