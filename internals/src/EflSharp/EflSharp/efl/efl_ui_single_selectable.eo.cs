...
#pragma warning restore CS0628
    ...
    public new class NativeMethods : Efl.Eo.EoWrapper.NativeMethods
    {
        ...
        public override System.Collections.Generic.List<Efl_Op_Description> GetEoOps(System.Type type, bool includeInherited)
        {
            ...
            {
                descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.FunctionInterop.LoadFunctionPointer(Module.Module, "efl_ui_selectable_last_selected_get"), func = Marshal.GetFunctionPointerForDelegate(efl_ui_selectable_last_selected_get_static_delegate) });
            }
            ...
            {
                descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.FunctionInterop.LoadFunctionPointer(Module.Module, "efl_ui_selectable_fallback_selection_get"), func = Marshal.GetFunctionPointerForDelegate(efl_ui_selectable_fallback_selection_get_static_delegate) });
            }
            ...
            {
                descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.FunctionInterop.LoadFunctionPointer(Module.Module, "efl_ui_selectable_fallback_selection_set"), func = Marshal.GetFunctionPointerForDelegate(efl_ui_selectable_fallback_selection_set_static_delegate) });
            }
        ...
        private delegate Efl.Ui.ISelectable efl_ui_selectable_last_selected_get_delegate(System.IntPtr obj, System.IntPtr pd);

        [return:MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(Efl.Eo.MarshalEo<Efl.Eo.NonOwnTag>))]
        public delegate Efl.Ui.ISelectable efl_ui_selectable_last_selected_get_api_delegate(System.IntPtr obj);

        public static Efl.Eo.FunctionWrapper<efl_ui_selectable_last_selected_get_api_delegate> efl_ui_selectable_last_selected_get_ptr = new Efl.Eo.FunctionWrapper<efl_ui_selectable_last_selected_get_api_delegate>(Module, "efl_ui_selectable_last_selected_get");

        private static Efl.Ui.ISelectable last_selected_get(System.IntPtr obj, System.IntPtr pd)
        {
            Eina.Log.Debug("function efl_ui_selectable_last_selected_get was called");
            ...
            {
                return efl_ui_selectable_last_selected_get_ptr.Value.Delegate(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)));
            }
        }
        ...
        [return:MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(Efl.Eo.MarshalEo<Efl.Eo.NonOwnTag>))]
        private delegate Efl.Ui.ISelectable efl_ui_selectable_fallback_selection_get_delegate(System.IntPtr obj, System.IntPtr pd);

        [return:MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(Efl.Eo.MarshalEo<Efl.Eo.NonOwnTag>))]
        public delegate Efl.Ui.ISelectable efl_ui_selectable_fallback_selection_get_api_delegate(System.IntPtr obj);

        public static Efl.Eo.FunctionWrapper<efl_ui_selectable_fallback_selection_get_api_delegate> efl_ui_selectable_fallback_selection_get_ptr = new Efl.Eo.FunctionWrapper<efl_ui_selectable_fallback_selection_get_api_delegate>(Module, "efl_ui_selectable_fallback_selection_get");

        private static Efl.Ui.ISelectable fallback_selection_get(System.IntPtr obj, System.IntPtr pd)
        {
            Eina.Log.Debug("function efl_ui_selectable_fallback_selection_get was called");
            var ws = Efl.Eo.Globals.GetWrapperSupervisor(obj);
            if (ws != null)
            {
                Efl.Ui.ISelectable _ret_var = default(Efl.Ui.ISelectable);
            ...
            {
                return efl_ui_selectable_fallback_selection_get_ptr.Value.Delegate(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)));
            }
        }
        ...
        private delegate void efl_ui_selectable_fallback_selection_set_delegate(System.IntPtr obj, System.IntPtr pd, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(Efl.Eo.MarshalEo<Efl.Eo.NonOwnTag>))] Efl.Ui.ISelectable fallback);

        
        public delegate void efl_ui_selectable_fallback_selection_set_api_delegate(System.IntPtr obj, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(Efl.Eo.MarshalEo<Efl.Eo.NonOwnTag>))] Efl.Ui.ISelectable fallback);

        public static Efl.Eo.FunctionWrapper<efl_ui_selectable_fallback_selection_set_api_delegate> efl_ui_selectable_fallback_selection_set_ptr = new Efl.Eo.FunctionWrapper<efl_ui_selectable_fallback_selection_set_api_delegate>(Module, "efl_ui_selectable_fallback_selection_set");

        private static void fallback_selection_set(System.IntPtr obj, System.IntPtr pd, Efl.Ui.ISelectable fallback)
        {
            Eina.Log.Debug("function efl_ui_selectable_fallback_selection_set was called");
            var ws = Efl.Eo.Globals.GetWrapperSupervisor(obj);
            if (ws != null)
            {
            ...
            {
                efl_ui_selectable_fallback_selection_set_ptr.Value.Delegate(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)), fallback);
            }
        }
