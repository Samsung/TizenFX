   ...
   , Efl.Gfx.Path
{
   ...
   public System.IntPtr NativeClass {
      get {
         if (((object)this).GetType() == typeof (ShapeConcrete))
            return Efl.Gfx.ShapeConcreteNativeInherit.GetEflClassStatic();
         else
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    private static extern double efl_gfx_shape_stroke_scale_get(System.IntPtr obj);
   /// <summary>The stroke scale to be used for stroking the path. Will be used along with stroke width property.
   /// 1.14</summary>
   /// <returns>Stroke scale value</returns>
   public double GetStrokeScale() {
       var _ret_var = efl_gfx_shape_stroke_scale_get(Efl.Gfx.ShapeConcrete.efl_gfx_shape_mixin_get());
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    private static extern  void efl_gfx_shape_stroke_scale_set(System.IntPtr obj,   double s);
   /// <summary>The stroke scale to be used for stroking the path. Will be used along with stroke width property.
   /// 1.14</summary>
   /// <param name="s">Stroke scale value</param>
   /// <returns></returns>
   public  void SetStrokeScale( double s) {
                         efl_gfx_shape_stroke_scale_set(Efl.Gfx.ShapeConcrete.efl_gfx_shape_mixin_get(),  s);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    private static extern  void efl_gfx_shape_stroke_color_get(System.IntPtr obj,   out  int r,   out  int g,   out  int b,   out  int a);
   /// <summary>The color to be used for stroking the path.
   /// 1.14</summary>
   /// <param name="r">The red component of the given color.</param>
   /// <param name="g">The green component of the given color.</param>
   ...
   public  void GetStrokeColor( out  int r,  out  int g,  out  int b,  out  int a) {
                                                                               efl_gfx_shape_stroke_color_get(Efl.Gfx.ShapeConcrete.efl_gfx_shape_mixin_get(),  out r,  out g,  out b,  out a);
      Eina.Error.RaiseIfUnhandledException();
                                                       }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    private static extern  void efl_gfx_shape_stroke_color_set(System.IntPtr obj,    int r,    int g,    int b,    int a);
   /// <summary>The color to be used for stroking the path.
   /// 1.14</summary>
   /// <param name="r">The red component of the given color.</param>
   /// <param name="g">The green component of the given color.</param>
   ...
   public  void SetStrokeColor(  int r,   int g,   int b,   int a) {
                                                                               efl_gfx_shape_stroke_color_set(Efl.Gfx.ShapeConcrete.efl_gfx_shape_mixin_get(),  r,  g,  b,  a);
      Eina.Error.RaiseIfUnhandledException();
                                                       }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    private static extern double efl_gfx_shape_stroke_width_get(System.IntPtr obj);
   /// <summary>The stroke width to be used for stroking the path.
   /// 1.14</summary>
   /// <returns>Stroke width to be used</returns>
   public double GetStrokeWidth() {
       var _ret_var = efl_gfx_shape_stroke_width_get(Efl.Gfx.ShapeConcrete.efl_gfx_shape_mixin_get());
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    private static extern  void efl_gfx_shape_stroke_width_set(System.IntPtr obj,   double w);
   /// <summary>The stroke width to be used for stroking the path.
   /// 1.14</summary>
   /// <param name="w">Stroke width to be used</param>
   /// <returns></returns>
   public  void SetStrokeWidth( double w) {
                         efl_gfx_shape_stroke_width_set(Efl.Gfx.ShapeConcrete.efl_gfx_shape_mixin_get(),  w);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    private static extern double efl_gfx_shape_stroke_location_get(System.IntPtr obj);
   /// <summary>Not implemented</summary>
   /// <returns>Centered stroke location</returns>
   public double GetStrokeLocation() {
       var _ret_var = efl_gfx_shape_stroke_location_get(Efl.Gfx.ShapeConcrete.efl_gfx_shape_mixin_get());
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    private static extern  void efl_gfx_shape_stroke_location_set(System.IntPtr obj,   double centered);
   /// <summary>Not implemented</summary>
   /// <param name="centered">Centered stroke location</param>
   /// <returns></returns>
   public  void SetStrokeLocation( double centered) {
                         efl_gfx_shape_stroke_location_set(Efl.Gfx.ShapeConcrete.efl_gfx_shape_mixin_get(),  centered);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    private static extern  void efl_gfx_shape_stroke_dash_get(System.IntPtr obj,   out  System.IntPtr dash,   out  uint length);
   /// <summary>Set stroke dash pattern. A dash pattern is specified by dashes, an array of <see cref="Efl.Gfx.Dash"/>. <see cref="Efl.Gfx.Dash"/> values(length, gap) must be positive.
   /// See also <see cref="Efl.Gfx.Dash"/></summary>
   /// <param name="dash">Stroke dash</param>
   /// <param name="length">Stroke dash length</param>
   ...
   public  void GetStrokeDash( out Efl.Gfx.Dash dash,  out  uint length) {
                   var _out_dash = new  System.IntPtr();
                        efl_gfx_shape_stroke_dash_get(Efl.Gfx.ShapeConcrete.efl_gfx_shape_mixin_get(),  out _out_dash,  out length);
      Eina.Error.RaiseIfUnhandledException();
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    private static extern  void efl_gfx_shape_stroke_dash_set(System.IntPtr obj,   ref Efl.Gfx.Dash_StructInternal dash,    uint length);
   /// <summary>Set stroke dash pattern. A dash pattern is specified by dashes, an array of <see cref="Efl.Gfx.Dash"/>. <see cref="Efl.Gfx.Dash"/> values(length, gap) must be positive.
   /// See also <see cref="Efl.Gfx.Dash"/></summary>
   /// <param name="dash">Stroke dash</param>
   /// <param name="length">Stroke dash length</param>
   ...
   public  void SetStrokeDash( ref Efl.Gfx.Dash dash,   uint length) {
       var _in_dash = Efl.Gfx.Dash_StructConversion.ToInternal(dash);
                                    efl_gfx_shape_stroke_dash_set(Efl.Gfx.ShapeConcrete.efl_gfx_shape_mixin_get(),  ref _in_dash,  length);
      Eina.Error.RaiseIfUnhandledException();
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    private static extern Efl.Gfx.Cap efl_gfx_shape_stroke_cap_get(System.IntPtr obj);
   /// <summary>The cap style to be used for stroking the path. The cap will be used for capping the end point of a open subpath.
   /// See also <see cref="Efl.Gfx.Cap"/>.
   /// 1.14</summary>
   /// <returns>Cap style to use, default is <see cref="Efl.Gfx.Cap.Butt"/></returns>
   public Efl.Gfx.Cap GetStrokeCap() {
       var _ret_var = efl_gfx_shape_stroke_cap_get(Efl.Gfx.ShapeConcrete.efl_gfx_shape_mixin_get());
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    private static extern  void efl_gfx_shape_stroke_cap_set(System.IntPtr obj,   Efl.Gfx.Cap c);
   /// <summary>The cap style to be used for stroking the path. The cap will be used for capping the end point of a open subpath.
   /// See also <see cref="Efl.Gfx.Cap"/>.
   /// 1.14</summary>
   /// <param name="c">Cap style to use, default is <see cref="Efl.Gfx.Cap.Butt"/></param>
   ...
   public  void SetStrokeCap( Efl.Gfx.Cap c) {
                         efl_gfx_shape_stroke_cap_set(Efl.Gfx.ShapeConcrete.efl_gfx_shape_mixin_get(),  c);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    private static extern Efl.Gfx.Join efl_gfx_shape_stroke_join_get(System.IntPtr obj);
   /// <summary>The join style to be used for stroking the path. The join style will be used for joining the two line segment while stroking the path.
   /// See also <see cref="Efl.Gfx.Join"/>.
   /// 1.14</summary>
   /// <returns>Join style to use, default is <see cref="Efl.Gfx.Join.Miter"/></returns>
   public Efl.Gfx.Join GetStrokeJoin() {
       var _ret_var = efl_gfx_shape_stroke_join_get(Efl.Gfx.ShapeConcrete.efl_gfx_shape_mixin_get());
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    private static extern  void efl_gfx_shape_stroke_join_set(System.IntPtr obj,   Efl.Gfx.Join j);
   /// <summary>The join style to be used for stroking the path. The join style will be used for joining the two line segment while stroking the path.
   /// See also <see cref="Efl.Gfx.Join"/>.
   /// 1.14</summary>
   /// <param name="j">Join style to use, default is <see cref="Efl.Gfx.Join.Miter"/></param>
   ...
   public  void SetStrokeJoin( Efl.Gfx.Join j) {
                         efl_gfx_shape_stroke_join_set(Efl.Gfx.ShapeConcrete.efl_gfx_shape_mixin_get(),  j);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    private static extern Efl.Gfx.FillRule efl_gfx_shape_fill_rule_get(System.IntPtr obj);
   /// <summary>The fill rule of the given shape object. <see cref="Efl.Gfx.FillRule.Winding"/> or <see cref="Efl.Gfx.FillRule.OddEven"/>.
   /// 1.14</summary>
   /// <returns>The current fill rule of the shape object. One of <see cref="Efl.Gfx.FillRule.Winding"/> or <see cref="Efl.Gfx.FillRule.OddEven"/></returns>
   public Efl.Gfx.FillRule GetFillRule() {
       var _ret_var = efl_gfx_shape_fill_rule_get(Efl.Gfx.ShapeConcrete.efl_gfx_shape_mixin_get());
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    private static extern  void efl_gfx_shape_fill_rule_set(System.IntPtr obj,   Efl.Gfx.FillRule fill_rule);
   /// <summary>The fill rule of the given shape object. <see cref="Efl.Gfx.FillRule.Winding"/> or <see cref="Efl.Gfx.FillRule.OddEven"/>.
   /// 1.14</summary>
   /// <param name="fill_rule">The current fill rule of the shape object. One of <see cref="Efl.Gfx.FillRule.Winding"/> or <see cref="Efl.Gfx.FillRule.OddEven"/></param>
   /// <returns></returns>
   public  void SetFillRule( Efl.Gfx.FillRule fill_rule) {
                         efl_gfx_shape_fill_rule_set(Efl.Gfx.ShapeConcrete.efl_gfx_shape_mixin_get(),  fill_rule);
      Eina.Error.RaiseIfUnhandledException();
                   }
...
public class ShapeConcreteNativeInherit : Efl.Eo.NativeClass{
