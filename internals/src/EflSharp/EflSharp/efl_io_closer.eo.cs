   ...
   public System.IntPtr NativeClass {
      get {
         if (((object)this).GetType() == typeof (CloserConcrete))
            return Efl.Io.CloserConcreteNativeInherit.GetEflClassStatic();
         else
...
private static object ClosedEvtKey = new object();
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    [return: MarshalAs(UnmanagedType.U1)] private static extern bool efl_io_closer_closed_get(System.IntPtr obj);
   /// <summary>If true will notify object was closed.
   /// 1.19</summary>
   /// <returns><c>true</c> if closed, <c>false</c> otherwise
   /// 1.19</returns>
   public bool GetClosed() {
       var _ret_var = efl_io_closer_closed_get(Efl.Io.CloserConcrete.efl_io_closer_interface_get());
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    [return: MarshalAs(UnmanagedType.U1)] private static extern bool efl_io_closer_close_on_exec_get(System.IntPtr obj);
   /// <summary>If true will automatically close resources on exec() calls.
   /// When using file descriptors this should set FD_CLOEXEC so they are not inherited by the processes (children or self) doing exec().
   /// 1.19</summary>
   /// <returns><c>true</c> if close on exec(), <c>false</c> otherwise
   ...
   public bool GetCloseOnExec() {
       var _ret_var = efl_io_closer_close_on_exec_get(Efl.Io.CloserConcrete.efl_io_closer_interface_get());
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    [return: MarshalAs(UnmanagedType.U1)] private static extern bool efl_io_closer_close_on_exec_set(System.IntPtr obj,  [MarshalAs(UnmanagedType.U1)]  bool close_on_exec);
   /// <summary>If <c>true</c>, will close on exec() call.
   /// 1.19</summary>
   /// <param name="close_on_exec"><c>true</c> if close on exec(), <c>false</c> otherwise
   /// 1.19</param>
   ...
   public bool SetCloseOnExec( bool close_on_exec) {
                         var _ret_var = efl_io_closer_close_on_exec_set(Efl.Io.CloserConcrete.efl_io_closer_interface_get(),  close_on_exec);
      Eina.Error.RaiseIfUnhandledException();
                  return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    [return: MarshalAs(UnmanagedType.U1)] private static extern bool efl_io_closer_close_on_invalidate_get(System.IntPtr obj);
   /// <summary>If true will automatically close() on object invalidate.
   /// If the object was disconnected from its parent (including the main loop) without close, this property will state whenever it should be closed or not.
   /// 1.19</summary>
   /// <returns><c>true</c> if close on invalidate, <c>false</c> otherwise
   ...
   public bool GetCloseOnInvalidate() {
       var _ret_var = efl_io_closer_close_on_invalidate_get(Efl.Io.CloserConcrete.efl_io_closer_interface_get());
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    private static extern  void efl_io_closer_close_on_invalidate_set(System.IntPtr obj,  [MarshalAs(UnmanagedType.U1)]  bool close_on_invalidate);
   /// <summary>If true will automatically close() on object invalidate.
   /// If the object was disconnected from its parent (including the main loop) without close, this property will state whenever it should be closed or not.
   /// 1.19</summary>
   /// <param name="close_on_invalidate"><c>true</c> if close on invalidate, <c>false</c> otherwise
   ...
   public  void SetCloseOnInvalidate( bool close_on_invalidate) {
                         efl_io_closer_close_on_invalidate_set(Efl.Io.CloserConcrete.efl_io_closer_interface_get(),  close_on_invalidate);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    private static extern  Eina.Error efl_io_closer_close(System.IntPtr obj);
   /// <summary>Closes the Input/Output object.
   /// This operation will be executed immediately and may or may not block the caller thread for some time. The details of blocking behavior is to be defined by the implementation and may be subject to other parameters such as non-blocking flags, maximum timeout or even retry attempts.
   /// 
   /// You can understand this method as close(2) libc function.
   ...
   public  Eina.Error Close() {
       var _ret_var = efl_io_closer_close(Efl.Io.CloserConcrete.efl_io_closer_interface_get());
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   /// <summary>If true will notify object was closed.
...
public class CloserConcreteNativeInherit : Efl.Eo.NativeClass{
