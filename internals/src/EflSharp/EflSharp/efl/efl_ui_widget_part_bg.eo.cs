...
public static class Efl_UiWidgetPartBg_ExtensionMethods {
    ...
    public static Efl.BindableProperty<double> BorderInsetsScale<T>(this Efl.Ui.ItemFactory<T> fac, Efl.Csharp.ExtensionTag<Efl.Ui.WidgetPartBg, T>magic = null) where T : Efl.Ui.WidgetPartBg {
