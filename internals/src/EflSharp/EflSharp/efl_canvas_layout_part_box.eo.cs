...
public class LayoutPartBox : Efl.Canvas.LayoutPart, Efl.Eo.IWrapper,Efl.Container,Efl.Pack,Efl.PackLinear,Efl.Ui.Direction
{
   ...
   public LayoutPartBox(Efl.Object parent = null, ConstructingMethod init_cb=null) : base("LayoutPartBox", efl_canvas_layout_part_box_class_get(), typeof(LayoutPartBox), parent)
   {
      if (init_cb != null) {
         init_cb(this);
      }
