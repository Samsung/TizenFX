...
namespace CoreUI.Wearable {
    /// <summary>Wearable Circle Title Item Class.</summary>
    /// <since_tizen> 6 </since_tizen>
    [CoreUI.Wearable.CircleTitleItem.NativeMethods]
    [CoreUI.Wrapper.BindingEntity]
    [SuppressMessage("Microsoft.Naming", "CA1724:TypeNamesShouldNotMatchNamespaces")]
    public class CircleTitleItem : CoreUI.Wearable.CircleItem, CoreUI.IText, CoreUI.ITextMarkup
    {
        ...
        public override System.IntPtr NativeClass
        {
            get
            {
                if (((object)this).GetType() == typeof(CircleTitleItem))
                {
        ...
        [System.Runtime.InteropServices.DllImport(CoreUI.Libs.Elementary)] internal static extern System.IntPtr
            efl_wearable_circle_title_item_class_get();

        /// <summary>Initializes a new instance of the <see cref="CircleTitleItem"/> class.
        /// </summary>
        /// <param name="parent">Parent instance.</param>
    /// <param name="style">The widget style to use. See <see cref="CoreUI.UI.Widget.SetStyle" /></param>
        public CircleTitleItem(CoreUI.Object parent, System.String style = null) : base(efl_wearable_circle_title_item_class_get(), parent)
        {
        ...
        protected CircleTitleItem(ConstructingHandle ch) : base(ch)
        {
        }
        ...
        internal CircleTitleItem(CoreUI.Wrapper.WrappingHandle wh) : base(wh)
        {
        }
        ...
        protected CircleTitleItem(IntPtr baseKlass, CoreUI.Object parent) : base(baseKlass, parent)
        {
        }
        ...
        {
            return CoreUI.Wearable.CircleTitleItem.efl_wearable_circle_title_item_class_get();
        }
...
#pragma warning disable CS1591
    /// <since_tizen> 6 </since_tizen>
    public static class CircleTitleItemExtensions {
        /// <since_tizen> 6 </since_tizen>
        public static CoreUI.BindableProperty<System.String> Text<T>(this CoreUI.UI.IGenericFactoryExtended<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Wearable.CircleTitleItem, T>magic = null) where T : CoreUI.Wearable.CircleTitleItem {
            return new CoreUI.BindableProperty<System.String>("text", fac.GetPropBind());
        }

        /// <since_tizen> 6 </since_tizen>
        public static CoreUI.BindableProperty<System.String> Markup<T>(this CoreUI.UI.IGenericFactoryExtended<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Wearable.CircleTitleItem, T>magic = null) where T : CoreUI.Wearable.CircleTitleItem {
            return new CoreUI.BindableProperty<System.String>("markup", fac.GetPropBind());
        }

        /// <since_tizen> 6 </since_tizen>
        public static CoreUI.BindablePart<CoreUI.UI.LayoutPartText> TextPart<T>(this CoreUI.UI.IGenericFactoryPartExtended<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Wearable.CircleTitleItem, T> x=null) where T : CoreUI.Wearable.CircleTitleItem
        {
