...
public class LoopMessage : Efl.Object, Efl.Eo.IWrapper
{
   ...
   public new delegate void ConstructingMethod(LoopMessage obj);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Ecore)] internal static extern System.IntPtr
      efl_loop_message_class_get();
   ///<summary>Creates a new instance.</summary>
   ///<param name="parent">Parent instance.</param>
   ///<param name="init_cb">Delegate to call constructing methods that should be run inside the constructor.</param>
   public LoopMessage(Efl.Object parent = null, ConstructingMethod init_cb=null) : base("LoopMessage", efl_loop_message_class_get(), typeof(LoopMessage), parent)
   {
      if (init_cb != null) {
         init_cb(this);
      }
   ...
   protected LoopMessage(String klass_name, IntPtr base_klass, System.Type managed_type, Efl.Object parent) : base(klass_name, base_klass, managed_type, parent) {}
