...
public struct Error : IComparable<Error>
{
    ...
    {
        return "UIKit.DataTypes.Error(" + code + ")";
    }
    ...
    [DllImport(UIKit.Libs.Eina)] static extern Error eina_error_msg_register(string msg);
    [DllImport(UIKit.Libs.Eina)] static extern Error eina_error_get();
    [DllImport(UIKit.Libs.Eina)] static extern void eina_error_set(Error error);
    [DllImport(UIKit.Libs.Eina)] static extern IntPtr eina_error_msg_get(Error error);
    ...
    public static String MsgGet(Error error)
    {
        ...
        return UIKit.DataTypes.StringConversion.NativeUtf8ToManagedString(cstr);
    }
    ...
    public static void Raise(Error e)
    {
        if (e != 0)
        {
            throw (new UIKit.UIKitException(MsgGet(e)));
        }
    }
