...
[ButtonNativeInherit]
public class Button : Efl.Ui.Layout, Efl.Eo.IWrapper,Efl.Content,Efl.Text,Efl.Ui.Autorepeat,Efl.Ui.Clickable
{
   ...
   public new delegate void ConstructingMethod(Button obj);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)] internal static extern System.IntPtr
      efl_ui_button_class_get();
   ///<summary>Creates a new instance.</summary>
   ///<param name="parent">Parent instance.</param>
   ///<param name="init_cb">Delegate to call constructing methods that should be run inside the constructor.</param>
   public Button(Efl.Object parent = null, ConstructingMethod init_cb=null) : base("Button", efl_ui_button_class_get(), typeof(Button), parent)
   {
      if (init_cb != null) {
         init_cb(this);
      }
   ...
   protected Button(String klass_name, IntPtr base_klass, System.Type managed_type, Efl.Object parent) : base(klass_name, base_klass, managed_type, parent) {}
...
private static object RepeatedEvtKey = new object();
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    protected static extern double efl_ui_autorepeat_initial_timeout_get(System.IntPtr obj);
   ...
   virtual public double GetAutorepeatInitialTimeout() {
       var _ret_var = efl_ui_autorepeat_initial_timeout_get((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    protected static extern  void efl_ui_autorepeat_initial_timeout_set(System.IntPtr obj,   double t);
   /// <summary>The initial timeout before the autorepeat event is generated
   /// Sets the timeout, in seconds, since the button is pressed until the first <c>repeated</c> signal is emitted. If <c>t</c> is 0.0 or less, there won&apos;t be any delay and the event will be fired the moment the button is pressed.
   /// 
   /// See also <see cref="Efl.Ui.Autorepeat.SetAutorepeatEnabled"/>, <see cref="Efl.Ui.Autorepeat.SetAutorepeatGapTimeout"/>.</summary>
   ...
   virtual public  void SetAutorepeatInitialTimeout( double t) {
                         efl_ui_autorepeat_initial_timeout_set((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle),  t);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    protected static extern double efl_ui_autorepeat_gap_timeout_get(System.IntPtr obj);
   ...
   virtual public double GetAutorepeatGapTimeout() {
       var _ret_var = efl_ui_autorepeat_gap_timeout_get((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    protected static extern  void efl_ui_autorepeat_gap_timeout_set(System.IntPtr obj,   double t);
   /// <summary>The interval between each generated autorepeat event
   /// After the first <c>repeated</c> event is fired, all subsequent ones will follow after a delay of <c>t</c> seconds for each.
   /// 
   /// See also <see cref="Efl.Ui.Autorepeat.SetAutorepeatInitialTimeout"/>.</summary>
   ...
   virtual public  void SetAutorepeatGapTimeout( double t) {
                         efl_ui_autorepeat_gap_timeout_set((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle),  t);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    [return: MarshalAs(UnmanagedType.U1)] protected static extern bool efl_ui_autorepeat_enabled_get(System.IntPtr obj);
   ...
   virtual public bool GetAutorepeatEnabled() {
       var _ret_var = efl_ui_autorepeat_enabled_get((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    protected static extern  void efl_ui_autorepeat_enabled_set(System.IntPtr obj,  [MarshalAs(UnmanagedType.U1)]  bool on);
   /// <summary>Turn on/off the autorepeat event generated when the button is kept pressed
   /// When off, no autorepeat is performed and buttons emit a normal <c>clicked</c> signal when they are clicked.
   /// 
   /// When on, keeping a button pressed will continuously emit a <c>repeated</c> signal until the button is released. The time it takes until it starts emitting the signal is given by <see cref="Efl.Ui.Autorepeat.SetAutorepeatInitialTimeout"/>, and the time between each new emission by <see cref="Efl.Ui.Autorepeat.SetAutorepeatGapTimeout"/>.</summary>
   ...
   virtual public  void SetAutorepeatEnabled( bool on) {
                         efl_ui_autorepeat_enabled_set((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle),  on);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Efl)]
    [return: MarshalAs(UnmanagedType.U1)] protected static extern bool efl_ui_autorepeat_supported_get(System.IntPtr obj);
   ...
   virtual public bool GetAutorepeatSupported() {
       var _ret_var = efl_ui_autorepeat_supported_get((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   /// <summary>Swallowed sub-object contained in this object.</summary>
...
public class ButtonNativeInherit : Efl.Ui.LayoutNativeInherit{
    ...
    private static  System.IntPtr text_get(System.IntPtr obj, System.IntPtr pd)
   {
      ...
      return Efl.Eo.Globals.cached_string_to_intptr(((Button)wrapper).cached_strings, _ret_var);
      } else {
