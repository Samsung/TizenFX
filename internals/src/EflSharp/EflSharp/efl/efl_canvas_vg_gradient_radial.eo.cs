...
public class GradientRadial : Efl.Canvas.Vg.Gradient, Efl.Eo.IWrapper,Efl.Gfx.IGradientRadial
{
    ...
    virtual public void GetCenter( out double x,  out double y) {
                                                         Efl.Gfx.IGradientRadialNativeInherit.efl_gfx_gradient_radial_center_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), out x,  out y);
    ...
    virtual public void SetCenter( double x,  double y) {
                                                         Efl.Gfx.IGradientRadialNativeInherit.efl_gfx_gradient_radial_center_set_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), x,  y);
        Eina.Error.RaiseIfUnhandledException();
                                         }
    ...
    virtual public double GetRadius() {
         var _ret_var = Efl.Gfx.IGradientRadialNativeInherit.efl_gfx_gradient_radial_radius_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    ...
    virtual public void SetRadius( double r) {
                                 Efl.Gfx.IGradientRadialNativeInherit.efl_gfx_gradient_radial_radius_set_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), r);
        Eina.Error.RaiseIfUnhandledException();
                         }
    ...
    virtual public void GetFocal( out double x,  out double y) {
                                                         Efl.Gfx.IGradientRadialNativeInherit.efl_gfx_gradient_radial_focal_get_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), out x,  out y);
        Eina.Error.RaiseIfUnhandledException();
                                         }
    ...
    virtual public void SetFocal( double x,  double y) {
                                                         Efl.Gfx.IGradientRadialNativeInherit.efl_gfx_gradient_radial_focal_set_ptr.Value.Delegate((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle), x,  y);
        Eina.Error.RaiseIfUnhandledException();
                                         }
    /// <summary>Gets the center radius of this radial gradient.</summary>
