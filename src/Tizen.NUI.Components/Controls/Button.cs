    ...
    public partial class Button : Control
    {
        ...
        public static readonly BindableProperty IsSelectedProperty = BindableProperty.Create(nameof(IsSelected), typeof(bool), typeof(Button), false, propertyChanged: (bindable, oldValue, newValue) =>
        {
            ...
            if (newValue != null)
            {
                ...
                if (instance.isSelected != newSelected)
                {
                    ...
                    if (Accessibility.Accessibility.Instance.IsEnabled() && instance.IsHighlighted)
                    {
        ...
        public string Text
        {
            ...
            set
            {
                ...
                if (Accessibility.Accessibility.Instance.IsEnabled() && IsHighlighted && String.IsNullOrEmpty(AccessibilityName) && GetAccessibilityNameSignal().Empty())
                {
