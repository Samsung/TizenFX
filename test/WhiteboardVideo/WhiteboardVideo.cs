...
namespace WhiteboardVideo
{
    class Program : NUIApplication
    {
        class CustomBorder : DefaultBorder
        {
          ...
          private static readonly string MaximizeIcon = ResourcePath + "/maximize.png";
          private static readonly string MaximizeIconPressed = ResourcePath + "/maximizep.png";
          private static readonly string MinimizedIcon = ResourcePath + "/minimize.png";
          private static readonly string MinimizedIconPressed = ResourcePath + "/minimizep.png";
          private static readonly string CloseIcon = ResourcePath + "/close.png";
          private static readonly string CloseIconPressed = ResourcePath + "/closep.png";
          private static readonly string PlayIcon = ResourcePath + "/play.png";
          private static readonly string PlayIconPressed = ResourcePath + "/playp.png";
          private static readonly string PauseIcon = ResourcePath + "/pause.png";
          private static readonly string PauseIconPressed = ResourcePath + "/pausep.png";
          ...
          public override bool CreateTopBorderView(View topView)
          {
            ...
            titleLabel.TouchEvent += OnMinimizeIconTouched;
          ...
          public override bool CreateBottomBorderView(View bottomView)
          {
            ...
            minMaxIcon.TouchEvent += OnMaximizeIconTouched;
          ...
          private void UpdateIcons()
          {
             if (BorderWindow != null && borderView != null)
             {
                 if (BorderWindow.IsMaximized() == true)
                 {
                     if (minMaxIcon != null)
                     {
                         minMaxIcon.ResourceUrl = MinimizedIcon;
                     }
                 }
                 else
                 {
                     if (minMaxIcon != null)
                     {
                         minMaxIcon.ResourceUrl = MaximizeIcon;
                     }
                }
             }
           }
          ...
          public override bool OnMaximizeIconTouched(object sender, View.TouchEventArgs e)
          {
            ...
            if (e.Touch.GetState(0) == PointStateType.Down)
            {
              if (BorderWindow.IsMaximized() == true)
              {
                minMaxIcon.ResourceUrl = MinimizedIconPressed;
              }
              else
              {
                minMaxIcon.ResourceUrl = MaximizeIconPressed;
              }
            }
            else if (e.Touch.GetState(0) == PointStateType.Up && videoView != null)
            {
              if (BorderWindow.IsMaximized() == true)
              {
          ...
          public override bool OnCloseIconTouched(object sender, View.TouchEventArgs e)
          {
              if (e.Touch.GetState(0) == PointStateType.Down)
              {
                  closeIcon.ResourceUrl = CloseIconPressed;
              }
              else if (e.Touch.GetState(0) == PointStateType.Up && app != null)
              {
          ...
          public bool OnPlayPauseIconTouched(object sender, View.TouchEventArgs e)
          {
            if (e.Touch.GetState(0) == PointStateType.Down)
            {
              if (isPlay == false)
              {
                playPauseIcon.ResourceUrl = PlayIconPressed;
              }
              else
              {
                playPauseIcon.ResourceUrl = PauseIconPressed;
              }
            } 
            else if (e.Touch.GetState(0) == PointStateType.Up && videoView != null)
            {
        ...
        static void Main(string[] args)
        {
            ...
            app = new Program("", new Size2D(600, 400), new Position2D(650, 100), customBorder);
            app.Run(args);
        }
    }
}
