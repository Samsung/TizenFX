...
namespace Tizen.NUI.Xaml.UIComponents
{
    ...
    public class Popup : Tizen.NUI.Xaml.Forms.BaseComponents.View
    {
        ...
        /// This will be public opened in tizen_5.0 after ACR done. Before ACR, need to be hidden as inhouse API.
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static readonly Binding.BindableProperty ContentProperty = Binding.BindableProperty.Create("Content", typeof(PropertyMap), typeof(Popup), null, propertyChanged: (bindable, oldValue, newValue) =>
        {
            var popup = ((Popup)bindable).popup;
