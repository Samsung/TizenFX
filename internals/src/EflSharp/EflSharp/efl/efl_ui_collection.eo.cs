...
/// 
/// Items inside this widget can be selected according to the <see cref="Efl.Ui.IMultiSelectable.SelectMode"/> policy, and the selection can be retrieved with <see cref="Efl.Ui.IMultiSelectable.NewSelectedIterator"/>.</summary>
[Efl.Ui.Collection.NativeMethods]
[Efl.Eo.BindingEntity]
public class Collection : Efl.Ui.LayoutBase, Efl.IPack, Efl.IPackLinear, Efl.Ui.IItemClickable, Efl.Ui.ILayoutOrientable, Efl.Ui.IMultiSelectable, Efl.Ui.IScrollable, Efl.Ui.IScrollbar, Efl.Ui.ISingleSelectable, Efl.Ui.IWidgetFocusManager, Efl.Ui.Focus.IManager, Efl.Ui.Focus.IManagerSub
{
...
/// <param name="style">The widget style to use. See <see cref="Efl.Ui.Widget.SetStyle" /></param>
    ...
    /// <summary>Position manager object that handles placement of items.
    /// 
    ...
    public virtual Efl.Ui.SelectMode GetSelectMode() {
        var _ret_var = Efl.Ui.MultiSelectableConcrete.NativeMethods.efl_ui_selectable_select_mode_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass)));
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SetSelectMode(Efl.Ui.SelectMode mode) {
        Efl.Ui.MultiSelectableConcrete.NativeMethods.efl_ui_selectable_select_mode_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass)),mode);
        Eina.Error.RaiseIfUnhandledException();
    ...
    public virtual Eina.Iterator<Efl.Ui.ISelectable> NewSelectedIterator() {
        var _ret_var = Efl.Ui.MultiSelectableConcrete.NativeMethods.efl_ui_selectable_selected_iterator_new_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass)));
        Eina.Error.RaiseIfUnhandledException();
    ...
    public virtual void SelectRange(Efl.Ui.ISelectable a, Efl.Ui.ISelectable b) {
        Efl.Ui.MultiSelectableConcrete.NativeMethods.efl_ui_selectable_range_select_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass)),a, b);
        Eina.Error.RaiseIfUnhandledException();
    ...
    /// <param name="a">One side of the range.</param>
    /// <param name="b">The other side of the range.</param>
    public virtual void RangeUnselect(Efl.Ui.ISelectable a, Efl.Ui.ISelectable b) {
        Efl.Ui.MultiSelectableConcrete.NativeMethods.efl_ui_selectable_range_unselect_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass)),a, b);
        Eina.Error.RaiseIfUnhandledException();
    ...
    public virtual void SelectAll() {
        Efl.Ui.MultiSelectableConcrete.NativeMethods.efl_ui_selectable_all_select_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass)));
        Eina.Error.RaiseIfUnhandledException();
    ...
    public virtual void AllUnselect() {
        Efl.Ui.MultiSelectableConcrete.NativeMethods.efl_ui_selectable_all_unselect_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass)));
        Eina.Error.RaiseIfUnhandledException();
    ...
    public new class NativeMethods : Efl.Ui.LayoutBase.NativeMethods
    {
        ...
        private static Efl.Ui.Focus.IManager focus_manager_create(System.IntPtr obj, System.IntPtr pd, Efl.Ui.Focus.IObject root)
        {
            ...
            if (ws != null)
            {
                ...
                try
                {
                    _ret_var = ((Collection)ws.Target).CreateFocusManager(root);
                }
                catch (Exception e)
                {
                    Eina.Log.Warning($"Callback error: {e.ToString()}");
