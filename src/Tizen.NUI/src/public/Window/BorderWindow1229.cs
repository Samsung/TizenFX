...
//         {
//             Tizen.Log.Error("gab_test", $"OnInterceptedTouch {e.Touch.GetPointCount()} {e.Touch.GetState(0)}\n");
...
//             winTapGestureDetector.Detected += OnTapGestureDetected;

//             winPinchGestureDetector = new PinchGestureDetector();
//             winPinchGestureDetector.Attach(windowView);
//             winPinchGestureDetector.Detected += OnPinchGestureDetected;
...
//             // check left corner
//             if (xPosition < 20 && yPosition > style.Height - 20)
//             {
//                 this.RequestResizeToServer(ResizeDirection.BottomLeft);
//                 return CommandType.ResizeLeftCorner;
//             }
//             // check right corner
//             else if (xPosition > this.WindowSize.Width - 20 && yPosition > style.Height - 20)
//             {
