...
namespace Tizen.Multimedia
{
    ...
    public class AudioStreamPolicy : IDisposable
    {
        ...
        /// </summary>
        /// <remarks>
        /// If <paramref name="withReference"/> is true, info.Type must be <see cref="SoundEffectType.ReferenceCopy"/> or
        ...
        /// If <paramref name="withReference"/> is false, info.Type must be <see cref="SoundEffectType.NoiseSuppression"/> or
