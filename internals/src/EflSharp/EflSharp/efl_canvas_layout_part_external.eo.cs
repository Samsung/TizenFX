...
public class LayoutPartExternal : Efl.Canvas.LayoutPart, Efl.Eo.IWrapper,Efl.Content
{
   ...
   public new delegate void ConstructingMethod(LayoutPartExternal obj);
   ...
   public LayoutPartExternal(Efl.Object parent = null, ConstructingMethod init_cb=null) : base("LayoutPartExternal", efl_canvas_layout_part_external_class_get(), typeof(LayoutPartExternal), parent)
   {
      if (init_cb != null) {
         init_cb(this);
      }
   ...
   protected LayoutPartExternal(String klass_name, IntPtr base_klass, System.Type managed_type, Efl.Object parent) : base(klass_name, base_klass, managed_type, parent) {}
