...
namespace Tizen.NUI.Components
{
    ...
    internal partial class DefaultThemeCreator : IThemeCreator
    {
        ...
        public Theme Create()
        {
            ...
            // OutlinedButton base style
            theme.AddStyleWithoutClone("Tizen.NUI.Components.OutlinedButton", new ButtonStyle()
            {
                Size = new Size(252, 48),
                ItemSpacing = new Size2D(8, 8),
                CornerRadius = 12.0f,
            ...
            // TextButton base style
            theme.AddStyleWithoutClone("Tizen.NUI.Components.TextButton", new ButtonStyle()
            {
                SizeHeight = 48,
