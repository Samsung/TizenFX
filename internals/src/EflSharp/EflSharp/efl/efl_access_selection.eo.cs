...
#pragma warning disable CS0628
    ...
    protected bool ChildSelect(int child_index) {
    ...
    protected bool SelectedChildDeselect(int child_index) {
    ...
    protected bool AllChildrenSelect() {
    ...
    /// <param name="child_index">Index of child</param>
    /// <returns><c>true</c> if selection was removed, <c>false</c> otherwise</returns>
    protected bool ChildDeselect(int child_index) {
