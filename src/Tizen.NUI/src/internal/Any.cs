...
namespace Tizen.NUI
{
    internal class Any : Disposable
    {
        ...
        {
            Interop.Any.AnyAssertAlways(assertMessage);
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
        }
        ...
        {
            Any ret = new Any(Interop.Any.AnyAssign(swigCPtr, Any.getCPtr(any)), false);
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
            return ret;
        }
        ...
        {
            SWIGTYPE_p_std__type_info ret = new SWIGTYPE_p_std__type_info(Interop.Any.AnyGetType(swigCPtr), false);
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
            return ret;
        }
        ...
        public bool Empty()
        {
            bool ret = Interop.Any.AnyEmpty(swigCPtr);
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
            return ret;
        }
        ...
        public class AnyContainerBase : Disposable
        {
            ...
            public new SWIGTYPE_p_std__type_info GetType()
            {
                SWIGTYPE_p_std__type_info ret = new SWIGTYPE_p_std__type_info(Interop.Any.AnyAnyContainerBaseGetType(swigCPtr), false);
                if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
                return ret;
            }
            ...
            public SWIGTYPE_p_std__type_info mType
            {
                get
                {
                    SWIGTYPE_p_std__type_info ret = new SWIGTYPE_p_std__type_info(Interop.Any.AnyAnyContainerBaseTypeGet(swigCPtr), false);
                    if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
                    return ret;
                }
            }
            ...
            public SWIGTYPE_p_f_r_q_const__Dali__Any__AnyContainerBase__p_Dali__Any__AnyContainerBase mCloneFunc
            {
                set
                {
                    Interop.Any.AnyAnyContainerBaseCloneFuncSet(swigCPtr, SWIGTYPE_p_f_r_q_const__Dali__Any__AnyContainerBase__p_Dali__Any__AnyContainerBase.getCPtr(value));
                    if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
                }
                get
                {
                    global::System.IntPtr cPtr = Interop.Any.AnyAnyContainerBaseCloneFuncGet(swigCPtr);
            ...
            public SWIGTYPE_p_f_p_q_const__Dali__Any__AnyContainerBase__void mDeleteFunc
            {
                set
                {
                    Interop.Any.AnyAnyContainerBaseDeleteFuncSet(swigCPtr, SWIGTYPE_p_f_p_q_const__Dali__Any__AnyContainerBase__void.getCPtr(value));
                    if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
                }
                get
                {
                    global::System.IntPtr cPtr = Interop.Any.AnyAnyContainerBaseDeleteFuncGet(swigCPtr);
        ...
        public Any.AnyContainerBase mContainer
        {
            set
            {
                Interop.Any.AnyContainerSet(swigCPtr, Any.AnyContainerBase.getCPtr(value));
                if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
            }
            get
            {
                global::System.IntPtr cPtr = Interop.Any.AnyContainerGet(swigCPtr);
