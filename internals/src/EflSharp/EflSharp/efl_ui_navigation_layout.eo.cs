...
public class NavigationLayout : Efl.Ui.Layout, Efl.Eo.IWrapper,Efl.Content
{
   ...
   public new delegate void ConstructingMethod(NavigationLayout obj);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)] internal static extern System.IntPtr
      efl_ui_navigation_layout_class_get();
   ///<summary>Creates a new instance.</summary>
   ///<param name="parent">Parent instance.</param>
   ///<param name="init_cb">Delegate to call constructing methods that should be run inside the constructor.</param>
   public NavigationLayout(Efl.Object parent = null, ConstructingMethod init_cb=null) : base("NavigationLayout", efl_ui_navigation_layout_class_get(), typeof(NavigationLayout), parent)
   {
      if (init_cb != null) {
         init_cb(this);
      }
   ...
   protected NavigationLayout(String klass_name, IntPtr base_klass, System.Type managed_type, Efl.Object parent) : base(klass_name, base_klass, managed_type, parent) {}
   ...
   [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Efl.Eo.MarshalTest<Efl.Ui.Layout, Efl.Eo.NonOwnTag>))] protected static extern Efl.Ui.Layout efl_ui_navigation_layout_bar_get(System.IntPtr obj);
   ...
   virtual public Efl.Ui.Layout GetBar() {
       var _ret_var = efl_ui_navigation_layout_bar_get((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    protected static extern  void efl_ui_navigation_layout_bar_set(System.IntPtr obj, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Efl.Eo.MarshalTest<Efl.Ui.Layout, Efl.Eo.NonOwnTag>))]  Efl.Ui.Layout value);
   /// <summary>The bar object which is located at the top area as a title. e.g. Navigation_Bar widget(Efl.Ui.Navigation_Bar) can be used as <c>bar</c>.</summary>
   /// <param name="value">The bar object located at the top area of the Navigation Layout.</param>
   /// <returns></returns>
   virtual public  void SetBar( Efl.Ui.Layout value) {
                         efl_ui_navigation_layout_bar_set((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle),  value);
      Eina.Error.RaiseIfUnhandledException();
                   }
...
public class NavigationLayoutNativeInherit : Efl.Ui.LayoutNativeInherit{
   public override System.Collections.Generic.List<Efl_Op_Description> GetEoOps(System.Type type)
   {
      ...
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_ui_navigation_layout_bar_get"), func = Marshal.GetFunctionPointerForDelegate(efl_ui_navigation_layout_bar_get_static_delegate)});
      efl_ui_navigation_layout_bar_set_static_delegate = new efl_ui_navigation_layout_bar_set_delegate(bar_set);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_ui_navigation_layout_bar_set"), func = Marshal.GetFunctionPointerForDelegate(efl_ui_navigation_layout_bar_set_static_delegate)});
   ...
   [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Efl.Eo.MarshalTest<Efl.Ui.Layout, Efl.Eo.NonOwnTag>))] private delegate Efl.Ui.Layout efl_ui_navigation_layout_bar_get_delegate(System.IntPtr obj, System.IntPtr pd);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)] [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Efl.Eo.MarshalTest<Efl.Ui.Layout, Efl.Eo.NonOwnTag>))] private static extern Efl.Ui.Layout efl_ui_navigation_layout_bar_get(System.IntPtr obj);
    private static Efl.Ui.Layout bar_get(System.IntPtr obj, System.IntPtr pd)
   {
      Eina.Log.Debug("function efl_ui_navigation_layout_bar_get was called");
      Efl.Eo.IWrapper wrapper = Efl.Eo.Globals.data_get(pd);
      if(wrapper != null) {
                  Efl.Ui.Layout _ret_var = default(Efl.Ui.Layout);
         try {
      ...
      return _ret_var;
         ...
         return efl_ui_navigation_layout_bar_get(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)));
      }
   }
   private efl_ui_navigation_layout_bar_get_delegate efl_ui_navigation_layout_bar_get_static_delegate;


    private delegate  void efl_ui_navigation_layout_bar_set_delegate(System.IntPtr obj, System.IntPtr pd, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Efl.Eo.MarshalTest<Efl.Ui.Layout, Efl.Eo.NonOwnTag>))]  Efl.Ui.Layout value);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]  private static extern  void efl_ui_navigation_layout_bar_set(System.IntPtr obj, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Efl.Eo.MarshalTest<Efl.Ui.Layout, Efl.Eo.NonOwnTag>))]  Efl.Ui.Layout value);
    private static  void bar_set(System.IntPtr obj, System.IntPtr pd,  Efl.Ui.Layout value)
   {
      ...
      if(wrapper != null) {
         ...
         efl_ui_navigation_layout_bar_set(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)),  value);
      }
   }
   private efl_ui_navigation_layout_bar_set_delegate efl_ui_navigation_layout_bar_set_static_delegate;
