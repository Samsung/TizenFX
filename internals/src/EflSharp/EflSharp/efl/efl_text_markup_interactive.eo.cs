    ...
    Efl.Eo.IWrapper, IDisposable
{
    ...
    void InsertCursorMarkup(Efl.TextCursorCursor cur, System.String markup);
...
#pragma warning disable CS0628
    ...
    /// <param name="cur">Cursor position to insert markup</param>
    /// <param name="markup">The markup text to insert</param>
    public void InsertCursorMarkup(Efl.TextCursorCursor cur, System.String markup) {
...
#pragma warning restore CS0628
    ...
    public new class NativeMethods : Efl.Eo.EoWrapper.NativeMethods
    {
        ...
        public override System.Collections.Generic.List<Efl_Op_Description> GetEoOps(System.Type type, bool includeInherited)
        {
            ...
            if (methods.FirstOrDefault(m => m.Name == "InsertCursorMarkup") != null)
            {
        ...
        private static void cursor_markup_insert(System.IntPtr obj, System.IntPtr pd, Efl.TextCursorCursor cur, System.String markup)
        {
            ...
            if (ws != null)
            {
                ...
                try
                {
                    ((ITextMarkupInteractive)ws.Target).InsertCursorMarkup(cur, markup);
                }
                catch (Exception e)
                {
                    Eina.Log.Warning($"Callback error: {e.ToString()}");
