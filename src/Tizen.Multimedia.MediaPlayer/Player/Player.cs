...
namespace Tizen.Multimedia
{
    ...
    public partial class Player : IDisposable, IDisplayable<PlayerErrorCode>
    {
        ...
        public Player()
        {
            ...
            _displaySettings = new Lazy<PlayerDisplaySettings>(() => PlayerDisplaySettings.Create(this));
        }
        ...
        public void ApplyAudioStreamPolicy(AudioStreamPolicy policy)
        {
            ...
            NativePlayer.SetAudioPolicyInfo(Handle, policy.Handle).
                ThrowIfFailed(this, "Failed to set the audio stream policy to the player");
        }
        #endregion
