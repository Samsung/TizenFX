...
public class TextEditable : Efl.Ui.Text, Efl.Eo.IWrapper
{
   ...
   public new delegate void ConstructingMethod(TextEditable obj);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)] internal static extern System.IntPtr
      efl_ui_text_editable_class_get();
   ///<summary>Creates a new instance.</summary>
   ///<param name="parent">Parent instance.</param>
   ///<param name="init_cb">Delegate to call constructing methods that should be run inside the constructor.</param>
   public TextEditable(Efl.Object parent = null, ConstructingMethod init_cb=null) : base("TextEditable", efl_ui_text_editable_class_get(), typeof(TextEditable), parent)
   {
      if (init_cb != null) {
         init_cb(this);
      }
   ...
   protected TextEditable(String klass_name, IntPtr base_klass, System.Type managed_type, Efl.Object parent) : base(klass_name, base_klass, managed_type, parent) {}
