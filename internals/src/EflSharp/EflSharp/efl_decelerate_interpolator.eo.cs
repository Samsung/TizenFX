...
public class DecelerateInterpolator : Efl.Object, Efl.Eo.IWrapper,Efl.Interpolator
{
   ...
   public new delegate void ConstructingMethod(DecelerateInterpolator obj);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Ecore)] internal static extern System.IntPtr
      efl_decelerate_interpolator_class_get();
   ///<summary>Creates a new instance.</summary>
   ///<param name="parent">Parent instance.</param>
   ///<param name="init_cb">Delegate to call constructing methods that should be run inside the constructor.</param>
   public DecelerateInterpolator(Efl.Object parent = null, ConstructingMethod init_cb=null) : base("DecelerateInterpolator", efl_decelerate_interpolator_class_get(), typeof(DecelerateInterpolator), parent)
   {
      if (init_cb != null) {
         init_cb(this);
      }
   ...
   protected DecelerateInterpolator(String klass_name, IntPtr base_klass, System.Type managed_type, Efl.Object parent) : base(klass_name, base_klass, managed_type, parent) {}
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Ecore)]
    protected static extern double efl_decelerate_interpolator_factor_get(System.IntPtr obj);
   /// <summary>Factor property</summary>
   /// <returns>Factor of the interpolation function.</returns>
   virtual public double GetFactor() {
       var _ret_var = efl_decelerate_interpolator_factor_get((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Ecore)]
    protected static extern  void efl_decelerate_interpolator_factor_set(System.IntPtr obj,   double factor);
   /// <summary>Factor property</summary>
   /// <param name="factor">Factor of the interpolation function.</param>
   /// <returns></returns>
   virtual public  void SetFactor( double factor) {
                         efl_decelerate_interpolator_factor_set((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle),  factor);
      Eina.Error.RaiseIfUnhandledException();
                   }
...
public class DecelerateInterpolatorNativeInherit : Efl.ObjectNativeInherit{
   public override System.Collections.Generic.List<Efl_Op_Description> GetEoOps(System.Type type)
   {
      ...
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_decelerate_interpolator_factor_get"), func = Marshal.GetFunctionPointerForDelegate(efl_decelerate_interpolator_factor_get_static_delegate)});
      efl_decelerate_interpolator_factor_set_static_delegate = new efl_decelerate_interpolator_factor_set_delegate(factor_set);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_decelerate_interpolator_factor_set"), func = Marshal.GetFunctionPointerForDelegate(efl_decelerate_interpolator_factor_set_static_delegate)});
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Ecore)]  private static extern double efl_decelerate_interpolator_factor_get(System.IntPtr obj);
    private static double factor_get(System.IntPtr obj, System.IntPtr pd)
   {
      ...
      return _ret_var;
         ...
         return efl_decelerate_interpolator_factor_get(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)));
      }
   }
   private efl_decelerate_interpolator_factor_get_delegate efl_decelerate_interpolator_factor_get_static_delegate;


    private delegate  void efl_decelerate_interpolator_factor_set_delegate(System.IntPtr obj, System.IntPtr pd,   double factor);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Ecore)]  private static extern  void efl_decelerate_interpolator_factor_set(System.IntPtr obj,   double factor);
    private static  void factor_set(System.IntPtr obj, System.IntPtr pd,  double factor)
   {
      ...
      if(wrapper != null) {
         ...
         efl_decelerate_interpolator_factor_set(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)),  factor);
      }
   }
   private efl_decelerate_interpolator_factor_set_delegate efl_decelerate_interpolator_factor_set_static_delegate;
