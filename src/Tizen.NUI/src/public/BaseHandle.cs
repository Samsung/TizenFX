...
namespace Tizen.NUI
{
    ...
    public class BaseHandle : Element, global::System.IDisposable
    {
        ...
        {
            bool ret = Interop.BaseHandle.BaseHandleDoAction(swigCPtrCopy, actionName, PropertyMap.getCPtr(attributes));
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
            return ret;
        }
        ...
        {
            string ret = Interop.BaseHandle.BaseHandleGetTypeName(swigCPtrCopy);
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
            return ret;
        }
        ...
        {
            bool ret = Interop.BaseHandle.BaseHandleGetTypeInfo(swigCPtrCopy, Tizen.NUI.TypeInfo.getCPtr(info));
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
            return ret;
        }
        ...
        public void Reset()
        {
            Interop.BaseHandle.BaseHandleReset(swigCPtrCopy);
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
        }
        ...
        {
            bool ret = Interop.BaseHandle.BaseHandleEqualTo(swigCPtrCopy, BaseHandle.getCPtr(rhs));
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
            return ret;
        }
        ...
        {
            bool ret = Interop.BaseHandle.BaseHandleNotEqualTo(swigCPtrCopy, BaseHandle.getCPtr(rhs));
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
            return ret;
        }
        ...
        public bool HasBody()
        {
            ...
            bool ret = Interop.BaseHandle.BaseHandleHasBody(swigCPtrCopy);
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
            return ret;
        }
        ...
        public bool IsEqual(BaseHandle rhs)
        {
            ...
            bool ret = Interop.BaseHandle.BaseHandleIsEqual(swigCPtrCopy, BaseHandle.getCPtr(rhs));
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
            return ret;
        }
