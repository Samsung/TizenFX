...
namespace CoreUI {
    /// <summary>Internal <see cref="CoreUI.IModel"/> implementation for the actual model data contained in a root <see cref="CoreUI.MonoModelInternal"/>.
    /// 
    /// This model&apos;s properties are added through C# reflection on the user-provided model through CoreUI.GenericModel&lt;T&gt;.</summary>
    /// <since_tizen> 6 </since_tizen>
    [CoreUI.MonoModelInternalChild.NativeMethods]
    [CoreUI.Wrapper.BindingEntity]
    [SuppressMessage("Microsoft.Naming", "CA1724:TypeNamesShouldNotMatchNamespaces")]
    public class MonoModelInternalChild : CoreUI.LoopConsumer, CoreUI.IModel
    {
        ...
        public MonoModelInternalChild(CoreUI.Object parent= null) : base(efl_mono_model_internal_child_class_get(), parent)
        {
            FinishInstantiation();
        }
        ...
        internal MonoModelInternalChild(CoreUI.Wrapper.WrappingHandle wh) : base(wh)
        {
        }
        ...
        protected MonoModelInternalChild(IntPtr baseKlass, CoreUI.Object parent) : base(baseKlass, parent)
        {
        }
    ...
    /// <param name="count">Range size. If count is 0, start is ignored.</param>
        ...
        {
            return CoreUI.MonoModelInternalChild.efl_mono_model_internal_child_class_get();
        }
