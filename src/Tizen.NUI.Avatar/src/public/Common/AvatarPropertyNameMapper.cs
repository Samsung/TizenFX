...
namespace Tizen.NUI.Avatar
{
    ...
    public class AvatarPropertyNameMapper
    {
        /// <summary>
        ...
        [EditorBrowsable(EditorBrowsableState.Never)]
        public AvatarPropertyNameMapper()
        {
        ...
        // This will be public opened after ACR done. (Before ACR, need to be hidden as Inhouse API)
        [EditorBrowsable(EditorBrowsableState.Never)]
        public AvatarPropertyNameMapper(AvatarPropertyNameMapper rhs)
        {
            if (rhs != null)
            {
        ...
        /// </summary>
        internal Dictionary<uint, string> mapper = null;

        /// <summary>
        /// The counter of index. It will be increased one when we register custom index.
        /// </summary>
        internal uint customIndexCounter = 0;
