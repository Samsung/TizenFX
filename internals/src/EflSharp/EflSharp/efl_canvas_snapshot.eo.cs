...
public class Snapshot : Efl.Canvas.ImageInternal, Efl.Eo.IWrapper
{
   ...
   public new delegate void ConstructingMethod(Snapshot obj);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Evas)] internal static extern System.IntPtr
      efl_canvas_snapshot_class_get();
   ///<summary>Creates a new instance.</summary>
   ///<param name="parent">Parent instance.</param>
   ///<param name="init_cb">Delegate to call constructing methods that should be run inside the constructor.</param>
   public Snapshot(Efl.Object parent = null, ConstructingMethod init_cb=null) : base("Snapshot", efl_canvas_snapshot_class_get(), typeof(Snapshot), parent)
   {
      if (init_cb != null) {
         init_cb(this);
      }
   ...
   protected Snapshot(String klass_name, IntPtr base_klass, System.Type managed_type, Efl.Object parent) : base(klass_name, base_klass, managed_type, parent) {}
