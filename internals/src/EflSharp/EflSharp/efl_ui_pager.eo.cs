...
[PagerNativeInherit]
public class Pager : Efl.Ui.Layout, Efl.Eo.IWrapper,Efl.Pack,Efl.PackLinear
{
   ...
   public new delegate void ConstructingMethod(Pager obj);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)] internal static extern System.IntPtr
      efl_ui_pager_class_get();
   ///<summary>Creates a new instance.</summary>
   ///<param name="parent">Parent instance.</param>
   ///<param name="init_cb">Delegate to call constructing methods that should be run inside the constructor.</param>
   public Pager(Efl.Object parent = null, ConstructingMethod init_cb=null) : base("Pager", efl_ui_pager_class_get(), typeof(Pager), parent)
   {
      if (init_cb != null) {
         init_cb(this);
      }
   ...
   protected Pager(String klass_name, IntPtr base_klass, System.Type managed_type, Efl.Object parent) : base(klass_name, base_klass, managed_type, parent) {}
...
private static object LayoutUpdatedEvtKey = new object();
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    protected static extern  void efl_ui_pager_transition_set(System.IntPtr obj, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Efl.Eo.MarshalTest<Efl.Page.Transition, Efl.Eo.NonOwnTag>))]  Efl.Page.Transition transition);
   ...
   virtual public  void SetTransition( Efl.Page.Transition transition) {
                         efl_ui_pager_transition_set((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle),  transition);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    protected static extern  void efl_ui_pager_indicator_set(System.IntPtr obj, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Efl.Eo.MarshalTest<Efl.Page.Indicator, Efl.Eo.NonOwnTag>))]  Efl.Page.Indicator indicator);
   ...
   virtual public  void SetIndicator( Efl.Page.Indicator indicator) {
                         efl_ui_pager_indicator_set((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle),  indicator);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    protected static extern  int efl_ui_pager_current_page_get(System.IntPtr obj);
   /// <summary>Get the current page</summary>
   /// <returns></returns>
   virtual public  int GetCurrentPage() {
       var _ret_var = efl_ui_pager_current_page_get((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    protected static extern  void efl_ui_pager_current_page_set(System.IntPtr obj,    int index);
   /// <summary>Set one page as current page</summary>
   /// <param name="index"></param>
   /// <returns></returns>
   virtual public  void SetCurrentPage(  int index) {
                         efl_ui_pager_current_page_set((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle),  index);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    protected static extern  void efl_ui_pager_scroll_block_get(System.IntPtr obj,  [MarshalAs(UnmanagedType.U1)]  out bool prev,  [MarshalAs(UnmanagedType.U1)]  out bool next);
   ...
   virtual public  void GetScrollBlock( out bool prev,  out bool next) {
                                           efl_ui_pager_scroll_block_get((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle),  out prev,  out next);
      Eina.Error.RaiseIfUnhandledException();
                               }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    protected static extern  void efl_ui_pager_scroll_block_set(System.IntPtr obj,  [MarshalAs(UnmanagedType.U1)]  bool prev,  [MarshalAs(UnmanagedType.U1)]  bool next);
   /// <summary>Pages can be scrolled back and forth by default. This property allows limiting the direction of scrolling, or blocking scroll gesture at all.</summary>
   /// <param name="prev"></param>
   /// <param name="next"></param>
   /// <returns></returns>
   virtual public  void SetScrollBlock( bool prev,  bool next) {
                                           efl_ui_pager_scroll_block_set((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle),  prev,  next);
      Eina.Error.RaiseIfUnhandledException();
                               }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    protected static extern Efl.Ui.PagerLoop efl_ui_pager_loop_mode_get(System.IntPtr obj);
   ...
   virtual public Efl.Ui.PagerLoop GetLoopMode() {
       var _ret_var = efl_ui_pager_loop_mode_get((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    protected static extern  void efl_ui_pager_loop_mode_set(System.IntPtr obj,   Efl.Ui.PagerLoop loop);
   /// <summary>Pager is not scrolled after it&apos;s scrolled to the end by default. This property gives the option to make a loop through pages.</summary>
   /// <param name="loop"></param>
   /// <returns></returns>
   virtual public  void SetLoopMode( Efl.Ui.PagerLoop loop) {
                         efl_ui_pager_loop_mode_set((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle),  loop);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    protected static extern Eina.Size2D_StructInternal efl_ui_pager_page_size_get(System.IntPtr obj);
   /// <summary></summary>
   /// <returns></returns>
   virtual public Eina.Size2D GetPageSize() {
       var _ret_var = efl_ui_pager_page_size_get((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
      Eina.Error.RaiseIfUnhandledException();
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    protected static extern  void efl_ui_pager_page_size_set(System.IntPtr obj,   Eina.Size2D_StructInternal size);
   /// <summary></summary>
   /// <param name="size"></param>
   /// <returns></returns>
   virtual public  void SetPageSize( Eina.Size2D size) {
       var _in_size = Eina.Size2D_StructConversion.ToInternal(size);
                  efl_ui_pager_page_size_set((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle),  _in_size);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    protected static extern  int efl_ui_pager_padding_get(System.IntPtr obj);
   /// <summary></summary>
   /// <returns></returns>
   virtual public  int GetPadding() {
       var _ret_var = efl_ui_pager_padding_get((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    protected static extern  void efl_ui_pager_padding_set(System.IntPtr obj,    int padding);
   /// <summary></summary>
   /// <param name="padding"></param>
   /// <returns></returns>
   virtual public  void SetPadding(  int padding) {
                         efl_ui_pager_padding_set((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle),  padding);
      Eina.Error.RaiseIfUnhandledException();
                   }
...
public class PagerNativeInherit : Efl.Ui.LayoutNativeInherit{
   public override System.Collections.Generic.List<Efl_Op_Description> GetEoOps(System.Type type)
   {
      ...
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_ui_pager_transition_set"), func = Marshal.GetFunctionPointerForDelegate(efl_ui_pager_transition_set_static_delegate)});
      efl_ui_pager_indicator_set_static_delegate = new efl_ui_pager_indicator_set_delegate(indicator_set);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_ui_pager_indicator_set"), func = Marshal.GetFunctionPointerForDelegate(efl_ui_pager_indicator_set_static_delegate)});
      efl_ui_pager_current_page_get_static_delegate = new efl_ui_pager_current_page_get_delegate(current_page_get);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_ui_pager_current_page_get"), func = Marshal.GetFunctionPointerForDelegate(efl_ui_pager_current_page_get_static_delegate)});
      efl_ui_pager_current_page_set_static_delegate = new efl_ui_pager_current_page_set_delegate(current_page_set);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_ui_pager_current_page_set"), func = Marshal.GetFunctionPointerForDelegate(efl_ui_pager_current_page_set_static_delegate)});
      efl_ui_pager_scroll_block_get_static_delegate = new efl_ui_pager_scroll_block_get_delegate(scroll_block_get);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_ui_pager_scroll_block_get"), func = Marshal.GetFunctionPointerForDelegate(efl_ui_pager_scroll_block_get_static_delegate)});
      efl_ui_pager_scroll_block_set_static_delegate = new efl_ui_pager_scroll_block_set_delegate(scroll_block_set);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_ui_pager_scroll_block_set"), func = Marshal.GetFunctionPointerForDelegate(efl_ui_pager_scroll_block_set_static_delegate)});
      efl_ui_pager_loop_mode_get_static_delegate = new efl_ui_pager_loop_mode_get_delegate(loop_mode_get);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_ui_pager_loop_mode_get"), func = Marshal.GetFunctionPointerForDelegate(efl_ui_pager_loop_mode_get_static_delegate)});
      efl_ui_pager_loop_mode_set_static_delegate = new efl_ui_pager_loop_mode_set_delegate(loop_mode_set);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_ui_pager_loop_mode_set"), func = Marshal.GetFunctionPointerForDelegate(efl_ui_pager_loop_mode_set_static_delegate)});
      efl_ui_pager_page_size_get_static_delegate = new efl_ui_pager_page_size_get_delegate(page_size_get);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_ui_pager_page_size_get"), func = Marshal.GetFunctionPointerForDelegate(efl_ui_pager_page_size_get_static_delegate)});
      efl_ui_pager_page_size_set_static_delegate = new efl_ui_pager_page_size_set_delegate(page_size_set);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_ui_pager_page_size_set"), func = Marshal.GetFunctionPointerForDelegate(efl_ui_pager_page_size_set_static_delegate)});
      efl_ui_pager_padding_get_static_delegate = new efl_ui_pager_padding_get_delegate(padding_get);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_ui_pager_padding_get"), func = Marshal.GetFunctionPointerForDelegate(efl_ui_pager_padding_get_static_delegate)});
      efl_ui_pager_padding_set_static_delegate = new efl_ui_pager_padding_set_delegate(padding_set);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_ui_pager_padding_set"), func = Marshal.GetFunctionPointerForDelegate(efl_ui_pager_padding_set_static_delegate)});
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]  private static extern  void efl_ui_pager_transition_set(System.IntPtr obj, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Efl.Eo.MarshalTest<Efl.Page.Transition, Efl.Eo.NonOwnTag>))]  Efl.Page.Transition transition);
    private static  void transition_set(System.IntPtr obj, System.IntPtr pd,  Efl.Page.Transition transition)
   {
      ...
      if(wrapper != null) {
         ...
         efl_ui_pager_transition_set(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)),  transition);
      }
   }
   private efl_ui_pager_transition_set_delegate efl_ui_pager_transition_set_static_delegate;
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]  private static extern  void efl_ui_pager_indicator_set(System.IntPtr obj, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Efl.Eo.MarshalTest<Efl.Page.Indicator, Efl.Eo.NonOwnTag>))]  Efl.Page.Indicator indicator);
    private static  void indicator_set(System.IntPtr obj, System.IntPtr pd,  Efl.Page.Indicator indicator)
   {
      ...
      if(wrapper != null) {
         ...
         efl_ui_pager_indicator_set(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)),  indicator);
      }
   }
   private efl_ui_pager_indicator_set_delegate efl_ui_pager_indicator_set_static_delegate;


    private delegate  int efl_ui_pager_current_page_get_delegate(System.IntPtr obj, System.IntPtr pd);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]  private static extern  int efl_ui_pager_current_page_get(System.IntPtr obj);
    private static  int current_page_get(System.IntPtr obj, System.IntPtr pd)
   {
      ...
      return _ret_var;
         ...
         return efl_ui_pager_current_page_get(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)));
      }
   }
   private efl_ui_pager_current_page_get_delegate efl_ui_pager_current_page_get_static_delegate;


    private delegate  void efl_ui_pager_current_page_set_delegate(System.IntPtr obj, System.IntPtr pd,    int index);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]  private static extern  void efl_ui_pager_current_page_set(System.IntPtr obj,    int index);
    private static  void current_page_set(System.IntPtr obj, System.IntPtr pd,   int index)
   {
      ...
      if(wrapper != null) {
         ...
         efl_ui_pager_current_page_set(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)),  index);
      }
   }
   private efl_ui_pager_current_page_set_delegate efl_ui_pager_current_page_set_static_delegate;
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]  private static extern  void efl_ui_pager_scroll_block_get(System.IntPtr obj,  [MarshalAs(UnmanagedType.U1)]  out bool prev,  [MarshalAs(UnmanagedType.U1)]  out bool next);
    private static  void scroll_block_get(System.IntPtr obj, System.IntPtr pd,  out bool prev,  out bool next)
   {
      ...
      if(wrapper != null) {
         ...
         efl_ui_pager_scroll_block_get(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)),  out prev,  out next);
      }
   }
   private efl_ui_pager_scroll_block_get_delegate efl_ui_pager_scroll_block_get_static_delegate;
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]  private static extern  void efl_ui_pager_scroll_block_set(System.IntPtr obj,  [MarshalAs(UnmanagedType.U1)]  bool prev,  [MarshalAs(UnmanagedType.U1)]  bool next);
    private static  void scroll_block_set(System.IntPtr obj, System.IntPtr pd,  bool prev,  bool next)
   {
      ...
      if(wrapper != null) {
         ...
         efl_ui_pager_scroll_block_set(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)),  prev,  next);
      }
   }
   private efl_ui_pager_scroll_block_set_delegate efl_ui_pager_scroll_block_set_static_delegate;


    private delegate Efl.Ui.PagerLoop efl_ui_pager_loop_mode_get_delegate(System.IntPtr obj, System.IntPtr pd);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]  private static extern Efl.Ui.PagerLoop efl_ui_pager_loop_mode_get(System.IntPtr obj);
    private static Efl.Ui.PagerLoop loop_mode_get(System.IntPtr obj, System.IntPtr pd)
   {
      ...
      return _ret_var;
         ...
         return efl_ui_pager_loop_mode_get(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)));
      }
   }
   private efl_ui_pager_loop_mode_get_delegate efl_ui_pager_loop_mode_get_static_delegate;


    private delegate  void efl_ui_pager_loop_mode_set_delegate(System.IntPtr obj, System.IntPtr pd,   Efl.Ui.PagerLoop loop);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]  private static extern  void efl_ui_pager_loop_mode_set(System.IntPtr obj,   Efl.Ui.PagerLoop loop);
    private static  void loop_mode_set(System.IntPtr obj, System.IntPtr pd,  Efl.Ui.PagerLoop loop)
   {
      ...
      if(wrapper != null) {
         ...
         try {
            ((Pager)wrapper).SetLoopMode( loop);
         } catch (Exception e) {
            Eina.Log.Warning($"Callback error: {e.ToString()}");
            Eina.Error.Set(Eina.Error.UNHANDLED_EXCEPTION);
         }
                        } else {
         efl_ui_pager_loop_mode_set(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)),  loop);
      }
   }
   private efl_ui_pager_loop_mode_set_delegate efl_ui_pager_loop_mode_set_static_delegate;


    private delegate Eina.Size2D_StructInternal efl_ui_pager_page_size_get_delegate(System.IntPtr obj, System.IntPtr pd);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]  private static extern Eina.Size2D_StructInternal efl_ui_pager_page_size_get(System.IntPtr obj);
    private static Eina.Size2D_StructInternal page_size_get(System.IntPtr obj, System.IntPtr pd)
   {
      ...
      return Eina.Size2D_StructConversion.ToInternal(_ret_var);
         ...
         return efl_ui_pager_page_size_get(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)));
      }
   }
   private efl_ui_pager_page_size_get_delegate efl_ui_pager_page_size_get_static_delegate;
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]  private static extern  void efl_ui_pager_page_size_set(System.IntPtr obj,   Eina.Size2D_StructInternal size);
    private static  void page_size_set(System.IntPtr obj, System.IntPtr pd,  Eina.Size2D_StructInternal size)
   {
      ...
      if(wrapper != null) {
         ...
         efl_ui_pager_page_size_set(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)),  size);
      }
   }
   private efl_ui_pager_page_size_set_delegate efl_ui_pager_page_size_set_static_delegate;


    private delegate  int efl_ui_pager_padding_get_delegate(System.IntPtr obj, System.IntPtr pd);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]  private static extern  int efl_ui_pager_padding_get(System.IntPtr obj);
    private static  int padding_get(System.IntPtr obj, System.IntPtr pd)
   {
      ...
      return _ret_var;
         ...
         return efl_ui_pager_padding_get(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)));
      }
   }
   private efl_ui_pager_padding_get_delegate efl_ui_pager_padding_get_static_delegate;


    private delegate  void efl_ui_pager_padding_set_delegate(System.IntPtr obj, System.IntPtr pd,    int padding);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]  private static extern  void efl_ui_pager_padding_set(System.IntPtr obj,    int padding);
    private static  void padding_set(System.IntPtr obj, System.IntPtr pd,   int padding)
   {
      ...
      if(wrapper != null) {
         ...
         efl_ui_pager_padding_set(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)),  padding);
      }
   }
   private efl_ui_pager_padding_set_delegate efl_ui_pager_padding_set_static_delegate;
