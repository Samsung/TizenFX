...
internal static partial class Interop
{
    internal static partial class NativePlayer
    {
        ...
        [DllImport(Libraries.Player, EntryPoint = "player_set_video_codec_type_ex")]
        internal static extern PlayerErrorCode SetVideoCodecType(IntPtr player, VideoCodecType type);

        [DllImport(Libraries.Player, EntryPoint = "player_get_video_codec_type_ex")]
        internal static extern PlayerErrorCode GetVideoCodecType(IntPtr player, out VideoCodecType type);
    }
