    ...
    
{
    ...
    public System.IntPtr NativeClass {
        get {
            if (((object)this).GetType() == typeof (ISizeClassConcrete))
                return Efl.Gfx.ISizeClassNativeInherit.GetEflClassStatic();
            else
    ...
    public bool GetSizeClass( System.String size_class,  out int minw,  out int minh,  out int maxw,  out int maxh) {
                                                                                                                                 var _ret_var = Efl.Gfx.ISizeClassNativeInherit.efl_gfx_size_class_get_ptr.Value.Delegate(this.NativeHandle, size_class,  out minw,  out minh,  out maxw,  out maxh);
    ...
    public bool SetSizeClass( System.String size_class,  int minw,  int minh,  int maxw,  int maxh) {
                                                                                                                                 var _ret_var = Efl.Gfx.ISizeClassNativeInherit.efl_gfx_size_class_set_ptr.Value.Delegate(this.NativeHandle, size_class,  minw,  minh,  maxw,  maxh);
        Eina.Error.RaiseIfUnhandledException();
                                                                                        return _ret_var;
 }
    /// <summary>Delete the size class.
    ...
    public void DelSizeClass( System.String size_class) {
                                 Efl.Gfx.ISizeClassNativeInherit.efl_gfx_size_class_del_ptr.Value.Delegate(this.NativeHandle, size_class);
        Eina.Error.RaiseIfUnhandledException();
                         }
...
public class ISizeClassNativeInherit  : Efl.Eo.NativeClass{
