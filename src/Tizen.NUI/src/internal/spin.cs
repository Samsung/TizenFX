...
namespace Tizen.NUI
{
    public class Spin : CustomView
    {
        ...
        public Spin() : base(ViewBehaviour.RequiresKeyboardNavigationSupport | ViewBehaviour.DisableStyleChangeSignals)
        {
        ...
        public override void OnInitialize()
        {
            ...
            _arrowVisualPropertyIndex = RegisterProperty("ArrowImage", new Tizen.NUI.PropertyValue(_arrowImage), Tizen.NUI.PropertyAccessMode.ReadWrite);
