...
namespace NUILayout
{
    internal class AbsolutePivotCenterPaddingMargin : View, IExample
    {
        public AbsolutePivotCenterPaddingMargin()
        {
        ...
        public void Activate()
        {
            ...
            {
                AppBar = new AppBar() { Title = "PivotCenter Padding Margin", BackgroundColor = Color.White },
                Content = this,
                WidthSpecification = LayoutParamPolicies.MatchParent,
                HeightSpecification = LayoutParamPolicies.MatchParent,
