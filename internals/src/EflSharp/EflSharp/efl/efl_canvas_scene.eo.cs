...
[Efl.Canvas.SceneConcrete.NativeMethods]
    ...
    Efl.Eo.IWrapper, IDisposable
{
    ...
    event EventHandler<Efl.Canvas.SceneObjectFocusInEventArgs> ObjectFocusInEvent;
    /// <summary>Called when object lost focus</summary>
    /// <since_tizen> 6 </since_tizen>
    /// <value><see cref="Efl.Canvas.SceneObjectFocusOutEventArgs"/></value>
    event EventHandler<Efl.Canvas.SceneObjectFocusOutEventArgs> ObjectFocusOutEvent;
...
/// <summary>Event argument wrapper for event <see cref="Efl.Canvas.IScene.ObjectFocusInEvent"/>.</summary>
[Efl.Eo.BindingEntity]
...
/// <summary>Event argument wrapper for event <see cref="Efl.Canvas.IScene.ObjectFocusOutEvent"/>.</summary>
[Efl.Eo.BindingEntity]
...
/// <summary>Event argument wrapper for event <see cref="Efl.Canvas.IScene.RenderPostEvent"/>.</summary>
[Efl.Eo.BindingEntity]
public class SceneRenderPostEventArgs : EventArgs {
    /// <summary>Actual event payload.</summary>
    /// <value>Called when post render happens</value>
    public Efl.Gfx.Event.RenderPost arg { get; set; }
}

/// <summary>Event argument wrapper for event <see cref="Efl.Canvas.IScene.DeviceChangedEvent"/>.</summary>
[Efl.Eo.BindingEntity]
public class SceneDeviceChangedEventArgs : EventArgs {
    /// <summary>Actual event payload.</summary>
    /// <value>Called when input device changed</value>
    public Efl.Input.Device arg { get; set; }
}

/// <summary>Event argument wrapper for event <see cref="Efl.Canvas.IScene.DeviceAddedEvent"/>.</summary>
[Efl.Eo.BindingEntity]
public class SceneDeviceAddedEventArgs : EventArgs {
    /// <summary>Actual event payload.</summary>
    /// <value>Called when input device was added</value>
    public Efl.Input.Device arg { get; set; }
}

/// <summary>Event argument wrapper for event <see cref="Efl.Canvas.IScene.DeviceRemovedEvent"/>.</summary>
[Efl.Eo.BindingEntity]
public class SceneDeviceRemovedEventArgs : EventArgs {
    /// <summary>Actual event payload.</summary>
    ...
    
{
    ...
    private SceneConcrete(Efl.Eo.Globals.WrappingHandle wh) : base(wh)
    {
    }
...
var _ret_var = Efl.Canvas.SceneConcrete.NativeMethods.efl_canvas_scene_image_max_size_get_ptr.Value.Delegate(this.NativeHandle,out _out_max);
...
max = _out_max;
    ...
    public bool GetGroupObjectsCalculating() {
        var _ret_var = Efl.Canvas.SceneConcrete.NativeMethods.efl_canvas_scene_group_objects_calculating_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public Efl.Input.Device GetDevice(System.String name) {
        var _ret_var = Efl.Canvas.SceneConcrete.NativeMethods.efl_canvas_scene_device_get_ptr.Value.Delegate(this.NativeHandle,name);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public Efl.Input.Device GetSeat(int id) {
        var _ret_var = Efl.Canvas.SceneConcrete.NativeMethods.efl_canvas_scene_seat_get_ptr.Value.Delegate(this.NativeHandle,id);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public Efl.Input.Device GetSeatDefault() {
        var _ret_var = Efl.Canvas.SceneConcrete.NativeMethods.efl_canvas_scene_seat_default_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
...
var _ret_var = Efl.Canvas.SceneConcrete.NativeMethods.efl_canvas_scene_pointer_position_get_ptr.Value.Delegate(this.NativeHandle,seat, out _out_pos);
        Eina.Error.RaiseIfUnhandledException();
pos = _out_pos;
        return _ret_var;
    }
    ...
    public void CalculateGroupObjects() {
        Efl.Canvas.SceneConcrete.NativeMethods.efl_canvas_scene_group_objects_calculate_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
...
var _ret_var = Efl.Canvas.SceneConcrete.NativeMethods.efl_canvas_scene_objects_at_xy_get_ptr.Value.Delegate(this.NativeHandle,_in_pos, include_pass_events_objects, include_hidden_objects);
        Eina.Error.RaiseIfUnhandledException();
    ...
    public Efl.Gfx.IEntity GetObjectTopAtXy(Eina.Position2D pos, bool include_pass_events_objects, bool include_hidden_objects) {
        Eina.Position2D.NativeStruct _in_pos = pos;
var _ret_var = Efl.Canvas.SceneConcrete.NativeMethods.efl_canvas_scene_object_top_at_xy_get_ptr.Value.Delegate(this.NativeHandle,_in_pos, include_pass_events_objects, include_hidden_objects);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
...
var _ret_var = Efl.Canvas.SceneConcrete.NativeMethods.efl_canvas_scene_objects_in_rectangle_get_ptr.Value.Delegate(this.NativeHandle,_in_rect, include_pass_events_objects, include_hidden_objects);
        Eina.Error.RaiseIfUnhandledException();
        return new Eina.Iterator<Efl.Gfx.IEntity>(_ret_var, true);
    ...
    public Efl.Gfx.IEntity GetObjectTopInRectangle(Eina.Rect rect, bool include_pass_events_objects, bool include_hidden_objects) {
        Eina.Rect.NativeStruct _in_rect = rect;
var _ret_var = Efl.Canvas.SceneConcrete.NativeMethods.efl_canvas_scene_object_top_in_rectangle_get_ptr.Value.Delegate(this.NativeHandle,_in_rect, include_pass_events_objects, include_hidden_objects);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public Eina.Iterator<Efl.Input.Device> Seats() {
        var _ret_var = Efl.Canvas.SceneConcrete.NativeMethods.efl_canvas_scene_seats_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
...
#if EFL_BETA
#pragma warning disable CS1591
public static class Efl_CanvasSceneConcrete_ExtensionMethods {
}
