...
namespace Tizen.NUI.BaseComponents
{
    internal class ViewEventRareData
    {
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate void BackgroundResourceLoadedCallbackType(IntPtr view);
        ...
        private EventHandler<View.BackgroundResourceLoadedEventArgs> _backgroundResourceLoadedEventHandler;
        private BackgroundResourceLoadedCallbackType _backgroundResourceLoadedCallback;
        ...
        public event EventHandler<View.BackgroundResourceLoadedEventArgs> BackgroundResourceLoaded
        {
            add
            {
                if (_backgroundResourceLoadedEventHandler == null)
                {
                    ...
                    Interop.ViewSignal.ResourceReadyConnect(_owner.SwigCPtr, _backgroundResourceLoadedCallback.ToHandleRef(this));
                    NDalicPINVOKE.ThrowExceptionIfExists();
                }
            ...
            {
                _backgroundResourceLoadedEventHandler -= value;
                if (_backgroundResourceLoadedEventHandler == null && _backgroundResourceLoadedCallback != null)
                {
                    Interop.ViewSignal.ResourceReadyDisconnect(_owner.SwigCPtr, _backgroundResourceLoadedCallback.ToHandleRef(this));
                    NDalicPINVOKE.ThrowExceptionIfExists();
        ...
        public void ClearSignal()
        {
            ...
            if (_backgroundResourceLoadedCallback != null)
            {
                ...
                Interop.ViewSignal.ResourceReadyDisconnect(handle, _backgroundResourceLoadedCallback.ToHandleRef(this));
                NDalicPINVOKE.ThrowExceptionIfExistsDebug();
                _backgroundResourceLoadedCallback = null;
            }
        }
        ...
        private void OnBackgroundResourceLoaded(IntPtr view)
        {
            ...
            View.BackgroundResourceLoadedEventArgs e = new()
            {
                Status = (ResourceLoadingStatusType)Interop.View.GetVisualResourceStatus(_owner.SwigCPtr, View.Property.BACKGROUND)
            };

            _backgroundResourceLoadedEventHandler?.Invoke(_owner, e);
        }
    }
}
