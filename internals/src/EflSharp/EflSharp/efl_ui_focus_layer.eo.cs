   ...
   public System.IntPtr NativeClass {
      get {
         if (((object)this).GetType() == typeof (LayerConcrete))
            return Efl.Ui.Focus.LayerConcreteNativeInherit.GetEflClassStatic();
         else
...
private static object Dirty_logic_freezeChangedEvtKey = new object();
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    [return: MarshalAs(UnmanagedType.U1)] private static extern bool efl_ui_focus_layer_enable_get(System.IntPtr obj);
   /// <summary>Enable property</summary>
   /// <returns><c>true</c> to set enable the layer <c>false</c> to disable it</returns>
   public bool GetEnable() {
       var _ret_var = efl_ui_focus_layer_enable_get(Efl.Ui.Focus.LayerConcrete.efl_ui_focus_layer_mixin_get());
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void efl_ui_focus_layer_enable_set(System.IntPtr obj,  [MarshalAs(UnmanagedType.U1)]  bool v);
   /// <summary>Enable property</summary>
   /// <param name="v"><c>true</c> to set enable the layer <c>false</c> to disable it</param>
   /// <returns></returns>
   public  void SetEnable( bool v) {
                         efl_ui_focus_layer_enable_set(Efl.Ui.Focus.LayerConcrete.efl_ui_focus_layer_mixin_get(),  v);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void efl_ui_focus_layer_behaviour_get(System.IntPtr obj,  [MarshalAs(UnmanagedType.U1)]  out bool enable_on_visible,  [MarshalAs(UnmanagedType.U1)]  out bool cycle);
   /// <summary>Constructor for setting the behaviour of the layer</summary>
   /// <param name="enable_on_visible"><c>true</c> means layer will set itself once the inheriting widget becomes visible, <c>false</c> means the layer isn&apos;t enabled automatically</param>
   /// <param name="cycle">If <c>true</c> the focus will cycle in the layer, if <c>false</c></param>
   /// <returns></returns>
   public  void GetBehaviour( out bool enable_on_visible,  out bool cycle) {
                                           efl_ui_focus_layer_behaviour_get(Efl.Ui.Focus.LayerConcrete.efl_ui_focus_layer_mixin_get(),  out enable_on_visible,  out cycle);
      Eina.Error.RaiseIfUnhandledException();
                               }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void efl_ui_focus_layer_behaviour_set(System.IntPtr obj,  [MarshalAs(UnmanagedType.U1)]  bool enable_on_visible,  [MarshalAs(UnmanagedType.U1)]  bool cycle);
   /// <summary>Constructor for setting the behaviour of the layer</summary>
   /// <param name="enable_on_visible"><c>true</c> means layer will set itself once the inheriting widget becomes visible, <c>false</c> means the layer isn&apos;t enabled automatically</param>
   /// <param name="cycle">If <c>true</c> the focus will cycle in the layer, if <c>false</c></param>
   /// <returns></returns>
   public  void SetBehaviour( bool enable_on_visible,  bool cycle) {
                                           efl_ui_focus_layer_behaviour_set(Efl.Ui.Focus.LayerConcrete.efl_ui_focus_layer_mixin_get(),  enable_on_visible,  cycle);
      Eina.Error.RaiseIfUnhandledException();
                               }
...
public class LayerConcreteNativeInherit : Efl.Eo.NativeClass{
    ...
    private static Efl.Ui.Focus.Object request_subchild(System.IntPtr obj, System.IntPtr pd,  Efl.Ui.Focus.Object child)
   {
      ...
      if(wrapper != null) {
                                    Efl.Ui.Focus.Object _ret_var = default(Efl.Ui.Focus.Object);
         try {
            _ret_var = ((LayerConcrete)wrapper).RequestSubchild( child);
         } catch (Exception e) {
            Eina.Log.Warning($"Callback error: {e.ToString()}");
            Eina.Error.Set(Eina.Error.UNHANDLED_EXCEPTION);
         }
