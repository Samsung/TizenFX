...
[PanesNativeInherit]
public class Panes : Efl.Ui.Layout, Efl.Eo.IWrapper,Efl.Ui.Clickable,Efl.Ui.Direction
{
   ...
   public new delegate void ConstructingMethod(Panes obj);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)] internal static extern System.IntPtr
      efl_ui_panes_class_get();
   ///<summary>Creates a new instance.</summary>
   ///<param name="parent">Parent instance.</param>
   ///<param name="init_cb">Delegate to call constructing methods that should be run inside the constructor.</param>
   public Panes(Efl.Object parent = null, ConstructingMethod init_cb=null) : base("Panes", efl_ui_panes_class_get(), typeof(Panes), parent)
   {
      if (init_cb != null) {
         init_cb(this);
      }
   ...
   protected Panes(String klass_name, IntPtr base_klass, System.Type managed_type, Efl.Object parent) : base(klass_name, base_klass, managed_type, parent) {}
   ...
   public event EventHandler UnpressEvt
   {
      add {
         lock (eventLock) {
            ...
            if (add_cpp_event_handler(key, this.evt_UnpressEvt_delegate)) {
...
private static object RepeatedEvtKey = new object();
   ...
   public Efl.Ui.PanesPart Second
   {
      get
      {
         Efl.Object obj = efl_part_get(NativeHandle, "second");
   ...
   public Efl.Ui.PanesPart First
   {
      get
      {
         Efl.Object obj = efl_part_get(NativeHandle, "first");
         return Efl.Ui.PanesPart.static_cast(obj);
      }
   }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    protected static extern double efl_ui_panes_split_ratio_get(System.IntPtr obj);
   ...
   virtual public double GetSplitRatio() {
       var _ret_var = efl_ui_panes_split_ratio_get((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    protected static extern  void efl_ui_panes_split_ratio_set(System.IntPtr obj,   double ratio);
   /// <summary>Set the split ratio between panes widget first and second parts.
   /// By default it&apos;s homogeneous, i.e., both sides have the same size.
   /// 
   /// If something different is required, it can be set with this function. For example, if the first content should be displayed over 75% of the panes size, <c>ratio</c> should be passed as 0.75. This way, second content will be resized to 25% of panes size.
   ...
   virtual public  void SetSplitRatio( double ratio) {
                         efl_ui_panes_split_ratio_set((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle),  ratio);
      Eina.Error.RaiseIfUnhandledException();
                   }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    [return: MarshalAs(UnmanagedType.U1)] protected static extern bool efl_ui_panes_fixed_get(System.IntPtr obj);
   ...
   virtual public bool GetFixed() {
       var _ret_var = efl_ui_panes_fixed_get((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle));
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    protected static extern  void efl_ui_panes_fixed_set(System.IntPtr obj,  [MarshalAs(UnmanagedType.U1)]  bool kw_fixed);
   /// <summary>Set whether the left and right panes can be resized by user interaction.
   /// By default panes&apos; contents are resizable by user interaction.</summary>
   ...
   virtual public  void SetFixed( bool kw_fixed) {
                         efl_ui_panes_fixed_set((inherited ? Efl.Eo.Globals.efl_super(this.NativeHandle, this.NativeClass) : this.NativeHandle),  kw_fixed);
      Eina.Error.RaiseIfUnhandledException();
                   }
...
public class PanesNativeInherit : Efl.Ui.LayoutNativeInherit{
   public override System.Collections.Generic.List<Efl_Op_Description> GetEoOps(System.Type type)
   {
      ...
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_ui_panes_split_ratio_get"), func = Marshal.GetFunctionPointerForDelegate(efl_ui_panes_split_ratio_get_static_delegate)});
      efl_ui_panes_split_ratio_set_static_delegate = new efl_ui_panes_split_ratio_set_delegate(split_ratio_set);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_ui_panes_split_ratio_set"), func = Marshal.GetFunctionPointerForDelegate(efl_ui_panes_split_ratio_set_static_delegate)});
      efl_ui_panes_fixed_get_static_delegate = new efl_ui_panes_fixed_get_delegate(fixed_get);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_ui_panes_fixed_get"), func = Marshal.GetFunctionPointerForDelegate(efl_ui_panes_fixed_get_static_delegate)});
      efl_ui_panes_fixed_set_static_delegate = new efl_ui_panes_fixed_set_delegate(fixed_set);
      descs.Add(new Efl_Op_Description() {api_func = Efl.Eo.Globals.dlsym(Efl.Eo.Globals.RTLD_DEFAULT, "efl_ui_panes_fixed_set"), func = Marshal.GetFunctionPointerForDelegate(efl_ui_panes_fixed_set_static_delegate)});
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]  private static extern double efl_ui_panes_split_ratio_get(System.IntPtr obj);
    private static double split_ratio_get(System.IntPtr obj, System.IntPtr pd)
   {
      ...
      return _ret_var;
         ...
         return efl_ui_panes_split_ratio_get(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)));
      }
   }
   private efl_ui_panes_split_ratio_get_delegate efl_ui_panes_split_ratio_get_static_delegate;


    private delegate  void efl_ui_panes_split_ratio_set_delegate(System.IntPtr obj, System.IntPtr pd,   double ratio);
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]  private static extern  void efl_ui_panes_split_ratio_set(System.IntPtr obj,   double ratio);
    private static  void split_ratio_set(System.IntPtr obj, System.IntPtr pd,  double ratio)
   {
      ...
      if(wrapper != null) {
         ...
         efl_ui_panes_split_ratio_set(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)),  ratio);
      }
   }
   private efl_ui_panes_split_ratio_set_delegate efl_ui_panes_split_ratio_set_static_delegate;
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]  [return: MarshalAs(UnmanagedType.U1)] private static extern bool efl_ui_panes_fixed_get(System.IntPtr obj);
    private static bool fixed_get(System.IntPtr obj, System.IntPtr pd)
   {
      ...
      return _ret_var;
         ...
         return efl_ui_panes_fixed_get(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)));
      }
   }
   private efl_ui_panes_fixed_get_delegate efl_ui_panes_fixed_get_static_delegate;
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]  private static extern  void efl_ui_panes_fixed_set(System.IntPtr obj,  [MarshalAs(UnmanagedType.U1)]  bool kw_fixed);
    private static  void fixed_set(System.IntPtr obj, System.IntPtr pd,  bool kw_fixed)
   {
      ...
      if(wrapper != null) {
         ...
         efl_ui_panes_fixed_set(Efl.Eo.Globals.efl_super(obj, Efl.Eo.Globals.efl_class_get(obj)),  kw_fixed);
      }
   }
   private efl_ui_panes_fixed_set_delegate efl_ui_panes_fixed_set_static_delegate;
