   ...
   
{
   ...
   public System.IntPtr NativeClass {
      get {
         if (((object)this).GetType() == typeof (ValueConcrete))
            return Efl.Access.ValueConcreteNativeInherit.GetEflClassStatic();
         else
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void efl_access_value_and_text_get(System.IntPtr obj,   out double value,  [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(Efl.Eo.StringKeepOwnershipMarshaler))]  out  System.String text);
   /// <summary>Gets value displayed by a accessible widget.</summary>
   /// <param name="value">Value of widget casted to floating point number.</param>
   /// <param name="text">string describing value in given context eg. small, enough</param>
   /// <returns></returns>
   public  void GetValueAndText( out double value,  out  System.String text) {
                                           efl_access_value_and_text_get(Efl.Access.ValueConcrete.efl_access_value_interface_get(),  out value,  out text);
      Eina.Error.RaiseIfUnhandledException();
                               }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    [return: MarshalAs(UnmanagedType.U1)] private static extern bool efl_access_value_and_text_set(System.IntPtr obj,   double value,  [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(Efl.Eo.StringKeepOwnershipMarshaler))]   System.String text);
   /// <summary>Value and text property</summary>
   /// <param name="value">Value of widget casted to floating point number.</param>
   /// <param name="text">string describing value in given context eg. small, enough</param>
   /// <returns><c>true</c> if setting widgets value has succeeded, otherwise <c>false</c> .</returns>
   public bool SetValueAndText( double value,   System.String text) {
                                           var _ret_var = efl_access_value_and_text_set(Efl.Access.ValueConcrete.efl_access_value_interface_get(),  value,  text);
      Eina.Error.RaiseIfUnhandledException();
                              return _ret_var;
 }
   ...
   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern  void efl_access_value_range_get(System.IntPtr obj,   out double lower_limit,   out double upper_limit,  [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(Efl.Eo.StringKeepOwnershipMarshaler))]  out  System.String description);
   /// <summary>Gets a range of all possible values and its description</summary>
   /// <param name="lower_limit">Lower limit of the range</param>
   /// <param name="upper_limit">Upper limit of the range</param>
   /// <param name="description">Description of the range</param>
   ...
   public  void GetRange( out double lower_limit,  out double upper_limit,  out  System.String description) {
                                                             efl_access_value_range_get(Efl.Access.ValueConcrete.efl_access_value_interface_get(),  out lower_limit,  out upper_limit,  out description);
      Eina.Error.RaiseIfUnhandledException();
                                           }


   [System.Runtime.InteropServices.DllImport(efl.Libs.Elementary)]
    private static extern double efl_access_value_increment_get(System.IntPtr obj);
   /// <summary>Gets an minimal incrementation value</summary>
   /// <returns>Minimal incrementation value</returns>
   public double GetIncrement() {
       var _ret_var = efl_access_value_increment_get(Efl.Access.ValueConcrete.efl_access_value_interface_get());
      Eina.Error.RaiseIfUnhandledException();
      return _ret_var;
 }
   /// <summary>Gets an minimal incrementation value</summary>
...
public class ValueConcreteNativeInherit : Efl.Eo.NativeClass{
    ...
    private static  void value_and_text_get(System.IntPtr obj, System.IntPtr pd,  out double value,  out  System.IntPtr text)
   {
      ...
      if(wrapper != null) {
         ...
         try {
            ...
            text= Efl.Eo.Globals.cached_string_to_intptr(((ValueConcrete)wrapper).cached_strings, _out_text);
                        } else {
      ...
      if(wrapper != null) {
         ...
         try {
            ...
            Eina.Error.Set(Eina.Error.UNHANDLED_EXCEPTION);
                  ...
                  description= Efl.Eo.Globals.cached_string_to_intptr(((ValueConcrete)wrapper).cached_strings, _out_description);
                              } else {
