    ...
    
{
    ...
    public System.IntPtr NativeClass {
        get {
            if (((object)this).GetType() == typeof (IFileConcrete))
                return Efl.IFileNativeInherit.GetEflClassStatic();
            else
    ...
    public Eina.File GetMmap() {
         var _ret_var = Efl.IFileNativeInherit.efl_file_mmap_get_ptr.Value.Delegate(this.NativeHandle);
    ...
    public Eina.Error SetMmap( Eina.File f) {
                                 var _ret_var = Efl.IFileNativeInherit.efl_file_mmap_set_ptr.Value.Delegate(this.NativeHandle, f);
        Eina.Error.RaiseIfUnhandledException();
                        return _ret_var;
 }
    /// <summary>Retrieve the file path from where an object is to fetch the data.
    ...
    public System.String GetFile() {
         var _ret_var = Efl.IFileNativeInherit.efl_file_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    /// <summary>Set the file path from where an object will fetch the data.
    ...
    public Eina.Error SetFile( System.String file) {
                                 var _ret_var = Efl.IFileNativeInherit.efl_file_set_ptr.Value.Delegate(this.NativeHandle, file);
        Eina.Error.RaiseIfUnhandledException();
                        return _ret_var;
 }
    /// <summary>Get the previously-set key which corresponds to the target data within a file.
    ...
    public System.String GetKey() {
         var _ret_var = Efl.IFileNativeInherit.efl_file_key_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    /// <summary>Set the key which corresponds to the target data within a file.
    ...
    public void SetKey( System.String key) {
                                 Efl.IFileNativeInherit.efl_file_key_set_ptr.Value.Delegate(this.NativeHandle, key);
        Eina.Error.RaiseIfUnhandledException();
                         }
    /// <summary>Get the load state of the object.
    /// (Since EFL 1.22)</summary>
    ...
    public bool GetLoaded() {
         var _ret_var = Efl.IFileNativeInherit.efl_file_loaded_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    /// <summary>Perform all necessary operations to open and load file data into the object using the <see cref="Efl.IFile.File"/> (or <see cref="Efl.IFile.Mmap"/>) and <see cref="Efl.IFile.Key"/> properties.
    ...
    public Eina.Error Load() {
         var _ret_var = Efl.IFileNativeInherit.efl_file_load_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    /// <summary>Perform all necessary operations to unload file data from the object.
    ...
    /// <returns></returns>
    public void Unload() {
         Efl.IFileNativeInherit.efl_file_unload_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
         }
    /// <summary>Get the mmaped file from where an object will fetch the real data (it must be an <see cref="Eina.File"/>).
/// (Since EFL 1.22)</summary>
...
public class IFileNativeInherit  : Efl.Eo.NativeClass{
