...
namespace NUILayout
{
    internal class AbsolutePivotBottomEndPaddingMargin : View, IExample
    {
        public AbsolutePivotBottomEndPaddingMargin()
        {
        ...
        public void Activate()
        {
            ...
            {
                AppBar = new AppBar() { Title = "PivotBottomEnd Padding Margin", BackgroundColor = Color.White },
                Content = this,
                WidthSpecification = LayoutParamPolicies.MatchParent,
                HeightSpecification = LayoutParamPolicies.MatchParent,
