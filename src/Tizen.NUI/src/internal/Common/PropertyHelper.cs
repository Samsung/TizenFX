...
namespace Tizen.NUI
{
    ...
    internal static class PropertyHelper
    {
        ...
        private static readonly FrozenDictionary<string, string> viewPropertySynonymTable = new Dictionary<string, string>()
        {
            ...
            // Legacy Actor property names renamed in dali-core 2.5.x (same type only).
            { "anchorPoint", "pivot" },
            { "AnchorPoint", "pivot" },
            { "anchorPointX", "pivotX" },
            { "AnchorPointX", "pivotX" },
            ...
            { "anchorPointZ", "pivotZ" },
            { "AnchorPointZ", "pivotZ" },
            { "positionUsesAnchorPoint", "positionUsesPivot" },
            { "PositionUsesAnchorPoint", "positionUsesPivot" },
            ...
            { "KeyboardFocusable", "focusable" },
            { "keyboardFocusableChildren", "allowDescendantFocus" },
            { "KeyboardFocusableChildren", "allowDescendantFocus" },
            { "touchFocusable", "focusOnTouch" },
            { "TouchFocusable", "focusOnTouch" },
            { "userInteractionEnabled", "enabled" },
            { "UserInteractionEnabled", "enabled" },
            { "allowOnlyOwnTouch", "allowSelfInitiatedTouchOnly" },
            { "AllowOnlyOwnTouch", "allowSelfInitiatedTouchOnly" },
            { "inheritLayoutDirection", "inheritLayoutDirectionLegacy" },
            { "InheritLayoutDirection", "inheritLayoutDirectionLegacy" },
        }.ToFrozenDictionary();
