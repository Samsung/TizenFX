...
namespace CoreUI
{
    namespace Wearable
    {
        ...
        public class CircleUIManager
        {
            ...
            /// <summary>
            /// Creates and initializes a new instance of the CircleUIManager class with the Window parent.
            /// </summary>
            /// <since_tizen> 6 </since_tizen>
            public CircleUIManager(CoreUI.UI.Win win)
            {
                _handle = Interop.Eext.eext_circle_surface_conformant_add(win.NativeHandle);
            }

            public CircleUIManager(CoreUI.Object layout)
            {
                _handle = Interop.Eext.eext_circle_surface_layout_add(layout.NativeHandle);
            }

            public CircleUIManager(CoreUI.UI.Spotlight.Container container)
            {
