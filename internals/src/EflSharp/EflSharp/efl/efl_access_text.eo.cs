    ...
    public System.IntPtr NativeClass {
        get {
            if (((object)this).GetType() == typeof (ITextConcrete))
                return Efl.Access.ITextNativeInherit.GetEflClassStatic();
            else
...
private static object AccessTextSelectionChangedEvtKey = new object();
    ...
    public Eina.Unicode GetCharacter( int offset) {
                                 var _ret_var = Efl.Access.ITextNativeInherit.efl_access_text_character_get_ptr.Value.Delegate(this.NativeHandle, offset);
        Eina.Error.RaiseIfUnhandledException();
                        return _ret_var;
 }
    /// <summary>Gets string, start and end offset in text according to given initial offset and granularity.</summary>
    ...
    public System.String GetString( Efl.Access.TextGranularity granularity,  int start_offset,  int end_offset) {
        ...
        var _in_end_offset = Eina.PrimitiveConversion.ManagedToPointerAlloc(end_offset);
                                                        var _ret_var = Efl.Access.ITextNativeInherit.efl_access_text_string_get_ptr.Value.Delegate(this.NativeHandle, granularity,  _in_start_offset,  _in_end_offset);
        Eina.Error.RaiseIfUnhandledException();
                                                        return _ret_var;
 }
    /// <summary>Gets text of accessible widget.</summary>
    ...
    public System.String GetAccessText( int start_offset,  int end_offset) {
                                                         var _ret_var = Efl.Access.ITextNativeInherit.efl_access_text_get_ptr.Value.Delegate(this.NativeHandle, start_offset,  end_offset);
        Eina.Error.RaiseIfUnhandledException();
                                        return _ret_var;
 }
    /// <summary>Gets offset position of caret (cursor)</summary>
    ...
    public int GetCaretOffset() {
         var _ret_var = Efl.Access.ITextNativeInherit.efl_access_text_caret_offset_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    /// <summary>Caret offset property</summary>
    ...
    public bool SetCaretOffset( int offset) {
                                 var _ret_var = Efl.Access.ITextNativeInherit.efl_access_text_caret_offset_set_ptr.Value.Delegate(this.NativeHandle, offset);
        Eina.Error.RaiseIfUnhandledException();
                        return _ret_var;
 }
    /// <summary>Indicate if a text attribute with a given name is set</summary>
    ...
    public bool GetAttribute( System.String name,  int start_offset,  int end_offset,  out System.String value) {
                 var _in_start_offset = Eina.PrimitiveConversion.ManagedToPointerAlloc(start_offset);
        var _in_end_offset = Eina.PrimitiveConversion.ManagedToPointerAlloc(end_offset);
                                                                                var _ret_var = Efl.Access.ITextNativeInherit.efl_access_text_attribute_get_ptr.Value.Delegate(this.NativeHandle, name,  _in_start_offset,  _in_end_offset,  out value);
        Eina.Error.RaiseIfUnhandledException();
                                                                        return _ret_var;
 }
    /// <summary>Gets list of all text attributes.</summary>
    ...
    public Eina.List<Efl.Access.TextAttribute> GetTextAttributes( int start_offset,  int end_offset) {
         var _in_start_offset = Eina.PrimitiveConversion.ManagedToPointerAlloc(start_offset);
        var _in_end_offset = Eina.PrimitiveConversion.ManagedToPointerAlloc(end_offset);
                                        var _ret_var = Efl.Access.ITextNativeInherit.efl_access_text_attributes_get_ptr.Value.Delegate(this.NativeHandle, _in_start_offset,  _in_end_offset);
        Eina.Error.RaiseIfUnhandledException();
    ...
    public Eina.List<Efl.Access.TextAttribute> GetDefaultAttributes() {
         var _ret_var = Efl.Access.ITextNativeInherit.efl_access_text_default_attributes_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return new Eina.List<Efl.Access.TextAttribute>(_ret_var, true, true);
 }
    /// <summary>Character extents</summary>
    ...
    public bool GetCharacterExtents( int offset,  bool screen_coords,  out Eina.Rect rect) {
                                ...
                                var _ret_var = Efl.Access.ITextNativeInherit.efl_access_text_character_extents_get_ptr.Value.Delegate(this.NativeHandle, offset,  screen_coords,  out _out_rect);
        Eina.Error.RaiseIfUnhandledException();
                        rect = _out_rect;
                                return _ret_var;
 }
    ...
    public int GetCharacterCount() {
         var _ret_var = Efl.Access.ITextNativeInherit.efl_access_text_character_count_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    /// <summary>Offset at given point</summary>
    ...
    public int GetOffsetAtPoint( bool screen_coords,  int x,  int y) {
                                                                                 var _ret_var = Efl.Access.ITextNativeInherit.efl_access_text_offset_at_point_get_ptr.Value.Delegate(this.NativeHandle, screen_coords,  x,  y);
        Eina.Error.RaiseIfUnhandledException();
                                                        return _ret_var;
 }
    /// <summary>Bounded ranges</summary>
    ...
    public Eina.List<Efl.Access.TextRange> GetBoundedRanges( bool screen_coords,  Eina.Rect rect,  Efl.Access.TextClipType xclip,  Efl.Access.TextClipType yclip) {
                 Eina.Rect.NativeStruct _in_rect = rect;
                                                                                        var _ret_var = Efl.Access.ITextNativeInherit.efl_access_text_bounded_ranges_get_ptr.Value.Delegate(this.NativeHandle, screen_coords,  _in_rect,  xclip,  yclip);
        Eina.Error.RaiseIfUnhandledException();
    ...
    public bool GetRangeExtents( bool screen_coords,  int start_offset,  int end_offset,  out Eina.Rect rect) {
                                                                 var _out_rect = new Eina.Rect.NativeStruct();
                                        var _ret_var = Efl.Access.ITextNativeInherit.efl_access_text_range_extents_get_ptr.Value.Delegate(this.NativeHandle, screen_coords,  start_offset,  end_offset,  out _out_rect);
        Eina.Error.RaiseIfUnhandledException();
                                rect = _out_rect;
                                        return _ret_var;
 }
    ...
    public int GetSelectionsCount() {
         var _ret_var = Efl.Access.ITextNativeInherit.efl_access_text_selections_count_get_ptr.Value.Delegate(this.NativeHandle);
        Eina.Error.RaiseIfUnhandledException();
        return _ret_var;
 }
    /// <summary>Selection property</summary>
    ...
    public void GetAccessSelection( int selection_number,  out int start_offset,  out int end_offset) {
                                                                                 Efl.Access.ITextNativeInherit.efl_access_text_access_selection_get_ptr.Value.Delegate(this.NativeHandle, selection_number,  out start_offset,  out end_offset);
        Eina.Error.RaiseIfUnhandledException();
                                                         }
    /// <summary>Selection property</summary>
    /// <param name="selection_number">Selection number for identification</param>
    ...
    public bool SetAccessSelection( int selection_number,  int start_offset,  int end_offset) {
                                                                                 var _ret_var = Efl.Access.ITextNativeInherit.efl_access_text_access_selection_set_ptr.Value.Delegate(this.NativeHandle, selection_number,  start_offset,  end_offset);
        Eina.Error.RaiseIfUnhandledException();
                                                        return _ret_var;
 }
    /// <summary>Add selection</summary>
    ...
    public bool AddSelection( int start_offset,  int end_offset) {
                                                         var _ret_var = Efl.Access.ITextNativeInherit.efl_access_text_selection_add_ptr.Value.Delegate(this.NativeHandle, start_offset,  end_offset);
        Eina.Error.RaiseIfUnhandledException();
                                        return _ret_var;
 }
    /// <summary>Remove selection</summary>
    ...
    public bool SelectionRemove( int selection_number) {
                                 var _ret_var = Efl.Access.ITextNativeInherit.efl_access_text_selection_remove_ptr.Value.Delegate(this.NativeHandle, selection_number);
        Eina.Error.RaiseIfUnhandledException();
                        return _ret_var;
 }
    /// <summary>Caret offset property</summary>
