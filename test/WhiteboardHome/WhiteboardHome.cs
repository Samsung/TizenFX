...
namespace WhiteboardGallery
{
    class Program : NUIApplication
    {
       class CustomBorder : DefaultBorder
        ...
        private Rectangle allAppsWinPosition = new Rectangle(100, 207, 460, 510);
        ...
        private Rectangle facebookWinPosition = new Rectangle(650, 250, 400, 400);
        //    
        ...
        // TrayItem App View    
        private ImageView [] trayItem = new ImageView[6];
        ...
        private float fontScale = 4.0f;
        private float fontFacebookScale = 4.4f;
        ...
        private double [] circlePositionX = new double[6]{1800, 1800, 1800, 1800, 1800, 1800};
        private double [] circlePositionY = new double[6]{110, 290, 455, 619, 780, 960};
        
        // Tray Items
        private View [] TrayPoint = new View[6];
        private float [] trayPointSize = new float[6]{200.0f, 160.0f, 160.0f, 160.0f, 160.0f, 200.0f};
        private double [] circleRadius = new double[6]{100.0f, 80.0f, 80.0f, 80.0f, 80.0f, 100.0f};
        ...
        void CreateVideo()
        {
            var appControl = new Tizen.Applications.AppControl();
            appControl.Operation = Tizen.Applications.AppControlOperations.Default;
            appControl.ApplicationId = "org.tizen.example.WhiteboardVideo";
            Tizen.Applications.AppControl.SendLaunchRequest(appControl);
        }
        ...
        void CreateFacebook()
        {
          ...
          {
            SubWindows[4] = new Window("FacebookWindow", new CustomBorder(), facebookWinPosition, false);
            ...
            textLongPressed.Detected += (s, e) =>
            {
              if(e.LongPressGesture.State == Gesture.StateType.Started)
              {
                ...
                shadowView = new TextLabel()
                {
                  ...
                  WidthSpecification = LayoutParamPolicies.MatchParent,
                  HeightSpecification = LayoutParamPolicies.WrapContent,
                  Position = new Position((int)originPointX, (int)originPointY),
        ...
        void changeTrayItemBackground(int itemID, bool isPressed)
        {
          ...
          {
            if (isPressed)
              trayItem[itemID].ResourceUrl = Tizen.Applications.Application.Current.DirectoryInfo.SharedResource + "videop.png";
            else
              trayItem[itemID].ResourceUrl = Tizen.Applications.Application.Current.DirectoryInfo.SharedResource + "video.png";
          }
          else if(itemID == 4)
          {
            if (isPressed)
        ...
        void CreateTrayApps()
        {
          if (trayWindow == null)
          {
            trayWindow = new Window("TrayWindow", new Rectangle(1700, 40, 200, 1000), false);
            ...
            {
              Size = new Size(145, 145),
              ResourceUrl = Tizen.Applications.Application.Current.DirectoryInfo.SharedResource + "video.png",
              Margin = 10,
            };
            ...
            trayItem[3].TouchEvent += (s, e) =>
            {
              ...
              {
                CreateVideo();
                trayItem[3].ResourceUrl = Tizen.Applications.Application.Current.DirectoryInfo.SharedResource + "video.png";
              }
              else if (e.Touch.GetState(0) == PointStateType.Down)
              {
                trayItem[3].ResourceUrl = Tizen.Applications.Application.Current.DirectoryInfo.SharedResource + "videop.png";
              }
              return true;
            };
            ...
            trayItem[4].TouchEvent += (s, e) =>
            {
              if (e.Touch.GetState(0) == PointStateType.Up)
              {
                trayItem[4].ResourceUrl = Tizen.Applications.Application.Current.DirectoryInfo.SharedResource + "painter.png";
                LaunchApp();
              }
              else if (e.Touch.GetState(0) == PointStateType.Down)
              {
                trayItem[4].ResourceUrl = Tizen.Applications.Application.Current.DirectoryInfo.SharedResource + "painterp.png";
              }
              return true;
            };
            ...
            mainView.Add(trayItem[5]);
            trayItem[5].TouchEvent += (s, e) =>
            {
              if (e.Touch.GetState(0) == PointStateType.Up)
              {
                CreateAllApps();
                trayItem[5].ResourceUrl = Tizen.Applications.Application.Current.DirectoryInfo.SharedResource + "allapps.png";
              }
              else if (e.Touch.GetState(0) == PointStateType.Down)
              {
                trayItem[5].ResourceUrl = Tizen.Applications.Application.Current.DirectoryInfo.SharedResource + "allappsp.png";
              }
              return true;
            };
          }
        ...
        void Initialize()
        {
            ...
            win.TouchEvent += (s, e) =>
            {
              ...
              {
                if (currentItemId == 4 && currentItemIdPressed)
                {
                  LaunchApp();
                }
                originPoint.Hide();
